...
data.basenodes.inns = {
	...
	['Icecrown']={
		...
		{name="The Shadow Vault",faction="B",npc="Initiate Brenners",npcid=30308,x=44.0,y=22.2},
	},
	['Durotar']={
	...
	['Frostfire Ridge']={
		...
		{name="Bladespire Fortress",faction="H",npc="Der'shway",npcid=76746,x=42.9,y=44.7},
	},
	['Lunarfall']={
	...
	["Mac'Aree"] = {
		-- The Vindicaar in Mac'Aree
			{name="The Vindicaar, Mac'Aree",faction="B",npc="High Priestess Ishanah",npcid=123395,f=3,x=49.63,y=68.54},
	},
