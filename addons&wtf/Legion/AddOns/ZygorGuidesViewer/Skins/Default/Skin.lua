...
function Skin:UpdateSkin()
	...
	ZygorGuidesViewerFrame_Border_Guides_GuideButton:SetDisabledTexture(ZygorGuidesViewerFrame_Border_Guides_GuideButton:GetHighlightTexture()) -- bandaid for grayed guide-menu
...
function Skin:AlignFrame()
	...
	CHAIN(ZygorGuidesViewerFrame_Border_Flash_Top) :SetColorTexture(1) :SetTexture(tx,true) :SetTexCoord(UPcoords(0,1,0,1))
