...
function Gathering:GetDisplayInfo(refresh)
	...
	-- rate
	local rate = ("%s"):format(ZGV.GetMoneyString(self.profitperhour,GOLD_FORMAT_TYPE)).."/hr"
	...
	local gold = ZGV.GetMoneyString(self.profitperhour*self.scale,GOLD_FORMAT_TYPE)
