...
function Mailtools:AddItemToInventory(bag,slot)
	...
	if itemid then
		...
		for i=1,n do
			...
			if line then
				isbop = isbop or line==ITEM_BIND_ON_PICKUP
				--isboa = isboa or line==ITEM_BIND_TO_BNETACCOUNT
				--isboa = isboa or line==ITEM_BNETACCOUNTBOUND
				isbound = isbound or line==ITEM_SOULBOUND
				isbound = isbound or line==ITEM_BIND_QUEST
				isbound = isbound or line==ITEM_CONJURED
