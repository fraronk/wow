...
function GuideMenu:Open(path,iscurrent,...)
	...
	elseif path~="Options" and path~="Search" then 
...
function ZGV:ZYGORGV_LOADING_TOPLEVEL_GROUPS_UPDATED()
...
function GuideMenu:Show(path,...)
	...
	ZGV:AddMessage("ZYGOR_GUIDES_PARSED",function() GuideMenu:Update() end)
