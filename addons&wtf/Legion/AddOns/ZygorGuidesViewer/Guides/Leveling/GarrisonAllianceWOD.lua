...
step
_Go through_ the doorway |goto Lunarfall 40.9,45.5 < 10 |walk
_Follow the road_ towards the beach |goto Lunarfall 21.4,38.4 < 20 |only if walking
...
step
_Follow_ the road out of your Garrison |goto Lunarfall 61.0,85.0 < 30 |only if walking
...
You can find another portal at [Shadowmoon Valley D 48.4,33.4]
You can find another portal at [Shadowmoon Valley D 48.9,31.8]
step
talk Hakaam##62769
...
step
click Draenei Bucket##230883 |goto Shadowmoon Valley D 51.8,32.5 < 10
...
step
label "voidmancers"
kill 8 Shadowmoon Voidmancer##80162 |q Dark Enemies##33765/1 |goto 52.48,34.20
step
_Swim across_ and _go up_ the hill |goto Shadowmoon Valley D 47.6,35.8 < 20 |only if walking
_Continue_ running up the hill and _to the left_ |goto 47.5,39.7 < 20 |only if walking
...
step
_Follow_ the trail _up_ through the cliffs |goto Shadowmoon Valley D 39.3,53.7 < 20 |only if walking
_Follow_ the path to the _right_ |goto Shadowmoon Valley D 38.0,55.3 < 20 |only if walking
...
step
Follow Prophet Velen |scenariogoal 24541 |goto Shadowmoon Valley D 79.9,46.6 |q 33059
scenariostage 1
step
kill Krull##77767 |scenariogoal 24539 |goto Shadowmoon Valley D 80.0,46.6 |q 33059
scenariostage 2
step
...
Speak to Velen on the Karabor Stairs |scenariogoal 24543 |goto Shadowmoon Valley D 79.2,46.6 |q 33059
scenariostage 4
step
Watch the dialogue
Witness the Fate of Karabor |q The Fate of Karabor##33059/2 |goto Shadowmoon Valley D 79.2,46.6 |q 33059
step
_Follow_ the path back _down_ |goto Shadowmoon Valley D 37.5,54.5 < 20 |only if walking
talk Prophet Velen##79043
...
step
_Follow_ the path |goto Stormshield/0 55.8,24.0 < 30 |only if walking
_Enter_ Ashran by going here |goto Ashran/0 41.9,80.2 < 20 |walk
|tip Accept the popup that displays to join the PvP battle.
_Follow_ the path |goto Ashran/0 45.4,76.4 < 30
...
_Follow_ the path |goto Ashran/0 45.4,76.4 < 30
kill Enemy Players in Ashran
collect Orc Heart##118362 |q Nemesis: Becoming Death##36963/1 |goto Ashran/0 46.7,70.8 |only if havequest(36963) or completedq(36963)
collect Pandaren Heart##118358 |q Nemesis: Becoming Death##36967/1 |goto Ashran/0 46.7,70.8 |only if havequest(36967) or completedq(36967)
collect Blood Elf Heart##118356 |q Nemesis: Becoming Death##36957/1 |goto Ashran/0 46.7,70.8 |only if havequest(36957) or completedq(36957)
collect Goblin Heart##118357 |q Nemesis: Becoming Death##36969/1 |goto Ashran/0 46.7,70.8 |only if havequest(36969) or completedq(36969)
collect Troll Heart##118360 |q Nemesis: Becoming Death##36965/1 |goto Ashran/0 46.7,70.8 |only if havequest(36965) or completedq(36965)
collect Tauren Heart##118361 |q Nemesis: Becoming Death##36961/1 |goto Ashran/0 46.7,70.8 |only if havequest(36961) or completedq(36961)
collect Forsaken Heart##118359 |q Nemesis: Becoming Death##36959/1 |goto Ashran/0 46.7,70.8 |only if havequest(36959) or completedq(36959)
...
step
Return to your Garrison |goto Lunarfall/0 30.0,34.1 < 300 |q 36963 |only if havequest(36963) or completedq(36963)
Return to your Garrison |goto Lunarfall/0 30.0,34.1 < 300 |q 36967 |only if havequest(36967) or completedq(36967)
Return to your Garrison |goto Lunarfall/0 30.0,34.1 < 300 |q 36957 |only if havequest(36957) or completedq(36957)
Return to your Garrison |goto Lunarfall/0 30.0,34.1 < 300 |q 36969 |only if havequest(36969) or completedq(36969)
Return to your Garrison |goto Lunarfall/0 30.0,34.1 < 300 |q 36965 |only if havequest(36965) or completedq(36965)
...
turnin Nemesis: Becoming Death##36969 |only if havequest(36969) or completedq(36969)
turnin Nemesis: Becoming Death##36965 |only if havequest(36965) or completedq(36965)
turnin Nemesis: Becoming Death##36961 |only if havequest(36961) or completedq(36961)
turnin Nemesis: Becoming Death##36959 |only if havequest(36959) or completedq(36959)
accept Nemesis: Orcslayer##36964 |only if havequest(36963) or completedq(36963)
accept Nemesis: Huojin's Fall##36968 |only if havequest(36967) or completedq(36967)
accept Nemesis: Death Stalker##36960 |only if havequest(36959) or completedq(36959)
accept Nemesis: Slayer of Sin'dorei##36958 |only if havequest(36957) or completedq(36957)
accept Nemesis: The Butcher##36962 |only if havequest(36961) or completedq(36961)
accept Nemesis: Troll Hunter##36966 |only if havequest(36965) or completedq(36965)
accept Nemesis: Killer of Kezan##36970 |only if havequest(36969) or completedq(36969)
step
_Follow_ the path |goto Stormshield/0 55.8,24.0 < 30 |only if walking
_Enter_ Ashran by going here |goto Ashran/0 41.9,80.2 < 20 |walk
|tip Accept the popup that displays to join the PvP battle.
_Follow_ the path |goto Ashran/0 45.4,76.4 < 30
kill Enemy Players in Ashran
kill 500 Orc Players |q Nemesis: Orcslayer##36964/1 |goto Ashran/0 46.7,70.8 |only if havequest(36963) or completedq(36963)
kill 500 Pandaren Players |q Nemesis: Huojin's Fall##36968/1 |goto Ashran/0 46.7,70.8 |only if havequest(36967) or completedq(36967)
kill 500 Blood Elf Players |q Nemesis: Slayer of Sin'dorei##36958/1 |goto Ashran/0 46.7,70.8 |only if havequest(36957) or completedq(36957)
kill 500 Goblin Players |q Nemesis: Killer of Kezan##36970/1 |goto Ashran/0 46.7,70.8 |only if havequest(36969) or completedq(36969)
kill 500 Troll Players |q Nemesis: Troll Hunter##36966/1 |goto Ashran/0 46.7,70.8 |only if havequest(36965) or completedq(36965)
kill 500 Tauren Players |q Nemesis: The Butcher##36962/1 |goto Ashran/0 46.7,70.8 |only if havequest(36961) or completedq(36961)
kill 500 Forsaken Players |q Nemesis: Death Stalker##36960/1 |goto Ashran/0 46.7,70.8 |only if havequest(36959) or completedq(36959)
...
turnin Nemesis: Slayer of Sin'dorei##36958 |only if havequest(36957) or completedq(36957)
turnin Nemesis: The Butcher##36962 |only if havequest(36961) or completedq(36961)
turnin Nemesis: Troll Hunter##36966 |only if havequest(36965) or completedq(36965)
turnin Nemesis: Killer of Kezan##36970 |only if havequest(36969) or completedq(36969)
step
_Follow_ the path |goto Stormshield/0 55.8,24.0 < 30 |only if walking
_Enter_ Ashran by going here |goto Ashran/0 41.9,80.2 < 20 |walk
|tip Accept the popup that displays to join the PvP battle.
...
Use the _Sticky Grenade Launcher_ #50# Times |goto Lunarfall/0 69.6,35.2 |achieve 9527/2
...
Use the _Pneumatic Power Gauntlet_ #50# Times |goto Lunarfall/0 69.6,35.2 |achieve 9527/3 |only if itemcount(114974) > 0
...
Use the _Pneumatic Power Gauntlet_ #50# Times |goto Lunarfall/0 69.6,35.2 |achieve 9527/3 |only if itemcount(114975) > 0
step
...
Use the _Sentry Turret Dispenser_ #10# Times |goto Lunarfall/0 44.8,46.0 |achieve 9527/7
...
|tip If you can't accept the quest, logout and login again, and the quest should be available.  This seems to be a bug.
step
_Follow_ the path |goto Nagrand D/0 80.3,42.8 < 20 |only if walking
|tip Be careful to stay a good distance away from the nearby Horde town.
_Run up_ the path |goto Nagrand D/0 82.8,41.7 < 20 |only if walking
_Keep running up_ the path |goto Nagrand D/0 84.3,40.2 < 20 |only if walking
...
|tip If you can't accept the quest, logout and login again, and the quest should be available.  This seems to be a bug.
step
_Jump across_ here |goto Nagrand D/0 58.9,60.0 < 15 |only if walking
...
kill Great-Tusk##87083 |q Clefthoof Training: Great-Tusk##36983/1 |goto Shadowmoon Valley D/0 62.9,39.1
...
kill Great-Tusk##87083 |q Talbuk Training: Great-Tusk##36971/1 |goto Shadowmoon Valley D/0 62.9,39.1
...
|tip He will offer other quests, but wait to do them later.  This will save you a lot of travel time each day you have to do these types of quests.  Only accept the quests listed in this step.
step
_Enter_ the small tunnel in the rocks |goto Frostfire Ridge/0 78.9,56.0 < 20 |walk
_Continue running_ through the tunnel |goto Frostfire Ridge/0 78.6,55.8 < 10 |walk
_Exit_ the tunnel |goto Frostfire Ridge/0 78.4,54.9 < 20 |walk
_Follow_ the path around the Horde village |goto Frostfire Ridge/0 75.3,55.6 < 20 |only if walking
_Follow_ the snow path |goto Frostfire Ridge/0 71.2,58.7 < 20 |only if walking
use Icehoof-In-Training Whistle##118348
kill Rakkiri##87085 |q Clefthoof Training: Rakkiri##36984/1 |goto Frostfire Ridge 72.9,69.9
|tip It's a huge bat flying in the air.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352 |goto Frostfire Ridge 72.9,69.9
kill Rakkiri##87085 |q Talbuk Training: Rakkiri##36972/1
|tip It's a huge bat flying in the air.
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
...
use Silverpelt-In-Training Whistle##118352
kill Riplash##87084 |q Talbuk Training: Riplash##36973/1 |goto Gorgrond 50.2,38.0
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Riplash##87084 |q Boar Training: Riplash##36995/1 |goto Gorgrond 50.2,38.0
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Riplash##87084 |q Clefthoof Training: Riplash##36985/1 |goto Gorgrond 50.2,38.0
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
use Silverpelt-In-Training Whistle##118352
kill Gezz'ran##87086 |q Talbuk Training: Gezz'ran##36974/1 |goto Talador 31.4,54.5
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Riverwallow-In-Training Whistle##118350
kill Gezz'ran##87086 |q Riverbeast Training: Gezz'ran##37005/1 |goto Talador 31.4,54.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Gezz'ran##87086 |q Boar Training: Gezz'ran##36996/1 |goto Talador 31.4,54.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Gezz'ran##87086 |q Clefthoof Training: Gezz'ran##36986/1 |goto Talador 31.4,54.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
use Riverwallow-In-Training Whistle##118350
kill Bulbapore##87087 |q Riverbeast Training: Bulbapore##37006/1 |goto Spires of Arak/0 66.7,75.7
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Bulbapore##87087 |q Talbuk Training: Bulbapore##36975/1 |goto Spires of Arak/0 66.7,75.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Bulbapore##87087 |q Boar Training: Bulbapore##36997/1 |goto Spires of Arak/0 66.7,75.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Bulbapore##87087 |q Clefthoof Training: Bulbapore##36987/1 |goto Spires of Arak/0 66.7,75.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
step
use Riverwallow-In-Training Whistle##118350
kill Gorian Beast-Lasher##87095 |q Riverbeast Training: Cruel Ogres##37007/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Gorian Beast-Lasher##87095 |q Talbuk Training: Cruel Ogres##36976/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Gorian Beast-Lasher##87095 |q Wolf Training: Cruel Ogres##37022/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Gorian Beast-Lasher##87095 |q Boar Training: Cruel Ogres##36998/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Gorian Beast-Lasher##87095 |q Clefthoof Training: Cruel Ogres##36988/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Gorian Beast-Lasher##87095 |q Elekk Training: Cruel Ogres##37015/1 |goto Nagrand D/0 79.1,71.7
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
use Riverwallow-In-Training Whistle##118350
kill Darkwing Roc##87088 |q Riverbeast Training: Darkwing Roc##37008/1 |goto Nagrand D/0 68.5,20.5
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Darkwing Roc##87088 |q Talbuk Training: Darkwing Roc##36977/1 |goto Nagrand D/0 68.5,20.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Darkwing Roc##87088 |q Wolf Training: Darkwing Roc##37023/1 |goto Nagrand D/0 68.5,20.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Darkwing Roc##87088 |q Boar Training: Darkwing Roc##36999/1 |goto Nagrand D/0 68.5,20.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Darkwing Roc##87088 |q Clefthoof Training: Darkwing Roc##36989/1 |goto Nagrand D/0 68.5,20.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Darkwing Roc##87088 |q Elekk Training: Darkwing Roc##37016/1 |goto Nagrand D/0 68.5,20.5
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
step
use Riverwallow-In-Training Whistle##118350
kill Moth of Wrath##87089 |q Riverbeast Training: Moth of Wrath##37009/1 |goto Nagrand D 43.6,69.6
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Moth of Wrath##87089 |q Talbuk Training: Moth of Wrath##36978/1 |goto Nagrand D 43.6,69.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Moth of Wrath##87089 |q Wolf Training: Moth of Wrath##37024/1 |goto Nagrand D 43.6,69.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Moth of Wrath##87089 |q Boar Training: Moth of Wrath##37000/1 |goto Nagrand D 43.6,69.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Moth of Wrath##87089 |q Clefthoof Training: Moth of Wrath##36990/1 |goto Nagrand D 43.6,69.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Moth of Wrath##87089 |q Elekk Training: Moth of Wrath##37017/1 |goto Nagrand D 43.6,69.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
step
_Follow_ the path |goto Nagrand D/0 73.6,29.8 < 30 |only if walking
_Go up_ the path |goto Nagrand D/0 79.8,31.4 < 30 |only if walking
_Jump down_ here |goto Nagrand D/0 82.1,32.2 < 20 |only if walking
_Follow_ the path up |goto Nagrand D/0 83.5,33.1 < 15 |only if walking
_Continue_ up the path |goto Nagrand D/0 85.0,34.8 < 15 |only if walking
_Run up_ the narrow path |goto Nagrand D/0 86.3,36.8 < 10 |only if walking
_Keep following_ the path up |goto Nagrand D/0 87.2,38.6 < 15 |only if walking
_Follow_ the path down |goto Nagrand D/0 88.6,35.0 < 10 |only if walking
_Jump down_ here | goto Nagrand D/0 88.5,32.6 < 15 |only if walking
_Follow_ the side of the mountain |goto Nagrand D/0 89.0,30.3 < 15 |only if walking
use Riverwallow-In-Training Whistle##118350
kill Thundercall##87102 |q Riverbeast Training: Thundercall##37010/1 |goto Nagrand D 90.6,23.6
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Thundercall##87102 |q Talbuk Training: Thundercall##36979/1 |goto Nagrand D 90.6,23.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Thundercall##87102 |q Wolf Training: Thundercall##37025/1 |goto Nagrand D 90.6,23.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Thundercall##87102 |q Boar Training: Thundercall##37001/1 |goto Nagrand D 90.6,23.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Thundercall##87102 |q Clefthoof Training: Thundercall##36991/1 |goto Nagrand D 90.6,23.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Thundercall##87102 |q Elekk Training: Thundercall##37018/1 |goto Nagrand D 90.6,23.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
step
use Riverwallow-In-Training Whistle##118350
kill Ironbore##87090 |q Riverbeast Training: Ironbore##37011/1 |goto Nagrand D/0 53.2,77.6
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Ironbore##87090 |q Talbuk Training: Ironbore##36980/1 |goto Nagrand D/0 53.2,77.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Ironbore##87090 |q Wolf Training: Ironbore##37026/1 |goto Nagrand D/0 53.2,77.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Ironbore##87090 |q Boar Training: Ironbore##37002/1 |goto Nagrand D/0 53.2,77.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Ironbore##87090 |q Clefthoof Training: Ironbore##36992/1 |goto Nagrand D/0 53.2,77.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Ironbore##87090 |q Elekk Training: Ironbore##37019/1 |goto Nagrand D/0 53.2,77.6
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
use Riverwallow-In-Training Whistle##118350
kill Maimclaw##87174 |q Riverbeast Training: The Garn##37013/1 |goto Nagrand D/0 63.8,80.8
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Silverpelt-In-Training Whistle##118352
kill Maimclaw##87174 |q Talbuk Training: The Garn##36982/1 |goto Nagrand D/0 63.8,80.8
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Snarler-In-Training Whistle##118353
kill Maimclaw##87174 |q Wolf Training: The Garn##37028/1 |goto Nagrand D/0 63.8,80.8
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Rocktusk-In-Training Whistle##118351
kill Maimclaw##87174 |q Boar Training: The Garn##37004/1 |goto Nagrand D/0 63.8,80.8
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Icehoof-In-Training Whistle##118348
kill Maimclaw##87174 |q Clefthoof Training: The Garn##36994/1 |goto Nagrand D/0 63.8,80.8
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
use Meadowstomper-In-Training Whistle##118349
kill Maimclaw##87174 |q Elekk Training: The Garn##37021/1 |goto Nagrand D/0 63.8,80.8
|tip Wait for him to respawn, since you just killed him.
|tip If you're a Hunter, make a macro that includes "/cast Mend Pet".  Using the whistle dismisses your pet and your mount takes damage in the fight.  Using this macro on your action bar will allow you to heal your mount. |only Hunter
step
#include "Garrison_Large_Building", action="talk Fanny Firebeard##86974", building="Stables"
...
_Follow_ the road |goto Talador/0 66.2,18.8 < 30 |only if walking
...
step
_Follow_ the path to the water |goto Talador/0 51.3,45.2 < 10 |only if walking
Use any Fishing Lure you have
...
step
Use your Fishing skill to fish in the water |cast Fishing##131474
collect Arcane Trout##118041 |q Luring Nat##36870/1 |goto Shadowmoon Valley D/0 36.8,26.3
step
talk Segumi##85708
...
step
_Run up_ the path |goto Frostfire Ridge/0 84.9,61.6 < 20 |only if walking
_Continue_ following the path |goto Frostfire Ridge/0 86.1,65.2 < 30 |only if walking
use Nat's Hookshot##116755
Use your Fishing skill to fish in the water |cast Fishing##131474
Catch a Lunker in Frostfire Ridge |q A True Draenor Angler##36611/1 |goto Frostfire Ridge/0 86.0,69.1
step
talk Nat Pagle##85984
...
|tip Use the Garrison Leveling guide to accomplish this.
step
Complete the Initial Battle Pets Questline |condition completedq(31593)
|tip Use the Battle Pet Questline guide to accomplish this. Complete everything up to where you turn in the "Got one!" quest to unlock the Menagerie quests.
step
...
collect Strange Stone##122458 |q Unearthed Magic##38241/1 |goto Lunarfall/0 65.8,42.4
step
talk Lio the Lioness##85418
...
Defeat Carrotus Maximus |q Pets Versus Pests##36423/1 |goto Lunarfall/0 57.71,60.13
step
clicknpc Gnawface##85419
Engage in a pet battle
Defeat Gnawface |q Pets Versus Pests##36423/3 |goto Lunarfall/0 60.13,77.82
step
clicknpc Gorefu##85463
Engage in a pet battle
Defeat Gorefu |q Pets Versus Pests##36423/2 |goto Lunarfall/0 57.75,21.80
step
...
step
_Follow_ the path |goto Shadowmoon Valley D/0 27.9,11.3 < 20 |only if walking
Meet Merreck Vonder at Your Fleet Command Table |q Naval Commander##39056/1 |goto Shadowmoon Valley D/0 28.2,11.7
step
...
Start a Naval Mission |q Naval Commander##39056/2 |goto Shadowmoon Valley D/0 28.2,11.7
step
clicknpc Fleet Command Table##94399
|tip It looks like a rectangle wooden table with a map on it.
...
Complete a Naval Mission |q Naval Commander##39056/3 |goto Shadowmoon Valley D/0 28.2,11.7
step
talk Merreck Vonder##93822
...
Learn the Ship Blueprint: Destroyer |q Destroying the Competition##39404/1
step
_Follow_ the path |goto Shadowmoon Valley D/0 28.7,11.1 < 30 |only if walking
talk Yanas Seastrike##95002
...
Build a Destroyer at Your Shipyard |q Destroying the Competition##39404/2 |goto Shadowmoon Valley D/0 29.8,10.7
step
_Run up_ the path |goto Shadowmoon Valley D/0 28.8,11.9 < 20 |only if walking
clicknpc Fleet Command Table##94399
|tip It looks like a rectangle wooden table with a map on it.
Click the _Yellow Anchor Icon_ on the map
...
Complete the Naval Mission: A Little Combat |q Destroying the Competition##39404/3 |goto Shadowmoon Valley D/0 28.2,11.7
step
talk Merreck Vonder##93822
...
click Alliance Destroyer Ship##243935
|tip It's a big metal and wooden ship sitting on the beach nearby. It takes 1 minute to build after you start the work order.
Build Another Destroyer Ship |q If At First You Fail, Try Again!##39655/1 |goto Shadowmoon Valley D/0 29.8,10.7
step
_Run up_ the path |goto Shadowmoon Valley D/0 28.8,11.9 < 20 |only if walking
clicknpc Fleet Command Table##94399
|tip It looks like a rectangle wooden table with a map on it.
...
Complete the Naval Mission: The Second Time Is the Charm |q If At First You Fail, Try Again!##39655/2 |goto Shadowmoon Valley D/0 28.2,11.7
step
talk Merreck Vonder##93822
...
step
_Follow_ the path down |goto Shadowmoon Valley D/0 27.9,11.2 < 20 |only if walking
talk Salty Jorren##93812
Tell him _"I hear you're and expert on naval equipment. Have some time to help me out?"_
Find Salty Jorren on the Docks |q Equipping Our Fleet##39666/1 |goto Shadowmoon Valley D/0 28.7,10.9
step
click Naval Equipment Blueprint: Blast Furnace##243938
|tip It looks like a tan scroll laying open on a flat wooden cart.
collect Equipment Blueprint: Blast Furnace##128274 |q Equipping Our Fleet##39666/2 |goto Shadowmoon Valley D/0 28.9,9.6
step
talk Salty Jorren##93812
...
Equip a Blast Furnace on a Ship |q A True Naval Commander##39665/1
step
_Run up_ the path |goto Shadowmoon Valley D/0 28.8,11.9 < 20 |only if walking
clicknpc Fleet Command Table##94399
|tip It looks like a rectangle wooden table with a map on it.
...
|tip Drag both of your ships to the yellow pulsing ship icons in the middle of the ship mission area.
Click the _Start Mission_ button
Complete the Naval Blockade Mission: South Sea |q A True Naval Commander##39665/2 |goto Shadowmoon Valley D/0 28.2,11.7
step
talk Merreck Vonder##93822
...
step
_Enter_ the building |goto Tanaan Jungle/0 58.1,59.9 < 20 |walk
Find Vindicator Krethos |q I Sunk Your Battleship##39601/1 |goto Tanaan Jungle/0 58.4,60.5
step
Earn Honored Reputation with the Hand of the Prophet Faction |q I Sunk Your Battleship##39601/2
...
Learn the Ship Blueprint: Battleship |q I Sunk Your Battleship##39601/3
step
talk Vindicator Krethos##90974
turnin I Sunk Your Battleship##39601 |goto Tanaan Jungle/0 58.4,60.5
step
_Go through_ the doorway |goto Lunarfall/0 26.5,48.9 < 30 |walk
_Follow_ the path down |goto Shadowmoon Valley D/0 27.3,14.2 < 30 |only if walking
talk Merreck Vonder##93822
...
|tip It looks like a rectangle wooden table with a map on it.
Send Boats on Missions
Complete #25# Naval Treasure Missions |q Naval Domination##39068/1 |goto Shadowmoon Valley D/0 28.2,11.8
...
step
Search Gloomshade Grove for Clues |q Gloomshade Grove##33263/1
step
talk Phlox##74667
...
step
label "Gloomshade"
_Leave_ the cave |goto 46.4,15.3 < 10 |walk
...
|tip Each wave will get progressively more difficult to kill.
Complete a Bronze Trial |q Proving Grounds##37433/2
step
...
collect Bryan Finn's Schematic##113095 |q I See Dead People##35329/1 |goto Spires of Arak/0 37.5,49.3
step
talk Bryan Finn##82100
Select _"Show the schematic to Bryan"_
Show Bryan Finn the Schematic |q I See Dead People##35329/2 |goto 39.0,48.8
step
talk Bryan Finn##82100
...
step
_Enter_ the Inn |goto Spires of Arak/0 37.7,51.3 < 10 |walk
_Go upstairs_ |goto Spires of Arak/0 37.5,50.7 < 8 |walk
talk Alice Finn##82110
Select _"Show the spectral essences to Alice"_
Free Alice Finn's Mind |q A Parting Favor##35339/2 |goto 37.6,51.0
step
talk Alice Finn##82110
turnin A Parting Favor##35339 |goto 37.6,51.0
accept A Piece of the Puzzle##35353 |goto 37.6,51.0
step
_Go downstairs_ |goto Spires of Arak/0 37.5,50.7 < 8 |walk
_Go down_ to the basement |goto Spires of Arak/0 37.4,50.8 < 8 |walk
kill Watch Commander Branson##82136 |q A Piece of the Puzzle##35353/1 |goto 37.6,51.0
step
talk Alice Finn##82124
turnin A Piece of the Puzzle##35353 |goto 37.6,51.0
accept Second in Command##35380 |goto 37.54,50.76
step
_Run up_ the stairs |goto Spires of Arak 37.4,50.8 < 10 |walk
...
step
_Leave_ the building |goto Spires of Arak 37.4,53.5 < 10 |walk
_Go through_ the doorway |goto Spires of Arak 37.0,55.2 < 10 |walk
...
accept For Old Times' Sake##36353 |instant |goto 39.98,60.66
step
...
step
talk Ahm##77031
accept Solidarity In Death##36522 |instant |goto Lunarfall 52.8,69.0
step
...
step
_Follow_ the winding pathway |goto Shadowmoon Valley D 59.0,24.9 < 20 |only if walking
talk Exarch Maladaar##80073
turnin Exarch Maladaar##34787 |goto 59.52,30.37
accept Trust No One##35552 |goto 59.52,30.37
step
_Go up_ the stairs and follow the trail |goto Shadowmoon Valley D 60.0,26.6 < 20 |only if walking
...
accept Artificer Romuul##35614 |instant |goto Shadowmoon Valley D/0 42.8,40.4
step
...
step
_Follow the steep, winding path_ up to _Blook's Overlook_ |goto Gorgrond 42.5,91.0 < 15 |only if walking
talk Blook##78031
Tell him _"What?"_
kill Blook##78031
...
step
Become Revered with the _Council of Exarchs_ |condition rep("Council of Exarchs") >= Revered |goto Shadowmoon Valley D/0 48.8,78.0
...
step
talk Dagg##79492
accept Services of Dagg##34733 |instant |goto Lunarfall 61.4,74.8
step
...
kill Soulbinder Halaari##79977 |q Gatekeepers of Auchindoun##34777/2 |goto 57.33,52.65
|tip This is a tough fight, you may need a friend to help you.
step
talk Vindicator Dalu##79970
Tell him: _"Very well. Let us fight."_
kill Vindicator Dalu##79970 |q Gatekeepers of Auchindoun##34777/1 |goto 57.39,52.77
|tip This is a tough fight, you may need a friend to help you.
step
talk Defender Illona##79979
turnin Gatekeepers of Auchindoun##34777 |goto 57.43,51.11
accept The True Path##36519 |instant |goto 57.42,51.12
step
...
collect Swamplighter Queen's Tail##108410 |q Swamplighter Queen##33808/1 |goto 51.62,55.13
step
label "Fio1"
kill Twilight Riverbeast##83455+
collect Riverbeast Heart##108394 |q Fiona's Solution##33787/1 |goto 51.41,57.58
step
label "Fio2"
kill Swamplighter Drone##82371+, Swamplighter Worker##82370+
collect 2 Swamplighter Venom##108395 |q Fiona's Solution##33787/2 |goto 51.41,57.58
step
label "Fio3"
kill Riot Blossom##82427+
collect 4 Riotvine##108396 |q Fiona's Solution##33787/3 |goto 51.41,57.58
step
label "Fio4"
click Moonlit Herb##225998
collect 3 Moonlit Herbs##108409 |q Fiona's Solution##33787/4 |goto 51.41,57.58
step
talk Fiona##76204
...
Speak With Fiona |q Cooking With Unstable Herbs##33788/1 |goto Shadowmoon Valley D/0 53.6,57.3
step
Complete the Elixir |q Cooking With Unstable Herbs##33788/2 |goto Shadowmoon Valley D/0 53.6,57.3
|tip You will need to add the ingredients she specifies until complete.
step
clicknpc Gidwin Goldbraids##80862
Use the Elixir on Gidwin |q Cooking With Unstable Herbs##33788/3 |goto 53.63,57.26
step
talk Fiona##76204
...
step
kill Blooming Genesaur##80662 |q Gestating Genesaur##35015/1 |goto 56.06,73.11
step
talk Rangari Arepheon##80781
turnin Gestating Genesaur##35015 |goto 55.66,71.98
step
talk Fiona##76204
accept Fiona##35617 |instant |goto 53.60,57.28
step
...
step
_Run down_ the small hill |goto Gorgrond 58.1,54.8 < 20 |only if walking
...
collect 100 Ancient Growth Sap##113136 |q Growing Wood##35652/1 |goto Gorgrond/0 60.2,67.5
step
label "pollenpod_HLC"
click Pollen Pod##235903
|tip Red plants with yellow glowing centers.
Destroy #8# Pollen Pods |q Chapter I: Plant Food##35654/1 |goto Gorgrond/0 60.2,67.5
step
label "ST5_HLC"
kill 4 Greenbough Ancient##82360 |q Chapter III: Ritual of the Charred##35650/1 |goto Gorgrond/0 60.2,67.5
step
talk Glirin##85119
...
step
talk Glirin##85119
accept Lumber, I Hardly Knew 'Er##36828 |instant |goto Gorgrond 53.0,59.8
|next "end"
step
label "buy"
...
step
_Run up_ the path |goto Spires of Arak 56.3,34.0 < 10 |only if walking
...
accept Standing United##37281 |instant |goto 39.73,60.88
|next "end"
step
label "buy"
talk Deluwin Whisperfield##88633
...
|tip Use the Leveling guides to accomplish this.
step
_Enter Magnarok_ |goto Frostfire Ridge/0 67.3,33.4 < 30 |walk
...
turnin Pinchwhistle Gearworks##36861 |goto Spires of Arak 61.48,72.93 |only if havequest(36861)
turnin Pinchwhistle Gearworks##35619 |goto Spires of Arak 61.48,72.93 |only if havequest(35619)
...
collect Lantresor's Blade##111938 |q The Blade Itself##34954/1 |goto Nagrand D/0 87.2,53.8
step
label "Locker"
collect Blademaster's Banner##111947 |q Not Without My Honor##34955/1 |goto 85.48,54.79
...
Free the Blade |q Challenge of the Masters##34957/1 |goto 53.01,68.47
step
kill Packleader Dran'ruk##80326, Gorn##80324, Sesk##80325, Warlord Dharl of the Thrice-Bloodied Bla##80327
Survive the Challenge |q Challenge of the Masters##34957/2 |goto 53.27,68.71
step
...
accept The Honor of a Blademaster##34747 |instant |goto 64.24,59.55
step
...
step
_Go up_ the stairs |goto Talador 68.5,79.0 < 15 |only if walking
...
Destroy #5# Astral Wards |q Orbs of Power##34911/1 |goto 66.53,80.22
You can find more here [Talador 69.4,79.7]
step
label "gordunnibeads"
kill Gordunni Cleaver##79234+, Gordunni Basher##79231+
collect 10 Gordunni Runebeads##112088 |q While We're in the Neighborhood##34909/1 |goto 65.99,79.47
step
...
accept Joining the Ranks##34993 |instant |goto 69.73,20.79
|next "end"
step
label "buy"
talk Deluwin Whisperfield##88633
...
step
talk Meatball##86272
accept Meatball##36702 |instant |goto Deeprun Tram/2 62.18,25.66
step
...
Click to Purchase this Follower with Gold |confirm |next "buy"
step
_Go through_ the doorway |goto Talador 69.0,20.8 < 10 |walk
...
accept Armor Up##34982 |instant |goto 69.78,20.75
|next "end"
step
label "buy"
talk Deluwin Whisperfield##88633
...
accept An Angler on Our Team##36616 |instant |goto Lunarfall/0 53.80,13.80
step
...
kill Slavemaster Ok'mok##75864 |q Krav'ogra##34702/1 |goto Gorgrond 40.4,67.6
step
...
collect 6 Zapper Sac##111637 |q Clear!##34761/1 |goto Talador 63.6,44.8
step
talk Torben Zapblast##79901
turnin Clear!##34761 |goto Talador 62.9,50.3
step
talk Pleasure-Bot 8000##79853
accept New Owner##35239 |instant |goto Talador 62.9,50.4
step
...
_Enter_ the camp |goto Gorgrond 48.2,51.8 < 20 |walk
...
Click to Purchase this Follower with Gold |confirm |next "buy"
step
_Run_ along the stone road |goto Gorgrond 47.4,81.4 < 20 |only if walking
_Go up_ the hill into Bastion Rise |goto 47.9,90.9 < 20 |only if walking
...
step
_Follow_ the path down |goto Gorgrond/16 56.3,83.6 < 10 |only if walking
click Will of the Genesaur##231961
|tip It's a large silver box with a yellow dome on top.
collect Will of the Genesaur##11299 |q Will of the Genesaur##35234/1 |goto Gorgrond/17 58.21,24.27
step
label "doomshot"
click Doomshot##232492
|tip They are bullet shaped containers on the ground around this area.
collect 5 Doomshot##112990 |q Just In Case##35233/1 |goto Gorgrond/17 56.1,51.6
step
label "acidmouth"
...
step
_Go back up_ the tunnel |goto Gorgrond/17 68.4,78.5 < 10
kill Iyu##78819 |q Iyu##35235/1 Gorgrond |goto Gorgrond 47.42,92.31
step
talk Yrel##75878
turnin Iyu##35235 |goto Gorgrond 47.7,93.3
step
talk Rangari Kaalya##81772
accept Service of Rangari Kaalya##35262 |instant |goto 47.78,93.27
|next "end"
step
label "buy"
talk Deluwin Whisperfield##88633
...
step
_Enter_ the cave |goto Shadowmoon Valley D/0 46.3,27.2 < 10 |walk
click Broken Totem
Find the Ancestor's Totem |q Ancestor's Memory##33082/1 |goto Shadowmoon Valley D/0 45.7,25.4
step
Watch the dialogue
talk Rulkan##75884
...
step
click Alliance Shield##223720
Investigate the Alliance Shield |q Gloomshade Grove##33263/5 |goto 39.84,19.92
step
talk Phlox##74667
Speak With Phlox |q Gloomshade Grove##33263/6 |goto 39.86,19.98
step
...
Investigate Gloomshade Grotto |q Gloomshade Grove##33263/9 |goto Shadowmoon Valley D/0 47.0,15.1
step
kill Phlox##74244 |q Gloomshade Grove##33263/10 |goto 47.1,14.8
step
talk Jarrod Hamby##73877
turnin Gloomshade Grove##33263 |goto 47.09,14.41
accept Game of Thorns##33271 |goto 47.09,14.41
step
_Follow the path_ |goto 36.8,21.9 |only if walking
kill King Deathbloom##73888 |q Game of Thorns##33271/1 |goto 35.7,19.8
step
talk Shelly Hamby##76748
turnin Game of Thorns##33271 |goto 36.39,19.28
...
step
_Run up_ the ramp |goto Talador/13 57.2,49.3 < 10 |only if walking
_Go through_ the doorway |goto Talador/13 47.3,35.7 < 10 |only if walking
...
step
_Go through_ the doorway |goto Talador/13 48.6,25.5 < 10 |only if walking
_Run up_ the stairs |goto Talador/13 43.0,22.2 < 10 |only if walking
talk Exarch Maladaar##75119
...
accept Together We Are Strong##36512 |instant |goto 46.32,74.08
step
...
Speak to Thisalee Crow |q Garrison Campaign: Awakening##36134/1 |goto Gorgrond 40.93,43.0
step
kill Duurg##84153 |q Garrison Campaign: Awakening##36134/2 |goto Gorgrond 37.8,44.6
step
...
Meet Bodrick Grey |q Primal Fury##36341/1 |goto Talador 69.4,9.1
step
_Enter_ Bladefury's Command |goto Talador/0 68.3,5.6 < 15 |walk
kill Gorgorek##85042 |q Primal Fury##36341/2 |goto Talador 69.2,3.2
step
_Continue further_ into Bladefury's Command |goto Talador/0 69.4,4.5 < 15 |walk
kill Azuka Bladefury##85046 |q Primal Fury##36341/3 |goto Talador 69.6,5.8
step
...
Speak to Thisalee Crow |q Primal Fury##36341/4 |goto Talador 67.5,7.6
step
Watch the dialogue
...
Assault the Hostile Creatures at Lost Veil Anzu |q Missive: Assault on Lost Veil Anzu##38198/1 |goto Spires of Arak/0 73.4,44.8 |next "Turnin" |or
|tip You will see a progress bar in your quest tracking area.
step
label "Evolved"
kill Infected Plunderer##86215+, Infected Mechanic##89144+, Amorphic Cognitor##86144+, Befuddled Relic-Seeker##86205+, Vigilant Dreadtalon##89125+, Skyreach Archaeologist##86163+
...
Assault the Arakkoa Forces at Skettis |q Missive: Assault on Skettis##38200/1 |goto Spires of Arak/0 58.0,11.5
|tip You will see a progress bar in your quest tracking area.
...
collect Cord of Ancient Wood##122569 |q Bringing the Bass##38356/5 |goto Gorgrond/0 56.8,44.1
step
kill Iron Shredder##75815
|tip They look like metal humanoid machines sawing on huge tree stumps around this area.
collect S.P.R.K. Capacitor##122568 |q Bringing the Bass##38356/4 |goto Talador/0 64.0,29.4
step
...
collect Bass Blaster##122565 |q Bringing the Bass##38356/1 |goto Nagrand D/0 57.8,10.9
step
...
collect Laz-Tron Disc Reader##122566 |q Bringing the Bass##38356/2 |goto Spires of Arak/0 55.5,90.6
step
...
collect Phonic Amplifier##122567 |q Bringing the Bass##38356/3 |goto Spires of Arak/0 57.7,12.4
step
talk Fix "Smallie" Biggswrench##91589
...
stickystart "Info1"
step
collect 5 Misprinted Draenic Coin##122618 |q Numismatics##38345/1
...
stickystart "Info2"
step
collect 10 Misprinted Draenic Coin##122618 |q Completionism##38394/1
|tip These coins are a reward for the first Heroic dungeon completed each day.
step
label "Info2"
...
stickystart "Info3"
step
collect 25 Misprinted Draenic Coin##122618 |q Curious Oddity##38396/1
|tip These coins are a reward for the first Heroic dungeon completed each day.
step
label "Info3"
...
stickystart "Info4"
step
collect 50 Misprinted Draenic Coin##122618 |q The Same, But Different##38402/1
|tip These coins are a reward for the first Heroic dungeon completed each day.
step
label "Info4"
