...
ZygorGuidesViewer:RegisterGuide("Zygor's Leveling Guides\\Battle for Azeroth\\Void Elf Race Unlock",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Leveling Guides\\Battle for Azeroth\\Lightforged Draenei Race Unlock",{
author="support@zygorguides.com",
