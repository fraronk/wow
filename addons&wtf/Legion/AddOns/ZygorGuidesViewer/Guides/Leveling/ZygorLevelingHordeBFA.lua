...
ZygorGuidesViewer:RegisterGuide("Zygor's Leveling Guides\\Battle for Azeroth\\Nightborne Race Unlock",{
...
ZygorGuidesViewer:RegisterGuide("Zygor's Leveling Guides\\Battle for Azeroth\\Highmountain Tauren Race Unlock",{
author="support@zygorguides.com",
