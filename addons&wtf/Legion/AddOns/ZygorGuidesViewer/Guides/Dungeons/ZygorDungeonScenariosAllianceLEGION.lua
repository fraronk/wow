...
Click here to load "The Deaths of Chromie (Stratholme Intro)" guide |confirm |next "Zygor's Leveling Guides\\Legion (100-110)\\The Deaths of Chromie (Stratholme Intro)"
]])
...
label "Andorhal"
talk Chromie##124154
accept Sky Ablaze With Cannonfire##47772 |goto 43.92,69.24 |repeatable
|only if inscenario
stickystart "Boom"
step
Check for a Time Chest |goto 47.74,64.43 < 20 |walk
kill Apothecary Tillings##124100
collect 1 Experimental Alchemy Reagent##151368 |goto 47.53,62.50
|only if inscenario
step
Check for a Time Chest |goto 47.63,69.90 < 20 |walk
kill Roobi Skizzelvolt##124101
collect 1 Lightning Absorption Capsule##151369 |goto 48.69,69.65
|only if inscenario
step
label "Boom"
kill Deathguard War-Captain##124074+
collect 7 Military Explosives##151370 |goto 48.60,67.37
...
Find a way to take down the Horde Siege Cannon |q 47772/1 |goto 46.89,67.32
|only if inscenario
step
talk Chromie##124154
turnin Sky Ablaze With Cannonfire##47772 |goto 43.92,69.23
|only if inscenario
step
label "leaveAnd"
...
|tip These can be found in Krokuun, Mac'Aree, and Antoran Wastes. They look like green portals.
step
label invasion-5379
...
step
label invasion-5380
Follow the path |goto Mac'Aree/0 43.95,54.55 < 15 |only if walking
...
step
label invasion-5367
Go up the hill |goto Mac'Aree/0 43.57,16.84 < 10 |only if walking
...
step
label invasion-5366
Follow the path |goto Mac'Aree/0 59.88,36.21 < 15 |only if walking
...
Enter the _Invasion Point: Bonich_ portal |scenariostart |goto Mac'Aree/0 61.01,18.74
|tip Open your map and look for an invasion icon. They look like green portals.
step
...
step
label invasion-5368
Follow the path |goto Mac'Aree/0 63.63,41.31 < 15 |only if walking
