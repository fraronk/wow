...
kill 1 Baron Silverlaine##3887 |q Plague...Plague Everywhere!##27988/1 |goto Shadowfang Keep/2 31.2,73.3 |only if havequest(27988)
...
kill 1 Commander Springvale##4278 |q Plague...Plague Everywhere!##27988/2 |goto Shadowfang Keep 28.4,58.6 |only if havequest(27988)
...
kill 1 Lord Walden##46963 |q Orders Are For the Living##27996/1 |goto Shadowfang Keep/4 54.2,54.3 |only if havequest(27996)
...
kill 1 Lord Godfrey##46964 |q Sweet, Merciless Revenge##27998/1 |goto Shadowfang Keep/6 61.6,23.8 |only if havequest(27998)
...
collect Of Love and Family##14679 |q Of Love and Family##27305/1 |goto 27.4,76.2 |only if havequest(27305)
...
Defeat Hellfire Watcher |scenariogoal 24926 |goto Hellfire Ramparts 76.9,34.4
step
map Hellfire Ramparts/1
path follow smart; loop off; ants curved; dist 15
