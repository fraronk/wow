...
collect 160 Linen Cloth##2589 |goto Durotar,47.4,48.9 |condition skill("First Aid")>=75
|tip You can also buy these materials from the Auction House.
step
...
step
Kill the _Thistle Fur_ enemies around the area
collect 75 Wool Cloth##2592 |goto Ashenvale,34.0,39.8 |condition skill("First Aid")>=150
|tip You can also buy these materials from the Auction House.
step
...
step
#include "trainer_FirstAid"
learn Silk Bandage##7928 |condition skill("First Aid")>=225
step
Kill the _Maraudine_ enemies around the area
collect 90 Silk Cloth##4306 |goto Desolace 30.6,54.6 |condition skill("First Aid")>=210
|tip You can also buy these materials from the Auction House.
step
...
step
#include "trainer_FirstAid"
skillmax First Aid,300
|tip You must be at least level 35.
step
#include "trainer_FirstAid"
learn Mageweave Bandage##10840 |condition skill("First Aid")>=300
step
Kill the _Deadwood and Jadefire_ enemies in the area
collect 50 Mageweave Cloth##4338 |goto Felwood,49.2,87.0 |condition skill("First Aid")>=300
|tip You can also buy these materials from the Auction House.
step
...
step
kill Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+
collect 80 Runecloth##14047 |goto Silithus 45.8,38.2 |condition skill("First Aid")>=300
|tip You can also buy these materials from the Auction House.
You can find more:
Around |goto 35.7,32.5
Around |goto 29.5,73.4
Around |goto 66.1,20.3
step
...
step
#include "trainer_FirstAid"
skillmax First Aid,375
|tip You must be at least level 50.
step
#include "trainer_FirstAid"
learn Netherweave Bandage##27032 |condition skill("First Aid")>=350
step
...
step
kill Dark Ritualist##34734+, Dark Zealot##34728+
collect 150 Frostweave Cloth##33470 |goto Icecrown,61.8,20.8 |condition skill("First Aid")>=450
|tip You can also buy these materials from the Auction House.
step
...
step
Click here to proceed |confirm |next "Profession Guides\\First Aid\\Leveling Guides\\First Aid 525-600 Leveling Guide"
|tip This will take you to the First Aid 500 - 600 guides.
]])
...
Gather _{_G.max(0 , (20-itemcount(818,774)))}_ gems |cast Prospecting##31252
|tip You can also buy these materials from the Auction House.
step
#include "maincity_forge2"
