...
collect 33 Stranglekelp##3820 |opt |condition skill("Alchemy")>=215
step
...
collect 40 Wild Steelbloom##3355 |opt |condition skill("Alchemy")>=215
|tip You can also buy these materials from the Auction House.
step
...
#include follow_path_herbs
collect 40 Khadgar's Whisker##3358 |condition skill("Alchemy")>=280
collect 30 Blindweed##8839 |condition skill("Alchemy")>=280
|tip You can also buy these materials from the Auction House.
step
#include "Sungrass_Path"
#include follow_path_herbs
collect 70 Sungrass##8838 |condition skill("Alchemy")>=280
|tip You can also buy these materials from the Auction House.
step
#include "GB_Path"
#include follow_path_herbs
collect 40 Gromsblood##8846 |condition skill("Alchemy")>=280
|tip You can also buy these materials from the Auction House.
step
#include "trainer_Alchemy"
...
step
#include "vendor_Alchemy"
buy 80 Crystal Vial##3371 |condition itemcount(3371) >= 80 or skill("Alchemy")>=250
step
...
step
#include "trainer_Alchemy"
learn Superior Mana Potion##17553 |condition skill("Alchemy")>=280
step
create 10 Superior Mana Potion##17553,Alchemy,280
step
#include "trainer_Alchemy"
...
#include "FW_DG_Path"
#include follow_path_herbs
collect 31 Mountain Silversage##13465 |condition skill("Alchemy")>=355
|tip These can be found tucked away in the sides of mountains, so keep an eye out for them.
collect 30 Dreaming Glory##22786 |opt |condition skill("Alchemy")>=355
collect 55 Felweed##22785 |opt |condition skill("Alchemy")>=355
|tip You can also buy these materials from the Auction House.
step
...
step
talk Haalrun##18005
buy 1 Recipe: Super Mana Potion##22907 |goto Zangarmarsh 67.8,48.0 |condition _G.IsSpellKnown(17556) or itemcount(22907) >= 1 or skill("Alchemy")>=355
|tip This recipe is a limited quality item. If the vendor is not carrying it, you may need to get it from the Auction House.
step
#include "trainer_Alchemy"
learn Major Healing Potion##17556 |condition skill("Alchemy")>=300
step
talk Haalrun##18005
buy 1 Recipe: Super Mana Potion##22907 |goto Zangarmarsh 67.8,48.0 |condition _G.IsSpellKnown(17556) or itemcount(22907) >= 1 or skill("Alchemy")>=355
step
...
collect 20 Tiger Lily##36904 |opt |condition skill("Alchemy")>=425
|tip You can also buy these materials from the Auction House.
...
collect 20 Stormvine##52984 |opt |condition skill("Alchemy")>=500
collect 16 Azshara's Veil##52985 |opt |condition skill("Alchemy")>=500
|tip You can also buy these materials from the Auction House.
step
...
step
#include "trainer_Alchemy"
learn Elixir of Mighty Speed##80493 |condition skill("Alchemy")>=495
step
...
#include "Tin_Path"
#include "follow_path_mine"
collect 60 Coarse Stone##2836 |condition skill("Blacksmithing")>=210 |only if itemcount(2836) < 30
collect 25 Tin Ore##2771 |condition skill("Blacksmithing")>=210
collect 28 Copper Bar##2840 |or |condition skill("Blacksmithing")>=210
|tip You can also buy these materials from the Auction House.
step
...
buy 35 Green Dye##2605 |condition itemcount(2605) >= 35 or skill("Blacksmithing")>=210
step
#include "trainer_Blacksmithing"
learn Heavy Grinding Stone##3337 |condition skill("Blacksmithing")>=210
step
#include "maincity_anvil"
create 50 Heavy Grinding Stone##3337,Blacksmithing,50 total |n
collect 50 Heavy Grinding Stone##3486 |condition skill("Blacksmithing")>=210
|tip Save 50 Heavy Grinding Stones, you'll need them later.
step
#include "trainer_Blacksmithing"
learn Patterned Bronze Bracers##2672 |condition skill("Blacksmithing")>=210
step
#include "maincity_anvil"
create Patterned Bronze Bracers##2672,Blacksmithing,155
step
#include "trainer_Blacksmithing"
learn Green Iron Leggings##3506 |condition skill("Blacksmithing")>=210
step
#include "maincity_anvil"
create Green Iron Leggings##3506,Blacksmithing,165
step
#include "trainer_Blacksmithing"
learn Green Iron Bracers##3501 |condition skill("Blacksmithing")>=210
step
#include "maincity_anvil"
...
step
#include "trainer_Blacksmithing"
learn Heavy Mithril Gauntlet##9928 |condition skill("Blacksmithing")>=300
step
#include "maincity_anvil"
create Heavy Mithril Gauntlet##9928,Blacksmithing,230
step
#include "trainer_Blacksmithing"
learn Mithril Coif##9961 |condition skill("Blacksmithing")>=300
step
#include "maincity_anvil"
create 20 Mithril Coif##9961,Blacksmithing,250
step
#include "trainer_Blacksmithing"
learn Dense Grinding Stone##16639 |condition skill("Blacksmithing")>=300
step
#include "maincity_anvil"
create 30 Dense Grinding Stone##16639,Blacksmithing,260
step
#include "trainer_Blacksmithing"
learn Thorium Bracers##16644 |condition skill("Blacksmithing")>=300
step
#include "maincity_anvil"
create 20 Thorium Bracers##16644,Blacksmithing,280
step
#include "trainer_Blacksmithing"
learn Imperial Plate Bracers##16649 |condition skill("Blacksmithing")>=300
step
#include "maincity_anvil"
...
#include "follow_path_mine"
collect 330 Fel Iron Ore##23424 |condition skill("Blacksmithing")>=300
|tip You can also buy these materials from the Auction House.
step
create Fel Iron Bar##29356,Mining,165 total |n
|tip Stand next to the anvil.
collect 165 Fel Iron Bar##23445 |condition skill("Blacksmithing")>=325 |goto Hellfire Peninsula 56.8,63.8
step
talk Mari Stonehand##19373
buy 1 Plans: Lesser Ward of Shielding##23638 |goto Shadowmoon Valley 36.8,55.0 |condition _G.IsSpellKnown(29728) or itemcount(23638) >= 1 or skill("Blacksmithing")>=325
|tip Save this recipe, you will learn it later, when your Blacksmithing skill is higher. This recipe is a limited supply item, so if it's not available for purchase, keep checking again every few minutes until you can buy it.
step
#include "trainer_Blacksmithing_Shatt"
learn Fel Iron Plate Gloves##29545 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
create Fel Iron Plate Gloves##29545,Blacksmithing,310
step
#include "trainer_Blacksmithing_Shatt"
learn Fel Iron Plate Belt##29547 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
create Fel Iron Plate Belt##29547,Blacksmithing,315
step
#include "trainer_Blacksmithing_Shatt"
learn Fel Iron Chain Gloves##29552 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
...
learn Smelt Adamantite##29358 |goto Shattrath City/0 43.7,90.9 |condition skill("Blacksmithing")>=325
only if rep ('The Scryers')>=Neutral
step
talk Fono##33682
learn Smelt Adamantite##29358 |goto Shattrath City 36.0,48.6 |condition skill("Blacksmithing")>=325
...
step
#include "trainer_Blacksmithing_Shatt"
learn Lesser Rune of Warding##32284 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
create Lesser Rune of Warding##32284,Blacksmithing,330
step
#include "trainer_Blacksmithing_Shatt"
learn Fel Iron Breastplate##29550 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
create Fel Iron Breastplate##29550,Blacksmithing,335
step
talk Aaron Hollman##19662
buy 1 Plans: Adamantite Cleaver##23591 |goto Shattrath City,64.1,71.9 |condition _G.IsSpellKnown(29568) or itemcount(23591) >= 1 or skill("Blacksmithing")>=325
The recipe is a limited supply item, so if it's not available for purchase
step
use Plans: Adamantite Cleaver##23591
learn Adamantite Cleaver##29568 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
create Adamantite Cleaver##29568,Blacksmithing,340
step
use Plans: Lesser Ward of Shielding##23638
learn Lesser Ward of Shielding##29728 |condition skill("Blacksmithing")>=325
step
#include "shatt_anvil"
...
step
#include "maincity_anvil"
create Saronite Bar##49258,Mining,311 total |n
...
collect 38 Volatile Earth##52327 |condition skill("Blacksmithing")>=475
|tip You will only need 10 to complete the 425-475 section of this guide.
step
#include "maincity_anvil"
...
step
#include "trainer_Blacksmithing"
learn Redsteel Bracers##76262 |condition skill("Blacksmithing")>=475
step
#include "maincity_anvil"
create 5 Redsteel Bracers##76262,Blacksmithing,460
step
#include "trainer_Blacksmithing"
...
step
#include "maincity_anvil"
create Obsidium Bar##84038,Mining,38 total |n
...
step
#include "maincity_anvil"
create Stormforged Legguards##76287,Blacksmithing,490
step
#include "trainer_Blacksmithing"
...
condition_suggested=function() return hasprof('First Aid',1,600) end,
description="This guide will walk you through leveling your First Aid skill from 1 - 600. It is written assuming that you are not guilded.",
},[[
step
...
step
kill Riverpaw Bandit##452+, Riverpaw Brute##124+, Riverpaw Herbalist##501+
collect 160 Linen Cloth##2589 |goto Westfall,50.8,53.0 |condition skill("First Aid")>=75
|tip You can also buy these materials from the Auction House.
only if not completedq(26370)
step
kill Rotted One##948+, Flesh Eater##3+, Bone Chewer##210+
collect 160 Linen Cloth##2589 |goto Duskwood,23.7,36.6 |condition skill("First Aid")>=75
|tip You can also buy these materials from the Auction House.
You can find more mobs in the provided crypt location |goto 25.8,34.6
Save _Wool Cloth_ you pick up
step
create Linen Bandage##3275,First Aid,40
step
#include "trainer_FirstAid"
learn Heavy Linen Bandage##3276 |condition skill("First Aid")>=75
step
create Heavy Linen Bandage##3276+,First Aid,75
step
#include "trainer_FirstAid"
skillmax First Aid,150
|tip You must be at least level 10.
step
create Heavy Linen Bandage##3276+,First Aid,80
step
#include "trainer_FirstAid"
learn Wool Bandage##3277 |condition skill("First Aid")>=150
step
kill Anguished Spirit##45614+,Forlorn Spirit##43923+
collect 75 Wool Cloth##2592 |goto Duskwood,21.4,68.7 |condition skill("First Aid")>=150
|tip You can also buy these materials from the Auction House.
step
create Wool Bandage##3277+,First Aid,115
step
#include "trainer_FirstAid"
learn Heavy Wool Bandage##3278 |condition skill("First Aid")>=150
step
create Heavy Wool Bandage##3278+,First Aid,150
step
#include "trainer_FirstAid"
skillmax First Aid,225
|tip You must be at least level 20.
step
#include "trainer_FirstAid"
learn Silk Bandage##7928 |condition skill("First Aid")>=210
step
kill Grimtotem Destroyer##23594+, Grimtotem Earthbinder##23595+
collect 90 Silk Cloth##4306 |goto Dustwallow Marsh 46.7,46.7 |condition skill("First Aid")>=210
|tip You can also buy these materials from the Auction House.
step
create Silk Bandage##7928,First Aid,180
step
#include "trainer_FirstAid"
learn Heavy Silk Bandage##7929 |condition skill("First Aid")>=210
step
...
step
kill Irontree Chopper##48453+
collect 50 Mageweave Cloth##4338 |goto Felwood,63.4,20.7 |condition skill("First Aid")>=300
step
create Mageweave Bandage##10840,First Aid,240
step
#include "trainer_FirstAid"
learn Heavy Mageweave Bandage##10841 |condition skill("First Aid")>=300
step
create Heavy Mageweave Bandage##10841+,First Aid,260
step
#include "trainer_FirstAid"
learn Runecloth Bandage##18629 |condition skill("First Aid")>=300
step
map Silithus
...
path	66.1,20.3
kill Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+
Defeat the enemies at each point on the provided path
collect 50 Runecloth##14047 |goto Silithus 45.8,38.2
|tip You can also buy these materials from the Auction House.
step
create Runecloth Bandage##18629+,First Aid,290
step
#include "trainer_FirstAid"
learn Heavy Runecloth Bandage##18630 |condition skill("First Aid")>=300
step
create Heavy Runecloth Bandage##18630,First Aid,300
step
label "aid_260-300_farm"
Kill the _Sunfury Enemies_ around the area
collect 50 Netherweave Cloth##21877 |goto Netherstorm 26.3,68.1 |condition skill("First Aid")>=350
|tip You can also buy these materials from the Auction House.
step
#include "trainer_FirstAid"
...
step
#include "trainer_FirstAid"
learn Heavy Netherweave Bandage##27033 |condition skill("First Aid")>=350
step
create Heavy Netherweave Bandage##27033,First Aid,350
step
#include "trainer_FirstAid"
skillmax First Aid,450
|tip You must be at least level 65.
step
#include "trainer_FirstAid"
learn Frostweave Bandage##45545 |condition skill("First Aid")>=450
step
kill Dark Ritualist##34734+, Dark Zealot##34728+
collect 150 Frostweave Cloth##33470 |goto Icecrown,61.8,20.8
|tip You can also buy these materials from the Auction House.
step
...
step
#include "trainer_FirstAid"
learn Heavy Frostweave Bandage##45546 |condition skill("First Aid")>=450
step
create Heavy Frostweave Bandage##45546+,First Aid,450
step
#include "trainer_FirstAid"
skillmax First Aid,525
|tip You must be at least level 75.
step
#include "trainer_FirstAid"
learn Embersilk Bandage##74556 |condition skill("First Aid")>=525
step
kill Twilight Augur##40713+, Twilight Retainer##40767+
collect 130 Embersilk Cloth##53010 |goto Mount Hyjal 35.0,24.0 |condition skill("First Aid")>=525
step
...
step
#include "trainer_Leatherworking"
learn Heavy Leather##20649 |condition skill("Leatherworking")>=200
step
...
step
#include "trainer_Leatherworking"
learn Cured Heavy Hide##3818 |condition skill("Leatherworking")>=200
step
#include "trainer_Leatherworking"
learn Heavy Armor Kit##3780 |condition skill("Leatherworking")>=200
step
...
step
#include "trainer_Leatherworking"
learn Barbaric Shoulders##7151 |condition skill("Leatherworking")>=200
step
create Barbaric Shoulders##7151,Leatherworking,190
step
#include "trainer_Leatherworking"
learn Guardian Gloves##7156 |condition skill("Leatherworking")>=200
step
...
step
#include "trainer_Leatherworking"
learn Thick Armor Kit##10487 |condition skill("Leatherworking")>=250
step
create Thick Armor Kit##10487,Leatherworking,220
step
#include "trainer_Leatherworking"
learn Nightscape Headband##10507 |condition skill("Leatherworking")>=250
step
create Nightscape Headband##10507,Leatherworking,230
step
#include "trainer_Leatherworking"
learn Nightscape Pants##10548 |condition skill("Leatherworking")>=250
step
...
Skin the beasts that you kill along the path
...
step
#include "trainer_Leatherworking"
learn Rugged Armor Kit##19058 |condition skill("Leatherworking")>=300
step
create Rugged Armor Kit##19058,Leatherworking,265
step
#include "trainer_Leatherworking"
learn Wicked Leather Bracers##19052 |condition skill("Leatherworking")>=300
step
create Wicked Leather Bracers##19052,Leatherworking,290
step
#include "trainer_Leatherworking"
learn Wicked Leather Headband##19071 |condition skill("Leatherworking")>=300
step
create Wicked Leather Headband##19071,Leatherworking,300
step
#include "trainer_Leatherworking"
skillmax Leatherworking,375
|tip You must be at least level 50.
step
...
Kill the Revenants inside of the cave |goto Dragonblight/0 74.7,22.9
...
step
#include "trainer_Leatherworking"
learn Arctic Boots##50948 |condition skill("Leatherworking")>=425
step
...
Kill the spiders around this area |goto Tol Barad Peninsula/0 53.9,51.5
