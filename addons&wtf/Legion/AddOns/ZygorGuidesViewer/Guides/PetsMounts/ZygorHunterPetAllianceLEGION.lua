...
condition_suggested=function() return level>=110 and ZGV.CurrentMapID==1135 end,
condition_valid=function() return raceclass('Hunter') end,
condition_valid_msg="You must be a hunter to tame pets.",
model={75475},
},[[
...
|tip Antilus the Soarer will be level 38.
...
|tip Feathermane Hunters will be level 110.
