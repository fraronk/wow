...
author="support@zygorguides.com",
description="This guide will assist you in earning the Crashin' Thrashin' title.",
},[[
step
This title is gained by completing the _Crashin' Thrashin' Commander_ achievement
Click here to load our "All Toys" achievement guide |confirm |next "Zygor's Achievement Guides\\Collections\\Toy Box\\All Toys"
|tip This guide will help you acquire these toys.
Collect 200 toys |achieve 10354
step
Congratulations!
You have earned the _Crashin' Thrashin'_ title!
]])
...
talk The Postmaster##103976 |goto 37.61,40.13
Tell him _"Give me a challenge! I want to sort the letters with partial addresses."_
|tip Each letter will have an address.
|tip Click the portal for the zone that corresponds to the address.
|tip Partially addressed letters are more difficult to sort because they do not have a zone name associated with them.
Earn the _Postmaster_ title |achieve 12439 |goto 37.59,40.53
step
Congratulations!
