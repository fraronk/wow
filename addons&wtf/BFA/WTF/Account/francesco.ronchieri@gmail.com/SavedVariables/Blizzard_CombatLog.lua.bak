	...
	["filters"] = {
		{
			...
			["tooltip"] = "Mostra i messaggi delle azioni che hai compiuto.",
			["name"] = "Mie azioni",
			["colors"] = {
				["schoolColoring"] = {
					{
		...
		{
			["quickButtonName"] = "Cosa mi è successo?",
			["onQuickBar"] = true,
			["quickButtonDisplay"] = {
				["party"] = true,
				["solo"] = true,
			...
			["tooltip"] = "Mostra tutto quello che ti è successo.",
			["name"] = "Cosa mi è successo?",
			["colors"] = {
				["schoolColoring"] = {
					{
						["a"] = 1,
