...
ArkInventory.Const = { -- constants
	...
	Blizzard = {
		...
		TOC = select( 4, GetBuildInfo( ) ) or 0,  -- /dump ArkInventory.Const.Blizzard.TOC
		...
		LE_ITEM_QUALITY_POOR = LE_ITEM_QUALITY_POOR or ( Enum and Enum.ItemQuality.Poor ) or 0,
		LE_ITEM_QUALITY_COMMON = LE_ITEM_QUALITY_COMMON or ( Enum and Enum.ItemQuality.Common ) or 1,
		LE_ITEM_QUALITY_UNCOMMON = LE_ITEM_QUALITY_UNCOMMON or ( Enum and Enum.ItemQuality.Uncommon )or 2,
		LE_ITEM_QUALITY_RARE = LE_ITEM_QUALITY_RARE or ( Enum and Enum.ItemQuality.Rare ) or 3,
		LE_ITEM_QUALITY_EPIC = LE_ITEM_QUALITY_EPIC or ( Enum and Enum.ItemQuality.Epic ) or 4,
		LE_ITEM_QUALITY_LEGENDARY = LE_ITEM_QUALITY_LEGENDARY or ( Enum and Enum.ItemQuality.Legendary ) or 5,
		LE_ITEM_QUALITY_ARTIFACT = LE_ITEM_QUALITY_ARTIFACT or ( Enum and Enum.ItemQuality.Artifact ) or 6,
		LE_ITEM_QUALITY_HEIRLOOM = LE_ITEM_QUALITY_HEIRLOOM or ( Enum and Enum.ItemQuality.Heirloom ) or 7,
		LE_ITEM_QUALITY_WOWTOKEN = LE_ITEM_QUALITY_WOWTOKEN or ( Enum and Enum.ItemQuality.WoWToken ) or 8,
		
		MAX_CONTAINER_ITEMS = MAX_CONTAINER_ITEMS or 36,
		
		ALREADY_KNOWN_FONT_COLOR_CODE = "fefe1f1f",
...
function ArkInventory.Output2( ... )
	if ArkInventory.Global.Debug2 then
		ArkInventory.Output( "|cff979711", ... ) -- fffff99a
	end
end
