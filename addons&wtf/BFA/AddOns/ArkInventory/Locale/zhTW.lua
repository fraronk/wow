...
--	restack
	L["RESTACK"] = "壓縮並重新堆疊"
	L["RESTACK_DESC"] = "重新堆疊物品以減少物品佔用的欄位，特殊背包的欄位將會優先被使用"
...
--	L["STATUS_SHORTNAME_COOKING"] = ""
	...
	L["STATUS_SHORTNAME_WEARING"] = "裝備"
	L["STATUS_SHORTNAME_JEWELCRAFTING"] = "珠寶"
--	L["STATUS_SHORTNAME_HEIRLOOM"] = ""
	L["STATUS_SHORTNAME_HERBALISM"] = "草藥"
	L["STATUS_SHORTNAME_INSCRIPTION"] = "銘文"
	L["STATUS_SHORTNAME_KEY"] = "鑰匙"
	L["STATUS_SHORTNAME_LEATHERWORKING"] = "製皮"
	L["STATUS_SHORTNAME_MAILBOX"] = "郵件"
...
--	main menu
	...
	L["MENU_CHARACTER_SWITCH_DESC"] = "切換顯示其他角色"
	L["MENU_CHARACTER_SWITCH_CHOOSE_NONE"] = "沒有其他角色資料"
	L["MENU_CHARACTER_SWITCH_CHOOSE_DESC"] = "切換顯示資料為 %1$s"
	L["MENU_CHARACTER_SWITCH_ERASE"] = "清除快取資料"
	L["MENU_CHARACTER_SWITCH_ERASE_DESC"] = "清除所有 %1$s 的快取資料"
	
	L["MENU_LOCATION_TOGGLE"] = "切換位置"
	L["MENU_LOCATION_TOGGLE_DESC"] = "切換 %1$s 視窗顯示"
--	L["MENU_LOCATION_NOT_SUPPORTED"] = ""
	
	
--	actions menu
	L["MENU_ACTION"] = "功能"
	L["MENU_ACTION_REFRESH_DESC"] = "更新及排序視窗內容"
--	L["MENU_ACTION_REFRESH_CLEAR_CACHE"] = ""
--	L["MENU_ACTION_REFRESH_CLEAR_CACHE_DESC"] = ""
	L["MENU_ACTION_RELOAD_DESC"] = "重載視窗，當你使用換裝軟體時使用"
	L["MENU_ACTION_EDITMODE"] = "開啟編輯模式"
	L["MENU_ACTION_EDITMODE_DESC"] = "切換編輯模式，讓你指定分組及調整樣式"
	L["MENU_ACTION_BAGCHANGER_DESC"] = "切換顯示背包置換區，以供你替換背包"
	
	
--	item menu
	L["MENU_ITEM_TITLE"] = "物品資訊"
	L["MENU_ITEM_ASSIGN_RESET"] = "重設為預設值"
--	L["MENU_ITEM_ASSIGN_RESET_DESC"] = "重設此物品為預設類別 (不會重設規則)"
	L["MENU_ITEM_ASSIGN_CHOICES"] = "可指定類別"
	L["MENU_ITEM_ASSIGN_CATEGORY"] = "指定類別"
	L["MENU_ITEM_ASSIGN_CATEGORY_DESC"] = "指定此物品為特定的類別"
...
--	L["MENU_BAR_BAG_ASSIGN_DESC"] = ""
	...
	L["MENU_BAR_RESET_DESC"] = "移除所有除了預設分類以外指定到此的類別"
	L["MENU_BAR_INSERT_DESC"] = "插入空白分組，將其他分組往後移"
	L["MENU_BAR_DELETE_DESC"] = "移除此分組，此分組內的類別將會被放回預設分組"
...
--	changer bag menu
	...
	L["MENU_BAG_SHOW_DESC"] = "顯示背包的內容"
	L["MENU_BAG_ISOLATE"] = "獨立"
	L["MENU_BAG_ISOLATE_DESC"] = "僅顯示此背包的內容"
...
--	configuration options > system
	L["CONFIG_GENERAL_DESC"] = "系統選項"
	
	L["CONFIG_GENERAL_FONT_DESC"] = "設定為 %s 的字型"
...
--	L["CONFIG_SORTING_WHEN_MANUAL_DESC"] = ""
	...
	L["CONFIG_GENERAL_TOOLTIP"] = "工具提示"
	L["CONFIG_GENERAL_TOOLTIP_ENABLE_DESC"] = "設定是否顯示工具提示"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD"] = "空行"
	L["CONFIG_GENERAL_TOOLTIP_EMPTY_ADD_DESC"] = "在提示框原有文字和自訂文字間顯示空行"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT"] = "顯示物品數量"
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_ENABLE_DESC"] = "設定是否在工具提示上顯示物品數量"
--	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_CLASS_DESC"] = ""
	L["CONFIG_GENERAL_TOOLTIP_ITEMCOUNT_COLOUR_TEXT_DESC"] = "設定物品數量的文字顏色"
...
--	L["CONFIG_GENERAL_TOOLTIP_SCALE_DESC"] = ""
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY"] = "只有目前角色"
	L["CONFIG_GENERAL_TOOLTIP_SELF_ONLY_DESC"] = "只顯示目前角色的物品數量"
...
--	L["CONFIG_GENERAL_TOOLTIP_REPUTATION_TOKEN_DESC"] = ""
	...
	L["CONFIG_GENERAL_WORKAROUND"] = "除錯/規避錯誤"
	L["CONFIG_GENERAL_WORKAROUND_DESC"] = "切換除錯或規避錯誤的程式碼"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL"] = "框架層級"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_DESC"] = "暴風雪的CreateFrame API有個bug會導致框架背景蓋住前景，使物品提示無法顯示，也不能點擊視窗裡的任何東西。"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_DESC"] = "設定框架層級除錯警告的顯示方式"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE0_DESC"] = "不顯示除錯警告"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE1_DESC"] = "顯示簡短的除錯警告"
	L["CONFIG_GENERAL_WORKAROUND_FRAMELEVEL_ALERT_STYLE2_DESC"] = "顯示完整的除錯警告"
...
--	configuration options > auto
	L["CONFIG_AUTO"] = "自動開關"
	L["CONFIG_AUTO_BANK"] = "開啟銀行"
	L["CONFIG_AUTO_VAULT"] = "開啟公會銀行"
	L["CONFIG_AUTO_MAILBOX"] = "開啟郵箱"
	L["CONFIG_AUTO_MERCHANT"] = "開啟商店視窗"
	L["CONFIG_AUTO_TRADE"] = "開啟交易視窗"
	L["CONFIG_AUTO_AUCTION"] = "開啟拍賣視窗"
--	L["CONFIG_AUTO_VOID"] = ""
--	L["CONFIG_AUTO_SCRAP"] = ""
--	L["CONFIG_AUTO_TRANSMOG"] = ""
	L["CONFIG_AUTO_COMBAT"] = "進入戰鬥"
...
--	L["CONFIG_LAYOUT_DESCRIPTION"] = ""
	...
	L["CONFIG_DESIGN_WINDOW_SCALE_DESC"] = "設定縮放視窗的大小比例"
	L["CONFIG_DESIGN_WINDOW_PADDING_DESC"] = "設定視窗邊緣至分組的間隔距離"
	L["CONFIG_DESIGN_WINDOW_WIDTH_DESC"] = "設定一行所能包含的物品欄位數目"
--	L["CONFIG_DESIGN_WINDOW_HEIGHT_DESC"] = ""
	L["CONFIG_DESIGN_WINDOW_BACKGROUND_COLOUR_DESC"] = "設定主要視窗的背景顏色"
	L["CONFIG_DESIGN_WINDOW_BORDER_SHOW_DESC"] = "設定是否顯示主要視窗的邊框"
	L["CONFIG_DESIGN_WINDOW_BORDER_STYLE_DESC"] = "設定主要視窗的邊框樣式"
	L["CONFIG_DESIGN_WINDOW_BORDER_COLOUR_DESC"] = "設定主要視窗的邊框顏色"
...
--	L["CONFIG_DESIGN_FRAME_CHANGER_HIGHLIGHT_DESC"] = ""
	L["CONFIG_DESIGN_FRAME_CHANGER_HIGHLIGHT_COLOUR_DESC"] = "設定標示滑鼠目前指向的背包的對應欄位顏色"
	L["CONFIG_DESIGN_FRAME_CHANGER_FREE"] = "顯示數量"
	L["CONFIG_DESIGN_FRAME_CHANGER_FREE_DESC"] = "切換是否在背包上顯示空格數量"
	L["CONFIG_DESIGN_FRAME_CHANGER_FREE_COLOUR_DESC"] = "設定空格數量文字顏色"
...
--	L["CONFIG_DESIGN_FRAME_TITLE_OFFLINE_COLOUR_DESC"] = ""
	...
	L["CONFIG_DESIGN_BAR_PER_ROW_DESC"] = "設定橫向所能包含的分組數目"
	L["CONFIG_DESIGN_BAR_BACKGROUND_DESC"] = "設定分組的背景顏色"
	L["CONFIG_DESIGN_BAR_COMPACT"] = "簡潔模式"
	L["CONFIG_DESIGN_BAR_COMPACT_DESC"] = "以現有順序顯示所有非空白欄位"
	L["CONFIG_DESIGN_BAR_SHOW_EMPTY"] = "顯示空格"
	L["CONFIG_DESIGN_BAR_SHOW_EMPTY_DESC"] = "設定是否顯示空白分組"
	L["CONFIG_DESIGN_BAR_PADDING_INTERNAL_DESC"] = "分組內距"
	L["CONFIG_DESIGN_BAR_PADDING_EXTERNAL_DESC"] = "分組外距"
	L["CONFIG_DESIGN_BAR_BORDER_DESC"] = "設定是否顯示分組邊框"
	L["CONFIG_DESIGN_BAR_BORDER_STYLE_DESC"] = "設定邊框樣式"
	L["CONFIG_DESIGN_BAR_BORDER_COLOUR_DESC"] = "設定分組的邊框顏色"
	L["CONFIG_DESIGN_BAR_NAME_DESC"] = "為此分組設定名稱"
	L["CONFIG_DESIGN_BAR_NAME_SHOW_DESC"] = "切換顯示分組名稱"
--	L["CONFIG_DESIGN_BAR_NAME_EDITMODE_DESC"] = ""
	L["CONFIG_DESIGN_BAR_NAME_COLOUR_DESC"] = "設定分組名稱的邊框顏色"
--	L["CONFIG_DESIGN_BAR_NAME_HEIGHT_DESC"] = ""
--	L["CONFIG_DESIGN_BAR_NAME_ANCHOR_DESC"] = ""
	
	L["CONFIG_DESIGN_ITEM_PADDING_DESC"] = "設定物品欄位的間隔距離"
	L["CONFIG_DESIGN_ITEM_HIDDEN"] = "顯示隱藏物品"
	L["CONFIG_DESIGN_ITEM_HIDDEN_DESC"] = "設定是否顯示在隱藏分組內的物品"
	L["CONFIG_DESIGN_ITEM_FADE"] = "淡化離線物品"
	L["CONFIG_DESIGN_ITEM_FADE_DESC"] = "設定是否淡化顯示離線物品"
	L["CONFIG_DESIGN_ITEM_TINT_USABLE"] = "標示可使用物品"
	L["CONFIG_DESIGN_ITEM_TINT_USABLE_DESC"] = "將可使用物品標示為紅色"
...
--	L["CONFIG_DESIGN_ITEM_COOLDOWN_COMBAT_DESC"] = ""
	...
	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_DESC"] = "設定是否依品質標示物品邊框顏色 (普通、精良、稀有...)"
--	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF"] = ""
--	L["CONFIG_DESIGN_ITEM_BORDER_QUALITY_CUTOFF_DESC"] = ""
	L["CONFIG_DESIGN_ITEM_BORDER_TEXTURE_OFFSET_DESC"] = "圖片外緣到邊框內緣的像素數(用來重新對齊邊框和物品材質)"
...
--	L["CONFIG_DESIGN_ITEM_NEW_RESET_DESC"] = ""
	...
	L["CONFIG_DESIGN_ITEM_AGE_SHOW_DESC"] = "顯示新物品文字"
	L["CONFIG_DESIGN_ITEM_AGE_COLOUR_DESC"] = "設定新物品文字顏色"
--	L["CONFIG_DESIGN_ITEM_AGE_CUTOFF_DESC"] = ""
	
	L["CONFIG_DESIGN_ITEM_EMPTY"] = "空格"
	L["CONFIG_DESIGN_ITEM_EMPTY_ICON_DESC"] = "切換是否使用圖示來表示空白欄位"
	L["CONFIG_DESIGN_ITEM_EMPTY_CLUMP"] = "整合空格"
	L["CONFIG_DESIGN_ITEM_EMPTY_CLUMP_DESC"] = "設定是否將同背包的空格跟非空格湊在一起，或將不同背包的空格視為一個特殊類別"
	L["CONFIG_DESIGN_ITEM_EMPTY_BORDER"] = "邊框著色"
	L["CONFIG_DESIGN_ITEM_EMPTY_BORDER_DESC"] = "切換是否依空白欄位的背包類別來著色邊框"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR"] = "空格著色"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR_DESC"] = "設定%1$s的空白欄位邊框和背景顏色"
...
--	L["CONFIG_SORTING"] = ""
	...
	L["CONFIG_SORTING_METHOD"] = "排序方式"
--	L["CONFIG_SORTING_METHOD_PLURAL"] = ""
--	L["CONFIG_SORTING_METHOD_DESC"] = ""
	L["CONFIG_SORTING_METHOD_BAGSLOT"] = "依背包/欄位"
	L["CONFIG_SORTING_METHOD_BAGSLOT_DESC"] = "依背包/欄位編號排序物品"
	L["CONFIG_SORTING_METHOD_USER"] = "使用者定義"
	L["CONFIG_SORTING_METHOD_USER_DESC"] = "設定排序規則為使用者定義"
...
--	L["CONFIG_SORTING_BAG_DESC"] = ""
	...
	L["CONFIG_SORTING_INCLUDE_NAME_DESC"] = "設定排序時是否考慮物品名稱"
	L["CONFIG_SORTING_INCLUDE_NAME_REVERSE"] = "包含反轉名稱"
	L["CONFIG_SORTING_INCLUDE_NAME_REVERSE_DESC"] = "設定排序時是否考慮反轉名稱。\n\n例如: 極效法力藥水變成法力藥水極效"
	L["CONFIG_SORTING_INCLUDE_QUALITY"] = "物品品質"
	L["CONFIG_SORTING_INCLUDE_QUALITY_DESC"] = "設定排序時是否考慮物品品質"
	L["CONFIG_SORTING_INCLUDE_LOCATION"] = "裝備部位"
	L["CONFIG_SORTING_INCLUDE_LOCATION_DESC"] = "設定排序時是否考慮物品裝備的部位 (如: 頭、手等)\n\n注意: 只影響可裝備的物品"
	L["CONFIG_SORTING_INCLUDE_ITEMTYPE"] = "物品類型"
	...
	L["CONFIG_SORTING_INCLUDE_ITEMSTATLEVEL_DESC"] = "設定排序時是否考慮物品等級 (stat)"
--	L["CONFIG_SORTING_INCLUDE_ITEMAGE"] = ""
--	L["CONFIG_SORTING_INCLUDE_ITEMAGE_DESC"] = ""
	L["CONFIG_SORTING_INCLUDE_VENDORPRICE"] = "商店價格"
	L["CONFIG_SORTING_INCLUDE_VENDORPRICE_DESC"] = "設定排序時是否考慮物品的商店價格"
...
--	L["CONFIG_SORTING_INCLUDE_COUNT_DESC"] = ""
	...
	L["CONFIG_SORTING_DIRECTION_DESC"] = "切換設定排序使用遞增或是遞減排序"
	L["CONFIG_SORTING_ORDER"] = "排序依據"
	L["CONFIG_SORTING_MOVE_UP"] = REALM_STATUS_UP
	L["CONFIG_SORTING_MOVE_UP_DESC"] = "將 %1$s 的優先性在排序規則中向上移動"
	L["CONFIG_SORTING_MOVE_DOWN"] = REALM_STATUS_DOWN
	L["CONFIG_SORTING_MOVE_DOWN_DESC"] = "將 %1$s 的優先性在排序規則中向下一動"
...
--	configuration options > debug
	L["CONFIG_DEBUG"] = "除錯模式"
	L["CONFIG_DEBUG_DESC"] = "顯示除錯訊息"
	
	
--	configuration options > generic
--	L["CONFIG_BORDER_SCALE_DESC"] = ""
	L["CONFIG_BORDER_TEXTURE_DESC"] = "邊框材質選項"
	L["CONFIG_BORDER_TEXTURE_FILE_DESC"] = "設定邊框材質 (改變此設定將會把縮放比例重置為 100%)"
	L["CONFIG_BORDER_TEXTURE_HEIGHT_DESC"] = "材質的高度 (以像素為單位)"
...
--	slash commands
	L["SLASH_UI"] = "介面"
	L["SLASH_UI_DESC"] = "介面選項"
	L["SLASH_UI_RESET"] = "重設"
	L["SLASH_UI_RESET_DESC"] = "將視窗移至螢幕中央"
	L["SLASH_UI_RESET_COMPLETE_DESC"] = "所有 UI 視窗重置到螢幕中央"
	L["SLASH_DB"] = "資料庫"
	L["SLASH_DB_DESC"] = "資料庫選項"
	L["SLASH_DB_RESET"] = "重設"
	L["SLASH_DB_RESET_DESC"] = "重設所有選項為預設值"
	L["SLASH_DB_RESET_CONFIRM"] = "確認"
	L["SLASH_DB_RESET_CONFIRM_DESC"] = "確認重設資料庫"
	L["SLASH_DB_RESET_COMPLETE_DESC"] = "設定檔已被重設 所有設定已重設為預設值"
	L["SLASH_CACHE"] = "暫存"
	L["SLASH_CACHE_DESC"] = "暫存選項"
	L["SLASH_CACHE_ERASE"] = "清除"
	L["SLASH_CACHE_ERASE_DESC"] = "清除所有暫存資料"
	L["SLASH_CACHE_ERASE_CONFIRM"] = "確認"
	L["SLASH_CACHE_ERASE_CONFIRM_DESC"] = "確認清除暫存資料"
	L["SLASH_CACHE_ERASE_COMPLETE_DESC"] = "所有暫存資料已被刪除"
	L["SLASH_MISC"] = "其他"
	L["SLASH_MISC_DESC"] = "其他選項"
--	L["SLASH_TRACK"] = ""
--	L["SLASH_TRACK_DESC"] = ""
