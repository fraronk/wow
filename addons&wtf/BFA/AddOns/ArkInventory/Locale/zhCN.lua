...
--	L["CONFIG_GENERAL_TOOLTIP_CROSSREALM_DESC"] = ""
	L["CONFIG_GENERAL_TOOLTIP_VAULT_DESC"] = "包括 %1$s 的数据" -- %1$s = vault
...
--	configuration options > auto
	L["CONFIG_AUTO"] = "自动开关"
	L["CONFIG_AUTO_BANK"] = "开启银行"
	L["CONFIG_AUTO_VAULT"] = "开启公会银行"
	L["CONFIG_AUTO_MAILBOX"] = "开启邮箱"
	L["CONFIG_AUTO_MERCHANT"] = "开启一个商人/商店"
	L["CONFIG_AUTO_TRADE"] = "开启一个交易"
	L["CONFIG_AUTO_AUCTION"] = "开启拍卖行"
--	L["CONFIG_AUTO_VOID"] = ""
--	L["CONFIG_AUTO_SCRAP"] = ""
...
--	L["CONFIG_DESIGN_ITEM_COOLDOWN_SHOW_DESC"] = "显示 %1$s 窗口中的物品冷却"
	...
	L["CONFIG_DESIGN_ITEM_COOLDOWN_GLOBAL_DESC"] = "GCD 更新时，刷新 窗口内物品冷却"
...
--	L["CONFIG_DESIGN_ITEM_NEW_RESET_DESC"] = ""
	...
	L["CONFIG_DESIGN_ITEM_EMPTY_BORDER_DESC"] = "切换是否依空格子的背包类别来着色边框"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR"] = "空格着色"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR_DESC"] = "设定空 %1$s 格子的边框和背景颜色"
