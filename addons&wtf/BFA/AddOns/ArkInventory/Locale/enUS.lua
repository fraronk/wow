...
--	configuration options > system
	...
	L["CONFIG_GENERAL_TOOLTIP_VAULT_DESC"] = "include data from %1$s" -- %1$s = vault
...
--	configuration settings > design/style/layout
	...
	L["CONFIG_DESIGN_ITEM_NEW_ENABLED_DESC"] = "temporarily moves new items into their own category"
	L["CONFIG_DESIGN_ITEM_NEW_CUTOFF_DESC"] = "only move items to the new items category if they are less than this value."
	L["CONFIG_DESIGN_ITEM_NEW_RESET_DESC"] = "reset the new item age timer"
	...
	L["CONFIG_DESIGN_ITEM_EMPTY_BORDER_DESC"] = "colour empty slot borders according to their bag type"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR"] = "Slot colours"
	L["CONFIG_DESIGN_ITEM_EMPTY_COLOUR_DESC"] = "set the border and background colour for empty %1$s slots" -- %1$s = slot name
	L["CONFIG_DESIGN_ITEM_EMPTY_ALPHA"] = "Background alpha level"
	L["CONFIG_DESIGN_ITEM_EMPTY_ALPHA_DESC"] = "set the alpha level of the background for empty slots"
...
-- libdatabroker
	...
	L["LDB_LOCATION_NOT_MONITORED"] = "%1$s is not being monitored"
