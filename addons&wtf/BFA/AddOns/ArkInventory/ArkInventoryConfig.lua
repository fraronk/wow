...
function ArkInventory.ConfigInternalDesignExport( id )
	...
	data.design = ArkInventory.Table.Copy( ArkInventory.ConfigInternalDesignGet( id ) )
...
function ArkInventory.ConfigInternalAccountDelete( id )
	...
	local v = ArkInventory.ConfigInternalAccountGet( id )
	v.used = "D"
...
function ArkInventory.ConfigInternalAccountCopy( src, id )
	
	if src == id then return end
	
	local v = ArkInventory.db.account.data
...
function ArkInventory.ConfigInternalAccountPurge( id )
	...
	ArkInventory.ConfigInternalAccountCopy( 0, id )
