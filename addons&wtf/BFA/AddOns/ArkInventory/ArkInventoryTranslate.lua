...
--		ArkInventory.Const.Skills.Data[773].text = value
--	end,
	["WOW_SKILL_JEWELCRAFTING"] = function( value )
		...
		ArkInventory.Const.Skills.Data[755].text = value
	end,
...
local itemTable = { -- key, project, 0=name | 1=itemtype | 2=itemsubtype, item id
	{ "WOW_ITEM_PROJECTILE_ARROW", ArkInventory.Const.Blizzard.Client.CLASSIC, 3, 2512 },
	{ "WOW_ITEM_PROJECTILE_BULLET", ArkInventory.Const.Blizzard.Client.CLASSIC, 3, 2516 },
	{ "WOW_ITEM_SOULSHARD", ArkInventory.Const.Blizzard.Client.CLASSIC, 1, 6265 },
}
...
--	{ "WOW_SKILL_INSCRIPTION", ArkInventory.Const.Blizzard.Client.RETAIL, { 45357 } }, -- WOW_ITEM_CLASS_RECIPE_INSCRIPTION
--	{ "WOW_SKILL_JEWELCRAFTING", ArkInventory.Const.Blizzard.Client.RETAIL, { 25229 } }, -- WOW_ITEM_CLASS_RECIPE_JEWELCRAFTING
