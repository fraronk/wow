...
L["%sCtrl+Right Click|r a line to edit officer note."] = "%sCtrl+ПКМ|r на строке для измения офицерской заметки."
...
L["%sLeft Click|r datatext panel to open friends list."] = "%sЛКМ|r на инфотектсе для открытия списка друзей."
...
L["FAQ_sle_4"] = "|cff30ee30В: Почему я вижу странные иконки около имен некоторых людей в чате?|r\n|cff9482c9О:|r Эти ионки обозначают людей, которых мы хотели выделить по той или иной причине.\nНапример: |TInterface\\AddOns\\ElvUI_SLE\\media\\textures\\SLE_Chat_Logo:12:28|t это иконка для разработчиков, а |TInterface\\AddOns\\ElvUI_SLE\\media\\textures\\SLE_Chat_Logo_Alt:16:16|t это иконка, которую иногда использует Repooc. |TInterface\\AddOns\\ElvUI_SLE\\media\\textures\\Chat_Test:16:16|t для людей, котрые в свое время помогли вычислить хитрый баг."
...
L["Show items used only by engineers when the profession is learned."] = "Отображать в списке инженерные гаджеты при наличии изученой профессии."
...
L["SLE_EM_CONDITIONS_DESC"] = "Определяет условия, при которых будут надеваться указанные сеты.  Работает по принципу макросов и контроллируется набором тэгов, представленным ниже."
...
L["SLE_LOGIN_MSG"] = "|cff9482c9S&L|r версии |cff1784d1%s%s|r для ElvUI загружен."
L["SLE_MEDIA_PVP"] = {"(Территория Орды)","(Территория Альянса)","(Спорная территори)","(Территория пришельцев)","(Курилка)","(Зона отдыха)","(Стоянка мамонтов)"}
L["SLE_MEDIA_PVPARENA"] = {"(PvP)","Не курить!","Самый низки наалог на доходы","Свободная зона","Идет самоуничтожение","Все по 40 рублей!","Ня!"}
