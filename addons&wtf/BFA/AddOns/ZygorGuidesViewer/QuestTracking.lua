...
-- #GLOBALS AbandonQuest,ERR_QUEST_COMPLETE_S,GetNumQuestLeaderBoards,GetNumQuestLogEntries,GetQuestID,GetQuestLogLeaderBoard,GetQuestLogQuestText,GetQuestLogQuestType,GetQuestLogSelection,GetQuestLogTitle,GetQuestProgressBarPercent,GetTitleText,IsQuestFlaggedCompleted,LE_QUEST_FREQUENCY_DAILY,LE_QUEST_FREQUENCY_WEEKLY,SelectQuestLogEntry,SetAbandonQuest,ZygorGuidesViewer
	...
	for i=1,GetNumWorldQuestWatches() do
		...
		if questID then
			...
			for objectiveIndex = 1, numObjectives do
				...
				tinsert(quest.goals, {leaderboard=text, item=ParseLeaderBoard(text,objectiveType), needed=total, num=num, type=objectiveType});
			end
			tinsert(self.quests,quest)
