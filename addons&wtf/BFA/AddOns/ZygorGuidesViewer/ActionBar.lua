...
-- #GLOBALS BINDING_HEADER_ZYGORGUIDESATIONBAR,GameTooltip,GetPetActionInfo,InCombatLockdown,UIParent,ZygorGuidesViewer
...
function ActionBar:SetButton(btype,object) 
	...
	local macro_text, macro_texture, macro_name,macro_tooltip,_ = "", 134400
	-- set data based on type
	if btype=="item" then 
		macro_name,_,_,_,_,_,_,_,_,macro_texture = ZGV:GetItemInfo(object)
		if not macro_name then return retry(timer_id) end
