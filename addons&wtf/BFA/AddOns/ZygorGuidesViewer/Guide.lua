...
-- #GLOBALS ACCEPT,CANCEL,NO,YES,C_PetJournal,CreateFrame,FillLocalizedClassList,GameTooltip,GetAchievementInfo,GetAchievementNumCriteria,GetDungeonDifficultyID,GetSpecialization,GetSpecializationInfo,GetTime,IsInInstance,IsQuestFlaggedCompleted,IsShiftKeyDown,IsTitleKnown,loadstring,OnOpen,Spoo,StaticPopupDialogs,UnitClass,UnitLevel,UnitSex
