...
condition_suggested=function() return level >= 120 and completedq(46291) and not completedq(54185) end,
...
'|condition not completedq(54186) |next "Begin_Pet_Battle_Challenge"
]])
...
|tip This can be completed every week on challenge mode.
|tip This guide will reset when you can complete it again.
'|condition not completedq(56492) |next "Begin_Pet_Battle_Challenge"
]])
...
keywords={"Pet", "Battle"},
condition_suggested=function() return level >= 120 and completedq(56491) and not completedq(58457) end,
...
|tip This can be completed every week on challenge mode.
|tip This guide will reset when you can complete it again.
'|condition not completedq(58458) |next "Begin_Pet_Battle_Challenge"
]])
