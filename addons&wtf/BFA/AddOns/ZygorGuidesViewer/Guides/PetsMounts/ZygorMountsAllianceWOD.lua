...
|tip The mount should be sent to the character that triggers the achievement, this may take a few minuites.
...
step
talk Keegan Firebeard##86973
turnin Clefthoof Training: Riplash##36985 |goto Lunarfall 39.8,56.6 |only if havequest(36985)
turnin Clefthoof Training: Gezz'ran##36986 |goto Lunarfall 39.8,56.6 |only if havequest(36986)
turnin Clefthoof Training: Bulbapore##36987 |goto Lunarfall 39.8,56.6 |only if havequest(36987)
turnin Clefthoof Training: Cruel Ogres##36988 |goto Lunarfall 39.8,56.6 |only if havequest(36988)
turnin Clefthoof Training: Darkwing Roc##36989 |goto Lunarfall 39.8,56.6 |only if havequest(36989)
turnin Clefthoof Training: Ironbore##36992 |goto Lunarfall 39.8,56.6 |only if havequest(36992)
turnin Clefthoof Training: Moth of Wrath##36990 |goto Lunarfall 39.8,56.6 |only if havequest(36990)
turnin Clefthoof Training: Orc Hunters##36993 |goto Lunarfall 39.8,56.6 |only if havequest(36993)
turnin Clefthoof Training: The Garn##36994 |goto Lunarfall 39.8,56.6 |only if havequest(36994)
turnin Clefthoof Training: Thundercall##36991 |goto Lunarfall 39.8,56.6 |only if havequest(36991)
turnin Clefthoof Training: Great-Tusk##36983 |goto Lunarfall 39.8,56.6 |only if havequest(36983)
turnin Clefthoof Training: Rakkiri##36984 |goto Lunarfall 39.8,56.6 |only if havequest(36984)
step
...
step
talk Keegan Firebeard##86973
turnin Elekk Training: Cruel Ogres##37015 |goto Lunarfall 39.8,56.6 |only if havequest(37015)
turnin Elekk Training: Darkwing Roc##37016 |goto Lunarfall 39.8,56.6 |only if havequest(37016)
turnin Elekk Training: Ironbore##37019 |goto Lunarfall 39.8,56.6 |only if havequest(37019)
turnin Elekk Training: Moth of Wrath##37017 |goto Lunarfall 39.8,56.6 |only if havequest(37017)
turnin Elekk Training: Orc Hunters##37020 |goto Lunarfall 39.8,56.6 |only if havequest(37020)
turnin Elekk Training: The Garn##37021 |goto Lunarfall 39.8,56.6 |only if havequest(37021)
turnin Elekk Training: Thundercall##37018 |goto Lunarfall 39.8,56.6 |only if havequest(37018)
step
...
step
talk Fanny Firebeard##86974
turnin Riverbeast Training: Gezz'ran##37005 |goto Lunarfall 38.66,61.94 |only if havequest(37005)
turnin Riverbeast Training: Bulbapore##37006 |goto Lunarfall 38.66,61.94 |only if havequest(37006)
turnin Riverbeast Training: Cruel Ogres##37007 |goto Lunarfall 38.66,61.94 |only if havequest(37007)
turnin Riverbeast Training: Darkwing Roc##37008 |goto Lunarfall 38.66,61.94 |only if havequest(37008)
turnin Riverbeast Training: Ironbore##37011 |goto Lunarfall 38.66,61.94 |only if havequest(37011)
turnin Riverbeast Training: Moth of Wrath##37009 |goto Lunarfall 38.66,61.94 |only if havequest(37009)
turnin Riverbeast Training: Orc Hunters##37012 |goto Lunarfall 38.66,61.94 |only if havequest(37012)
turnin Riverbeast Training: The Garn##37013 |goto Lunarfall 38.66,61.94 |only if havequest(37013)
turnin Riverbeast Training: Thundercall##37010 |goto Lunarfall 38.66,61.94 |only if havequest(37010)
step
...
step
talk Keegan Firebeard##86973
turnin Boar Training: Riplash##36995 |goto Lunarfall 39.8,56.6 |only if havequest(36995)
turnin Boar Training: Gezz'ran##36996 |goto Lunarfall 39.8,56.6 |only if havequest(36996)
turnin Boar Training: Bulbapore##36997 |goto Lunarfall 39.8,56.6 |only if havequest(36997)
turnin Boar Training: Cruel Ogres##36998 |goto Lunarfall 39.8,56.6 |only if havequest(36998)
turnin Boar Training: Darkwing Roc##36999 |goto Lunarfall 39.8,56.6 |only if havequest(36999)
turnin Boar Training: Ironbore##37002 |goto Lunarfall 39.8,56.6 |only if havequest(37002)
turnin Boar Training: Moth of Wrath##37000 |goto Lunarfall 39.8,56.6 |only if havequest(37000)
turnin Boar Training: Orc Hunters##37003 |goto Lunarfall 39.8,56.6 |only if havequest(37003)
turnin Boar Training: The Garn##37004 |goto Lunarfall 39.8,56.6 |only if havequest(37004)
turnin Boar Training: Thundercall##37001 |goto Lunarfall 39.8,56.6 |only if havequest(37001)
step
...
step
talk Fanny Firebeard##86974
turnin Talbuk Training: Riplash##36973 |goto Lunarfall 38.66,61.94 |only if havequest(36973)
turnin Talbuk Training: Gezz'ran##36974 |goto Lunarfall 38.66,61.94 |only if havequest(36974)
turnin Talbuk Training: Bulbapore##36975 |goto Lunarfall 38.66,61.94 |only if havequest(36975)
turnin Talbuk Training: Cruel Ogres##36976 |goto Lunarfall 38.66,61.94 |only if havequest(36976)
turnin Talbuk Training: Darkwing Roc##36977 |goto Lunarfall 38.66,61.94 |only if havequest(36977)
turnin Talbuk Training: Ironbore##36980 |goto Lunarfall 38.66,61.94 |only if havequest(36980)
turnin Talbuk Training: Moth of Wrath##36978 |goto Lunarfall 38.66,61.94 |only if havequest(36978)
turnin Talbuk Training: Orc Hunters##36981 |goto Lunarfall 38.66,61.94 |only if havequest(36981)
turnin Talbuk Training: The Garn##36982 |goto Lunarfall 38.66,61.94 |only if havequest(36982)
turnin Talbuk Training: Thundercall##36979 |goto Lunarfall 38.66,61.94 |only if havequest(36979)
turnin Talbuk Training: Great-Tusk##36971 |goto Lunarfall 38.66,61.94 |only if havequest(36971)
turnin Talbuk Training: Rakkiri##36972 |goto Lunarfall 38.66,61.94 |only if havequest(36972)
step
...
step
talk Fanny Firebeard##86974
turnin Wolf Training: Cruel Ogres##37022 |goto Lunarfall 38.66,61.94 |only if havequest(37022)
turnin Wolf Training: Darkwing Roc##37023 |goto Lunarfall 38.66,61.94 |only if havequest(37023)
turnin Wolf Training: Ironbore##37026 |goto Lunarfall 38.66,61.94 |only if havequest(37026)
turnin Wolf Training: Moth of Wrath##37024 |goto Lunarfall 38.66,61.94 |only if havequest(37024)
turnin Wolf Training: Orc Hunters##37027 |goto Lunarfall 38.66,61.94 |only if havequest(37027)
turnin Wolf Training: The Garn##37028 |goto Lunarfall 38.66,61.94 |only if havequest(37028)
turnin Wolf Training: Thundercall##37025 |goto Lunarfall 38.66,61.94 |only if havequest(37025)
step
...
collect Warsong Direfang##116780 |condition hasmount(171837)
...
collect Rattling Iron Cage##128025 |n
use Rattling Iron Cage##128025
collect Armored Razorback##116669 |condition hasmount(171630)
...
collect Rattling Iron Cage##128025 |n
use Rattling Iron Cage##128025
collect Tundra Icehoof##116658 |condition hasmount(171619)
|tip This is a random drop from any of these mobs. You will need to be in a group to kill them, and only one person in the group gets the mount. You will see people talking in chat about these mobs, looking for groups, so join them when you see this. Additionally, you could create your own Custom Group by pressing "I", then selecting Premade Groups -> Custom. Getting this mount will likely take a lot of time and patience.
step
...
step
use Vicious War Ram##116777 in your bags |use Reins of the Vicious War Ram##116777
...
model={64960},
mounts={191314},	patch='62200',
mounttype='Ground',
description="\nThis guide will help you acquire the Minion of Grumpus mount.",
},[[
step
This mount was released during the 2015 christmas event.
|tip It can only be obtained by completing the christmas dailies in your garrison and then buying the Savage Gift with the tokens recieved from said dailies.
...
kill_ any beasts you see on this path for skinning
|next "nextl"
step
label "buyl"
...
collect Ironhoof Destroyer##116660 |condition hasmount(171621)
step
...
|tip Only one mount drops per kill.
collect Felsteel Annihilator##123890 |condition hasmount(182912)
step
...
model={59739},
mounts={171633},	patch='60100',
mounttype='Ground',
description="\nThis guide will help you acquire the Wild Goretusk mount.",
},[[
step
Reach _Honored_ Reputation with The Saberstalkers |condition rep('The Saberstalkers') >= Honored
|tip Use "The Saberstalkers" dailies guide to accomplish this.
step
talk Z'tenga the Walker##92805
buy Wild Goretusk##116671 |condition hasmount(171633) |goto Tanaan Jungle/0 55.3,74.8
...
model={64726},
mounts={190690},	patch='62000',
mounttype='Ground',
description="\nThis guide will help you acquire the Bristling Hellboar mount.",
},[[
step
Reach _Exalted_ Reputation with The Saberstalkers |condition rep('The Saberstalkers') == Exalted
|tip Use "The Saberstalkers" dailies guide to accomplish this.
step
talk Z'tenga the Walker##92805
buy Bristling Hellboar##128480 |condition hasmount(190690) |goto Tanaan Jungle/0 55.3,74.8
...
model={64849},
mounts={190977},	patch='62000',
mounttype='Ground',
description="\nThis guide will help you acquire the Deathtusk Felboar mount.",
},[[
step
Reach _Exalted_ Reputation with Hand of the Prophet |condition rep('Hand of the Prophet') == Exalted
|tip Use the "Hand of the Prophet" dailies guide to accomplish this.
step
talk Vindicator Krethos##90974
buy Deathtusk Felboar##128526 |condition hasmount(190977) |goto Tanaan Jungle/0 58.4,60.5
...
model={59348},
mounts={171628},	patch='60100',
mounttype='Ground',
description="\nThis guide will help you acquire the Rocktusk Battleboar mount.",
},[[
step
talk Trader Araanda##95470
buy Rocktusk Battleboar##116667 |condition hasmount(171628) |goto Lunarfall/0 30.0,34.6
...
model={59321},
mounts={171616},	patch='60100',
mounttype='Ground',
description="\nThis guide will help you acquire the Witherhide Cliffstomper mount.",
},[[
step
talk Trader Araanda##95470
buy Witherhide Cliffstomper##116655 |condition hasmount(171616) |goto Lunarfall/0 30.0,34.6
...
model={60207},
mounts={171846},	patch='60100',
mounttype='Ground',
description="\nThis guide will help you acquire the Champion's Treadblade mount.",
},[[
step
talk Paulie##87501
buy Witherhide Cliffstomper##116789 |condition hasmount(171846) |goto Stormwind City 73.1,59
...
|tip these portals also only last about 3 minuites and then disappear.
step
...
model={63032},
mounts={183117},	patch='62000',
mounttype='Flying',
description="\nThis guide will help you acquire the Corrupted Dreadwing mount.",
},[[
step
Reach _Friendly_ Reputation with Order of the Awakened |condition rep('Order of the Awakened') >= Friendly
|tip Use the "Order of the Awakened" dailies guide to accomplish this.
step
talk Dawn-Seeker Krisek##95424
buy Reins of the Corrupted Dreadwing##123974 |condition hasmount(183117) |goto Tanaan Jungle/0 58.0,59.4
...
model={48946},
mounts={142910},	patch='53000',
mounttype='Flying',
description="\nThis guide will help you acquire the Bridle of the Ironbound Wraithcharger mount.",
},[[
step
talk Auzin##98690
buy Bridle of the Ironbound Wraithcharger##129922 |condition hasmount(142910) |goto Dalaran 50.4,46.1
...
model={27525},
mounts={194464},	patch='62200',
mounttype='Flying',
description="\nThis guide will help you acquire the Reins of the Eclipse Dragonhawk mount.",
},[[
step
talk Auzin##98690
buy Reins of the Eclipse Dragonhawk##129923 |condition hasmount(194464) |goto Dalaran 50.4,46.1
|tip This costs 5,000 Timewarped Badges.
|tip These can only be obtained through completing timewalking dungeons during the timewalking events.
|tip These events only happen twice a month.
step
