...
mounts={138424},	patch='52000',
mounttype='Ground',
model={47718},
description="\nThis guide will help you acquire the Amber Primordial Direhorn Mount mount.",
},[[
step
label "start"
kill Zandalari Warbringer##69769 |goto The Jade Forest 52.5,18.9
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Amber Primordial Direhorn##94230 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Krasarang Wilds 38.8,67.4
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Amber Primordial Direhorn##94230 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Dread Wastes 47.5,61.5
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Amber Primordial Direhorn##94230 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Townlong Steppes 36.7,85.7
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Amber Primordial Direhorn##94230 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Kun-Lai Summit 75.0,67.6
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Amber Primordial Direhorn##94230 |next "end"
...
mounts={138642},	patch='52000',
mounttype='Ground',
model={47828},
description="\nThis guide will help you acquire the Black Primal Raptor Mount mount.",
},[[
step
...
model={47716},
mounts={130965},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Cobalt Primordial Direhorn mount.",
},[[
step
kill Oondasta##69161
...
mounts={138643},	patch='52000',
mounttype='Ground',
model={47827},
description="\nThis guide will help you acquire the Green Primal Raptor Mount mount.",
},[[
step
To attain this mount, you must kill the beasts on the Isle of Giants.
It is also recommended that you bring a friend for the _Primal_ enemies if below the max level.
...
mounts={138426},	patch='52000',
mounttype='Ground',
model={47717},
description="\nThis guide will help you acquire the Jade Primordial Direhorn Mount mount.",
},[[
step
label "start"
kill Zandalari Warbringer##69769 |goto The Jade Forest 52.5,18.9
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Jade Primordial Direhorn##94231 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Krasarang Wilds 38.8,67.4
|tip The color of the Warbringer's mount is the color of the mount that will drop.
...
keywords={"green","primal","raptor","ground","mount"},
mounts={138641},	patch='52000',
mounttype='Ground',
model={47826},
description="\nThis guide will help you acquire the Red Primal Raptor Mount mount.",
},[[
step
To attain this mount, you must kill the beasts on the Isle of Giants.
It is also recommended that you bring a friend for the _Primal_ enemies if below the max level.
...
mounts={138425},	patch='52000',
mounttype='Ground',
model={47715},
description="\nThis guide will help you acquire the Slate Primordial Direhorn Mount mount.",
},[[
step
label "start"
kill Zandalari Warbringer##69769 |goto The Jade Forest 52.5,18.9
|tip The color of the Warbringer's mount is the color of the mount that will drop.
collect Reins of the Slate Primordial Direhorn##94229 |next "end"
_Click_ here if the mount did not drop from this Warbringer |confirm
step
kill Zandalari Warbringer##69769 |goto Krasarang Wilds 38.8,67.4
|tip The color of the Warbringer's mount is the color of the mount that will drop.
...
model={45264},
mounts={138423},	patch='52000',
mounttype='Ground',
description="\nThis guide will help you acquire the Son of Galleon mount.",
},[[
step
kill Galleon##62346
...
model={43717},
mounts={127286},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Black Dragon Turtle mount.",
},[[
step
...
buy Tushui Tabard ##83079 |goto Stormwind City 67.8,18.6
step
label "tushui_tab"
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Black Dragon Turtle##91008 |goto Stormwind City 67.8,18.6
step
...
model={43718},
mounts={127287},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Blue Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Blue Dragon Turtle##91009 |goto Stormwind City 67.8,18.6
step
...
model={43719},
mounts={127288},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Brown Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Brown Dragon Turtle##91005 |goto Stormwind City 67.8,18.6
step
...
model={43723},
mounts={127295},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Black Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Great Black Dragon Turtle##91011 |goto Stormwind City 67.8,18.6
step
...
model={43724},
mounts={127302},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Blue Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Brown Dragon Turtle##91013 |goto Stormwind City 67.8,18.6
step
...
model={43725},
mounts={127308},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Brown Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Great Brown Dragon Turtle##91014 |goto Stormwind City 67.8,18.6
step
...
model={43722},
mounts={127293},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Green Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Great Green Dragon Turtle##91012 |goto Stormwind City 67.8,18.6
step
...
model={43726},
mounts={127310},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Purple Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Great Purple Dragon Turtle##91015 |goto Stormwind City 67.8,18.6
step
...
model={42352},
mounts={120822},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Great Red Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Great Red Dragon Turtle##91010 |goto Stormwind City 67.8,18.6
step
...
model={42250},
mounts={120395},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Green Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Green Dragon Turtle##91004 |goto Stormwind City 67.8,18.6
step
...
model={43910},
mounts={127289},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Purple Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Purple Dragon Turtle##91006 |goto Stormwind City 67.8,18.6
step
...
model={43721},
mounts={127290},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Red Dragon Turtle mount.",
},[[
step
Routing to the next step |next "rep"
only if not Pandaren
...
label "buy"
talk Old Whitenose##65068
buy Reins of the Red Dragon Turtle##91007 |goto Stormwind City 67.8,18.6
step
...
mounts={138640},	patch='52000',
mounttype='Ground',
model={47825},
description="\nThis guide will help you acquire the Bone-White Primal Raptor mount.",
},[[
step
...
mounts={142641},	patch='53000',
mounttype='Ground',
model={48858},
description="\nThis guide will help you acquire the Brawler's Burly Mushan Beast mount.",
},[[
step
...
mounts={148428},	patch='54000',
mounttype='Ground',
model={51484},
description="\nThis guide will help you acquire the Ashhide Mushan mount.",
},[[
step
...
model={51485},
mounts={148417},	patch='54000',
mounttype='Ground',
description="\nThis guide will help you acquire the Kor'kron Juggernaut mount.",
},[[
step
...
mounts={136471},	patch='52000',
mounttype='Ground',
model={47238},
description="\nThis guide will help you acquire the Spawn of Horridon mount.",
},[[
step
...
model={43090},
mounts={123886},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Amber Scorpion mount.",
},[[
step
label "a"
...
model={43704},
mounts={127174},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Azure Riding Crane mount.",
},[[
step
...
model={41711},
mounts={118089},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Azure Water Strider mount.",
},[[
step
...
Exalted with the Anglers |goto Krasarang Wilds 68.4,43.5 |achieve 6547
step
label "buy"
...
model={44836},
mounts={130138},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Black Riding Goat mount.",
},[[
step
label "a"
...
model={43900},
mounts={129934},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Blue Shado-Pan Riding Tiger mount.",
},[[
step
label "a"
...
step
talk Lao Lang##64030
accept The Shado-Pan##31455 |goto Vale of Eternal Blossoms 84.2,61.4
only if not completedq(31389)
step
talk Ban Bearheart##62304
turnin The Shado-Pan##31389 |goto Townlong Steppes 49.0,70.4
only if not completedq(31389)
|next "a"
step
label "b"
...
model={44807},
mounts={130086},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Brown Riding Goat mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Tillers_.
...
model={48101},
mounts={140250},	patch='52000',
mounttype='Ground',
description="\nThis guide will help you acquire the Crimson Prime Direhorn mount.",
},[[
step
...
model={48100},
mounts={140249},	patch='52000',
mounttype='Ground',
description="\nThis guide will help you acquire the Golden Prime Direhorn mount.",
},[[
step
...
buy Reins of the Golden Primal Direhorn##95564 |goto Isle of Thunder/2 64.4,74.4
|tip This costs 3,000 gold.
learnmount Golden Primal Direhorn##140249 |use Reins of the Golden Primal Direhorn##95564
step
_Congratulations!_
...
model={43705},
mounts={127176},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Golden Riding Crane mount.",
},[[
step
This mount requires you to be _Exalted_ with _The Golden Lotus_.
Click here to be taken to the reputation guide to become Exalted with The Golden Lotus. |confirm |next "dailies"
...
model={44759},
mounts={129932},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Green Shado-Pan Riding Tiger mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Shado-Pan_.
...
model={44757},
mounts={129935},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Red Shado-Pan Riding Tiger mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Shado-Pan_.
...
model={43706},
mounts={127177},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Regal Riding Crane mount.",
},[[
step
This mount requires you to be _Exalted_ with _The Golden Lotus_.
Click here to be taken to the reputation guide to become Exalted with The Golden Lotus. |confirm |next "dailies"
...
model={44837},
mounts={130137},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the White Riding Goat mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Tillers_.
...
model={43712},
mounts={127220},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Blonde Riding Yak mount.",
},[[
step
...
model={42703},
mounts={122708},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Grand Expedition Yak mount.",
},[[
step
talk Uncle Bigpocket##64518
...
model={43711},
mounts={127216},	patch='50400',
mounttype='Ground',
description="\nThis guide will help you acquire the Grey Riding Yak mount.",
},[[
step
talk Uncle Bigpocket##64518
...
model={48816},
mounts={142478},	patch='53000',
mounttype='Flying',
description="\nThis guide will help you acquire the Armored Blue Dragonhawk mount.",
},[[
step
...
model={47256},
mounts={136400},	patch='52000',
mounttype='Flying',
description="\nThis guide will help you acquire the Armored Skyscreamer mount.",
},[[
step
...
model={41592},
mounts={127156},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Crimson Cloud Serpent mount.",
},[[
step
...
model={43692},
mounts={127161},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Heavenly Crimson Cloud Serpent mount.",
},[[
step
...
model={47166},
mounts={136163},	patch='51000',
mounttype='Flying',
description="\nThis guide will help you acquire the Grand Gryphon mount.",
},[[
step
...
learnmount Grand Gryphon##136163 |use Grand Gryphon##93385
step
_Congratulations!_
...
model={42147},
mounts={133023},	patch='51000',
mounttype='Flying',
description="\nThis guide will help you acquire the Jade Pandaren Kite mount.",
},[[
step
...
model={41903},
mounts={118737},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Pandaren Kite mount.",
},[[
step
...
model={43686},
mounts={124408},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Thundering Jade Cloud Serpent mount.",
},[[
step
...
model={51479},
mounts={148392},	patch='54000',
mounttype='Flying',
description="\nThis guide will help you acquire the Spawn of Galakras mount.",
},[[
step
...
mounts={139595},	patch='52000',
mounttype='Flying',
model={48020},
description="\nThis guide will help you acquire the Armored Bloodwing mount.",
},[[
step
...
model={59583},
mounts={142878},	patch='53000',
mounttype='Flying',
description="\nThis guide will help you acquire the Enchanted Fey Dragon mount.",
},[[
step
...
model={55896},
mounts={163024},	patch='60100',
mounttype='Flying',
description="\nThis guide will help you acquire the Warforged Nightmare mount.",
},[[
step
This mount is purchased for 25 dollars via the Blizzard store.
After purchasing please check your in game mail for the mount.
...
model={47981},
mounts={139442},	patch='52000',
mounttype='Flying',
description="\nThis guide will help you acquire the Thundering Cobalt Cloud Serpent.",
},[[
step
kill Nalak##69099
...
keywords={"heavenly","onyx","cloud","serpent","sha","of","anger","flying","mount"},
model={43689},
mounts={127158},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Heavenly Onyx Cloud Serpent mount.",
},[[
step
...
model={51488},
mounts={148476},	patch='54000',
mounttype='Flying',
description="\nThis guide will help you acquire the Thundering Onyx Cloud Serpent mount.",
},[[
step
kill Huolon##73167
|tip He is a rarespawn.
...
model={45797},
mounts={132036},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Thundering Ruby Cloud Serpent mount.",
},[[
step
...
model={48931},
mounts={142073},	patch='53000',
mounttype='Flying',
description="\nThis guide will help you acquire the Hearthsteed mount.",
},[[
step
...
model={41990},
mounts={127154},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Onyx Cloud Serpent mount.",
},[[
step
...
model={43637},
mounts={126507},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Depleted-Kyparium Rocket mount.",
},[[
step
...
step
collect 200 Kyparite##72093
collect 10 Kyparite Fragment##97546 |n
|tip Once you gather enough fragments, click them to create a Kyparite.
...
model={43638},
mounts={126508},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Geosynchronous World Spinner mount.",
},[[
step
Skipping to the next step |next |only if skill("Engineering")<600
talk Lilliam Sparkspindle##5518 |only if skill("Engineering")>=600
learn Geosynchronous World Spinner##127138 |goto Stormwind City 63.2,31.4 |only if skill("Engineering")>=600
Click here if you do not wish to make this pet yourself |confirm |only if skill("Engineering")>=600
step
You can either _buy_ this _mount_ from the _Auction House_ or make it:
...
keywords={"engineering","flying","mount"},
model={46686},
mounts={134359},	patch='51000',
mounttype='Flying',
description="\nThis guide will help you acquire the Sky Golem mount.",
},[[
step
...
model={42502},
mounts={121837},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Jade Panther mount.",
},[[
step
...
learn Jade Panther##121844 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
...
model={42185},
mounts={120043},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Jeweled Onyx Panther mount.",
},[[
step
Skipping to the next step |next |only if skill("Jewelcrafting")<600
talk San Redscale##58414 |only if skill("Jewelcrafting")>=600
buy 1 Design: Jeweled Onyx Panther##83877 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
learn Jeweled Onyx Panther##120045 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
Click here if you do not wish to make this pet yourself |confirm |only if skill("Jewelcrafting")>=600
step
You can either _buy_ this _mount_ from the _Auction House_ or make it:
...
model={42499},
mounts={121838},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Ruby Panther mount.",
},[[
step
Skipping to the next step |next |only if skill("Jewelcrafting")<600
talk San Redscale##58414 |only if skill("Jewelcrafting")>=600
buy 1 Design: Ruby Panther##83931 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
learn Ruby Panther##121841 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
Click here if you do not wish to make this pet yourself |confirm |only if skill("Jewelcrafting")>=600
step
You can either _buy_ this _mount_ from the _Auction House_ or make it:
...
model={42500},
mounts={121836},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Sapphire Panther mount.",
},[[
step
Skipping to the next step |next |only if skill("Jewelcrafting")<600
talk San Redscale##58414 |only if skill("Jewelcrafting")>=600
buy 1 Design: Sapphire Panther##83932 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
learn Sapphire Panther##121842 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
Click here if you do not wish to make this pet yourself |confirm |only if skill("Jewelcrafting")>=600
step
You can either _buy_ this _mount_ from the _Auction House_ or make it:
...
model={42501},
mounts={121839},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Sunstone Panther mount.",
},[[
step
Skipping to the next step |next |only if skill("Jewelcrafting")<600
talk San Redscale##58414 |only if skill("Jewelcrafting")>=600
buy 1 Design: Sunstone Panther##83830 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
learn Sunstone Panther##121843 |goto The Jade Forest 56.7,44.4 |only if skill("Jewelcrafting")>=600
Click here if you do not wish to make this pet yourself |confirm |only if skill("Jewelcrafting")>=600
step
You can either _buy_ this _mount_ from the _Auction House_ or make it:
...
model={46087},
mounts={127170},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Astral Cloud Serpent mount.",
},[[
step
...
model={47983},
mounts={139448},	patch='52000',
mounttype='Flying',
description="\nThis guide will help you acquire the Clutch of Ji-kun mount.",
},[[
step
...
model={41989},
mounts={123992},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Azure Cloud Serpent mount.",
},[[
step
label "a"
...
model={41991},
mounts={123993},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Golden Cloud Serpent mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Order of the Cloud Serpent_.
...
model={46929},
mounts={135416},	patch='51000',
mounttype='Flying',
description="\nThis guide will help you acquire the Grand Armored Gryphon mount.",
},[[
step
label "a"
...
model={43693},
mounts={127164},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Heavenly Golden Cloud Serpent mount.",
},[[
step
...
model={40590},
mounts={113199},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Jade Cloud Serpent mount.",
},[[
step
label "a"
This mount requires you to be _Exalted_ with _The Order of the Cloud Serpent_.
...
model={44808},
mounts={130092},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Red Flying Cloud mount.",
},[[
step
...
model={43686},
mounts={129918},	patch='50400',
mounttype='Flying',
description="\nThis guide will help you acquire the Thundering August Cloud Serpent mount.",
},[[
step
...
mounts={136505},	patch='52000',
mounttype='Flying',
model={48014},
description="\nThis guide will help you acquire the Ghastly Charger mount.",
},[[
step
