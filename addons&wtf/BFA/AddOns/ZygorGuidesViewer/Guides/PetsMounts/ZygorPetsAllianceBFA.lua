...
step
Wait for Children's Week to Begin |condition isevent("Children's Week") |or
|tip This event starts on May 2 and ends on May 9.
'|learnpet Beakbert##150119 |or
step
...
step
use Beakbert##167010
Collect the "Beakbert" Battle Pet |learnpet Beakbert##150119
step
_Congratulations!_
...
'|learnpet Brilliant Glimmershell##154827 |or
step
use Brilliant Glimmershell##169354
Learn the "Brilliant Glimmershell" Battle Pet |learnpet Brilliant Glimmershell##154827
step
_Congratulations!_
...
|tip Inside the building.
buy Bucketshell##163974 |goto Stormwind City/0 61.12,70.61 |condition haspet(2479)
...
pet=2691,
model={91021},
description="\nThis battle pet can be purchased from Crafticus Mindbender in Mezzamere for 30 Nazjatar Battle Commendations.",
},[[
step
...
step
talk Crafticus Mindbender##154653
|tip Inside the building.
...
|tip Use the "Trap" ability once it is below 35% health.
Collect the "Coastal Bounder" Battle Pet |learnpet Coastal Bounder##143057 |goto Tiragarde Sound/0 80.83,23.46
step
_Congratulations!_
...
Collect the "Crimson Frog" Battle Pet |learnpet Crimson Frog##143205 |next "Unlocked_Crimson_Frog"
step
...
buy Crimson Octopode##166500 |goto Boralus/0 66.05,32.32 |condition haspet(2562)
step
...
Collect the "Froglet" Battle Pet |learnpet Froglet##150120
step
_Congratulations!_
...
Collect the "Mr. Crabs" Battle Pet |learnpet Mr. Crabs##150098
step
_Congratulations!_
...
step
Collect 150 Prismatic Manapearls |condition curcount(1721) >= 150 |or
|tip They can be acquired from rares and various quests around Nazjatar.
'|condition haspet(2686) |or
step
...
Collect the "Pearlescent Glimmershell" Battle Pet |learnpet Pearlescent Glimmershell##154825
step
_Congratulations!_
...
|tip Inside the building.
buy Sir Snips##163975 |goto 56.43,27.25 |condition haspet(2478)
|tip You will need Honor Level 400 in order to purchase this.
step
use Sir Snips##163975
Collect the "Sir Snips" Battle Pet |learnpet Sir Snips##144005
step
_Congratulations!_
...
collect Storm's Wake Supplies##166294 |goto Stormsong Valley/0 59.2,69.4 |condition haspet(2569)
step
use the Storm's Wake Supplies##166294
collect Violet Abyssal Eel##149376 |condition haspet(2569)
...
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2758) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2758) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2758) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2758) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Eel this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2758) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2758) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2758) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167808) >= 1 or haspet(2758) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167808) == 0 and not haspet(2758) |next "Wait_For_Reset" |or
step
use the Slimy Eel##167808
Collect the "Slimy Eel" Battle Pet |learnpet Slimy Eel##151697
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2765) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2765) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2765) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2765) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2765) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Sea Slug this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2765) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2765) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2765) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167804) >= 1 or haspet(2765) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167804) == 0 and not haspet(2765) |next "Wait_For_Reset" |or
step
use the Slimy Sea Slug##167804
Collect the "Slimy Sea Slug" Battle Pet |learnpet Slimy Sea Slug##151631
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2757) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2757) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2757) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2757) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2757) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Otter this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2757) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2757) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2757) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167805) >= 1 or haspet(2757) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167805) == 0 and not haspet(2757) |next "Wait_For_Reset" |or
step
use the Slimy Otter##167805
Collect the "Slimy Otter" Battle Pet |learnpet Slimy Otter##151700
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2760) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2760) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2760) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2760) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2760) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Octopode this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2760) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2760) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2760) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167806) >= 1 or haspet(2760) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167806) == 0 and not haspet(2760) |next "Wait_For_Reset" |or
step
use the Slimy Octopode##167806
Collect the "Slimy Octopode" Battle Pet |learnpet Slimy Octopode##151673
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2763) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2763) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2763) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2763) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2763) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Hermit Crab this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2763) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2763) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2763) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167810) >= 1 or haspet(2763) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167810) == 0 and not haspet(2763) |next "Wait_For_Reset" |or
step
use the Slimy Hermit Crab##167810
Collect the "Slimy Hermit Crab" Battle Pet |learnpet Slimy Hermit Crab##151632
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2761) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2761) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2761) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2761) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2761) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Fangtooth this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2761) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2761) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2761) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167807) >= 1 or haspet(2761) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167807) == 0 and not haspet(2761) |next "Wait_For_Reset" |or
step
use the Slimy Fangtooth##167807
Collect the "Slimy Fangtooth" Battle Pet |learnpet Slimy Fangtooth##151696
step
_Congratulations!_
...
collect 4 Prismatic Crystal##167893 |or
|tip These can be found near waterfalls across Nazjatar.
'|condition haspet(2762) |or
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55430,55473) or haspet(2762) |goto 32.76,39.53
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55429,55472) or haspet(2762) |goto 45.70,24.11
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55427,55470) or haspet(2762) |goto 54.90,48.70
step
use the Prismatic Crystal##167893
|tip Use it on any non-aquatic critter in Nazjatar.
|tip You can find slugs, snails, crabs, and birds all over Nazjatar.
Feed the Ravenous Slime |condition completedanyq(55428,55471) or haspet(2762) |goto 71.71,25.70
step
label "Wait_For_Reset"
You have fed all of the Ravenous slimes |only if not completedanyq(55478,55477,55475,55476)
You did not get the Slimy Darkhunter this week |only if completedanyq(55478,55477,55475,55476)
|tip This guide will reset when you can feed the slimes again.
'|condition haspet(2762) |or
'|condition not completedanyq(55430,55429,55427,55428) and not completedanyq(55473,55472,55470,55471) and not haspet(2762) |next "Collect_Prismatic_Crystals" |or
'|condition completedq(55473) and completedq(55472) and completedq(55470) and completedq(55471) and not completedanyq(55478,55477,55475,55476) and not haspet(2762) |next "Collect_Battle_Pet" |or
step
label "Collect_Battle_Pet"
click Slimy Cocoon
Loot the Cocoon |condition completedanyq(55478,55477,55475,55476) and itemcount(167809) >= 1 or haspet(2762) |goto 71.71,25.70 |or
'|condition completedanyq(55478,55477,55475,55476) and itemcount(167809) == 0 and not haspet(2762) |next "Wait_For_Reset" |or
step
use the Slimy Darkhunter##167809
Collect the "Slimy Darkhunter" Battle Pet |learnpet Slimy Darkhunter##151651
step
_Congratulations!_
...
talk Auctioneer Fitch##8719
|tip Inside the building.
collect 1 Dart##156566 |goto Stormwind City/0 61.12,70.62 |condition haspet(2157)
...
talk Auctioneer Fitch##8719
|tip Inside the building.
collect 1 Snake Charmer's Flute##160847 |goto Stormwind City/0 61.12,70.62 |condition haspet(2190)
|tip This pet must be collected on a Horde character.
|tip If you are Alliance you can purchase it from the Auction House.
step
...
buy 1 Bloodfeaster Larva##163500 |goto Nazmir/0 66.92,42.06 |condition haspet(2414)
step
...
Collect the "Damplight Slug" Battle Pet |learnpet Damplight Slug##154838
step
_Congratulations!_
...
step
Reach Friendly Reputation with the Waveblade Ankoan |condition rep('Waveblade Ankoan') >= Friendly
...
'|condition haspet(2698) |or
step
use the Prismatic Softshell##169364
Collect the "Prismatic Softshell" Battle Pet |learnpet Prismatic Softshell##154837
step
_Congratulations!_
...
talk Madeline Netley##136674
|tip Inside the building.
buy Saurolisk Hatchling##163560 |goto Stormsong Valley/0 31.58,67.34 |condition haspet(2421)
step
use the Saurolisk Hatchling##163560
Collect the "Saurolisk Hatchling" Battle Pet |learnpet Saurolisk Hatchling##143202
step
_Congratulations!_
...
Collect the "Scaley" Battle Pet |learnpet Scaley##150126
step
_Congratulations!_
...
talk Madeline Netley##136674
|tip Inside the building.
buy Violent Looking Flower Pot##163514 |goto Stormsong Valley/0 31.58,67.34 |condition haspet(2428)
step
...
step
talk Captain Klarisa##148922
buy Albino Duskwatcher##166491 |goto Boralus/0 66.05,32.32 |condition haspet(2555)
step
...
|tip This will appear once you reach 10000 reputation past exalted with the "Proudmoore Admiralty".
collect Proudmoore Admiralty Supplies##166295 |condition haspet(2566)
step
use the Proudmoore Admiralty Supplies##166295
collect Albatross Feather##166714 |condition haspet(2566)
|tip This is a random drop.
step
...
talk Madeline Netley##136674
|tip Inside the building.
buy Butterfly in a Jar##163508 |goto Stormsong Valley/0 31.58,67.34 |condition haspet(2422)
step
use the Butterfly in a Jar##163508
Collect the "Blue Flitter" Battle Pet |learnpet Blue Flitter##143203
step
_Congratulations!_
...
step
Kill enemies around this area
collect Annealed Honey Amulet##163699 |goto Stormsong Valley/0 69.55,68.58 |condition haspet(2442)
...
collect Rosaline's Letter##163702 |next "Meadery"  |condition haspet(2442)
...
|tip Give Rosaline the Annealed Honey Amulet.
Click Here to Continue |confirm |next "Rosaline_Loop" |condition haspet(2442)
|tip Click the line above if she isn't here.
step
label "Meadery"
talk Ancel Mildenhall##131793
...
collect Order of Embers Supplies##166297 |goto Drustvar/0 37.90,49.00 |condition haspet(2568)
step
use the Order of Embers Supplies##166297
collect Cobalt Raven Hatchling##166718 |condition haspet(2568)
step
...
step
collect 200 Polished Pet Charm##163036 |condition haspet(2405)
|tip These are earned from questing in Zandalar and Kul Tiras as well as War Campaign Missions, World Quests, treasures and rares.
step
talk Quartermaster Alcorn##135815
buy Pristine Falcon Feather##163491 |goto Drustvar/0 37.89,49.00 |condition haspet(2405)
step
...
talk Auctioneer Fitch##8719
|tip Inside the building.
collect Pair of Tiny Bat Wings##166716 |goto Stormwind City/0 61.12,70.62 |condition haspet(2567)
step
...
buy Darkshore Sentinel##166449 |goto Darkshore/0 41.64,76.65 |condition haspet(2405)
step
...
step
collect 200 Polished Pet Charm##163036 |condition haspet(2409)
|tip These are earned from questing in Zandalar and Kul Tiras as well as War Campaign Missions, World Quests, treasures and rares.
step
...
|tip Inside the building.
buy Greatwing Macaw Feather##163495 |goto 50.92,45.92 |condition haspet(2409)
step
...
step
Summon the "Bumbles" or "Seabreeze Bumblebee" Battle Pet |condition activepet(143730) or activepet(143176) |goto Stormsong Valley/0 69.24,64.20 |q 56104 |future |or
|tip Use their respective battle pet guides to collect one.
'|learnpet Papi##158681 |or
step
Watch the dialogue
...
step
use Papi##172491
Collect the "Papi" Battle Pet |learnpet Papi##158681
step
_Congratulations!_
...
step
Reach Revered Reputation with the Storm's Wake |condition rep('Storm\'s Wake')>=Revered
|tip Use the Battle for Azeroth "World Quests" guides to complete "Storm's Wake" world quests.
|tip Complete Missions at your mission table that reward reputation with the Storm's Wake.
step
collect 250 Polished Pet Charm##163036
...
buy Pair of Bee Wings##163490 |goto Stormsong Valley/0 59.29,69.33 |condition haspet(2404)
step
...
Summon the "Bumbles" or "Seabreeze Bumblebee" Battle Pet |condition activepet(143730) or activepet(143176) |goto Stormsong Valley/0 69.24,64.20 |q 56104 |future |or
|tip Use their respective battle pet guides to collect one.
'|learnpet Sunsoaked Flitter##158683 |or
step
Watch the dialogue
|tip Summon the "Bumbles" battle pet.
Summon the "Bumbles" Battle Pet Near Barry |q 55906 |goto 69.24,64.20 |future |or
...
Collect the "Sunsoaked Flitter" Battle Pet |learnpet Sunsoaked Flitter##158683
step
_Congratulations!_
...
step
Learn the "Gillvanas" Battle Pet |learnpet Gillvanas##157715
...
step
Learn the "Finduin" Battle Pet |learnpet Finduin##157716
...
step
You will need to kill the rare spawn Aiji the Accursed to gain access to the vendor Shoak
Click Here to Continue |confirm |condition haspet(2420)
step
click Ancient Tablet
accept An Ancient Curse##50976 |goto Nazmir/0 52.92,75.96
step
...
collect Baa'ls Darksign##162578 |goto Frostfire Ridge/0 62.27,22.86 |condition haspet(2352)
step
...
|tip Inside the building.
|tip If your faction doesn't control the Arathi Highlands Warfront, you will be flagged for PVP.
collect Tiny Grimoire##163652 |goto Arathi Highlands/0 50.6,61.2 |condition haspet(2434)
...
'|learnpet Feathers##147583 |or
step
use Feathers##165845
Collect the "Feathers" Battle Pet |learnpet Feathers##147583
step
_Congratulations!_
...
step
collect 200 Polished Pet Charm##163036 |condition haspet(2443)
|tip These are earned from questing in Zandalar and Kul Tiras as well as War Campaign Missions, World Quests, treasures and rares.
step
talk Vindicator Jaelaana##135446
|tip Standing on the dock leading to the ship.
buy Lil' Siege Tower##163778 |goto Boralus/0 68.96,24.72 |condition haspet(2443)
step
...
|tip Complete Missions at your mission table that reward reputation with the 7th Legion.
step
collect 200 Polished Pet Charm##163036 |condition haspet(2444)
|tip These are earned from questing in Zandalar and Kul Tiras as well as War Campaign Missions, World Quests, treasures and rares.
step
talk Vindicator Jaelaana##135446
|tip Standing on the dock leading to the ship.
buy Lil' War Machine##163779 |goto Boralus/0 68.96,24.72 |condition haspet(2444)
step
...
step
collect 75 Polished Pet Charm##163036 |condition haspet(2409)
|tip These are earned from questing in Zandalar and Kul Tiras as well as War Campaign Missions, World Quests, treasures and rares.
step
Run down the stairs |goto Boralus/0 67.39,16.18 < 10 |only if walking
Continue down the stairs |goto 66.42,19.90 < 10 |only if walking
...
talk Dana Pull##142065
|tip Inside the building.
buy Strange Looking Mechanical Squirrel##163496 |goto 50.92,45.92 |condition haspet(2410)
step
...
collect Banana-Shaped Power Cell##166734 |goto Vol'dun/0 41.84,42.32 |or |condition haspet(2564)
collect Steel-Plated Primate Exoskeleton##166733 |goto 41.84,42.32 |or |condition haspet(2564)
collect Bludgeoning-Resistant Chest Reinforcer##166732 |goto 41.84,42.32 |or |condition haspet(2564)
step
You must gather 3 material that only appear during a Faction Assault on Vol'dun
|tip You will only be able to collect one of the 3 items needed per Assault.
|tip This means that you will not be able to gather these in a single day.
...
click Loose Parts##311902
|tip This will spawn when Dookthar the Destroyer is killed and Arachni is still alive.
collect Banana-Shaped Power Cell##166734 |goto Vol'dun/0 41.84,42.32 |or 2 |condition haspet(2564)
collect Steel-Plated Primate Exoskeleton##166733 |goto 41.84,42.32 |or 2 |condition haspet(2564)
collect Bludgeoning-Resistant Chest Reinforcer##166732 |goto 41.84,42.32 |or 2 |condition haspet(2564)
step
You must gather 3 material that only appear during a Faction Assault on Vol'dun
|tip You will only be able to collect one of the 3 items needed per Assault.
|tip This means that you will not be able to gather these in a single day.
...
click Loose Parts##311902
|tip This will spawn when Dookthar the Destroyer is killed and Arachni is still alive.
collect Banana-Shaped Power Cell##166734 |goto Vol'dun/0 41.84,42.32 |condition haspet(2564)
collect Steel-Plated Primate Exoskeleton##166733 |goto 41.84,42.32|condition haspet(2564)
collect Bludgeoning-Resistant Chest Reinforcer##166732 |goto 41.84,42.32 |condition haspet(2564)
step
use Banana-Shaped Power Cell##166734
collect Rebuilt Gorilla Bot##166715 |condition haspet(2564)
step
...
talk Auctioneer Fitch##8719
|tip Inside the building.
collect 1 Rebuilt Mechanical Spider##166723 |goto Stormwind City/0 61.12,70.62 |condition haspet(2565)
...
'|condition haspet(2753) |or
step
use Spraybot 0D##169886
Collect the "Spraybot 0D" Battle Pet |learnpet Spraybot 0D##155600
step
_Congratulations!_
...
Collect the "Microbot XD" Battle Pet |learnpet Microbot XD##154856
step
_Congratulations!_
