...
Defeat Kura Thunderhoof |q 38300/1 |goto Frostwall/0 33.3,42.9
step
talk Kura Thunderhoof##91362
...
To earn tokens, _click here_. |next "Events Guides\\Love is in the Air (February 6th - 20th)\\Love is in the Air Dailies" |confirm |only if ZGV.guidesets["DailiesACATA"]
...
step
_Click here_ if you need to do the quests leading up to the dailies. |next "Events Guides\\Brewfest\\Brewfest Quests" |confirm |confirm |only if ZGV.guidesets["DailiesHCATA"]
_Click here_ if you have completed the quests and only need the dailies. |next "Events Guides\\Brewfest\\Brewfest Dailies" |confirm |confirm |only if ZGV.guidesets["DailiesHCATA"]
step
...
click Rustling Peachick Nest##237483 |goto The Everbloom 55.8,22.1
...
step
kill Demidos##84911
|tip Demidos is a level 100 rare elite and may require a group.
collect Servant of Demidos##119431 |goto Shadowmoon Valley D/0 46.00,71.58 |or
|tip This pet is not a gauranteed drop.
'|learnpet Servant of Demidos##88692 |or
step
use the Servant of Demidos##119431
Learn the "Servant of Demidos" Battle Pet |learnpet Servant of Demidos##88692
step
_Congratulations!_
...
Learn the "Iron Starlette" Battle Pet |learnpet Iron Starlette##77221
step
_Congratulations!_
