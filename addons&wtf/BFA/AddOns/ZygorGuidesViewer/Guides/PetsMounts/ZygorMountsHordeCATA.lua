...
|only if not Paladin
step
To obtain this mount you must level a Tauren Paladin to level 40
|tip Once your character is level 40, this mount will be rewarded automatically.
...
|only if not Paladin
step
To obtain this mount you must level a Blood Elf Paladin to level 40
|tip Once your character is level 40, this mount will be rewarded automatically.
...
|only if not Warlock
step
To obtain this mount you must level a Warlock to level 40
|tip Once your character is level 40 this mount will be rewarded automatically.
...
mounts={63635,65644},	patch='30103',
mounttype='Ground',
model={29261},
...
mounts={63640,65646},	patch='30103',
mounttype='Ground',
model={29879},
...
mounts={63642,65639},	patch='30103',
mounttype='Ground',
model={29262},
...
mounts={63641,65641},	patch='30103',
mounttype='Ground',
model={29259},
...
mounts={63643,65645},	patch='30103',
mounttype='Ground',
model={29257},
...
|tip If you're level 85 take off most, if not all, of your gear and punch the Venomhide Ravasaurs to get the debuff. This quest will take a while...
step
talk Mor'vek##11701
...
mounts={96499,96491},	patch='unknown',
mounttype='Ground',
model={37799},
...
mounts={35025,33660,35027,35022,35020,35018,34795},	patch='30202',
mounttype='Ground',
model={19482},
...
mounts={64657,18989,23247,23249,23248,18990},	patch='60204',
mounttype='Ground',
model={14349},
...
mounts={10799,10796,8395,23243,23242,23241},	patch='40300',
mounttype='Ground',
model={14344},
...
mounts={17465,66846,23246,64977,17463,17464,17462},	patch='unknown',
mounttype='Ground',
model={10720},
...
mounts={87091,87090},	patch='unknown',
mounttype='Ground',
model={35250},
...
mounts={23250,23252,23251,64658,6654,6653,580},	patch='unknown',
mounttype='Ground',
model={30047},
...
mounts={25953,26056,26054,26055},	patch='30300',
mounttype='Ground',
model={15681},
...
mounts={88748,88749},	patch='unknown',
mounttype='Ground',
model={37492},
...
mounts={39315,34896,39317,34898,39318,34899,39319,34897},	patch='40200',
mounttype='Ground',
model={19377},
...
label "turn_in"
talk Warden Bullrok##18407
accept More Warbeads##10478 |goto Nagrand,55.8,37.9 |instant |repeatable
...
mounts={38207},	patch='unknown',
mounttype='unknown',
model={30989},
description="\nThis guide will help you acquire the Big Love Rocket mount.",
},[[
step
This requires the _Love is in the Air_ event
|tip You must be at least level 98 to obtain this mount.
...
Travel to the Past |condition ZGV.InPhase('Old Undercity') |goto Tirisfal Glades/0 69.45,62.80
step
talk Chub##53757
...
turning Warning the Cenarion Circle##9724 |goto Hellfire Peninsula,16,52.2
...
accept A Mission Statement##11864 |goto Borean Tundra,57,44.3 |instant
...
label "plants_turnin"
talk Lauranna Thar'well##17909
accept Plants of Zangarmarsh##9802 |goto 80.4,64.2 |instant |repeatable
...
step
talk Arch Druid Lathorius##25809
accept Can't Get Ear-nough...##11867 |goto Borean Tundra,57,0,44.2 |instant |repeatable
...
accept Earning Your Wings...##11063 |goto 65.9,87.2 |instant
step
...
accept Taking the Battlefront##27542 |goto 51.9,65.0 |instant
step
Next to you:
...
step
talk Maztha##44919 |only if Orc
talk Velma Warnam##4773 |only if Undead
talk Kar Stormsinger##3690 |only if Tauren
talk Xar'Ti##7953 |only if Troll
talk Perascamin##16280 |only if BloodElf
|tip Inside the building. |only if BloodElf
talk Revi Ramrod##48513 |only if Goblin
talk Softpaws##70301 |only if Pandaren
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 48.91,59.27 |only if Orc
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Tirisfal Glades/0 61.88,51.86 |only if Undead
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Mulgore/0 47.78,57.98 |only if Tauren
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Durotar/0 55.28,75.49 |only if Troll
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Eversong Woods/0 61.38,53.98 |only if BloodElf
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 38.55,78.22 |only if Goblin
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 69.92,40.99 |only if Pandaren
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |only if Nightborne or HMTauren or MHOrc or ZTroll
|tip You will start with this ability. |only if Nightborne or HMTauren or MHOrc or ZTroll
step
...
talk Revi Ramrod##48513 |only if Goblin
talk Softpaws##70301 |only if Pandaren
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 48.91,59.27 |only if Orc
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Tirisfal Glades/0 61.88,51.86 |only if Undead
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Mulgore/0 47.78,57.98 |only if Tauren
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Durotar/0 55.28,75.49 |only if Troll
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Eversong Woods/0 61.38,53.98 |only if BloodElf
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 38.55,78.22 |only if Goblin
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 69.92,40.99 |only if Pandaren
step
Reach Level 60 |ding 60
step
talk Maztha##44919
Train the "Expert Riding" Ability |condition knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 48.91,59.27
step
Reach Level 70 |ding 70
step
talk Maztha##44919
Train the "Artisan Riding" Ability |condition knowspell(34091) or knowspell(90265) |goto Orgrimmar/1 48.91,59.27
step
Reach Level 80 |ding 80
step
talk Maztha##44919
Train the "Master Riding" Ability |condition knowspell(90265) |goto Orgrimmar/1 48.91,59.27
step
_Congratulations!_
