...
talk Sage Paluna##87242 |goto Frostwall 59.15,50.58
You will only be able to _complete 1 of the following quests_ per day
turnin Riverbeast Training: Gezz'ran##37071 |only if havequest(37049)
turnin Riverbeast Training: Bulbapore##37072 |only if havequest(37049)
turnin Riverbeast Training: Cruel Ogres##37073 |only if havequest(37049)
turnin Riverbeast Training: Darkwing Roc##37074 |only if havequest(37049)
turnin Riverbeast Training: Ironbore##37077 |only if havequest(37049)
turnin Riverbeast Training: Moth of Wrath##37075 |only if havequest(37049)
turnin Riverbeast Training: Orc Hunters##37078 |only if havequest(37049)
turnin Riverbeast Training: The Garn##37079 |only if havequest(37049)
turnin Riverbeast Training: Thundercall##37076 |only if havequest(37049)
step
...
step
collect Vicious Saddle##103533 |condition hasmount(171835)
|tip You will receive this item in the mail after you earn the "Primal Combatant" achievement.
step
talk Deathguard Netharian##73151
buy Vicious War Raptor##116778 |condition hasmount(171835) |goto Orgrimmar/1 41.9,73.2
...
|tip To do this, press "I", then select the "Player vs. Player" tab, then select the "Rated" section.
step
collect Vicious Saddle##103533 |condition hasmount(185052)
|tip You will receive this item in the mail after you earn the "Primal Combatant" achievement.
step
talk Deathguard Netharian##73151
buy Vicious War Kodo##124540 |condition hasmount(185052) |goto Orgrimmar/1 41.9,73.2
|tip This costs 1 Vicious Saddle.
step
...
|tip Only one mount drops per kill.
collect Felsteel Annihilator##116660 |condition hasmount(171621)
step
...
buy Wild Goretusk##116671 |condition hasmount(171633)
...
step
Reach _Exalted_ Reputation with Vol'jin's Headhunters |condition rep("Vol'jin's Headhunters") == Exalted
|tip Use the "Vol'jin's Headhunters" dailies guide to accomplish this.
step
talk Shadow Hunter Denjai##96014
buy Deathtusk Felboar##128526 |condition hasmount(190977) |goto Tanaan Jungle/0 61.6,45.6
...
If you logged into a horde character between July 25th, 2014 and September 30th, 2014 you recieved this mount via in-game mail
]])
...
keyword={"mosshide","riverwallow","ground","mount"},
model={59745},
...
buy Rocktusk Battleboar##116667 |condition hasmount(171628) |goto Frostwall/0 40.8,55.8
...
step
talk Trader Darakk##95471
buy Witherhide Cliffstomper##116655 |condition hasmount(171616) |goto Frostwall/0 40.8,55.8
...
buy Reins of the Corrupted Dreadwing##123974 |condition hasmount(183117) |goto Tanaan Jungle/0 60.4,46.6
