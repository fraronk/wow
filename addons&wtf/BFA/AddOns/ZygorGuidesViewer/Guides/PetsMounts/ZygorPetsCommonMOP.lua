...
'|condition haspet(2587) |or
step
use Spawn of Garalon##167054
Learn the "Spawn of Garalon" Battle Pet |learnpet Spawn of Garalon##150377
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2579) |or
step
use Stoneclaw##167047
Learn the "Stoneclaw" Battle Pet |learnpet Stoneclaw##150354
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2583) |or
step
use the Azure Cloud Serpent Egg##167051
Learn the "Azure Windseeker" Battle Pet |learnpet Azure Windseeker##150365
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2590) |or
step
use Essence of Pride##167056
Learn the "Ravenous Prideling" Battle Pet |learnpet Ravenous Prideling##150381
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2584) |or
step
use Spirit of the Spring##167052
Learn the "Spirit of the Spring" Battle Pet |learnpet Spirit of the Spring##150372
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2586) |or
step
use the Tiny Amber Wings##167053
Learn the "Amberglow Stinger" Battle Pet |learnpet Amberglow Stinger##150375
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2585) |or
step
use Kor'thik Swarmling##167058
Learn the "Kor'thik Swarmling" Battle Pet |learnpet Kor'thik Swarmling##150374
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2582) |or
step
use the Mogu Statue##167050
Learn the "Baoh-Xi" Battle Pet |learnpet Baoh-Xi##150360
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2581) |or
step
use the Celestial Gift##167049
Learn the "Comet" Battle Pet |learnpet Comet##150357
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2589) |or
step
use Amber Goo Puddle##167055
Learn the "Living Amber" Battle Pet |learnpet Living Amber##150380
step
_Congratulations!_
...
|tip This pet is not a guaranteed drop.
|tip It can be caged, meaning you can purchase it from the Auction House as well.
'|condition haspet(2580) |or
step
use the Wayward Spirit##167048
Learn the "Wayward Spirit" Battle Pet |learnpet Wayward Spirit##150356
step
_Congratulations!_
