...
|only if not Paladin
step
To obtain this mount you must level a Human/Dwarven Paladin to level 40
...
|only if not Paladin
step
To obtain this mount you must level a Draenei Paladin to level 40
|tip Once your character is level 40, this mount will be rewarded automatically.
...
mounts={63637,65638},	patch='30103',
mounttype='Ground',
model={29256,14333},
...
mounts={63639,65637},	patch='30103',
mounttype='Ground',
model={29255,28606},
...
mounts={63638,65642},	patch='40003',
mounttype='Ground',
model={14375,28571},
...
mounts={63636,65643},	patch='30103',
mounttype='Ground',
model={29258,28612},
...
mounts={63232,65640},	patch='30103',
mounttype='Ground',
model={29043,28912},
...
use Winterspring Cub##68646
talk Winterspring Cub##51677
turnin Cub's First Toy##29040 |or |only NightElf,Gnome,Draenei |only if havequest(29040)
turnin Cub's First Toy##29051 |or |only Dwarf,Worgen |only if havequest(29051)
turnin A Cub's Craving##29035 |or |only NightElf,Gnome,Draenei |only if havequest(29035)
turnin A Cub's Cravings##29052 |or |only Dwarf,Worgen |only if havequest(29052)
turnin Hunting Practice##29038 |or |only NightElf,Gnome,Draenei |only if havequest(29038)
turnin Hunting Practice##29039 |or |only Dwarf,Worgen |only if havequest(29039)
turnin 'Borrowing' From the Winterfall##29037 |or |only NightElf,Gnome,Draenei |only if havequest(29037)
turnin 'Borrowing' From the Winterfall##29053 |or |only Dwarf,Worgen |only if havequest(29053)
...
mounts={35711,35710,35714,34406,35712,35713},	patch='60204',
mounttype='Ground',
model={19873},
...
mounts={23229,23227,23228,458,6648,472},	patch='unknown',
mounttype='Ground',
model={14338},
...
mounts={23225,23223,23222,10969,17453,10873,17454},	patch='30305',
mounttype='Ground',
model={31670},
...
mounts={6898,6777,6899,23240,23239,23238},	patch='40100',
mounttype='Ground',
model={14347},
...
mounts={23221,23219,23338,10789,66847,8394,10793},	patch='30200',
mounttype='Ground',
model={14332},
...
killmax Archaeology,75 |only if skillmax("Archaeology")<1
...
_Exalted_ with _Alliance Vanguard_ |condition rep("Alliance Vanguard")>=Exalted
...
mounts={103196,103195},	patch='43000',
mounttype='Ground',
model={65},
...
label "turn_in"
talk Warden Moi'bff Jill##18408
accept More Warbeads##10477 |goto Nagrand,54.7,70.9 |instant |repeatable
...
step
talk Severin##23042
accept More Shadow Dust##11006 |goto 64.0,66.9 |instant |n
...
step
talk Hazzik##23306
accept Tokens of the Descendants##11074 |goto Terokkar Forest,64.3,66.9 |instant |n
...
step
talk Ambrose Boltspark##33335
|tp You will only be able to accept, and turn in, 1 of these 3 daily quests per day.
...
accept Mac'Aree Mushroom Menagerie##9648 |goto 56.4,56.8
step
talk Laando##17554
...
accept Urgent Delivery##9671 |goto 56.0,56.5 |instant
step
talk Vindicator Aalesia##17433
...
|tip You need to be at level 3 to get this quest.
step
ding 3
step
...
|tip He is a level 16 elite, so you should be able to kill him easily.
...
accept The Sprouted Fronds##2399 |goto 43.9,44.1 |instant
step
...
step
talk Darlene Stokx##43693 |only if Human or Pandaren
talk Ultham Ironhorn##4772 |only if Dwarf
talk Jartsam##4753 |only if NightElf or Worgen
talk Binjy Featherwhistle##7954 |only if Gnome
talk Aalun##20914 |only if Draenei
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Stormwind City/0 77.24,67.76 |only if Human or Pandaren
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Dun Morogh/0 71.15,48.41 |only if Dwarf
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Darnassus/0 42.78,32.93 |only if NightElf or Worgen
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Dun Morogh/0 56.27,46.42 |only if Gnome
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto The Exodar/0 81.34,52.62 |only if Draenei
Train the "Apprentice Riding" Ability |condition knowspell(33388) or knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |only if VoidElf or DIDwarf or LFDraenei or KTHuman
|tip You will start with this ability. |only if VoidElf or DIDwarf or LFDraenei or KTHuman
step
...
talk Binjy Featherwhistle##7954 |only if Gnome
talk Aalun##20914 |only if Draenei
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Stormwind City/0 77.24,67.76 |only if Human or Pandaren
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Dun Morogh/0 71.15,48.41 |only if Dwarf
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Darnassus/0 42.78,32.93 |only if NightElf or Worgen
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Dun Morogh/0 56.27,46.42 |only if Gnome
Train the "Journeyman Riding" Ability |condition knowspell(33391) or knowspell(34090) or knowspell(34091) or knowspell(90265) |goto The Exodar/0 81.34,52.62 |only if Draenei
step
Reach Level 60 |ding 60
step
talk Bralla Cloudwing##43769
Train the "Expert Riding" Ability |condition knowspell(34090) or knowspell(34091) or knowspell(90265) |goto Stormwind City/0 70.23,73.35
step
Reach Level 70 |ding 70
step
talk Bralla Cloudwing##43769
Train the "Artisan Riding" Ability |condition knowspell(34091) or knowspell(90265) |goto 70.23,73.35
step
Reach Level 80 |ding 80
step
talk Bralla Cloudwing##43769
Train the "Master Riding" Ability |condition knowspell(90265) |goto 70.23,73.35
step
_Congratulations!_
