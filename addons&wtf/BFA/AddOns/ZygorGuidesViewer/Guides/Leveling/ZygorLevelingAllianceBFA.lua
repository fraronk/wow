...
|only if havequest(51534) or completedq(51534) and level < 120
step
talk Sergeant Calvin##130190
...
Calvin can also be found at [57.61,66.41]
|tip He sometimes appears on the bridge in Brennadam.
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the cross-zone quests in Zuldazar.",
condition_suggested=function() return level >= 110 and level <= 120 end,
condition_end=function() return completedq(51069) end,
},[[
step
Unlock the "Mugamba Overlook" Outpost |condition completedq(52852)
|tip Use the "Mugamba Overlook (Zuldazar)" leveling guide to accomplish this.
step
...
talk Excavator Morgrum Emberflint##131763
turnin Grand Theft Telemancy##49428 |goto 41.35,71.44
turnin Not Our Purple Elves##49427 |goto 41.35,71.44
step
...
author="support@zygorguides.com",
description="\nTo unlock the new Dark Iron Dwarf allied race, you will need to earn exalted reputation with the 7th Legion and complete the Alliance War Campaign.",
...
author="support@zygorguides.com",
description="\nTo unlock the new Kul Tiran allied race, you will need to earn exalted reputation with \n"..
...
image=ZGV.DIR.."\\Guides\\Images\\KulTiranUnlock",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Allied Races\\Mechagnome Race Unlock",{
author="support@zygorguides.com",
description="To unlock the new Mechagnome allied race, you will need to earn exalted reputation with \n"..
"the Rustbolt Resistance and \"The Mechagonian Threat\" achievement.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return level == 120 and not achieved(14013) and achieved(13553) and rep('Rustbolt Resistance') == Exalted end,
condition_end=function() return achieved(14013) end,
image=ZGV.DIR.."\\Guides\\Images\\MechagnomeUnlock",
},[[
step
...
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return (raceclass('pandaren') or raceclass('lightforgeddraenei') or raceclass('voidelf') or raceclass('darkirondwarf') or raceclass('kultiran') or raceclass('mechagnome')) and raceclass('DeathKnight') and level == 58 end,
condition_suggested_exclusive=true,
condition_valid=function() return (raceclass('pandaren') or raceclass('lightforgeddraenei') or raceclass('voidelf') or raceclass('darkirondwarf') or raceclass('kultiran') or raceclass('mechagnome')) and raceclass('DeathKnight') and level == 58 end,
...
step
Follow the path |goto Stormwind City/0 66.89,78.43 < 30 |only if walking
click Hero's Call Board
Use the Hero's Call Board |q 58902/4 |goto 62.91,71.54
step
Click the Complete Quest Box:
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Allied Race Intros\\Mechagnome Intro",{
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Mechagnome introduction.",
condition_suggested=function() return raceclass('Mechagnome') and level == 20 end,
condition_suggested_exclusive=true,
condition_valid=function() return raceclass('Mechagnome') end,
condition_valid_msg="You must be a Mechagnome to complete this guide!",
startlevel=20.0,
},[[
step
talk Gelbin Mekkatorque##159587
accept For the Alliance##58146 |goto Mechagon City/1 18.65,67.49
step
Teleport to Stormwind |q 58146/1 |goto 20.42,59.84
|tip Step onto the grate.
step
talk Ambassador Moorgard##133362
turnin For the Alliance##58146 |goto Stormwind City/0 53.07,15.27
accept Stranger in a Strange Land##58147 |goto 53.07,15.27
step
Run up the stairs |goto 60.09,25.80 < 30 |only if walking
click Hero's Call Board
Find the Hero's Call Board |q 58147/1 |goto 62.20,29.82
step
talk Lulana##160600
turnin Stranger in a Strange Land##58147 |goto 62.49,29.73
step
_Congratulations!_
You Completed the "Mechagnome Intro" Leveling Guide.
|tip You may now choose a leveling guide to proceed.
]])
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Heritage Armor\\Worgen Heritage Armor",{
author="support@zygorguides.com",
...
step
Complete the "Back to the Sea" Quest |condition completedq(56162)
|tip Use the "Nazjatar" leveling guide to accomplish this.
step
...
step
Complete the Quest "Uniting Kul Tiras" |condition completedanyq(51918,52450)
