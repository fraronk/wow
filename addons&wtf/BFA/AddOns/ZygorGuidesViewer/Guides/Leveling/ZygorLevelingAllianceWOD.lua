...
Speak with Archmage Khadgar |q 34398/1 |goto Blasted Lands/0 54.9,50.3
step
talk Archmage Khadgar##78558
...
Open the Eastern Cage |q 35240/2 |goto 65.70,54.17
step
...
step
click Bleeding Hollow Cage##229353
Open the Southern Cage |q 35240/1 |goto 61.01,62.74
step
use Lucifrium Bead##113191
|tip Use the Lucifrium Bead quest item near huts around this area.
...
Slay #6# Bleeding Hollow Orcs |q 35242/1 |goto 61.47,61.66
step
...
Free Exarch Maladaar |q 34478/1 |goto 69.0,33.8
step
...
Escort Yrel to Safety |q 34434/1 |goto Assault on the Dark Portal/1 57.9,38.7
step
...
collect 30 Blackrock Weapon##112337 |q 35019/1 |goto 42.92,15.94
step
talk Vindicator Maraad##78554
...
step
kill 15 Blackrock Grunt##80786 |q 34439/1 |goto Assault on the Dark Portal 44.3,17.8
step
label "ogronwarcrushers"
kill 3 Ogron Warcrusher##80775 |q 34439/2 |goto Assault on the Dark Portal 44.3,17.8
step
...
Depress the _Makeshift Plunger_ |q 34987/2 |goto 44.1,29.6
step
talk Hansel Heavyhands##78569
...
Get to the Docks |q 35884/1 |goto 44.4,80.5
step
talk Archmage Khadgar##78563
...
step
label "paledevourers"
kill 8 Pale Devourer##79205 |q 35174/2 |goto Shadowmoon Valley D 26.55,8.76
step
...
collect 15 Drudgeboat Salvage##112696 |q 35166/1 |goto Shadowmoon Valley D 28.19,6.80
...
talk Diaani##78889
Save Diaani |q 33419/2 |goto Shadowmoon Valley D/15 52.3,54.3
step
...
talk Arekk##78890
Save Arekk |q 33419/1 |goto Shadowmoon Valley D/15 32.8,52.7
step
...
talk Zuulo##78891
Save Zuulo |q 33419/3 |goto Shadowmoon Valley D/15 50.2,68.3
step
...
kill 12 Pale Crawler##76382 |q 34504/1 |goto Shadowmoon Valley D/15 60.0,32.0
step
...
Collect #20# Mushroom Juice |q 34504/2 |goto Shadowmoon Valley D/15 60.0,32.0
step
...
collect 100 Shockscale##113248 |q 35345/1 |goto Shadowmoon Valley D 54.0,45.1
only if skill("Alchemy") >= 1
step
talk Abatha##82497
...
Find Duna |q 36311/1 |goto Shadowmoon Valley D 51.09,36.93
only if skill("Blacksmithing") >= 1
step
_Follow_ the road |goto Shadowmoon Valley D 47.4,41.7 < 20 |only if walking
talk Haephest##80827
...
collect 4 Shadowmooon Hide##114900 |q 36177/1 |goto Shadowmoon Valley D 41.62,44.76
only if skill("Leatherworking") >= 1
step
label "silverwingtalon"
kill Silverwing Kaliri##82175+
|tip They fly around this area overhead.
collect 3 Silverwing Talon##114901 |q 36177/2 |goto Shadowmoon Valley D 41.62,44.76
only if skill("Leatherworking") >= 1
step
talk Fanara##84385
...
collect 10 Ceremonial Shadowmoon Robes##115013 |q 36266/1 |goto Shadowmoon Valley D 36.9,64.3
only if skill("Tailoring") >= 1
step
talk Ameeka##84523
...
Create the Hexweave Swatch |q 36269/1 |goto Shadowmoon Valley D 58.3,26.6
only if skill("Tailoring") >= 1
step
talk Ameeka##84523
...
Free Deema |q 36313/1 |goto Shadowmoon Valley D 36.0,72.8
only if skill("Enchanting") >= 1
step
talk Deema##84961
...
Build a Profession Building |q 36100/1 |goto 41.09,48.90
only if skill("Jewelcrafting") >= 1 or skill("Engineering") >= 1 or skill("Alchemy") >= 1 or skill("Leatherworking") >= 1 or skill("Inscription") >= 1 or skill("Tailoring") >= 1 or skill("Blacksmithing") >= 1 or skill("Enchanting") >= 1
step
talk Baros Alexston##77209
...
Escort the Laborers |q 34779/3 |goto Shadowmoon Valley D 55.7,32.9
step
...
step
Carry a Crystal to the Tertiary Pylon |q 34780/3 |goto 56.18,33.44
step
click Charged Resonance Crystal
|tip They look like pink crystals on pedastals.
Get a Crystal |havebuff 132885 |q 34780 |goto Shadowmoon Valley D 56.8,34.3
step
Carry a Crystal to the Secondary Pylon |q 34780/2 |goto 56.62,33.13
step
click Charged Resonance Crystal
|tip They look like pink crystals on pedastals.
Get a Crystal |havebuff 132885 |q 34780 |goto Shadowmoon Valley D 56.8,34.3
step
Carry a Crystal to the Primary Pylon |q 34780/1 |goto 56.25,32.76
step
...
Slay #8# Shadowmoon Invaders |q 34781/1 |goto 55.59,34.03
step
click Defense Pylon Central Control Console##230933
|tip It's a big purple crystal in this small building.
...
Disable the Crystal |q 35070/1 |goto 64.44,26.23 |indoors Elodor Dig
step
label "gorenscales"
kill Crystalmaw Goren##81156+, Crystalmaw Spitter##81157+
collect 20 Crystallized Goren Scale##112738 |q 34786/1 |goto 62.62,25.54 |indoors Elodor Dig
step
...
kill 12 Shaded Plainsstalker##75483 |q 34496/1 |goto Shadowmoon Valley D 61.9,31.4
|tip They are purple and all around this area, spread out, so you'll have to run around a little to find more.
kill 12 Seacliff Kaliri##82354 |q 34496/2 |goto Shadowmoon Valley D 61.9,31.4
...
collect 1000 Raw Elekk Steak##108670 |q 33084/1 |goto Shadowmoon Valley D 62.5,35.6
step
talk Traevar Gunnermark##74233
...
Collect the Volatile Spores |q 34784/1 |goto 53.82,21.81
step
label "stinger"
kill Moonglow Sporebat##82323+
...
Reveal the Traitor |q 34792/2 |goto 60.48,20.7
step
...
Speak to Dungar Longdrink |q 36624/1 |goto Lunarfall 48.0,49.8
step
...
Speak with Jaesia Rosecheer |q 36629/1 |goto Stormshield 35.7,77.9
step
...
Speak with Vindicator Nuurem |q 36629/3 |goto Stormshield 46.6,76.7
step
...
Speak with a New Recruit |q 36629/2 |goto Stormshield 62.7,41.7
step
...
Find 1 Hidden Rangari |q 34897/1 |count 1 |goto Shadowmoon Valley D 43.9,52.7
step
talk Hidden Rangari##80387
Find 2 Hidden Rangari |q 34897/1 |count 2 |goto Shadowmoon Valley D 44.8,51.2
step
talk Hidden Rangari##80387
Find 3 Hidden Rangari |q 34897/1 |count 3 |goto Shadowmoon Valley D 45.0,50.4
step
talk Hidden Rangari##80387
Find 4 Hidden Rangari |q 34897/1 |count 4 |goto Shadowmoon Valley D 47.4,48.9
step
talk Hidden Rangari##80387
Find 5 Hidden Rangari |q 34897/1 |count 5 |goto Shadowmoon Valley D 46.4,51.6
step
...
Search #5# Loose Mud |q 34876/1 |goto Shadowmoon Valley D 46.7,49.3
step
label "frogs"
clicknpc Belly Toad##75470
collect 6 Vial of Toad Juice##110723 |q 33077/1 |goto Shadowmoon Valley D 46.3,50.2
step
label "hearts"
...
step
Enter the Scenario |scenariostart |q 33059
step
Follow Prophet Velen |scenariogoal 1/24541 |goto Shadowmoon Valley D/0 79.87,46.60 |q 33059
step
kill Krull##77767 |scenariogoal 2/24539 |goto 79.87,46.60 |q 33059
step
Witness Commander Vorka's Arrival |scenariogoal 3/24542 |goto 79.87,46.60 |q 33059
step
...
kill 6 Shadowmoon Void Priestess##82196 |q 34076/1 |goto Shadowmoon Valley D 43.5,64.2
...
kill 6 Orc spirits |q 34076/2 |goto Shadowmoon Valley D 43.5,64.2
kill 3 Phantom Pearltusk##79148 |q 34076/3 |goto Shadowmoon Valley D 43.5,64.2
step
talk Loreseeker Heidii##74121
...
Find Fiona |q 33786/1 |goto Shadowmoon Valley D 53.61,57.27
step
talk Fiona##76204
...
collect Swamplighter Queen's Tail##108410 |q 33808/1 |goto Shadowmoon Valley D 51.71,54.93
step
label "swamplightervenom"
kill Swamplighter Drone##82371+
collect 2 Swamplighter Venom##108395 |q 33787/2 |goto Shadowmoon Valley D 51.25,60.48
step
label "riotvine"
kill Riot Blossom##82427+
collect 4 Riotvine##108396 |q 33787/3 |goto 51.66,60.51
step
label "moonlitherb"
click Moonlit Herb##225998
|tip They look like thin plants with blue leaves.
collect 3 Moonlit Herb##108409 |q 33787/4 |goto Shadowmoon Valley D 51.8,65.1
step
label "riverbeastheart"
kill Twilight Riverbeast##83455+
collect 1 Riverbeast Heart##108394 |q 33787/1 |goto 51.87,60.00
step
kill 5 Blooming Mandragora##80752 |q 34996/1 |goto 52.06,64.95
step
talk Rangari Duula##80859
...
Speak with Fiona |q 33788/1 |goto 53.59,57.31
...
Complete the Elixir |q 33788/2 |goto 53.59,57.31
step
clicknpc Gidwin Goldbraids##80862
Use the Elixir on Gidwin |q 33788/3 |goto 53.63,57.25
step
talk Fiona##76204
...
Cure Argus |q 35006/2 |goto Shadowmoon Valley D 56.8,70.4
stickystart "youthvine"
step
talk Talren Highbeacon##80906
Cure Talren |q 35006/3 |goto Shadowmoon Valley D 54.1,70.8
step
label "youthvine"
click Youthvine##231152
|tip They look like green plants with red flowers on the ground around this area.
collect 5 Youngroot##112328 |q 34994/1 |goto 54.87,71.70
step
...
step
kill Blooming Genesaur##80662 |q 35015/1 |goto 56.13,73.27
step
talk Rangari Arepheon##80781
...
Destroy #8# Slumberblooms |q 34997/1 |goto 54.37,70.83
step
label "botani"
kill Botani Bloomkeeper##80766+, Blademoon Botani##80606+
Kill #5# Blademoon Botani |q 34995/1 |goto 54.91,69.01
...
kill Sargerei Netherbinder##79681 |q 34728/3	|goto Shadowmoon Valley D 62.8,62.7
step
label "shimmermoor"
accept Bonus Objective: The Shimmer Moor##34728
click Lost Iridescent Egg##230613
|tip They look like big white eggs sitting on the ground next to trees around this area.
collect 14 Iridescent Egg##111559 |q 34728/1 |goto Shadowmoon Valley D 59.4,65.4
kill 8 Arcane Anomaly##79658 |q 34728/2 |goto Shadowmoon Valley D 59.4,65.4
step
...
Find the Ancestor's Totem |q 33082/1 |goto 45.71,25.39
step
Watch the dialogue:
talk Rulkan##75884
...
Find Kral'za |q 34847/1 |goto 48.12,14.96 |indoors Dol'mak's Hideout
kill Dol'mak##80250 |q 34847/2 |goto 48.12,14.96 |indoors Dol'mak's Hideout
kill Dark Apparition##76295 |q 34847/3 |goto 48.12,14.96 |indoors Dol'mak's Hideout
step
label "lunarblossom"
...
collect 5 Lunarblossom##111937 |q 34836/1 |goto 51.50,19.54
step
talk Zukaza##80296
...
collect 3 Gulper Leg##111888 |q 33461/3 |goto 39.35,23.30
step
label "shadowribs"
kill Gloomshade Howler##74169+
collect 5 Shadowstalker Ribs##111884 |q 33461/1 |goto 39.10,25.65
step
label "ossifiedvenom"
kill Gloomshade Fungi##74175+
collect 5 Ossified Venom Gland##106869 |q 33461/2 |goto 41.41,17.34
step
talk Baros Alexston##77209
...
step
Search Gloomshade Grove for Clues |q 33263/1 |goto Shadowmoon Valley D/0 39.31,25.52
step
talk Phlox##74667
...
Open the Doorway |q 35032/1 |goto Shadowmoon Valley D 35.03,37.89
...
Deactivate the Mark of Shadows |q 35032/3 |goto 34.49,41.40
step
kill Shadowmoon Prophet##80787+
|tip They will release the Essence, allowing you to attack it.
kill Essence of Shadow##76209 |q 33793/1 |goto 33.89,43.48
step
_Go through_ the stone gate |goto Shadowmoon Valley D 34.9,42.2 < 20 |only if walking
_Enter_ the cave |goto 35.3,44.0 < 20 |walk
kill Essence of Anguish##76210 |q 33793/3 |goto Shadowmoon Valley D 34.8,45.5 |indoors Ancestor's Grotto
step
_Leave_ the cave |goto 35.3,44.0 < 20 |walk
_Go through_ the stone gate |goto Shadowmoon Valley D 34.9,42.2 < 20 |only if walking
clicknpc Mark of Anguish##80950
|tip It looks like a swirling pink orb with a purple rune inside.
Deactivate the Mark of Anguish |q 35032/4 |goto 32.65,38.75
step
kill Shadowmoon Prophet##80787+
|tip They will release the Essence, allowing you to attack it.
kill Essence of Darkness##74519 |q 33793/2 |goto 31.28,39.48
step
clicknpc Mark of Darkness##80741
|tip It looks like a swirling pink orb with a purple rune inside.
Deactivate the Mark of Darkness |q 35032/2 |goto Shadowmoon Valley D 29.5,39.8
step
Click the _Quest Complete_ Box:
...
Find Velen and Yrel at the Terrace of the Stars |q 34054/1 |goto Shadowmoon Valley D 30.2,43.3
step
Watch the dialogue
kill Arkeddon##74632 |q 34054/2 |goto 31.00,43.85
step
label "starreading"
click Star Reading##223508
|tip They look like purple rugs laying on the ground all around this area.
collect 5 Star Reading##112385 |q 33795/1 |goto 33.54,39.96
step
label "shadowforces"
kill Shadowmoon Voidclaw##74374+, Shadowmoon Necrolyte##80788+, Shadowmoon Voidaxe##74373+
Kill #15# Shadowmoon Forces |q 33083/1 |goto 33.83,39.59
step
label "draeneiprisoners"
click Shadowmoon Cage##225924
|tip They look like wooden cages all around this area.
Rescue #8# Draenei Prisoners |q 33794/1 |goto 33.94,40.26
step
Watch the dialogue:
talk Prophet Velen##77282
...
step
Enter the Waning Crescent |q 33837/1 |goto Shadowmoon Valley D 46.48,45.25
step
...
Find Ner'zhul |q 33837/2 |goto Shadowmoon Valley D 51.55,46.22
step
kill Ner'zhul##76172
...
Defeat Ner'zhul |q 33837/3 |goto Shadowmoon Valley D 51.82,46.14
step
talk Yrel##73395
...
Escort Your Garrison Army to Karabor |q 33255/1
step
...
step
Scout Ahead For Naielle's Watch |q 35033/1 |goto 63.67,53.45
step
_Go up_ the dirt path |goto Gorgrond 63.4,51.9 < 20 |only if walking
_Find_ the Rangari Survivors |q 35033/2 |goto 64.23,51.87
...
kill Harvester Ommru##84373 |q 35065/1 |goto 63.1,46.8 |indoors Rangari Hollow
step
...
Find the Pilot of the Dark Iron Tank |q 36595/1 |goto 64.98,48.55
step
...
Punt #20# Thorny Leafling |q 36571/2 |goto 62.73,53.46
...
Find Rangari Kolaan |q 35050/1 |goto 59.46,53.18
step
talk Rangari Rajess##81013
Tell her _"D'kaan is coming with help."_
Find Rangari Rajess |q 35050/2 |goto 57.71,54.30
step
...
Select a Building |q 35063/1 |goto 53.46,60.31
...
Slay Slavemaster Ok'mok in the Stonemaul Arena |q 34702/1 |goto Gorgrond 40.4,67.6
step
...
Rescue Nazgrel |q 34700/1 |goto 36.85,70.58 |indoors Kor'gall's Hovel
step
_Follow_ the path |goto Gorgrond 37.6,69.4 < 20 |walk |indoors Kor'gall's Hovel
talk Bruto##77014
...
kill Kor'gall##77020
collect Serathil##109023 |q 34703/1 |goto 36.46,70.07 |indoors Kor'gall's Hovel
step
label "ogreteeth"
kill Stonemaul Slaver##75835+, Stonemaul Guard##75819+
collect 30 Ogre Tooth##108898 |q 34012/1 |goto Gorgrond 37.1,68.2 |indoors Kor'gall's Hovel
step
...
Break #25# Hydra Eggs |q 36563/2 |goto 52.42,67.57
...
Recover #5# Rangari Pouches |q 35633/1 |goto 59.44,59.57
step
label "fungallurcher"
kill 7 Fungal Lurcher##80714 |q 35640/1 |goto 59.44,59.57
...
Inspect the Strange Fungus Site |q 35656/1 |goto 58.91,62.53
step
talk Khaano##82477
...
collect 3 Enlarged Stomper Spore Pod##112394 |q 35647/1 |goto 59.03,63.88
step
talk Khaano##82477
...
step
kill Khaano##86282
Stop Khaano |q 35659/1 |goto 61.19,61.84
step
...
kill Skull Thrash##85733 |q 36520/3 |goto Gorgrond 44.4,88.8
step
...
Kill #12# Tailthrasher Saberon |q 36520/1 |goto Gorgrond 44.9,90.9
...
Fly to the Iron Docks |q 36576/1 |goto Gorgrond 52.8,59.3
...
Complete the Iron Approach |q 36576/2 |goto 44.30,16.58
step
...
Talk to Birchus |q 36437/1 |goto 50.33,47.51
step
label "dionordefendersLC"
kill Dionor Seedpriest##81721+, Primal Growth##81769+
Slay #12# Dionor Defenders |q 36436/1 |goto 50.75,46.16
step
talk Altauur##85432
...
Breach the Saberon Camp |q 36438/1 |goto 50.59,51.44
step
talk Altauur##85431
...
collect 8 Saberon Herb Bundle##115442 |q 36441/1 |goto 51.12,51.04
step
label "steamscar_primalistsLC"
kill 10 Steamscar Primalist##81747 |q 36440/1 |goto Gorgrond/0 52.3,50.4
step
...
Acquire the Death Bloom |q 36442/1 |goto 54.31,52.65
step
talk Birchus##82302
...
collect Chunk of Lunar Rock##102491 |q 33113/1 |goto Shadowmoon Valley D 23.2,20.9
step
...
Capture the All-Seeing Eye |q 33062/1 |goto Shadowmoon Valley D 21.77,16.13
step
...
Destroy the Northern Shrouding Stone |q 33115/2 |goto 25.99,15.88
step
...
|tip It looks like a large stone pillar with runes carved in them.
Destroy the Central Shrouding Stone |q 33115/1 |goto 23.07,24.48
step
...
click Shrouding Stone##227272
|tip It looks like a large stone pillar with runes carved in them.
Destroy the Southern Shrouding Stone |q 33115/3 |goto Shadowmoon Valley D 23.8,28.7
step
label "curseuponthewoods"
kill Corrupted Toad##73805+, Cursed Wolf##73101+
Kill #10# Fel-cursed creatures |q 33120/1 |goto Shadowmoon Valley D 22.8,27.2
step
...
Compel the All-Seeing Eye |q 33112/1 |goto 28.74,25.21
step
talk Archmage Khadgar##77184
...
collect Kurgoth's Shard##106986 |q 33066/3 |goto 18.27,24.15
step
...
collect Hagra's Shard##109186 |q 33066/1 |goto 20.88,27.31
step
kill Grogal the Harvester##72674
collect Grogal's Shard##109187 |q 33066/2 |goto 20.88,31.54
step
label "gul'varorcs"
kill Shadow Warrior##77518+, Gul'var Peon##77522+, Lesser Warlock##77517+
kill 20 Gul'var orcs |q 33269/1 |goto Shadowmoon Valley D 20.8,28.9
step
...
step
kill Krosnis##77488
collect Dulled Claw##106867 |q 33168/1 |goto 17.83,27.57
step
...
Forge the Gul'dan Soul Trap |q 33114/1 |goto 19.08,28.57 |only if walking
step
talk Image of Archmage Khadgar##77417
...
Use Gul'dan's Soul Trap |use Gul'dan's Soul Trap##109246 |q 33116/1 |goto 18.01,30.37
step
kill Razuun##72793 |q 33116/2 |goto 17.90,30.09
step
...
Speak with Sergeant Crowler and choose _"Prepare to battle the Shadowmoon Clan"_ |q 37289/1
step
...
stickystart "TH1"
step
kill Ontogen the Harvester##82372 |q 35651/1 |goto 59.88,71.07
step
label "TH1"
click Pollen Pod##235903
|tip They are yellow-orange spiky looking plant blulbs on the ground around this area.
Destroy #8# Pollen Pods |q 35654/1 |goto 59.02,70.50
kill Greenbough Ancient##82360+, Emberbark Ancient##82284+, Tangleheart Cultivator##82322+
Kill #4# Ancients |q 35650/1 |goto 59.02,70.50
collect 100 Ancient Growth Sap##113136 |q 35652/1 |goto 59.62,70.10
step
talk Glirin##85130
...
kill Voice of Iyu##81634 |q 35215/1 |goto 49.4,71.7
...
Find Nori Sootstash |q 35213/2 |goto 48.13,73.57
step
label "infestedbehemoth"
kill Infested Orc##81617+, Infested Behemoth##82841+
Kill #6# Infested |q 35214/1 |goto Gorgrond 47.6,72.8
step
...
step
kill Infested Ogron##82062 |q 36523/1 |goto 43.00,80.66
step
Next to you:
...
Burn #6# Bodies |q 35205/1 |goto 42.92,81.99
step
Next to you:
|tip If you are in Evermorn Springs, he will be standing next to you.
talk Burrian Coalpart##81601
...
kill 3 Dew Master##81553 |q 35207/1 |goto 39.70,81.81
step
Next to you:
|tip If you are in Evermorn Springs, he will be standing next to you.
talk Burrian Coalpart##81601
...
step
kill Utrophis##75094
collect Waters of Utrophis##112905 |q 35209/1 |goto 40.68,81.79
step
label "bloomweaversLC"
kill 9 Bloom Weaver##81575 |q 35206/1 |goto 42.82,82.76
step
...
collect 5 Doomshot##112990 |q 35233/1 |goto Gorgrond/16 62.13,54.85
step
label "acidmouth"
kill 5 Acidmouth Breacher##81690 |q 35229/1 |goto 62.13,54.85
step
...
kill Iyu##78819 |q 35235/1 |goto Gorgrond/0 47.42,92.31
step
talk Yrel##75878
...
Slay #25# Monsters |q 36473/1 |goto Gorgrond 43.6,64.4
clicknpc Ancient Seedbearer##82392+
|tip They look like big tree ents with leafy green plants as hair laying on the ground around this area.
Burn #5# Ancient Seedbearers |q 36473/2 |goto Gorgrond 43.6,64.4
stickystart "lesserbrimfury"
step
_Go up_ the hill |goto Gorgrond/0 44.0,55.9 < 20 |only if walking
accept Bonus Objective: Brimstone Springs##36603 |goto Gorgrond/0 40.4,57.5
...
Execute #8# Dying Grom'kar Peons |q 36476/3 |goto Gorgrond 47.4,53.8
step
accept Bonus Objective: Valley of Destruction##36480 |goto Gorgrond/0 44.7,48.2 < 15
kill 5 Canyon Boulderbreaker##81246 |q 36480/1 |goto 44.69,47.82
kill 20 Goren Nibbler##81775 |q 36480/2 |goto 46.07,47.61
...
talk Rangari Rajess##81074
Tell her _"I am needed urgently at the Iron Docks."_
Fly to the Iron Docks |q 36575/1 |goto Gorgrond 52.8,59.3
...
|tip Stay close to Yrel while fighting, she will cast bubbles of healing that will keep you healed up so you don't die. You will no longer be able to use your Access Artifact skill.
Defeat Commander Gar |scenariogoal 25392 |goto Gorgrond 44.1,15.7
Complete the Iron Approach |q 36575/2 |goto 44.30,16.58
step
_Follow_ the path |goto Gorgrond 44.5,19.3 < 30 |only if walking
talk Nisha##84700
fpath Iron Docks |goto Gorgrond 43.1,20.2
...
label "dionordefendersLC"
kill Dionor Seedpriest##81721+, Primal Growth##81769+
Kill #12# Dionor defenders |q 36436/1 |goto 50.75,46.16
step
talk Altauur##85432
|tip He's inside this small cave.
turnin Ambassador to the Ancient##36437 |goto 51.32,47.97
...
Shred the Vine Barrier and Enter the Saberon Camp |q 36439/1 |goto 52.22,48.62
step
talk Altauur##85431
...
_Enter_ the cave |goto Gorgrond 53.8,51.9 < 10 |walk
kill Smokemaster Snarl##81749
collect Dionor's Death Bloom##113187 |q 36442/1 |goto 54.31,52.65
step
talk Birchus##82302
turnin Taking the Death Bloom##36442 |goto 50.32,47.50
accept Laying Dionor to Rest##36443 |goto 50.32,47.50
...
_Follow_ the grassy path |goto Shadowmoon Valley D 23.9,17.9 < 20 |only if walking
_Enter_ the cave |goto Shadowmoon Valley D 23.0,16.9 < 20 |walk
kill All-Seeing Eye##72783 |q 33062/1 |goto Shadowmoon Valley D 21.77,16.13
step
_Leave_ the cave |goto Shadowmoon Valley D 23.0,16.9 < 20 |walk
_Run on_ this road |goto Shadowmoon Valley D 25.4,19.2 < 20 |only if walking
_Turn and run_ in the grass here |goto Shadowmoon Valley D 25.7,26.2 < 20 |only if walking
...
step
use Gul'var Soul Shards##109224
Forge the Gul'dan Soul Trap |q 33114/1 |goto 19.08,28.57
step
talk Image of Archmage Khadgar##77417
turnin Forging the Soul Trap##33114 |goto 19.08,28.57
accept To Catch a Shadow##33116 |goto 19.08,28.57
...
step
talk Bodrick Grey##81492
accept The Critical Path##37183 |or |goto Lunarfall 38.31,36.78
'|accept The Critical Path##34676 |or |goto Lunarfall 38.31,36.78
'|accept Hero's Call: Talador!##49565 |or |goto Lunarfall 38.31,36.78
step
talk Dungar Longdrink##81103
Tell him _"Take me to my base in Talador."_ |goto 47.89,49.68
Arrive in Talador |goto Talador 68.3,20.6 < 10 |noway |q 37183 |only if havequest(37183) or completedq(37183)
Arrive in Talador |goto Talador 68.3,20.6 < 10 |noway |q 34676 |only if havequest(34676) or completedq(34676)
Arrive in Talador |goto Talador 68.3,20.6 < 10 |noway |q 49565 |only if havequest(49565) or completedq(49565)
|only if not completedq(37183) or not completedq(34676) or not completedq(49565)
step
...
turnin Hero's Call: Talador!##49565 |goto Talador 69.88,20.81 |only if havequest(49565) or completedq(49565)
...
Use the Drafting Table |q 34558/1 |goto 69.78,20.72
step
clicknpc Drafting Table##81119
|tip It looks like a wooden table with a slanted top and blueprints laying on it.
Select a Building |q 34558/2 |goto 69.78,20.72
...
Gather #6# Goren Gas Samples |q 34624/1 |goto 75.70,21.09 |indoors Kuuro's Claim
step
label "Igneous"
kill Iridium Geode##80072
collect 8 Igneous Elemental Chunk##107472 |q 34573/1 |goto 75.70,21.09 |indoors Kuuro's Claim
step
label "joviteAT"
click Jovite Ore##230268
|tip They look like bright green ore nodes all along the cave walls.
collect 12 Jovite Ore##111906 |q 34571/1 |goto 75.70,21.09 |indoors Kuuro's Claim
step
_Enter_ the big metal building |goto Talador 69.8,20.6 < 10 |walk
talk Miall##79329
...
collect 5 Thunderbrew Keg##111809 |q 34773/2 |goto 72.18,21.57
step
label "footman"
...
collect 5 Footman Longsword##111808 |q 34773/1 |goto 73.04,19.30
step
...
kill Ripgut##80058 |q 34804/1 |goto 67.29,20.91
step
_Go through_ the doorway |goto Talador 69.0,20.8 < 20 |only if walking
talk Quartermaster O'Riley##79963
...
Look through Thaelin's Observicopter |q 34087/1 |goto 63.07,26.20
step
talk Vindicator Maraad##75803
...
Destroy the Thunderlord Cache |q 34090/1 |goto Talador 66.5,26.7
step
use Thaelin's Quick Fix##109161
Destroy the Forge |q 34090/2 |goto 64.84,32.72
step
...
kill Engineer Trak##77387 |q 34091/1 |goto 63.03,23.68
step
clicknpc Decommissioned Iron Shredder##75809
|tip It looks like a bulky metal humanoid machine.
Steal the Decommissioned Iron Shredder |q 34091/2 |goto 63.19,23.68
step
Transport the Decommissioned Iron Shredder to Redemption Rise |q 34091/3 |goto 63.20,25.87
step
talk Yrel##75804
...
Destroy #6# Siege Weapons |q 34095/1 |goto 58.35,29.39
step
kill Dreadpiston##80576 |q 34959/1 |goto 56.49,27.19
step
talk Ahm##77031
...
collect Ahm's Heirloom##108825 |q 33973/1 |goto 57.05,24.25
step
talk Ahm##77031
...
Look through Thaelin's Observicopter |q 34096/1 |goto 63.06,26.20
step
talk Thaelin Darkanvil##75874
...
Take control of the Iron Shredder |q 34097/1 |goto 63.08,26.34
step
...
Kill #100# Iron Horde |q 34097/2 |goto 61.98,39.32
step
...
step
kill Ketya Shrediron##75986 |q 34098/1 |goto 61.08,38.83
step
talk Vindicator Maraad##75803
...
step
Enter the Scenario |scenariostart |goto Talador/0 50.69,35.35 < 40 |q 34099
step
talk Thaelin Darkanvil##77192
Tell him _"Thanks. I'll meet them at the docks."_
Speak with Thaelin |scenariogoal 1/25835 |goto Shattrath City 2/0 74.72,74.45
step
...
step
Complete the Battle for Shattrath |q 34099/1
step
clicknpc Portal to Talador##45454 |goto Shattrath City 2/0 65.69,42.41
Leave Shattrath City |goto Talador/0 69.7,21.0 < 100 |noway |c |q 34099
step
talk Yrel##79608
...
Defeat Soulbinder Halaari |q 34777/2 |goto 57.33,52.65
step
talk Vindicator Dalu##79970
Tell him _"Very well. Let us fight."_
kill Vindicator Dalu##79970
Defeat Vindicator Dalu |q 34777/1 |goto 57.39,52.77
step
talk Defender Illona##79979
...
clicknpc Gordunni Boulderthrower##80428
|tip It looks like a big stone and wooden contraption.
Destroy the Summit Catapult |q 34976/3 |goto Talador 66.8,67.9
step
...
collect Fury of the Forge##112308 |q 34980/2 |goto 64.07,81.79
step
talk Miall##80630
...
Slay #12# Adherent Invaders |q 33740/1 |goto Talador 77.2,43.4
step
...
collect 6 Zapper Sac##111637 |q 34761/1 |goto Talador/0 61.7,48.6
step
talk Torben Zapblast##79901
...
Slay #15# Demons |q 34407/1 |goto 56.34,64.08
step
talk Vindicator Nobundo##78482
...
kill Xanatos the Defiler##75294 |q 33958/1 |goto 65.44,86.64 |indoors Deathweb Hollow
...
collect Sha'tari##110683 |q 33958/2 |goto 65.79,86.87 |indoors Deathweb Hollow
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy 1 Defiling Crystal |q 33969/1 |count 1 |goto Talador 64.8,86.9 |indoors Deathweb Hollow
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy 2 Defiling Crystals |q 33969/1 |count 2 |goto 65.3,85.4 |indoors Deathweb Hollow
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy 3 Defiling Crystals |q 33969/1 |count 3 |goto 64.0,85.6 |indoors Deathweb Hollow
stickystart "deathwebfangAT"
step
...
Seal #4# of Zorka's Void Gates |q 34660/1 |goto Talador/0 53.9,87.5
step
...
Slay #12# Telmor Invaders |q 34234/1 |goto Talador 48.6,88.2
step
Click the _Quest Complete_ Box:
...
Kill #10# Ango'rosh |q 35227/1 |goto 41.00,82.61
step
...
Slay #15# Demons |q 35254/1 |goto 34.53,73.91
step
...
collect 6 Arcane Essence##110390|q 34403/1 |goto 52.07,48.50 |indoors Jorune Mine
step
label "injured_minersAT"
kill Arcane Wraith##78326+, Crystal Rager##78327+
Save #8# Injured Miners |q 34406/1	|goto 52.07,48.50 |indoors Jorune Mine
step
...
collect Crystal Giant Heart##110418 |q 34415/1 |goto Talador 54.3,50.0 |indoors Jorune Mine
step
...
Speak With Elandra |q 34448/1 |goto 51.65,50.51 |indoors Jorune Mine
step
Wait to be teleported:
kill Kaelynara Sunchaser##78501 |q 34448/2 |goto 52.08,47.54 |indoors Jorune Mine
step
...
Kill #8# Goren |q 37421/1 |goto Talador 77.5,18.2 |indoors Kuuro's Claim
kill 6 Iridium Geode##80072 |q 37421/2 |goto Talador 78.4,18.6 |indoors Kuuro's Claim
...
|tip It's a small blue swirling portal.
Take Khadgar's Portal |q 34815/1 |goto 80.63,26.11
step
...
Harvest the Energy |q 34619/1 |count 1 |goto Talador/0 83.3,28.7
step
clicknpc Arcane Vortex##87570
|tip They look like blue or purple balls of swirling energy.
Harvest the Energy |q 34619/1 |count 2 |goto 81.7,29.1
step
clicknpc Arcane Vortex##87570
|tip They look like blue or purple balls of swirling energy.
Harvest the Energy |q 34619/1 |goto 82.8,27.1
step
...
Prune #3# Slumbering Protectors |q 34612/1 |goto Talador 81.5,28.2
step
label "pustuleAS"
kill Encroaching Giant##79333+, Invasive Shambler##79335+
collect 30 Pulsating Pustule##111322 |q 34609/1 |goto Talador 81.5,28.2
step
Next to you:
...
label "ironshreddermanual"
kill Burning Blademaster##75794+, Grom'kar Siegesmith##80552+, Fireblade Invoker##77047+
collect 20 Manual Pages##107843 |q 34094/1 |goto 56.35,26.56
step
talk Thaelin Darkanvil##75874
turnin Vol. X Pages ?##34094 |goto 63.09,26.15
step
...
Use the abilities on your hot bar:
kill Grom'kar Vanguard##75948+, Grom'kar Deadeye##75943+, Burning Blademaster##75945+, Grom'kar Shadowblade##75946+, Grom'kar Grimshot##75947+, Fireblade Invoker##77066+
Slay #100# Iron Horde |q 34097/2 |goto 61.98,39.32
step
talk Iron Shredder Prototype##75968
|tip Click yourself, since you're riding in the Iron Shredder Prototype.
turnin Born to Shred##34097
...
Complete the Battle for Shattrath |q 34099/1 |goto Talador 46.5,19.1
...
clicknpc Gordunni Boulderthrower##80428
|tip It looks like a big stone and wooden contraption.
Destroy the Catapult |q 34913/1 |count 1 |goto 63.61,68.98
step
_Run up_ the path |goto Talador 63.9,69.8 < 10 |only if walking
clicknpc Gordunni Boulderthrower##80428
|tip It looks like a big stone and wooden contraption.
Destroy the Catapults |q 34913/1 |count 2 |goto Talador 65.5,68.8
step
clicknpc Gordunni Boulderthrower##80428
|tip It looks like a big stone and wooden contraption.
Destroy the Catapults |q 34913/1 |count 3 |goto Talador 66.8,67.9
step
...
Take the Portal |q 34913/3 |goto 69.15,69.45
step
...
Destroy the Astral Ward |q 34911/1 |count 1 |goto Talador 70.2,72.3
step
_Cross_ the bridge |goto Talador 69.5,73.7 < 20 |only if walking
_Run over_ the small hill |goto Talador 68.8,75.9 < 10 |only if walking
click Astral Ward##230960
|tip It looks like a big blue orb floating over a stone pedastal.
Destroy the Astral Ward |q 34911/1 |count 2 |goto Talador 68.2,76.4
step
click Astral Ward##230960
|tip It looks like a big blue orb floating over a stone pedastal.
Destroy the Astral Ward |q 34911/1 |count 3 |goto Talador 69.4,79.7
step
_Go up_ the stairs |goto Talador 68.5,79.0 < 10 |only if walking
...
click Astral Ward##230960
|tip It looks like a big blue orb floating over a stone pedastal.
Destroy the Astral Ward |q 34911/1 |count 4 |goto Talador 69.0,82.1
step
_Run up_ the stairs |goto Talador 67.8,79.5 < 10 |only if walking
click Astral Ward##230960
|tip It looks like a big blue orb floating over a stone pedastal.
Destroy the Astral Ward |q 34911/1 |goto Talador 67.5,78.0
step
...
collect 8 Gordunni Runebeads##112088 |q 34909/1 |goto Talador 66.0,79.9
step
Next to you:
|tip If you are in Gordal Fortress, she will be next to you.
...
step
use Elixir of Memories##108749
Enter the spirit realm |havebuff 460857 |q 33874 |c
only if havequest(33874)
step
kill Aruumel##76824 |q 33874/1 |goto Talador 68.9,55.0
step
...
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy the Defiling Crystal |q 33969/1 |count 1 |goto Talador 64.8,86.9 |indoors Deathweb Hollow
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy the Defiling Crystal |q 33969/1 |count 2 |goto 65.3,85.4 |indoors Deathweb Hollow
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy the Defiling Crystal |q 33969/1 |count 3 |goto 64.0,85.6 |indoors Deathweb Hollow
stickystart "deathwebfangAS"
step
_Enter_ the hallway |goto Talador/0 63.3,84.4 < 10 |walk |indoors Deathweb Hollow
_Follow_ the path |goto Talador/0 62.3,84.0 < 10 |walk |indoors Deathweb Hollow
...
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy the Defiling Crystal |q 33969/1 |count 4 |goto Talador 58.7,82.7
step
click Defiling Crystal##228051
|tip It looks like a floating gold colored crystal.
Destroy the Defiling Crystal |q 33969/1 |count 5 |goto Talador 61.6,81.7
step
...
label "telmorinvadors"
kill Demon Conjurer##77901+, Fervid Adherent##77022+, Depraved Hunter##77026+, Wrathguard Destroyer##75382+
Kill #12# Telmor invaders |q 34234/1 |goto Talador 48.6,88.2
step
Click the _Quest Complete_ Box:
turnin Invasion of the Soul Eaters##33988
step
...
Collect #5# Illusion Charm |q 34756/1 |goto 51.34,33.77
...
collect The Eye of Anzu##113282 |q 35668/1 |goto 48.35,42.93
step
...
Convince Shadow-Sage Iskar |q 35274/1 |goto 46.52,45.61
step
talk Jasper Fel##81891
...
step
clicknpc Drafting Table##81119
Use the Drafting Table |q 35286/1 |goto 39.72,60.81
...
Select a Building |q 35286/2 |goto 39.72,60.81
step
label "brew1"
talk Lieutenant Willem##81929
...
Show the Schematic to Bryan Finn |q 35329/2 |goto 38.94,48.79
step
talk Bryan Finn##82065
...
Slay #20# Shattered Hand |q 35649/4 |goto Spires of Arak/0 32.1,43.9
step
...
Travel to Pinchwhistle Gearworks |q 35619/1
step
...
clicknpc Firebomb##81632
|tip It's a big see-through yellow spiked bomb inside this small hut.
Place the Firebombs |q 35211/1 |count 2 |goto Spires of Arak 56.3,91.6
step
...
Place the Firebombs |q 35211/1 |count 3 |goto Spires of Arak 55.7,91.0
step
clicknpc Firebomb##81632
|tip It's a big see-through yellow spiked bomb sitting on the ground.
Place the Firebombs |q 35211/1 |count 4 |goto Spires of Arak 56.5,89.5
step
clicknpc Firebomb##81632
|tip It's a big see-through yellow spiked bomb inside this small hut.
Place the Firebombs |q 35211/1 |count 5 |goto Spires of Arak 56.6,90.0
step
...
Slay #15# Shattered Hand Orcs |q 34829/1 |goto 47.26,31.37
step
...
kill Shattered Hand Blood-Singer##83760 |q 36023/3 |goto 54.10,28.58
step
...
Defeat Gardul Venomshiv |q 36029/1 |goto 56.24,33.98
step
...
Deliver the Peace Offering |q 35699/1 |goto 43.90,48.90
step
talk Dusk-Seer Irizzar##83463
...
collect 30 Fresh Charcoal##113404 |q 35739/1 |goto 60.52,54.33
step
talk Dilbert Tinkertoss##82788
...
collect Organic Laser Apparatus##113441 |q 35835/1 |goto 65.23,61.34
step
talk Dilbert Tinkertoss##82788
...
Place the Offering |q 34921/1 |goto 48.93,48.92
step
...
Rescue "Tillik" |q 34991/1 |goto 48.73,51.52
step
talk Iktis of the Flock##80639
...
Kill #18# Bloodmane Saberon |q 36790/1 |goto 50.31,56.11
step
...
collect Prop Rotor##112957 |q 34678/2 |goto 63.77,61.57
step
...
collect Transmission Flywheel##112962 |q 34678/3 |goto 63.69,62.38
step
...
collect Assorted Engineering Parts##112963 |q 34678/1 |goto 62.08,62.13
step
...
Use Thaelin's Copter |q 34682/1 |goto 63.02,62.00
step
...
Rescue Caregiver Felaani & Isel |q 34718/2 |goto 68.50,67.05
step
...
Rescue Hansel Heavyhands |q 34718/3 |goto 67.63,64.49
step
...
Rescue Arbiter Khan |q 34718/1 |goto 65.27,65.07
step
label "killwarsong"
kill Warsong Raider##79744+, Invading Warsinger##79753+
Kill #15# Warsong Forces at Telaar |q 34717/1 |goto 67.85,66.60
step
...
collect Garrison Blueprints##111619 |q 34746/2 |goto 66.80,65.63
step
clicknpc Arkonite Crystal##79919
|tip It looks like a huge pink floating crystal.
Destroy the Arkonite Crystal |q 34746/1 |goto 66.81,65.50
step
...
step
clicknpc Drafting Table##81119
Choose to build the Rangari Corral or Telaari Tankworks |q 34769/1 |goto 63.08,61.95
...
collect 12 Pair of Leatherhide Ears##113100 |q 35337/1 |goto 69.65,55.82
step
label "shootingthebreeze"
kill Breezestrider Colt##78277+, Breezestrider Talbuk##78278+
collect 24 Breezestrider Horn##113102 |q 35338/1 |goto 68.79,56.81
step
label "rangariarrow"
...
collect Tall Buck's Tail##113104 |q 35357/1 |goto 57.82,69.03
step
map Nagrand D
...
collect Thulgork's Orders##111065 |q 34593/2 |goto 83.17,70.42
step
...
collect Crulgorosh's Orders##111066 |q 34593/1 |goto 84.15,73.70
step
label "ogreresearch"
...
Destroy #8# Boxes of Ogre Research |q 34597/1 |goto Nagrand D 82.1,75.9
step
label "margokogres"
kill Gorian Arcanist##79023+, Gorian Cohort##79070+
Kill #15# Ogres at Mar'gok's Overwatch |q 34572/1 |goto Nagrand D 82.4,75.
step
...
kill Grand Magister Reglakk##79105 |q 34596/1 |goto 81.51,76.65
step
clicknpc Portal to Highmaul##81374
|tip It looks like a swirling blue portal.
Destroy the Portal to Highmaul |q 34877/1 |goto 82.60,81.04
step
talk Rangari D'kaan##79576
...
kill Razorpaw##79002 |q 34513/1 |goto 75.18,62.47
|tip He's inside this small cave.
...
Find Bazwix's Stolen Treasure |q 34516/1 |goto 74.73,61.56
step
talk Bazwix##79897
...
Rescue #6# Goblin Traders |q 34515/1 |goto 74.71,60.04
step
label "stolengoods"
...
collect 10 Stolen Goods##110719 |q 34514/1 |goto 74.55,60.02
step
label "saberonclaw"
kill Sabermaw Scarfang##78976+, Sabermaw Mauler##78990+
collect 10 Saberon Claw##110714 |q 34512/1 |goto 74.27,60.41
step
...
collect 8 Nagrand Antiquity##111891 |q 34811/1 |goto Nagrand D 66.1,54.0
step
label "earthencore"
kill Raging Crusher##80144+
collect 4 Earthen Core##111874 |q 34809/1 |goto Nagrand D 66.1,54.0
step
...
Place the Beacon |q 35632/1 |goto Nagrand D/11 67.4,42.5
step
Watch the scene:
Recover the Mysterious Artifact |q 35632/2 |goto 69.81,42.27
step
...
collect 10 Mysterious Artifact##113272 |q 35663/1 |goto Nagrand D 66.6,49.8
step
...
collect Lantresor's Blade##111938 |q 34954/1 |goto 85.99,53.76
step
...
collect Blademaster's Banner##111947 |q 34955/1 |goto 84.86,55.30
...
Slay #15# Burning Blade Forces at Hallvalor |q 34952/1 |goto 86.23,54.64
step
talk Lantresor of the Blade##80161
|tip He's inside the building.
...
Win the Challenge |q 34957/2 |goto 53.2,68.5
...
Destroy the War Machine |q 35067/1 |count 1 |goto 55.98,43.03
step
_Go through_ the doorway |goto Nagrand D 56.2,43.7 < 10 |only if walking
_Enter_ the cave |goto Nagrand D/0 57.2,42.6 < 10 |walk
kill Shagor##80263
collect Shagor's Collar##112620 |q 35069/1 |goto 58.21,43.37
step
_Leave_ the cave |goto Nagrand D/0 57.2,42.6 < 10 |walk
_Go through_ the doorway |goto Nagrand D 56.2,43.7 < 10 |only if walking
clicknpc Iron Horde War Machine##81050
|tip It looks like a huge metal cannon.
Destroy the War Machine |q 35067/1 |count 2 |goto Nagrand D/0 55.8,46.5
step
kill Uruk Foecleaver##80264 |q 35061/1 |goto 55.64,47.76
|tip He's inside a small round building.
step
clicknpc Iron Horde War Machine##81050
|tip It looks like a huge metal cannon.
Destroy the War Machine |q 35067/1 |count 3 |goto Nagrand D/0 54.5,44.9
step
label "lok-rathforces"
kill Warsong Wolf Master##80253+, Lok-rath Windtamer##80255+, Iron Cannoneer##80964+, Nagrand Raider##80254+
Slay #10# Lok-rath Enemy Forces |q 35068/1	|goto 55.60,43.89
step
...
Capture #15# Baby Goren |q 35140/1 |goto 62.07,40.46
step
talk Vindicator Yrel##81039
...
Speak with Vindicator Yrel at the Gates of Grommashar |q 35169/1 |goto 74.56,69.55
step
...
Speak with Vindicator Nobundo |q 35331/1 |goto 71.72,19.63
Watch the dialogue
Commune with the Furies |q 35331/2 |goto 71.72,19.63
step
talk Vindicator Nobundo##82138
...
Attune to the Earth |q 35333/1	|goto 79.29,11.67
step
...
Attune to the Water |q 35333/4 |goto 73.86,10.45
step
label "water"
...
|tip It looks like a huge stone.
Attune to the Flame |q 35333/3 |goto 67.47,9.06
step
...
|tip It looks like a huge stone.
Attune to the Wind |q 35333/2 |goto 78.29,24.35
step
...
collect 10 Ancient Snarlpaw Skull##119184 |q 37318/1 |goto Nagrand D 78.5,28.8
step
label "killsnarlpaw"
accept Bonus Objective: Snarlpaw Ledge##37280
...
Rescue Dr. Hadley Ricard |q 35146/1 |goto 83.20,22.62
step
...
collect Research Journal##115272 |q 36275/1 |goto 88.86,19.78
step
click Anti-fungal Boots##234169
|tip It looks like a pair of boots on top of a mushroom.
collect Anti-Fungal Boots##115274 |q 36275/3 |goto 91.77,21.74
step
label "fsg"
...
collect 12 Fungal Spores##115276 |q 36284/1 |goto 87.24,21.89
step
...
Kill #20# Spiteleaf Podlings |q 36273/1 |goto 84.99,27.87
step
...
Speak with Challe |q 34932/1 |goto 77.95,23.31
step
kill Challe##80483
Defeat Challe |q 34932/2 |goto 77.94,23.31
step
...
Witness the Passing of Gar'rok |q 34941/1 |goto 75.08,22.74
step
talk Kalandrios##80595
...
Speak with Kalandrios |q 35330/1 |goto 72.72,19.74
step
talk Vindicator Nobundo##82138
...
Speak with Gixmo Moneycash |q 35372/1 |goto 73.69,26.63
step
...
Liberate #8# Elemental spirits |q 35398/1 |goto 58.67,60.34
step
label "palesubjugator"
kill Pale Subjugator##81578+
Kill #6# Pale Orcs |q 35397/2 |goto 58.51,60.44
step
...
kill Greyseer##81309 |q 35397/1 |goto Nagrand D/12 66.06,18.08
step
...
step
kill Gordawg##80592
collect Heart of the Fury##113077 |q 35395/1 |goto 40.22,41.98
step
...
Enter the Sanctum of the Naaru |q 35396/1 |goto 18.70,64.77
step
kill Decimatus##81989 |q 35396/2 |goto 14.27,69.39
step
...
Destroy the Gra'ah Totem |q 35083/2 |count 1 |goto 52.19,62.99
step
clicknpc Ritual Totem##81705
|tip It looks like a shaman totem with spikes coming out the sides and a blue aura on the ground beneath it.
Destroy 3 Gra'ah Totem |q 35083/2 |goto Nagrand D/0 52.4,63.9
step
...
collect Nagrand Scouting Report##113552 |q 35386/4 |goto 54.58,67.05
step
...
collect Warsong Outrider Orders##113551 |q 35386/3 |goto Nagrand D/0 51.9,67.8
step
_Leave_ the building |goto Nagrand D/0 51.9,68.0 < 10 |walk
clicknpc Ritual Totem##81705
|tip It looks like a shaman totem with spikes coming out the sides and a blue aura on the ground beneath it.
Destroy the Kag'ah Totem |q 35083/3 |count 1 |goto 50.47,70.02
step
clicknpc Ritual Totem##81705
|tip It looks like a shaman totem with spikes coming out the sides and a blue aura on the ground beneath it.
Destroy the Kag'ah Totem |q 35083/3 |goto Nagrand D/0 50.4,71.0
step
...
clicknpc Ritual Totem##81705
|tip It looks like a shaman totem with spikes coming out the sides and a blue aura on the ground beneath it.
Destroy the Mok'gor Totem |q 35083/1 |count 1 |goto 48.45,58.70
step
clicknpc Ritual Totem##81705
|tip It looks like a shaman totem with spikes coming out the sides and a blue aura on the ground beneath it.
Destroy the Mok'gor Totem |q 35083/1 |goto 48.45,58.70 |goto Nagrand D/0 47.8,58.7
step
...
collect Mixed Unit Tactics##113549 |q 35386/2 |goto 47.07,56.03
step
...
|tip It looks like a brown rolled-up scroll sitting on a table at the back of the room.
collect Warsong Command Brief##113550 |q 35386/1 |goto 52.52,55.80
step
...
Collapse #6# Void Portal |q 35087/1 |goto Nagrand D/0 51.4,60.5
step
label "voidterrors"
kill 10 Void Terror##81216 |q 35086/1 |goto 51.38,59.35
step
label "voidtendrils"
kill 15 Void Tendril##81230 |q 35086/2 |goto 51.38,59.35
step
click Shamanstone##233263
|tip It looks like a huge stone.
...
kill Invalidus##81215 |q 35088/1 |goto 48.09,58.57
step
click Shamanstone##233263
|tip It looks like a huge stone.
...
click Ceremonial Pyre##231210
|tip It looks like a circular stone fire pit.
Light the Ceremonial Pyre |q 35022/1 |count 2 |goto 38.3,57.2
step
click Ceremonial Pyre##231210
|tip It looks like a circular stone fire pit.
Light the Ceremonial Pyre |q 35022/1 |count 3 |goto 38.6,56.1
step
click Ceremonial Pyre##231210
|tip It looks like a circular stone fire pit.
Light the Ceremonial Pyre |q 35022/1 |count 4 |goto 38.7,54.6
step
click Ceremonial Pyre##231210
|tip It looks like a circular stone fire pit.
Light the Ceremonial Pyre |q 35022/1 |count 5 |goto 39.5,53.1
step
click Ceremonial Pyre##231210
|tip It looks like a circular stone fire pit.
Light the Ceremonial Pyre |q 35022/1 |goto 37.4,53.0
step
label "tormentedecho"
...
step
kill Golmash Hellscream##80747 |q 35024/1 |goto 37.16,55.67
step
talk Gar'rok##80864
