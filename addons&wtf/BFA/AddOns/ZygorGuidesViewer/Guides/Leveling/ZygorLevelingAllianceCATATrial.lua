...
condition_suggested=function() return (raceclass('Human') or raceclass('Dwarf') or raceclass('NightElf') or raceclass('Gnome') or raceclass('Draenei') or raceclass('Worgen')) and raceclass('DeathKnight') and not completedq(13188) and level < 100 end,
...
accept Alas, Gilneas##14467 |goto 41.94,20.21 |instant
step
talk King Genn Greymane##36743
|tip At the top of the tower.
...
|tip Use it next to Constriction Totems.
...
|tip Target Frostmane Builders when using the item above.
...
step
Follow the path |goto Dun Morogh/0 64.69,53.25 < 15 |only if walking
...
|tip Use it on the Dark Iron enemies below.
...
use the Gryphon Chow##58935
|tip Use it on Trained Razorbeaks.
...
step
Follow the road |goto 74.01,70.37 < 30 |only if walking
Continue following the road |goto Azuremyst Isle/0 26.49,52.34 < 30 |only if walking
click Portal to Darnassus |goto 21.35,54.04
|tip At the end of the dock.
Teleport to Teldrassil |goto Teldrassil/0 52.38,89.47 |noway |c |q 26383 |future
step
talk Sentinel Cordressa Briarbow##42936
|tip Upstairs inside the building.
...
Follow the path up |goto 54.76,63.07 < 10 |walk
Continue up the path |goto 54.08,64.19 < 10 |walk
Follow the path up |goto 54.56,64.53 < 10 |walk
Continue up the path |goto 54.62,64.01 < 10 |walk
Continue up the path |goto 53.86,62.63 < 10 |walk
Leave the mine |goto 52.23,62.34 < 10 |walk
...
Follow the path |goto Howling Fjord/0 56.39,52.32 < 10 |walk
...
Enter the cave |goto Howling Fjord/0 33.57,75.64 < 7 |walk
Follow the path |goto 33.56,77.30 < 7 |walk
...
Follow the path |goto 33.66,76.43 < 7 |walk
...
step
use the Wyrmcaller's Horn##33282
...
use the Runeseeking PIck##33806
|tip Use it on their corpses.
