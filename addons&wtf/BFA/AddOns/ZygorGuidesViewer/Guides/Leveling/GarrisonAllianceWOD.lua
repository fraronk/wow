...
condition_suggested=function() return level >= 90 and level <= 100 and not completedq(36615) and garrisonlvl() < 3 end,
condition_end=function() return garrisonlvl(3) end,
},[[
step
Complete the "Tanaan Jungle (90)" Guide |condition completedq(34575)
|tip Use the "Tanaan Jungle (90)" leveling guide to accomplish this.
step
...
confirm |q 36615 |future
step
talk Prophet Velen##79206
accept Finding a Foothold##34582 |goto Shadowmoon Valley D/0 26.98,8.09
step
Follow the path up |goto 27.37,13.70 < 20 |only if walking
Accompany Prophet Velen to the Lunarfall Ruins |q 34582/1 |goto Lunarfall/0 30.01,34.38
step
talk Vindicator Maraad##79470
turnin Finding a Foothold##34582 |goto 30.01,34.38
accept For the Alliance!##34583 |goto 30.01,34.38
step
...
turnin For the Alliance!##34583 |goto 32.71,34.05
accept Looking for Lumber##34584 |goto 32.71,34.05
accept Ravenous Ravens##34616 |goto 32.71,34.05
...
Mark #8# Trees for Lumberjacks |q 34584/1 |goto 53.43,42.59
step
label "Kill_Lunarfall_Ravens"
kill 6 Lunarfall Raven##82037 |q 34616/1 |goto 53.43,42.59
step
talk Baros Alexston##79243
turnin Looking for Lumber##34584 |goto 32.71,34.05
turnin Ravenous Ravens##34616 |goto 32.71,34.05
step
talk Yrel##79567
accept Quakefist##34585 |goto 31.39,35.86
step
Enter the cave |goto 41.22,78.80 < 7 |walk
kill Quakefist##81360 |q 34585/1 |goto 43.14,88.38
|tip Inside the cave.
step
talk Yrel##79567
turnin Quakefist##34585 |goto 31.39,35.86
step
talk Baros Alexston##79243
accept Establish Your Garrison##34586 |goto 32.71,34.05
step
talk Baros Alexston##79243
Tell him _"We have everything we need. It's time to build the garrison."_
Speak With Baros to Build Your Garrison |q 34586/1 |goto 32.71,34.05
step
...
step
Leave the Garrison and enter Shadowmoon Valley |goto Shadowmoon Valley D/0 < 1000 |q 35174
step
Follow the path |goto 26.07,7.81 < 20 |only if walking
kill Gnaw Bloodseeker##81670 |q 35174/1 |goto 25.60,5.76
step
label "Kill_Pale_Devourers"
kill 8 Pale Devourer##79205 |q 35174/2 |goto 26.57,6.12
step
...
collect 15 Drudgeboat Salvage##112696 |q 35166/1 |goto 26.57,6.12
You can find more around [27.85,4.91]
step
Return to the Garrison |goto Lunarfall/0 50.0,50.0 < 1000 |q 35166
step
#include "Garrison_BAlexston"
...
step
Leave the Garrison and enter Shadowmoon Valley |goto Shadowmoon Valley D/0 < 1000 |q 34646
step
talk Qiana Moonshadow##79446
Speak With Qiana Moonshadow |q 34646/1 |goto 29.94,29.21
step
Return to the Garrison |goto Lunarfall/0 50.0,50.0 < 1000 |q 34646
step
...
|tip Click the "Killing the Corrupted" mission.
|tip Assign "Qiana Moonshadow" to the mission and start it.
...
step
Leave the Garrison and enter Shadowmoon Valley |goto Shadowmoon Valley D/0 < 1000 |q 33075
step
Find Samaara at Embaari Village |q 33075/1 |goto 45.67,38.84
step
talk Samaara##75005
...
use the Draenei Bucket##111908
|tip Use the bucket on the small blue fire.
Douse the Floor Fire |q 33813/2 |goto 52.04,32.87
step
click Draenei Bucket##230883 |goto 51.79,32.52
|tip They look like small buckets of water on the ground around a fountain.
|tip Collect a bucket after dousing each fire.
...
use the Draenei Bucket##111908
|tip Use the bucket on the small blue fire.
Douse the Table Fire |q 33813/3 |goto 52.03,32.93
step
talk Ariaana##71502
...
step
Cross the bridge |goto 52.10,38.04 < 20 |only if walking
...
step
Watch the dialogue
Confront Ner'zhul |q 34019/1 |goto 49.35,37.21
step
...
step
Follow the path up |goto 39.66,53.64 < 20 |only if walking
Cross the bridge |goto 37.33,52.78 < 20 |only if walking
talk Prophet Velen##79043
...
step
Follow Prophet Velen |scenariostage 1 |goto 79.86,46.62 |q 33059
step
kill Krull##77767 |scenariogoal 2/24539 |goto 79.86,46.62 |q 33059
step
Watch the dialogue
Witness Commander Vorka's Arrival |scenariogoal 3/24542 |q 33059
step
talk Prophet Velen##79522
Tell him _"Prophet, we're being overrun!"_
Speak to Velen on the Karabor Stairs |scenariogoal 4/24543 |goto 79.21,46.59 |q 33059
step
Watch the dialogue
Witness the Fate of Karabor |q 33059/2 |goto 79.21,46.59
step
Follow the path down |goto 37.33,52.90 < 20 |only if walking
Continue down the path |goto 38.15,55.35 < 20 |only if walking
talk Prophet Velen##79043
turnin The Fate of Karabor##33059 |goto 40.52,54.91
step
label "Gain_Shadowmoon_Orc_Disguise"
use Sylene's Amulet of Illusion##107076
Gain the Shadowmoon Orc Disguise |condition hasbuff("spell:150455") or hasbuff("spell:150456") or hasbuff("spell:148600") or hasbuff("spell:148601") |q 33080 |or
step
clicknpc Explosives##74811
|tip Inside the building.
Plant Explosives at the Supply Hut |q 33080/2 |goto 37.17,59.25 |or
'|condition not hasbuff("spell:150455") and not hasbuff("spell:150456") and not hasbuff("spell:148600") and not hasbuff("spell:148601") and not readyq(33080) and not completedq(33080) |next "Gain_Shadowmoon_Orc_Disguise" |or
step
clicknpc Explosives##74811
|tip Inside the building.
Plant Explosives at the Main Lodge |q 33080/3 |goto 36.35,61.44 |or
'|condition not hasbuff("spell:150455") and not hasbuff("spell:150456") and not hasbuff("spell:148600") and not hasbuff("spell:148601") and not readyq(33080) and not completedq(33080) |next "Gain_Shadowmoon_Orc_Disguise" |or
step
clicknpc Explosives##74811
Plant Explosives at the Chieftain's Seat |q 33080/4 |goto 39.12,62.87 |or
'|condition not hasbuff("spell:150455") and not hasbuff("spell:150456") and not hasbuff("spell:148600") and not hasbuff("spell:148601") and not readyq(33080) and not completedq(33080) |next "Gain_Shadowmoon_Orc_Disguise" |or
step
clicknpc Explosives##74811
Plant Explosives at the Training Pit |q 33080/5 |goto 36.53,65.49 |or
'|condition not hasbuff("spell:150455") and not hasbuff("spell:150456") and not hasbuff("spell:148600") and not hasbuff("spell:148601") and not readyq(33080) and not completedq(33080) |next "Gain_Shadowmoon_Orc_Disguise" |or
step
talk Yrel##74877
...
step
Follow and protect Yrel
kill Terrorfang##73062
Escape Shaz'gul With Yrel |q 33081/2 |goto 38.75,59.19
step
talk Yrel##74877
...
step
Return to the Garrison |goto Lunarfall/0 50.0,50.0 < 1000 |q 33814
step
#include "Garrison_BAlexston"
...
step
#include "Garrison_ArchitectTable"
|tip Click your Town Hall and then click "Upgrade."
|tip You will need 200 Garrison Resources to upgrade your Garrison to Level 2.
...
step
_Congratulations_!
You Upgraded your Garrison to Level 3.
]])
...
condition_suggested=function() return level >= 90 and level <= 100 and garrisonlvl()>0 end,
},[[
step
#include "Garrison_ArchitectTable"
...
condition_suggested=function() return level >= 98 and level <= 100 and garrisonlvl()>0 end,
},[[
step
...
_Follow_ the path |goto Ashran/0 45.4,76.4 < 30
kill Enemy Players in Ashran
collect Orc Heart##118362 |q 36963/1 |goto Ashran/0 46.7,70.8 |only if havequest(36963) or completedq(36963)
collect Pandaren Heart##118358 |q 36967/1 |goto Ashran/0 46.7,70.8 |only if havequest(36967) or completedq(36967)
collect Blood Elf Heart##118356 |q 36957/1 |goto Ashran/0 46.7,70.8 |only if havequest(36957) or completedq(36957)
collect Goblin Heart##118357 |q 36969/1 |goto Ashran/0 46.7,70.8 |only if havequest(36969) or completedq(36969)
collect Troll Heart##118360 |q 36965/1 |goto Ashran/0 46.7,70.8 |only if havequest(36965) or completedq(36965)
collect Tauren Heart##118361 |q 36961/1 |goto Ashran/0 46.7,70.8 |only if havequest(36961) or completedq(36961)
collect Forsaken Heart##118359 |q 36959/1 |goto Ashran/0 46.7,70.8 |only if havequest(36959) or completedq(36959)
...
_Follow_ the path |goto Ashran/0 45.4,76.4 < 30
kill Enemy Players in Ashran
kill 500 Orc Players |q 36964/1 |goto Ashran/0 46.7,70.8 |only if havequest(36963) or completedq(36963)
kill 500 Pandaren Players |q 36968/1 |goto Ashran/0 46.7,70.8 |only if havequest(36967) or completedq(36967)
kill 500 Blood Elf Players |q 36958/1 |goto Ashran/0 46.7,70.8 |only if havequest(36957) or completedq(36957)
kill 500 Goblin Players |q 36970/1 |goto Ashran/0 46.7,70.8 |only if havequest(36969) or completedq(36969)
kill 500 Troll Players |q 36966/1 |goto Ashran/0 46.7,70.8 |only if havequest(36965) or completedq(36965)
kill 500 Tauren Players |q 36962/1 |goto Ashran/0 46.7,70.8 |only if havequest(36961) or completedq(36961)
kill 500 Forsaken Players |q 36960/1 |goto Ashran/0 46.7,70.8 |only if havequest(36959) or completedq(36959)
...
condition_suggested=function() return level == 100 and garrisonlvl()>0 end,
},[[
step
#include "Garrison_ArchitectTable"
...
condition_suggested=function() return level >= 94 and level <= 100 and not completedq(36611) and garrisonlvl()>0 end,
},[[
step
...
condition_suggested=function() return level >= 92 and level <= 100 and garrisonlvl()>0 end,
},[[
step
...
condition_suggested=function() return level >= 96 and level <= 100 and garrisonlvl()>0 end,
},[[
step
...
turnin Audrey Burnhep##32008 |goto 69.48,25.15 |only if havequest(32008)
...
condition_suggested=function() return level == 100 and not completedq(39068) and garrisonlvl()>0 end,
},[[
step
Reach Level 100 |ding 100
|tip Use the Leveling guide to accomplish this.
...
condition_suggested=function() return level >= 90 and level <= 100 and not completedq(38408) and garrisonlvl()>0 end,
},[[
step
