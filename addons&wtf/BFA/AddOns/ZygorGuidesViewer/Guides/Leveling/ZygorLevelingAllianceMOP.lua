...
accept The King's Command##29547 |goto Stormwind City/0 85.47,32.66 |or
'|accept The King's Command##37193 |or
step
Watch the dialogue
Visit Stormwind Keep |q 29547/1 |goto 85.47,32.66 |only if havequest(29547) or completedq(29547)
Visit Stormwind Keep |q 37193/1 |goto 85.47,32.66 |only if havequest(37193) or completedq(37193)
step
talk Rell Nightwind##55789
turnin The King's Command##29547 |goto 78.95,39.81 |only if havequest(29547) or completedq(29547)
turnin The King's Command##37193 |goto 78.95,39.81 |only if havequest(37193) or completedq(37193)
...
turnin The Rider's Journey##30139 |goto 57.56,45.10 |only if havequest(30139) or completedq(30139)
turnin The Rider's Journey##30140 |goto 57.56,45.10 |only if havequest(30140) or completedq(30140)
turnin The Rider's Journey##30141 |goto 57.56,45.10 |only if havequest(30141) or completedq(30141)
...
turnin His Name Was... Stormstout##32018 |goto Valley of the Four Winds/0 85.94,22.10 |only if havequest(32018) or completedq(32018)
...
|tip They look like tigers, usually stealted around this area.
...
collect 5 Intact Skitterer Glands##78911 |q 30350/1 |goto 64.06,29.35
step
talk Daggle Bombstrider##58779
...
|only if havequest(30675) or completedq(30675)
step
Click the Complete Quest Box:
...
|only if havequest(31254) or completedq(31254)
step
...
Honor the Shrine of the Seeker's Body |q 30684/1 |goto 44.79,49.17 |only if havequest(30684) or completedq(30684)
Honor the Shrine of the Seeker's Body |q 31306/1 |goto 44.79,49.17 |only if havequest(31306) or completedq(31306)
step
click Shrine of the Seeker's Breath##211601
|tip Avoid the tornados around this area.
Honor the Shrine of the Seeker's Breath |q 30684/2 |goto 42.69,50.02 |only if havequest(30684) or completedq(30684)
Honor the Shrine of the Seeker's Breath |q 31306/2 |goto 42.69,50.02 |only if havequest(31306) or completedq(31306)
step
click Shrine of the Seeker's Heart##211602
Honor the Shrine of the Seeker's Heart |q 30684/3 |goto 43.18,51.98 |only if havequest(30684) or completedq(30684)
Honor the Shrine of the Seeker's Heart |q 31306/3 |goto 43.18,51.98 |only if havequest(31306) or completedq(31306)
step
...
|tip They look liek small piles of red berries on the ground around this area inside the cave.
...
turnin Beyond the Wall##31695 |goto Townlong Steppes/0 71.15,56.69 |only if havequest(31695) or completedq(31695)
...
turnin Better Dead than Dread##31847 |goto 14.15,76.96 |only if havequest(31847) or completedq(31847)
...
|only if havequest(31023) or completedq(31023)
step
...
Krasarang Wilds Quests |achieve 6535 |loadguide "Leveling Guides\\Pandaria (80-90)\\Krasarang Wilds (81-90)"
