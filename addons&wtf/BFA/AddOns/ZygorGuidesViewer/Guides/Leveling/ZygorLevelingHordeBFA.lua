...
step
Leave the building |goto Dazar'alor/0 49.95,42.12 < 10 |walk
...
step
talk Jorak##127691
accept Fond Farewells##49040 |goto 52.91,89.14 |or
'|accept Fond Farewells##49731 |goto 52.91,89.14 |or
step
...
|tip He walks around this area.
|tip You must have the "Avatar of the Desert" buff to talk to him.
...
turnin Fond Farewells##49040 |goto Dazar'alor/0 40.35,19.10 |only if havequest(49040) or completedq(49040)
turnin Fond Farewells##49731 |goto Dazar'alor/0 40.35,19.10 |only if havequest(49731) or completedq(49731)
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the cross-zone quests in Tiragarde Sound.",
condition_suggested=function() return level >= 110 and level <= 120 end,
...
condition_suggested=function() return level >= 110 and level <= 120 and not completedq(54282) and completedq(52131) end,
...
|tip Inside the building.
accept The War Campaign##52749 |goto Dazar'alor/2 40.18,71.70 |or
'|condition completedq(52746) |or
step
talk Nathanos Blightcaller##135691
...
'|accept Uniting Zandalar##52451 |or |next "Accept_Breaking_Kul_Tiran_Will"
step
...
step
label "Accept_Breaking_Kul_Tiran_Will"
talk Nathanos Blightcaller##135691
...
step
Complete "The Fate of Saurfang" Guide |condition completedanyq(54754,54109)
...
Sail to Tiragarde Sound |q 54961/2 |goto Zuldazar/0 58.46,62.99 |only if havequest(54961)
step
...
step
talk Thomas Zelling##150311
Accept Under False Colors |condition haveanyquest(54999,55034) or completedanyq(54999,55034)
...
Use the Charm of Returning |q 54999/1 |only if havequest(54999) or completedq(54999)
Use the Charm of Returning |q 55034/1 |only if havequest(55034) or completedq(55034)
step
click Mission Commander Table
|tip Start the mission "Casting the Bait."
|tip It will take up to 24 hours to complete.
Start the Mission "Casting the Bait" |q 54999/2 |goto Dazar'alor/0 51.58,99.57 |only if havequest(54999) or completedq(54999)
Start the Mission "Casting the Bait" |q 55034/2 |goto Dazar'alor/0 51.58,99.57 |only if havequest(55034) or completedq(55034)
step
talk Nathanos Blightcaller##135691
turnin Under False Colors##54999 |goto Zuldazar/0 58.44,62.67 |only if havequest(54999) or completedq(54999)
turnin Under False Colors##55034 |goto Zuldazar/0 58.44,62.67 |only if havequest(55034) or completedq(55034)
step
...
turnin Securing Warfang Hold##55047 |goto Stormsong Valley/0 50.98,32.87 |only if havequest(55047) or completedq(55047)
turnin Securing Warfang Hold##55052 |goto Stormsong Valley/0 50.98,32.87 |only if havequest(55052) or completedq(55052)
...
Accept Old Allies |condition haveanyquest(55781,55780) or completedanyq(55781,55780) |goto 48.50,62.18 |or
...
|only if havequest(55780) or completedq(55780)
step
talk Thrall##152977
Tell him _"I am with you."_
Speak with Thrall |q 55781/1 |goto Orgrimmar/2 56.13,68.00 |only if havequest(55781) or completedq(55781)
Speak with Thrall |q 55780/2 |goto Orgrimmar/2 56.13,68.00 |only if havequest(55780) or completedq(55780)
step
talk Thrall##152977
turnin Old Allies##55781 |goto 56.13,68.00 |only if havequest(55781) or completedq(55781)
turnin Old Allies##55780 |goto 56.13,68.00 |only if havequest(55780) or completedq(55780)
Accept Stay of Execution |condition haveanyquest(55779,55782) or completedanyq(55779,55782) |goto 56.13,68.00 |or
'|accept Stay of Execution##55779 |or
'|accept Stay of Execution##55782 |or
step
talk Thrall##152977 |goto 56.13,68.00
Tell him _"I am ready to go."_
Enter the Scenario |goto Baine Rescue/0 15.78,83.74 < 1000 |c |noway |q 55779 |only if havequest(55779) or completedq(55779)
Enter the Scenario |goto Baine Rescue/0 15.78,83.74 < 1000 |c |noway |q 55782 |only if havequest(55782) or completedq(55782)
step
Watch the dialogue
kill 2 Underhold Elite Guard##152282 |scenariogoal 1/45190 |goto 22.54,61.91 |q 55779 |only if havequest(55779) or completedq(55779)
kill 2 Underhold Elite Guard##152282 |scenariogoal 1/45190 |goto 22.54,61.91 |q 55782 |only if havequest(55782) or completedq(55782)
step
talk Thrall##152155
Tell him _"Understood. I'll stick close."_
Speak with Thrall |scenariogoal 2/45101 |goto 23.04,61.80 |q 55779 |only if havequest(55779) or completedq(55779)
Speak with Thrall |scenariogoal 2/45101 |goto 23.04,61.80 |q 55782 |only if havequest(55782) or completedq(55782)
step
Cross the Room with Thrall and Saurfang |scenariogoal 2/44886 |q 55779 |only if havequest(55779) or completedq(55779)
Cross the Room with Thrall and Saurfang |scenariogoal 2/44886 |q 55782 |only if havequest(55782) or completedq(55782)
|tip Stay close to Thrall.
step
talk Thrall##152155
Tell him _"I can keep them busy."_
Devise a Plan with Thrall |scenariogoal 3/44895 |goto 30.35,37.97 |q 55779 |only if havequest(55779) or completedq(55779)
Devise a Plan with Thrall |scenariogoal 3/44895 |goto 30.35,37.97 |q 55782 |only if havequest(55782) or completedq(55782)
step
talk Dark Ranger Lenara##152333
Ask her _"Yes I would. Care to duel?"_
Duel Lenara |scenariogoal 4/44931 |goto 38.53,21.37 |q 55779 |only if havequest(55779) or completedq(55779)
Duel Lenara |scenariogoal 4/44931 |goto 38.53,21.37 |q 55782 |only if havequest(55782) or completedq(55782)
...
|only if havequest(55779) or completedq(55779)
step
talk Dark Ranger##152409
Tell him _"Well done."_
...
|only if havequest(55782) or completedq(55782)
step
talk Dark Ranger Lenara##152333
...
|only if havequest(55782) or completedq(55782)
step
Continue Deeper into the Underhold |scenariogoal 6/44933 |goto 46.32,31.43 |q 55779 |only if havequest(55779) or completedq(55779)
Continue Deeper into the Underhold |scenariogoal 6/44933 |goto 46.32,31.43 |q 55782 |only if havequest(55782) or completedq(55782)
step
talk Thrall##152155
Tell him any dialogue choice
Speak with Thrall |scenariogoal 7/45027 |goto 50.12,32.82 |q 55779 |only if havequest(55779) or completedq(55779)
Speak with Thrall |scenariogoal 7/45027 |goto 50.12,32.82 |q 55782 |only if havequest(55782) or completedq(55782)
step
Watch the dialogue
Follow the path |goto 61.86,23.60 < 20 |walk
Reach the End of the Corridor |scenariogoal 7/44937 |goto 68.28,33.17 |q 55779 |only if havequest(55779) or completedq(55779)
Reach the End of the Corridor |scenariogoal 7/44937 |goto 68.28,33.17 |q 55782 |only if havequest(55782) or completedq(55782)
step
kill Rowa Bloodstrike##152202 |scenariogoal 8/45006 |goto 72.37,42.79 |q 55779 |only if havequest(55779) or completedq(55779)
kill Rowa Bloodstrike##152202 |scenariogoal 8/45006 |goto 72.37,42.79 |q 55782 |only if havequest(55782) or completedq(55782)
step
Reach Baine Bloodhoof |scenariogoal 9/44961 |goto 80.02,59.49 |q 55779 |only if havequest(55779) or completedq(55779)
Reach Baine Bloodhoof |scenariogoal 9/44961 |goto 80.02,59.49 |q 55782 |only if havequest(55782) or completedq(55782)
step
Kill enemies around this area
|tip Pull them to the group in the center of the room for assistance.
Defeat #3# of Sylvanas's Forces |scenariogoal 10/44962 |goto 83.45,66.89 |count 3 |q 55779 |only if havequest(55779) or completedq(55779)
Defeat #3# of Sylvanas's Forces |scenariogoal 10/44962 |goto 83.45,66.89 |count 3 |q 55782 |only if havequest(55782) or completedq(55782)
step
kill Elite Battlemage##153031
click Inhibitor Crystal
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 78.51,66.67 |count 1 |q 55779 |only if havequest(55779) or completedq(55779)
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 78.51,66.67 |count 1 |q 55782 |only if havequest(55782) or completedq(55782)
step
kill Elite Battlemage##153031
click Inhibitor Crystal
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 82.44,76.08 |count 2 |q 55779 |only if havequest(55779) or completedq(55779)
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 82.44,76.08 |count 2 |q 55782 |only if havequest(55782) or completedq(55782)
step
kill Elite Battlemage##153031
click Inhibitor Crystal
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 89.11,69.44 |count 3 |q 55779 |only if havequest(55779) or completedq(55779)
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 89.11,69.44 |count 3 |q 55782 |only if havequest(55782) or completedq(55782)
step
kill Elite Battlemage##153031
click Inhibitor Crystal
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 85.07,60.40 |count 4 |q 55779 |only if havequest(55779) or completedq(55779)
Destroy the Inhibitor Crystal |scenariogoal 10/44964 |goto 85.07,60.40 |count 4 |q 55782
step
kill Magister Hathorel##152199 |scenariogoal 10/44962 |goto 81.52,62.51 |count 4 |q 55779 |only if havequest(55779) or completedq(55779)
kill Magister Hathorel##152199 |scenariogoal 10/44962 |goto 81.52,62.51 |count 4 |q 55782 |only if havequest(55782) or completedq(55782)
|tip Click the button that appears on-screen during Annihilation.
step
Leave the Scenario |scenarioend |q 55779 |only if havequest(55779) or completedq(55779)
Leave the Scenario |scenarioend |q 55782 |only if havequest(55782) or completedq(55782)
step
talk Lor'themar Theron##151848
...
|only if havequest(57147)
step
Enter the building |goto Durotar/0 53.26,42.60 < 10 |walk
talk Varok Saurfang##155786
|tip Inside the building.
turnin The Eve of Battle##56496 |goto 54.08,42.41 |only if havequest(56496) or completedq(56496)
...
'|condition haveanyquest(57130,57147)
step
talk Eitrigg##156124
|tip Inside the building.
...
condition_suggested=function() return level == 120 and not completedq(55752) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Allied Races\\Vulpera Race Unlock",{
author="support@zygorguides.com",
description="To unlock the new Vulpera allied race, you will need to earn exalted reputation with \n"..
"the Voldunai and the \"Secrets in the Sands\" achievement.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return level == 120 and not achieved(13206) and achieved(12478) and rep('Voldunai') == Exalted end,
condition_end=function() return achieved(13206) end,
image=ZGV.DIR.."\\Guides\\Images\\VulperaUnlock",
},[[
step
...
author="support@zygorguides.com",
description="\nTo unlock the new Zandalari Troll allied race, you will need to earn exalted reputation with \n"..
...
image=ZGV.DIR.."\\Guides\\Images\\ZandalariTrollUnlock",
},[[
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the level 110 character boost introduction.",
...
Use Your Hearthstone |goto Seething Shore/0 0.00,0.00 > 1000 |c |noway |or |next "Leveling Guides\\Battle for Azeroth (110-120)\\Intro & Quest Zone Choice"
step
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Pandaren and Allied Race Death Knight Intro",{
author="support@zygorguides.com",
description="This guide will walk you through completing the brief introduction for Pandaren and Alliied Race Death Knights.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return (raceclass('pandaren') or raceclass('highmountaintauren') or raceclass('zandalaritroll') or raceclass('nightborne') or raceclass('magharorc') or raceclass('vulpera')) and raceclass('DeathKnight') and level == 58 end,
condition_suggested_exclusive=true,
condition_valid=function() return (raceclass('pandaren') or raceclass('highmountaintauren') or raceclass('zandalaritroll') or raceclass('nightborne') or raceclass('magharorc') or raceclass('vulpera')) and raceclass('DeathKnight') and level == 58 end,
...
|tip Use the "Swear Fealty" button that appears on-screen.
step
talk The Lich King##163016
...
step
Follow the path |goto Orgrimmar/1 49.44,91.29 < 30 |only if walking
click Warchief's Command Board
Use the Warchief's Command Board |q 58903/4 |goto 49.66,76.46
step
Click the Complete Quest Box:
turnin Defender of Azeroth##58903
step
_Congratulations!_
You Completed the "Pandaren and Allied Race Death Knight Intro" Leveling Guide.
|tip You may now choose a leveling guide to proceed.
]])
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Allied Race Intros\\Vulpera Intro",{
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Vulpera introduction.",
condition_suggested=function() return raceclass('Vulpera') and level == 20 end,
condition_suggested_exclusive=true,
condition_valid=function() return raceclass('Vulpera') end,
condition_valid_msg="You must be a Vulpera to complete this guide!",
startlevel=20.0,
},[[
step
talk Nilsa##160452
accept For the Horde##58122 |goto Orgrimmar/1 64.65,46.51
step
Follow the path |goto 60.28,49.93 < 30 |only if walking
Continue following the path |goto 53.68,64.23 < 30 |only if walking
Run up the ramp |goto 43.99,70.74 < 20 |only if walking
talk Ambassador Blackguard##133407
turnin For the Horde##58122 |goto 39.38,79.57
accept Stranger in a Strange Land##58124 |goto 39.38,79.57
step
Run down the ramp |goto 43.84,75.44 < 20 |only if walking
click Warchief's Command Board
Find the Warchief's Command Board |q 58124/1 |goto 49.67,76.45
step
Follow the path |goto 54.58,64.87 < 30 |only if walking
Continue following the path |goto 60.41,49.81 < 30 |only if walking
talk Nilsa##160452
turnin Stranger in a Strange Land##58124 |goto 64.65,46.51
step
_Congratulations!_
You Completed the "Vulpera Intro" Leveling Guide.
|tip You may now choose a leveling guide to proceed.
]])
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Heritage Armor\\Goblin Heritage Armor",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Horrific Vision of Stormwind",{
author="support@zygorguides.com",
description="This guide will walk you through completing the \"Horrific Vision of Stormwind\" scenario.",
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return level == 120 and havequest(57374) or completedq(57374) end,
condition_valid=function() return havequest(57374) or completedq(57374) end,
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Horrific Vision of Orgrimmar",{
author="support@zygorguides.com",
...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Battle for Azeroth (110-120)\\Heart of Azeroth\\Magni's Plan",{
author="support@zygorguides.com",
...
condition_suggested=function() return level == 120 and not completedq(58632) end,
...
step
Complete the Quest "Uniting Zandalar" |condition completedanyq(51916,52451)
