...
condition_suggested=function() return level >= 81 and level <= 90 and not completedq(29990) end,
startlevel=81,
endlevel=90,
},[[
step
...
step
talk Chen Stormstout##56133 |goto 75.28,35.51
Tell him _"I'm ready. Let's hit the road."_
Watch the dialogue
Begin Following Chen |goto 75.29,36.23 < 5 |noway |q 29919
step
Watch the dialogue
...
Start the Brawl |goto 35.06,70.24 < 5 |or |noway |next "Cleaning_House_Mudmug" |q 30078
...
stickystart "Slay_Essences_of_Despair"
step
...
step
label "Slay_Essences_of_Despair"
...
Reflect at the Shrine of the Seeker's Body |q 30684/1 |goto 44.78,49.17 |only if havequest(30684) or completedq(30684)
Reflect at the Shrine of the Seeker's Body |q 31306/1 |goto 44.78,49.17 |only if havequest(31306) or completedq(31306)
|tip Watch out for the falling snow.
step
click Shrine of the Seeker's Breath##211601
Reflect at the Shrine of the Seeker's Breath |q 30684/2 |goto 42.69,50.02 |only if havequest(30684) or completedq(30684)
Reflect at the Shrine of the Seeker's Breath |q 31306/2 |goto 42.69,50.02 |only if havequest(31306) or completedq(31306)
|tip Watch out for the freezing winds; they look like tornados.
step
click Shrine of the Seeker's Heart##211602
Reflect at the Shrine of the Seeker's Heart |q 30684/3 |goto 43.18,51.98 |only if havequest(30684) or completedq(30684)
Reflect at the Shrine of the Seeker's Heart |q 31306/3 |goto 43.18,51.98 |only if havequest(31306) or completedq(31306)
step
talk Lorewalker Cho##60795
turnin Seeker's Folly##30684 |or |goto 43.79,51.05 |only if havequest(30684) or completedq(30684)
turnin Seeker's Folly##31306 |or |goto 43.79,51.05 |only if havequest(31306) or completedq(31306)
...
Enter the building |goto Vale of Eternal Blossoms/0 63.47,17.00 < 7 |walk |only if level <= 119
Enter the building |goto Vale of Eternal Blossoms New/0 63.73,14.33 < 7 |walk |only if level >= 120
talk Madam Vee Luo##62996
|tip Inside the building.
turnin A Witness to History##31511 |goto Shrine of Two Moons/1 68.45,47.64 |only if level <= 119
turnin A Witness to History##31511 |goto Vale of Eternal Blossoms New/0 62.92,11.94 |only if level >= 120
step
...
Explore the Vale's Past |havebuff spell:317931 |goto Vale of Eternal Blossoms/0 80.48,31.96 |q 30690
only if level >= 120
step
...
Speak with Lya of Ten Songs |q 31129/2 |goto 50.73,11.71 |only if havequest(31129) or completedq(31129)
Speak with Lya of Ten Songs |q 31076/2 |goto 50.73,11.71 |only if havequest(31076) or completedq(31076)
step
talk Sapmaster Vu##62666
Ask him _"Have you seen anybody named Stormstout come through here?"_
Speak with Sapmaster Vu |q 31129/1 |goto 51.21,11.39 |only if havequest(31129) or completedq(31129)
Speak with Sapmaster Vu |q 31076/1 |goto 51.21,11.39 |only if havequest(31076) or completedq(31076)
step
talk Big Dan Stormstout##62845
Ask him _"Is your name really Stormstout?"_
Speak with Big Dan Stormstout |q 31129/3 |goto 50.91,11.37 |only if havequest(31129) or completedq(31129)
Speak with Big Dan Stormstout |q 31076/3 |goto 50.91,11.37 |only if havequest(31076) or completedq(31076)
step
talk Chen Stormstout##62779
turnin Fate of the Stormstouts##31129 |or |goto 50.45,12.05 |only if havequest(31129) or completedq(31129)
turnin Fate of the Stormstouts##31076 |or |goto 50.45,12.05 |only if havequest(31076) or completedq(31076)
step
talk Chen Stormstout##62779
...
step
_This quest is bugged_ for level 120 players due to the N'Zoth Invasions |only if level >= 120
...
description="\nThis guide will walk you through the Monk quest at level 40.",
},[[
step
...
description="\nThis guide will walk you through the Monk quest at level 50.",
},[[
step
...
description="\nThis guide will walk you through the Monk quest at level 60.",
},[[
step
...
description="\nThis guide will walk you through the Monk quest at level 70.",
},[[
step
...
description="\nThis guide will walk you through the Monk quest at level 80.",
},[[
step
...
description="\nThis guide will walk you through the Monk quest at level 90.",
},[[
step
