...
condition_suggested=function() return skill('Alchemy') > 0 and skill('Draenor Alchemy') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Archaeology') < 700 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Blacksmithing') > 0 and skill('Draenor Blacksmithing') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Cooking') > 0 and skill('Draenor Cooking') < 100 and level >= 90 end,
},[[
step
...
|tip Keep all of these for later.
Create 20 Pan-Seared Talbuk |condition itemcount(111434) >= 175
...
|tip Keep all of these for later.
Create 20 Sturgeon Stew |condition itemcount(111442) >= 175
|only if skill("Draenor Cooking") < 75
step
...
condition_suggested=function() return skill('Enchanting') > 0 and skill('Draenor Enchanting') < 100 and level >= 90 end,
},[[
step
talk Bob##87022
...
condition_suggested=function() return skill('Engineering') > 0 and skill('Draenor Engineering') < 100 and level >= 90 end,
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Profession Guides\\Fishing\\Leveling Guides\\Warlords of Draenor\\Fishing 600-700 Leveling Guide",{
author="support@zygorguides.com",
...
condition_suggested=function() return skill('Inscription') > 0 and skill('Draenor Inscription') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Jewelcrafting') > 0 and skill('Draenor Jewelcrafting') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Leatherworking') > 0 and skill('Draenor Leatherworking') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Tailoring') > 0 and skill('Draenor Tailoring') < 100 and level >= 90 end,
},[[
step
