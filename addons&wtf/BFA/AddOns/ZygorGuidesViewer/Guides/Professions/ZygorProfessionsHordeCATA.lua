...
condition_suggested=function() return skill('Outland Alchemy') > 0 and skill('Outland Alchemy') < 75 and level >= 58 end,
},[[
step
talk Lorokeem##19052
|tip Inside the building.
...
condition_suggested=function() return skill('Northrend Alchemy') > 0 and skill('Northrend Alchemy') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Alchemy') > 0 and skill('Cataclysm Alchemy') < 75 and level >= 78 end,
},[[
step
talk Yelmak##3347
|tip Inside the building.
...
author="support@zygorguides.com",
description="\nClam Meat can be gathered from the Echo Isles in southern Durotar.",
},[[
step
...
condition_suggested=function() return skill('Outland Cooking') > 0 and skill('Outland Cooking') < 75 and level >= 58 end,
},[[
step
talk Allison##49789
|tip Inside the building.
...
condition_suggested=function() return skill('Northrend Cooking') > 0 and skill('Northrend Cooking') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Cooking') > 0 and skill('Cataclysm Cooking') < 75 and level >= 78 end,
},[[
step
talk Arugi##46709
|tip She walks around inside the building.
...
condition_suggested=function() return skill('Outland Enchanting') > 0 and skill('Outland Enchanting') < 75 and level >= 58 end,
},[[
step
talk Felannia##18753
...
talk Felannia##18753
|tip Upstairs inside the building.
learn Small Prismatic Shard##42615 |goto Hellfire Peninsula/0 52.34,35.97
step
...
condition_suggested=function() return skill('Northrend Enchanting') > 0 and skill('Northrend Enchanting') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Enchanting') > 0 and skill('Cataclysm Enchanting') < 75 and level >= 78 end,
},[[
step
talk Godan##3345
|tip Inside the building.
...
condition_suggested=function() return skill('Northrend Engineering') > 0 and skill('Northrend Engineering') < 75 and level >= 58 end,
},[[
step
...
step
talk Lumak##3332
Train Cataclysm Fishing |skillmax Cataclysm Fishing,75  |goto Orgrimmar/1 66.44,41.93
step
Fish in the open water
|tip You can fish anywhere and gain skill.
...
author="support@zygorguides.com",
description="\nEarthroot can be gathered from Tirisfal Glades.",
...
path	55.74,47.59	53.73,48.21	53.09,46.14	49.86,48.75	48.50,49.87
path	47.72,47.74	47.72,43.59	48.94,38.93	49.88,36.54	50.15,35.25
path	49.93,32.44	46.50,29.10	43.86,30.07	43.77,33.95	44.30,36.48
path	44.07,40.05	42.29,42.56	42.75,45.97	43.01,49.19	43.24,53.28
path	43.72,57.16	45.69,58.96	48.20,59.53	50.93,57.12	53.37,56.60
path	55.71,56.01	56.91,52.20	59.45,51.67	61.39,52.92	62.25,50.52
path	64.77,50.31	66.95,51.49	65.92,48.67	65.01,48.52	64.75,45.91
path	64.83,43.09	65.99,40.54	66.86,38.14	67.05,35.86	64.78,33.77
path	62.73,33.57	61.17,33.83	60.26,36.49	58.89,35.52	57.52,34.90
path	56.80,37.17	55.65,39.57	53.76,42.32
...
author="support@zygorguides.com",
description="\nPeacebloom can be gathered from Tirisfal Glades.",
...
condition_suggested=function() return skill('Outland Herbalism') > 0 and skill('Outland Herbalism') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Northrend Herbalism') > 0 and skill('Northrend Herbalism') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Herbalism') > 0 and skill('Cataclysm Herbalism') < 75 and level >= 78 end,
},[[
step
...
condition_suggested=function() return skill('Outland Inscription') > 0 and skill('Outland Inscription') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Northrend Inscription') > 0 and skill('Northrend Inscription') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Northrend Jewelcrafting') > 0 and skill('Northrend Jewelcrafting') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Outland Leatherworking') > 0 and skill('Outland Leatherworking') < 75 and level >= 58 end,
},[[
step
talk Darmari##19187
...
condition_suggested=function() return skill('Northrend Leatherworking') > 0 and skill('Northrend Leatherworking') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Leatherworking') > 0 and skill('Cataclysm Leatherworking') < 75 and level >= 78 end,
},[[
step
talk Karolek##3365
|tip Inside the building.
...
author="support@zygorguides.com",
description="\nCopper can be gathered from Durotar and Mulgore.",
condition_end=function() return skill('Mining') >= 50 end,
},[[
step
label "Durotar_Farming_Location"
map Durotar/0
path follow smart; loop on; ants curved
path	49.06,21.21	49.95,24.57	50.32,26.52	49.53,28.74	48.66,28.20
path	47.14,23.26	46.13,22.60	43.93,22.02	41.21,16.72	38.94,15.89
path	38.54,20.54	38.44,22.76	36.66,24.93	36.76,26.91	36.50,29.54
path	36.09,32.89	36.20,36.36	36.75,39.89	36.71,45.12	36.89,49.87
path	36.47,53.50	37.14,56.21	38.32,53.98	39.80,52.39	42.82,50.24
path	44.94,48.91	47.07,48.67	48.72,49.12	49.89,49.45	50.41,51.32
path	50.82,54.71	51.40,56.87	52.14,58.44	51.81,60.60	51.34,64.68
path	53.10,66.34	55.19,66.56	54.90,64.10	54.56,60.96	55.19,60.14
path	55.96,57.84	56.04,54.45	56.13,50.11	55.39,46.58	56.57,41.87
path	55.66,40.80	55.74,39.37	56.35,38.14	55.35,35.35	54.87,34.09
path	55.78,32.03	57.53,30.07	55.83,28.76	56.59,26.04	56.12,24.15
path	55.58,21.00	54.46,18.44	52.81,16.88	50.84,16.28	49.76,17.81
Mine along the path
|tip Make sure you enable "Find Minerals" in the tracking menu on the minimap.
click Copper Vein##1731+
|tip Gather Copper along the path.
collect Copper Ore##2770 |n
Click Here for the Mulgore Farming Path |confirm
step
map Mulgore/0
path follow smart; loop on; ants curved
path	37.78,16.78	39.37,11.57	41.16,10.31	43.86,10.19	47.20,10.15
path	48.86,10.28	52.12,10.73	54.59,13.83	56.04,17.33	57.31,19.01
path	57.64,20.51	59.33,21.63	61.62,23.70	61.31,27.02	60.00,29.86
path	58.01,32.00	56.95,35.04	56.24,39.50	56.29,43.02	58.24,46.13
path	60.72,49.74	62.05,52.06	62.20,55.06	63.44,56.97	65.49,57.73
path	67.13,59.93	66.78,64.34	65.69,67.58	64.34,69.36	62.82,70.61
path	59.84,69.74	56.75,71.06	53.36,72.35	51.92,70.53	50.89,69.20
path	48.23,71.71	45.49,69.76	42.31,71.31	39.33,73.20	37.20,76.93
path	35.07,76.45	35.49,70.81	35.67,65.16	35.76,59.26	35.58,55.17
path	35.58,50.69	35.55,45.42	33.53,43.53	33.17,41.49	34.66,40.68
path	35.09,37.97	34.26,34.35	32.39,30.72	30.29,25.73	31.70,21.12
path	34.29,18.03
Mine along the path
|tip Make sure you enable "Find Minerals" in the tracking menu on the minimap.
click Copper Vein##1731+
|tip Gather Copper along the path.
collect Copper Ore##2770 |n
Click Here to Go Back to the Durotar Farming Path |confirm |next "Durotar_Farming_Location"
'|confirm
]])
...
condition_suggested=function() return skill('Outland Mining') > 0 and skill('Outland Mining') < 75 and level >= 58 end,
},[[
step
talk Krugosh##18747
...
condition_suggested=function() return skill('Northrend Mining') > 0 and skill('Northrend Mining') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Mining') > 0 and skill('Cataclysm Mining') < 75 and level >= 78 end,
},[[
step
talk Gonto##46357
|tip He walks around Inside the building.
...
map Durotar/0
path follow smart; loop on; ants curved
path	44.10,20.62	45.73,23.81	45.10,31.26	45.52,37.61	45.02,44.42
path	41.12,46.65	36.91,45.23	36.01,34.80	38.01,25.22	41.93,19.40
...
condition_suggested=function() return skill('Outland Skinning') > 0 and skill('Outland Skinning') < 75 and level >= 58 end,
},[[
step
talk Moorutu##18755
...
condition_suggested=function() return skill('Northrend Skinning') > 0 and skill('Northrend Skinning') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Skinning') > 0 and skill('Cataclysm Skinning') < 75 and level >= 78 end,
},[[
step
talk Thuwd##7088
|tip Inside the building.
...
author="support@zygorguides.com",
description="\nLinen Cloth can be gathered from the Silverpine Forest.",
},[[
step
...
author="support@zygorguides.com",
description="\nSilk Cloth can be gathered from the northwestern Thousand Needles.",
},[[
step
Kill enemies around this area
...
condition_suggested=function() return skill('Outland Tailoring') > 0 and skill('Outland Tailoring') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Northrend Tailoring') > 0 and skill('Northrend Tailoring') < 75 and level >= 58 end,
},[[
step
...
condition_suggested=function() return skill('Cataclysm Tailoring') > 0 and skill('Cataclysm Tailoring') < 75 and level >= 78 end,
},[[
step
...
step
talk Mender Jessara##133109
learn Embersilk Bandage##74556 |goto 38.49,86.41
step
Open Your Tailoring Crafting Panel:
...
step
talk Mender Jessara##133109
learn Heavy Embersilk Bandage##74557 |goto 38.49,86.41
step
Open Your Tailoring Crafting Panel:
...
step
Complete the "Muddied Waters" Quest |condition completedq(26784)
