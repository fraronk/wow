...
condition_suggested=function() return skill('Fishing') > 0 and skill('Draenor Fishing') < 100 and level >= 90 end,
},[[
step
...
condition_suggested=function() return skill('Inscription') > 0 and skill('Draenor Inscription') < 100 end,
},[[
step
talk Maru'sa##87551
