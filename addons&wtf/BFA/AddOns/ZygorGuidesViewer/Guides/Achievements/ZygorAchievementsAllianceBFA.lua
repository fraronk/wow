...
step
label "start"
You will need to collect the Uldir Raid set for this achievement
|tip It may take multiple attempts to complete a set.
Click Here to Continue |confirm
step
Inside the Uldir Raid:
|tip Be sure to set the raid difficulty to normal.
kill Taloc##137119
collect Volatile Walkers##160714 |n
|tip The Rare Elite Hailstone Construct can drop the "Ice-Rimed Slippers".
|tip The World Boss Azurethos can drop "Sandals of Rustling Rage".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
Inside the Uldir Raid:
|tip Be sure to set the raid difficulty to normal.
kill Zek'voz##134445
collect Mantle of Contained Corruption##160613 |n
|tip Later in the raid, G'huun can drop the "Amice of Corrupting Horror".
|tip The World Boss Warbringer Yenajz in Stormsong Valley can drop the "Amice of the Rending Abyss"
collect Void-Lashed Wristband##160617 |n
|tip Random trash in Uldir can drop the "Bloody Experimenter's Wraps".
|tip The World Boss Warbringer Yenajz can drop "Wristwraps of Warped Reality".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
...
|tip Be sure to set the raid difficulty to normal.
kill Mother##140853
collect Leggings of Lingering Infestation##160615 |n
|tip The Hailstone Construct can drop "Frostbreath Leggings".
|tip The World Boss T'zane can drop "Wailing Terror Leggings".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
...
|tip Be sure to set the raid difficulty to normal.
kill Vectis##134442
collect Mutagenic Protofluid Handwraps##160715 |n
|tip Random trash in Uldir can drop "Spellbound Specimen Handlers", which can also be bought from the AH.
|tip The World Boss Azurethos in Tiragarde Sound can drop "Windcaller's Down Handwraps".
|tip The Rare Elite Ji'arak in Zuldazar can drop "Gloves of Enveloping Winds".
collect Cord of Animated Contagion##160734 |n
|tip Later in the raid, G'huun can drop "Cord of Septic Envelopment".
|tip The World Boss T'zane can drop the "Cinch of All-Consuming Death".
|tip The World Boss Dunegorger Kraulok can drop the "Cord of Flowing Sands".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
...
|tip Be sure to set the raid difficulty to normal.
kill Zul##138967
collect Horrific Amalgam's Hood##160616 |n
|tip The Fetid Devourer in Uldir can drop "Visage of the Ascended Prophet".
|tip The Rare Elite Ji'arak can drop "Matriarch's Shadowveil".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
...
collect Robes of the Unraveler##160614 |n
|tip The World Boss Dunegorger Kraulok in Vol'dun can drop "Raider's Shrouding Thobe".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Mage, Priest, Warlock
step
...
|tip Be sure to set the raid difficulty to normal.
kill Taloc##137119
collect Rubywrought Sparkguards##160629 |n
|tip Trash in Uldir can drop "Reinforced Test Subject Shackles".
|tip The World Boss Azurethos in Tiragarde Sound can drop "Bindings of the Winged Typhoon".
|tip The World Boss Dunegorger Kraulok in Vol'dun can drop "Shrouded Sandscale Bracers".
collect Legguards of Coalescing Plasma##160631 |n
|tip Later in the raid, Vectis can drop "Blighted Anima Greaves".
|tip The World Boss T'zane can drop "Legguards of the Barkbound Dead".
|tip The Rare Elite Ji'arak can drop "Windshear Leggings".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Hunter, Shaman
step
...
|tip Be sure to set the raid difficulty to normal.
kill Zek'voz##134445
collect Chainvest of Assured Quality##160627 |n
|tip Later in the raid, Mythrax the UNraveler can drop "C'thraxxi General's Hauberk".
|tip The Rare Elite Hailstone Construct can drop "Hailstone Hauberk".
collect Titanspark Energy Girdle##160633 |n
|tip Later in the raid, Zul can drop "Cincture of Profane Deeds".
|tip The Rare Elite Hailstone Construct can drop "Freezing Tempest Waistguard".
|tip The Rare Elite Ji'arak can drop "Hurricane Cinch".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Hunter, Shaman
step
...
|tip Be sure to set the raid difficulty to normal.
kill MOTHER##140853
collect Gloves of Involuntary Amputation##160626 |n
|tip Trash in the Uldir raid can drop "Iron-Grip Specimen Handlers".
|tip Later in the raid, Mythrax the Unraveler can drop "Oblivion Crushers".
|tip The World Boss Dunegorger Kraulok can drop "Dunegorger's Grips".
collect Flame-Sterilized Spaulders##160632 |n
|tip The World Boss Warbringer Yenajz can drop "Spaulders of the Enveloping Maw".
|tip Later in the raid, G'huun can drop "Spaulders of Coagulated Viscera".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Hunter, Shaman
step
...
|tip Be sure to set the raid difficulty to normal.
kill Zul##138967
collect Crest of the Undying Visionary##160630 |n
|tip Azurethos in Tiragarde Sound can drop "Feathered Galeforce Crest".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Hunter, Shaman
step
...
collect Fused Monstrosity Stompers##160628 |n
|tip The World Boss Warbringer Yenajz in Stormsong Valley can drop "Yenajz's Chitinous Stompers".
|tip The World Boss T'zane in Nazmir can drop "Swampwalker's Soul-Treads".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only Hunter, Shaman
step
...
|tip Be sure to set the raid difficulty to normal.
kill Taloc##137119
collect Gloves of Descending Madness##160618 |n
|tip Trash in Uldir can drop "Antiseptic Specimen Handlers".
|tip The World Boss Warbringer Yenajz can drop "Shadow-Wreathed Gloves".
|tip The World Boss Dunegorger Kraulok can drop "Gloves of the Desert Assassin".
collect Bloodstorm Buckle##160622 |n
|tip The next boss Zek'voz can drop "Replicated Chitin Cord".
|tip The rare elite Ji'arak can drop "Avian Clutch Belt".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
Inside the Uldir Raid:
|tip Be sure to set the raid difficulty to normal.
kill Zek'voz##134445
collect Quarantine Protocol Treads##160624 |n
|tip Later in the raid, G'huun can drop "Striders of the Putrescent Path".
|tip The World Boss Azurethos can drop "Footpads of the Encircling Storm".
|tip The Rare Elite Hailstone Construct can drop "Ice Stalker Boots".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
...
|tip Be sure to set the raid difficulty to normal.
kill MOTHER##140853
collect Pathogenic Legwraps##160625 |n
|tip The World Boss Warbringer Yenajz in Stormsong Valley can drop "Leggings of the Endless Void".
|tip The Rare Elite Ji'arak can drop "Savage Terrorwing Leggings".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
...
|tip Be sure to set the raid difficulty to normal.
kill Vectis##134442
collect Wristwraps of Coursing Miasma##160621 |n
|tip Trash in Uldir can drop "Splatterguards".
|tip Later in the raid, Zul can drop "Armbands of Sacrosanct Acts".
|tip The Rare Elite Hailstone Construct can drop "Chill's End Wristguards".
|tip The World Boss T'zane can drop "Bindings of Eternal Fears".
collect Hood of Pestilent Ichor##160623 |n
|tip The World Boss Dunegorger Kraulok can drop "Hood of the Sinuous Devilsaur".
|tip Later in the raid, the boss Mythrax the Unraveler can drop "Cowl of Dark Portents".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
...
|tip Be sure to set the raid difficulty to normal.
kill Zul##138967
collect Usurper's Bloodcaked Spaulders##160620 |n
|tip The World Boss T'zane can drop "Deathshambler's Shoulderpads".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
...
|tip Be sure to set the raid difficulty to normal.
kill Fetid Devourer##133298
collect Jerkin of the Aberrant Chimera##160619 |n
|tip Later in the raid, G'huun can drop "Tunic of the Sanguine Deity".
|tip The World Boss Azurethos can drop the "Chestguard of Dire Winds".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DemonHunter, Druid, Monk, Rogue
step
...
|tip Be sure to set the raid difficulty to normal.
kill Taloc##137119
collect Crimson Colossus Armguards##160637 |n
|tip Later in the raid, Zul can drop "Imperious Vambraces".
|tip Trash in Uldir can drop "Crushproof Vambraces".
|tip The World Boss T'zane can drop "Soulplank Vambraces".
|tip The World Boss Azurthos can drop "Talonscored Azure Vambraces".
collect Greaves of Unending Vigil##160639 |n
|tip Later in the raid, Zek'voz can drop "Greaves of Creeping Darkness".
|tip The World Boss Dunegorger Kraulok can drop "Sandswept Legionnaire's Legplates".
|tip The World Boss Azurethos can drop "Roost-Defender's Legguards".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
...
|tip Be sure to set the raid difficulty to normal.
kill Zek'voz##134445
collect Warboots of Absolute Eradication##160640 |n
|tip Later in the raid, G'huun can drop "Hematocyst Stompers".
|tip The Rare Elite Ji'arak can drop "Galebreaker's Sabatons".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DeathKnight, Paladin, Warrior
step
...
|tip Be sure to set the raid difficulty to normal.
kill MOTHER##140853
collect Gridrunner Galea##160634 |n
|tip Later in the raid, G'huun can drop "Helm of the Defiled Laboratorium".
|tip The World Boss T'zane can drop "Petrified Mask of the Afterlife".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DeathKnight, Paladin, Warrior
step
...
|tip Be sure to set the raid difficulty to normal.
kill Vectis##134442
collect Chestguard of Virulent Mutagens##160636 |n
|tip Later in the raid, Zul can drop "Chestplate of Apocalyptic Machinations".
|tip The Rare Elite Ji'arak can drop "Stormcrash Chestguard".
collect Decontaminator's Greatbelt##160638 |n
|tip The Rare Elite Hailstone Construct can drop "Girdle of Biting Winds".
|tip The World Boss T'zane can drop "Death Devouring Girdle".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DeathKnight, Paladin, Warrior
step
...
|tip Be sure to set the raid difficulty to normal.
kill Fetid Devourer##133298
collect Waste Disposal Crushers##160635 |n
|tip Trash in Uldir can drop "Fluid-Resistant Specimen Handlers".
|tip The World Boss Warbringer Yenajz can drop "Existence-Shattering Gauntlets".
|tip The Rare Elite can drop "Glacial Spike Gauntlets".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DeathKnight, Paladin, Warrior
step
...
|tip Be sure to set the raid difficulty to normal.
kill Mythrax the Unraveler##136383
collect Chitinspine Pauldrons##160641 |n
|tip The Rare Elite Hailstone Construct can drop "Ice-Carved Shoulderplates".
Earn the "New Mog, G'huun This?" Achievement  |achieve 12991 |next "end"
Click Here to Continue |confirm
|only DeathKnight, Paladin, Warrior
step
If you didn't complete your set, you will need to try next week on the raid reset
Click Here to Continue |next "start"
step
label "end"
_Congratulations!_
...
Earn the "Don't Warfront Me" Achievement |achieve 12993 |goto Boralus/0 66.05,25.97
step
_Congratulations!_
...
author="support@zygorguides.com",
description="\nCollect armor pieces from The Battle for Darkshore weekly quest to earn this achievement.",
achieveid={13433},
patch='80100',
startlevel=120,
...
accept Warfront: The Battle for Darkshore##53992 |goto Boralus/0 65.88,26.04
...
step
click War Table
Choose "Join Battle" under Battle for Darkshore |goto 66.05,25.96
Click here once you have entered the Battle for Darkshore |confirm
step
Defeat the Horde at the Battle for Darkshore |q 53992/1
step
talk Ralston Karn##142721
turnin Warfront: The Battle for Darkshore##53992 |goto Boralus/0 65.88,26.04
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Glory of the Wartorn Hero\" Achievement.",
achieveid={12812},
patch='80001',
startlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through Earning Mythic: Temple of Sethraliss Achievement.",
achieveid={12506},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Double Dribble achievement.",
achieveid={12551},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Edgelords achievement.",
achieveid={12830},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Elevator Music achievement.",
achieveid={12937},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to complete the following achievements:\n\nCan I Get a Hek Hek Hek Yeah?\nWalk the Dinosaur\nPraise the Sunflower\nBarrel of Monkeys\nSnow Fun Allowed\nI Got Next!\nHidden Dragon\nDe Lurker Be'loa\nWe Got Spirit, How About You?.",
achieveid={13315},
patch='80100',
startlevel=120,
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Mythic: N'Zoth, the Corruptor",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat N'Zoth, the Corruptor in Ny'alotha, the Waking City on Mythic difficulty.",
keywords={"Ny'alotha","Waking","City","Mythic","Raid","BFA","Battle","for","Azeroth","8.3"},
achieveid={14055},
patch='80300',
startlevel=120,
endlevel=120,
...
step
To earn this achievement, defeat N'Zoth the Corruptor in Ny'alotha, the Waking City on Mythic difficulty
Click here to load the "Ny'alotha, the Waking City - The Waking Dream" raid guide |confirm |next "Dungeon Guides\\Battle for Azeroth Raids\\Ny'alotha, the Waking City - The Waking Dream"
Earn the "Mythic: N'Zoth, the Corruptor" Achievement |achieve 14055
step
_Congratulations!_
You Earned the "Mythic: N'Zoth, the Corruptor" Achievement.
]])
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Now We Got Bad Blood achievement.",
achieveid={12772},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Parental Controls achievement.",
achieveid={12938},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat the Opulence in Battle of Dazar'alor after /praising a Singing Sunflower while under the effects of Brilliant Aura on Normal difficulty or higher.",
achieveid={13345},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeating the following bosses in the Battle of Dazar'alor:\n\nChampion of the Light\nGrong the Revenant\nJadefire Masters.",
achieveid={13286},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to build a Frosty Snowmon then destroy it before defeating Lady Jaina Proudmoore in the Battle of Dazar'alor on Normal Difficulty or higher.",
achieveid={13410},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the Thrash Mouth - All Stars achievement.",
achieveid={12823},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat the Conclave of the Chosen in Battle of Dazar'alor without killing the initial raptors summoned by Gonk's Wrath on normal difficulty or higher.",
achieveid={13325},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to to defeat King Rastakhan with all phantoms still alive.",
achieveid={13425},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis mount will walk you through earning the What's in the Box? achievement.",
achieveid={12828},
patch='80001',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through earning the Mythic: Champion of the Light Achievement.",
achieveid={13292},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through earning the Mythic: Jadefire Masters Achievement.",
achieveid={13293},
patch='80100',
startlevel=120,
endlevel=120,
...
step
kill Ma'ra Grimfang##148238
kill Anathos Firecaller##146100
|tip This is the second boss for Battle of Dazar'alor.
|tip Form your group and set the raid to Mythic difficulty.
Earn the "Mythic: Jadefire Masters" Achievement |achieve 13298 |goto Battle of Dazar'alor/0 0.00,0.00
step
_Congratulations!_
You Earned the "Mythic: Jadefire Masters" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Mythic: King Rastakhan",{
author="support@zygorguides.com",
description="\nThis guide will walk you through earning the Mythic: King Rastakhan Achievement.",
achieveid={13311},
patch='80100',
startlevel=120,
endlevel=120,
keywords={"Battle, of, Dazar'alor, Mythic, King, Rastakhan, Raid, BFA, Battle, for, Azeroth"},
},[[
step
kill King Rastakhan##146409
|tip This is the 6th boss for Battle of Dazar'alor.
|tip Form your group and set the raid to Mythic difficulty.
Earn the "Mythic: King Rastakhan" Achievement |achieve 13311 |goto Battle of Dazar'alor/0 0.00,0.00
step
_Congratulations!_
You Earned the "Mythic: King Rastakhan" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Mythic: Lady Jaina Proudmoore",{
author="support@zygorguides.com",
description="\nThis guide will walk you through earning the Mythic: Lady Jaina Proudmoore Achievement.",
achieveid={13314},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through Earning Mythic: Mekkatorque Achievement.",
achieveid={13312},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through Earning Mythic: Opulence Achievement.",
achieveid={13299},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through Earning Mythic: Stormwall Blockade Achievement.",
achieveid={12506},
patch='80001',
startlevel=120,
endlevel=120,
...
step
Defeat the "Conclave of the Chosen" Encounter
|tip This is the 8th boss in Battle for Dazar'alor, where you will face the Pa'ku, Gonk Kimbul and Akunda's aspect.
|tip Form your group and set the raid to Mythic difficulty.
...
author="support@zygorguides.com",
description="\nThis guide will walk you through Earning the Snow Fun Allowed Achievement.",
achieveid={13417},
patch='80100',
startlevel=120,
endlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you need to defeat the Conclave of the Chosen in Battle of Dazar'alor without killing the initial raptors summoned by Gonk's Wrath on normal difficulty or higher.",
achieveid={12587},
patch='80001',
startlevel=120,
endlevel=120,
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\You and What Army?",{
author="support@zygorguides.com",
achieveid={13684},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"You and What Army?\" Achievement.",
},[[
step
kill Abyssal Commander Sivara##155144
|tip The Lieutenants needed for the achievement are found before Abyssal Commander Sivara.
|tip Clear the trash at the middle and the right side of the room, leaving all Lieutenants alive.
|tip You should use 4 tanks, one for each Lieutenant and one for Abyssal Commander Sivara.
|tip Garval the Vanquisher will cast "Rallying banner", which needs to be destroyed or you can move him away from it.
|tip Tideshaper Korvess will cast "Roaring Tides", which can be evaded by moving away from her while she channels.
|tip She will also cast "Soothing Currents", which will need to be interrupted.
|tip You can avoid interrupting this by keeping her away from Abyssal Commander Sivara.
|tip Gorjesh the Smasher will cast "Bellowing Roar" which must be interrupted every cast.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "You and What Army?" Achievement |achieve 13684
step
_Congratulations!_
You Earned the "You and What Army?" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Fun Run",{
author="support@zygorguides.com",
achieveid={13767},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Fun Run\" Achievement.",
},[[
step
kill Radiance of Azshara##152364
|tip During the encounter, you will need to run 6 consecutive laps without falling into the water.
|tip After 3 laps, you will get the debuff "Fun Run" if you are doing it correctly.
|tip After 3 more, the "Fun Run" buff will change, stating that you have Completed a full distance Fun Run.
|tip Save all cooldowns for "Stormwraith" adds that spawn during the encounter.
|tip It needs to die fast so you won't be pushed off by "Gale Buffet".
|tip Be on the look out for "Arcanado" as well as it can send you backwards, removing the "Fun Run" buff.
|tip Stormwraiths spawn in the 4 corners of the room.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "Fun Run" Achievement |achieve 13767
step
_Congratulations!_
You Earned the "Fun Run" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Intro to Marine Biology",{
author="support@zygorguides.com",
achieveid={13628},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Intro to Marine Biology\" Achievement.",
},[[
step
kill Blackwater Behemoth##154986
|tip Assign a few raid members to swim around the combat area and collect samples of marine biology.
|tip You will be able to collect Abyssal Clams, Depth Skulkers, Scavenging Crabs and Ventfeeder Worms.
|tip The achievement tracker is busted, so the players collecting will need to communicate to see how many have been collected.
|tip Collect 60 as opposed to 50 as the achievement states, as it is currently bugged.
|tip It will help if players collecting are tank spec'd so they don't get hit with the Toxic Spine ability.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "Intro to Marine Biology" Achievement |achieve 13628
step
_Congratulations!_
You Earned the "Intro to Marine Biology" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Simple Geometry",{
author="support@zygorguides.com",
achieveid={13629},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Simple Geometry\" Achievement.",
},[[
step
kill Lady Ashvane##153142
|tip When "Arcing Azerite" is cast, it will target 6 raid members.
|tip After 10 seconds, the spell will detonate, damaging anyone caught in the line between the pair that has been marked.
|tip The 3 pairs of players should move to opposite sides of Lady Ashvane as to not hit each other, or raid members.
|tip Each Arcing Azerite cast must hit Lady Ashvane for the achievement.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "Simple Geometry" Achievement |achieve 13629
step
_Congratulations!_
You Earned the "Simple Geometry" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\If It Please the Court",{
author="support@zygorguides.com",
achieveid={13633},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"If It Please the Court\" Achievement.",
},[[
step
kill Silivaz the Zealous##152853
|tip During the encounter, you will need to target Queen Azshara and use specific emotes depending on which decree is active.
|tip "Form Ranks" Decree - use the "/salute" emote on Queen Azshara.
|tip "Repeat Performance" Decree - use the "/cutsey" emote on Queen Azshara.
|tip "Stand Alone" Decree - use the "/applause" emote on Queen Azshara.
|tip "Deferred Sentence" Decree - use the "/grovel" emote on Queen Azshara.
|tip "Obey or Suffer" Decree - use the "/kneel" emote on Queen Azshara.
|tip This achievement is earned on Normal or higher difficulty.
|tip Continue doing this once per decree until recieving the "Queen's Favor" buff.
Earn the "If It Please the Court" Achievement |achieve 13633
step
_Congratulations!_
You Earned the "If It Please the Court" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\A Smack of Jellyfish",{
author="support@zygorguides.com",
achieveid={13724},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"A Smack of Jellyfish\" Achievement.",
},[[
step
kill Orgozoa##152128
|tip For this achievement, you will need to assign a person to stand on the edge of the platform outside of the boss room.
|tip They will catch the an egg that falls, then bring it to the boss area.
|tip Avoid "Hatchery Moulting" and "Eggsplosion" while on your way.
|tip It's important to note that you MUST NOT use any abilities, or you will drop the egg!
|tip Don't interrupt "Massive Incubator" early, whoever is transporting the egg will have a 30% movement speed reduction.
|tip Before killing the boss, make sure the egg carrier is afflicted with "Incubation Fluid", then defeat the boss.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "A Smack of Jellyfish" Achievement |achieve 13724
step
_Congratulations!_
You Earned the "A Smack of Jellyfish" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Lactose Intolerant",{
author="support@zygorguides.com",
achieveid={13716},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Lactose Intolerant\" Achievement.",
},[[
step
kill Za'qul##150859
|tip During the encounter, there will be 6 red runes on the ground.
|tip Use the raid interface to mark each of the red runes.
|tip During phase 4 of the encounter, have players stand in each of the red runes.
|tip They will afflicted with "Manic Dread", which will automatically be removed dealing damage.
|tip The red runes will be empowered with "Caustic Delirium".
|tip Once all the runes are active, a portal will open in the middle of the room.
|tip An extra action button will appear, pressing it will send you into the secret area.
|tip Kill 10 "Twinklehoof Bovines" as quickly as possible, as you have limited time to do so.
|tip After you have done so, defeat the boss.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "Lactose Intolerant" Achievement |achieve 13716
step
_Congratulations!_
You Earned the "Lactose Intolerant" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\The Best of Us",{
author="support@zygorguides.com",
achieveid={13768},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing \"The Best of Us\" Achievement.",
},[[
step
kill Queen Azshara##155126
|tip For this achievement, bring Queen Azshara down to about 500k health.
|tip Then, have the raid stay in the Ancient Wards save for 2 tanks and a healer.
|tip The 3 remaining players must then bring Queen Azshara down to 200k health then stop damaging her.
|tip Use the "Controlled Release" button until one of the 2 tanks gets the "Essence of Azeroth" buff.
|tip The tank that didn't get the buff and the healer now need to enter the Ancient Ward and die.
|tip Once only the tank with Essence of Azeroth is the only raid member left alive, they must kill the boss for the achievement.
|tip This achievement is earned on Normal or higher difficulty.
Earn the "The Best of Us" Achievement |achieve 13768
step
_Congratulations!_
You Earned the "The Best of Us" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Glory of the Eternal Raider",{
author="support@zygorguides.com",
achieveid={13687},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Glory of the Eternal Raider\" Achievement.",
},[[
step
Earn the "You and What Army?" Achievement |achieve 13687/1
|tip Refer to the "You and What Army?" achievement guide to accomplish this.
step
Earn the "Fun Run" Achievement |achieve 13687/2
|tip Refer to the "Fun Run" achievement guide to accomplish this.
step
Earn the "Intro to Marine Biology" Achievement |achieve 13687/3
|tip Refer to the "Intro to Marine Biology" achievement guide to accomplish this.
step
Earn the "Simple Geometry" Achievement |achieve 13687/4
|tip Refer to the "Simple Geometry" achievement guide to accomplish this.
step
Earn the "A Smack of Jellyfish" Achievement |achieve 13687/6
|tip Refer to the "A Smack of Jellyfish" achievement guide to accomplish this.
step
Earn the "If It Please the Court" Achievement |achieve 13687/5
|tip Refer to the "If It Please the Court" achievement guide to accomplish this.
step
Earn the "Lactose Intolerant" Achievement |achieve 13687/7
|tip Refer to the "Lactose Intolerant" achievement guide to accomplish this.
step
Earn the "The Best of Us" Achievement |achieve 13687/8
|tip Refer to the "The Best of Us" achievement guide to accomplish this.
step
_Congratulations!_
You Earned the "Glory of the Eternal Raider" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Dungeons & Raids\\Battle for Azeroth\\Mythic: Queen Azshara",{
author="support@zygorguides.com",
achieveid={13733},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Mythic: Queen Azshara\" Achievement.",
},[[
step
kill Queen Azshara##155126
|tip You must set the Raid Difficulty to Mythic to earn this achievement.
Earn the "Mythic: Queen Azshara" Achievement |achieve 13733 |goto The Eternal Palace/0 48.27,51.97
step
_Congratulations!_
You Earned the "Mythic: Queen Azshara" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\The Even More Horrific Vision of Orgrimmar",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete all objectives in the Horrific Vision of Orgrimmar "..
"in one visit.",
keywords={"Battle","for","Azeroth","8.3"},
achieveid={14065},
patch='80300',
startlevel=120,
},[[
step
Earn the "The Even More Horrific Vision of Orgrimmar" Achievement |achieve 14065
|tip To earn this achievement, complete all objectives in the Horrific Vision of Orgrimmar in one visit.
|tip Fully complete the "Horrific Vision of Orgrimmar" leveling guide in one run to earn this achievement.
step
_Congratulations!_
You Earned the "The Even More Horrific Vision of Orgrimmar" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\The Even More Horrific Vision of Stormwind",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete all objectives in the Horrific Vision of Stormwind "..
"in one visit.",
keywords={"Battle","for","Azeroth","8.3"},
achieveid={14064},
patch='80300',
...
step
Earn the "The Even More Horrific Vision of Stormwind" Achievement |achieve 14064
|tip To earn this achievement, complete all objectives in the Horrific Vision of Stormwind in one visit.
|tip Fully complete the "Horrific Vision of Stormwind" leveling guide in one run to earn this achievement.
step
_Congratulations!_
You Earned the "The Even More Horrific Vision of Stormwind" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\The Most Horrific Vision of Orgrimmar",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete all objectives in the Horrific Vision of Orgrimmar "..
"in one visit with all five Faceless Masks active.",
keywords={"Battle","for","Azeroth","8.3"},
achieveid={14067},
patch='80300',
startlevel=120,
...
step
Earn the "The Most Horrific Vision of Orgrimmar" Achievement |achieve 14067
|tip To earn this achievement, complete all objectives in the Horrific Vision of Orgrimmar in one visit with all five Faceless Masks active.
|tip Faceless Mask of the Long Night requires you to complete all five objectives in a single Horrific Vision.
|tip Faceless Mask of the Burned Bridge requires you to complete the Valley of Wisdom in the Horrific Vision of Orgrimmar with at least one mask active.
|tip Faceless Mask of the Daredevil requires you to complete the Valley of Honor in the Horrific Vision of Orgrimmar with at least one mask active.
|tip Faceless Mask of the Pained requires you to complete the Old Town in the Horrific Vision of Stormwind with at least one mask active.
|tip Faceless Mask of the Dark Imagination requires you to complete the Mage Quarter in the Horrific Vision of Stormwind with at least one mask active.
|tip Refer to our Horrific Vision guides to accomplish this.
step
_Congratulations!_
You Earned the "The Most Horrific Vision of Orgrimmar" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\The Most Horrific Vision of Stormwind",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete all objectives in the Horrific Vision of Stormwind "..
"in one visit with all five Faceless Masks active.",
keywords={"Battle","for","Azeroth","8.3"},
...
step
Earn the "The Most Horrific Vision of Stormwind" Achievement |achieve 14066
|tip To earn this achievement, complete all objectives in the Horrific Vision of Stormwind in one visit with all five Faceless Masks active.
|tip Faceless Mask of the Long Night requires you to complete all five objectives in a single Horrific Vision.
|tip Faceless Mask of the Burned Bridge requires you to complete the Valley of Wisdom in the Horrific Vision of Orgrimmar with at least one mask active.
|tip Faceless Mask of the Daredevil requires you to complete the Valley of Honor in the Horrific Vision of Orgrimmar with at least one mask active.
|tip Faceless Mask of the Pained requires you to complete the Old Town in the Horrific Vision of Stormwind with at least one mask active.
...
step
_Congratulations!_
You Earned the "The Most Horrific Vision of Stormwind" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\Reeking of Visions",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete all objectives in the Horrific Vision of Orgrimmar "..
...
step
_Congratulations!_
You Earned the "Reeking of Visions" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\The Shadows Revealed",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the following pet battle challenge dungeons:\n\n"..
...
keywords={"Battle","for","Azeroth","8.3","Pet","Battle"},
achieveid={14021},
patch='80300',
startlevel=120,
},[[
step
Earn the "Pet Battle Challenge: Wailing Caverns" Achievement |achieve 11765
|tip Use the "Wailing Caverns" pet battle dungeon guide to accomplish this.
step
Earn the "Pet Battle Challenge: Deadmines" Achievement |achieve 11856
|tip Use the "Deadmines" pet battle dungeon guide to accomplish this.
step
Earn the "Pet Battle Challenge: Gnomeregan" Achievement |achieve 13269
|tip Use the "Gnomeregan" pet battle dungeon guide to accomplish this.
step
Earn the "Pet Battle Challenge: Stratholme" Achievement |achieve 13627
|tip Use the "Stratholme" pet battle dungeon guide to accomplish this.
step
Earn the "Pet Battle Challenge: Blackrock Depths" Achievement |achieve 14020
|tip Use the "Blackrock Depths" pet battle dungeon guide to accomplish this.
step
Earn the "The Shadows Revealed" Achievement |achieve 14021
step
_Congratulations!_
You Earned the "The Shadows Revealed" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\Through the Depths of Visions",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the following achievements:\n\n Unwavering Resolve\n"..
"We Have the Technology\nThe Most Horrific Vision of Stormwind\nThe Most Horrific Vision of Orgrimmar",
keywords={"Battle","for","Azeroth","Horrific","Vision","Nzoth","N'zoth","8.3"},
achieveid={13994},
patch='80300',
startlevel=120,
},[[
...
|tip Refer to our Horrific Vision guides to accomplish this.
step
Earn the "Unwavering Resolve" Achievement |achieve 14060
|tip To earn this achievement, upgrade your legendary cloak to rank 15.
|tip Ashjra'kamas, Shroud of Resolve can be upgraded with Torn Pages from Horrific Vision chests.
|tip The bonus chests at the end of the run have a chance to contain Torn Pages.
|tip Complete the "Magni's Plan" leveling guide to accomplish this.
step
Earn the "We Have the Technology" Achievement |achieve 14061 |goto Chamber of Heart/0 46.34,70.41
|tip To earn this achievement, run horrific visions and collect Corrupted Mementos.
|tip Use the Corrupted Mementos that you collect to purchase every available research trait at the Titan Research Archive.
step
Earn the "Through the Depths of Visions" Achievement |achieve 13994
step
_Congratulations!_
You Earned the "Through the Depths of Visions" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\Unwavering Resolve",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to upgrade Ashjra'kamas, Shroud of Resolve to rank 15.",
keywords={"Battle","for","Azeroth","Horrific","Vision","Nzoth","N'zoth","8.3","Shroud","of","Ashjra'kamas"},
achieveid={14060},
patch='80300',
startlevel=120,
},[[
...
step
_Congratulations!_
You Earned the "Unwavering Resolve" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Expansion Features\\Visions of N'Zoth\\We Have the Technology",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to purchase every available research trait at the Titan"..
" Research Archive in the Chamber of Heart.",
achieveid={14061},
patch='80300',
startlevel=120,
keywords={"Battle","for","Azeroth","Horrific","Vision","Titan","Research"},
},[[
step
Earn the "We Have the Technology" Achievement |achieve 14061 |goto Chamber of Heart/0 46.34,70.41
|tip To earn this achievement, run horrific visions and collect Corrupted Mementos.
...
step
_Congratulations!_
You Earned the "We Have the Technology" Achievement.
]])
...
description="\nThis guide will walk you through completing the \"Battle for Azeroth Pathfinder, Part One\" Achievement.",
},[[
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to complete Part One, explore Mechagon Island and Nazjatar, "..
"and earn Revered reputation with the Rustbolt Resistance and Waveblade Ankoan.",
...
step
Reach Revered Reputation Status with the Waveblade Ankoan |condition rep('Waveblade Ankoan') >= Revered
|tip Use "Waveblade Ankoan" reputation guide to accomplish this.
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to explore the following areas on Mechagon Island:\n\nRustbolt\n"..
"Sparkweaver Point\nJunkwatt Depot\nThe Heaps\nScrapbone Den\nWestern Spray\nThe Outflow\nThe Fleeting Forest",
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to explore the following areas in Nazjatar:\n\nAshen Strand\n"..
...
step
Follow the path |goto Nazjatar/0 35.82,53.78 < 30 |only if walking
...
step
Explore The Hanging Reef |achieve 13712/10 |goto 43.11,61.06
step
Follow the path up |goto 41.48,62.29 < 20 |only if walking
Explore the Spears of Azshara |achieve 13712/13 |goto 37.88,72.24
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, collect ten crystalline cat figurines across Nazjatar",
keywords={"BFA"},
achieveid={13836},
patch='80200',
startlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will need to contribute to various construction projects "..
...
author="support@zygorguides.com",
description="\nTo earn this achievement you will need to craft 250 Junkyard Tinkering items at Pascal-K1N6 "..
...
author="support@zygorguides.com",
description="\nTo earn this achievement you will need to craft 50 Junkyard Tinkering items at Pascal-K1N6 "..
"in Rustbolt on Mechagon Island.",
keywords={"BFA","Tinkering","Rustbolt","Mechagon","Island"},
achieveid={13475},
patch='80200',
...
author="support@zygorguides.com",
description="\nTo earn this achievement you will need to craft 1,000 Junkyard Tinkering items at Pascal-K1N6 "..
"in Rustbolt on Mechagon Island.",
keywords={"BFA","Tinkering","Rustbolt","Mechagon","Island"},
achieveid={13476},
patch='80200',
...
author="support@zygorguides.com",
description="\nTo earn this achievement you will need to complete the \"Junkyard Tinkerer\" and "..
...
description="\nThis guide will walk you through completing the \"Kul Tiran Up the Dance Floor\" Achievement.",
},[[
step
...
description="\nTo earn this achievement, you will be required to discover each of the lore objects in Stormsong Valley that tell the legacy of the tidesages.",
},[[
step
...
description="\nTo earn this achievement, you will be required to kill the following fungarian villains in Zandalar:\n\nSkullcap\nBane of the Woods\nPortakilio\nToadcruel.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Sausage Sampler\" Achievement.",
},[[
step
...
description="\nTo earn this achievement, you will be required to collect all the junk items lost in the sands of Vol'dun.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Shanty Raid\" Achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Three Sheets to the Wind\" Achievement.",
},[[
step
talk Nicolas Moal##143487
buy Arathor Single Cask##163639 |n
Acquire the "Arathor Single Cask" Drink |achieve 13061/3 |goto Boralus/0 58.17,70.24
step
talk Nicolas Moal##143487
buy Corlain Estate 12 Year##163638 |n
Acquire the "Corlain Estate 12 Year" Drink |achieve 13061/7 |goto 58.17,70.24
step
talk Ruddy the Rat##142189
buy Patina Pale Ale##162560 |n
Acquire the "Patina Pale Ale" Drink |achieve 13061/16 |goto 69.3,29.8
step
talk Barserver Aspen##142760
buy Drop Anchor Dunkel##163019 |n
Acquire the "Drop Anchor Dunkel" Drink |achieve 13061/9 |goto 55.30,15.61
step
talk Barserver Aspen##142760
buy Pontoon Pilsner##163018 |n
Acquire the "Pontoon Pilsner" Drink |achieve 13061/17 |goto 55.30,15.61
step
talk Sarella Griffin##126601
buy Hook Point Porter##162026 |n
Acquire the "Hook Point Porter" Drink|achieve 13061/11 |goto Tiragarde Sound/0 49.78,25.13
step
talk Sarella Griffin##126601
buy Hook Point Schnapps##159849 |n
Acquire the "Hook Point Schnapps" Drink |achieve 13061/12 |goto 49.78,25.13
step
talk Sarella Griffin##126601
buy Tradewinds Kolsch##163098 |n
Acquire the "Tradewinds Kolsch" Drink |achieve 13061/21 |goto 49.78,25.13
step
talk "Nasty" Buck##138221
|tip Inside the building
buy "Aurora Borealis"##160484 |n
Acquire the "Aurora Borealis" Drink |achieve 13061/1 |goto Stormsong Valley/0 58.63,70.26
step
talk "Nasty" Buck##138221
|tip Inside the building
buy Brennadam Apple Brandy##159845 |n
|tip Collect it from the mail for credit.
Acquire the "Brennadam Apple Brandy" Drink |achieve 13061/6 |goto 58.63,70.26
step
talk Emma Haribull##135600
|tip Inside the building.
buy Foaming Turtle Broth##158927 |n
Acquire the "Foaming Turtle Broth" Drink|achieve 13061/10 |goto 44.4,54.2
step
talk Rebecca Barnes##141853
buy Dark and Stormy##163522 |n
|tip Collect it from the mail for credit.
Acquire the "Dark and Stormy" Drink |achieve 13061/8 |goto 41.22,50.20
step
Enter the cave |goto 48.81,56.68 < 15 |walk
click Long Forgotten Rum##292656
|tip Inside the cave.
buy Long Forgotten Rum##161153 |n
Acquire the "Long Forgotten Rum" Drink |achieve 13061/14 |goto 49.31,58.22
step
talk Barkeep Cotner##139638
buy Snowberry Berliner##163094 |n
Acquire the "Snowberry Berliner" Drink |achieve 13061/19 |goto Drustvar/0 21.04,66.08
step
talk Barkeep Cotner##139638
buy Sausage Martini##163651 |n
Acquire the "Sausage Martini" Drink |achieve 13061/18 |goto 21.04,66.08
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Mildenhall Mead##159847 |n
Acquire the "Mildenhall Mead" Drink |achieve 13061/15 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Bitter Darkroot Vodka##159850 |n
Acquire the "Bitter Darkroot Vodka" Drink |achieve 13061/4 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Thornspeaker Moonshine##163549 |n
Aqcuir the "Thornspeaker Moonshine" Drink |achieve 13061/20 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Whitegrove Pale Ale##159846 |n
Acquire the "Whitegrove Pale Ale" Drink |achieve 13061/22 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Kul Tiran Tripel##163548 |n
Acquire the "Kul Tiran Tripel" Drink |achieve 13061/13 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Blacktooth Bloodwine##159848 |n
Acquire the "Blacktooth Bloodwine" Drink |achieve 13061/5 |goto 21.50,43.59
step
talk Linda Deepwater##137040
|tip She walks around inside the cave.
buy Admiralty-Issued Grog##163103 |n
Acquire the "Admiralty-Issued Grog" Drink |achieve 13061/2 |goto 21.50,43.59
step
_Congratulations!_
...
description="\nThis guide will walk you through completing the \"Treasures of Drustvar\" achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Treasures of Nazmir\" achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Treasures of Stormsong Valley\" achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Treasures of Tiragarde Sound\" achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Treasures of Vol'dun\" achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Treasures of Zuldazar\" achievement.",
},[[
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, collect all of the Arcane Chests and Glowing Arcane Trunks in Nazjatar.",
keywords={"BFA"},
achieveid={13549},
patch='80200',
startlevel=120,
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"I Thought You Said They'd Be Rare?\" Achievement.",
},[[
step
Earn the "I Thought You Said They'd Be Rare?" Achievement |achieve 13556
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Outside Influences\" Achievement.",
},[[
step
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Rest In Pistons\" Achievement.",
},[[
step
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Junkyard Collector\" Achievement.",
},[[
step
...
accept Blueprint: Mechanocat Laser Pointer##55056 |goto Mechagon Island/0 63.35,42.95
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
...
accept Blueprint: G99.99 Landshark##55063 |goto 65.62,51.64
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
...
step
talk Pascal-K1N6##150359
turnin Blueprint: Beastbot Powerpack##55066 |goto 71.36,32.27
step
Unlock the "Beastbot Powerpack" Blueprint |achieve 13478/14
step
kill Mr. Fixthis##151627
collect Blueprint: BAWLD-371##168248 |n
accept Blueprint: BAWLD-371##55068 |goto 61.03,61.48
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
turnin Blueprint: BAWLD-371##55068 |goto 71.36,32.27
step
Unlock the "BAWLD-371" Blueprint |achieve 13478/15
step
...
accept Blueprint: Blue Spraybot##55077 |goto 82.45,20.94
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
turnin Blueprint: Blue Spraybot##55077 |goto 71.36,32.27
step
...
accept Blueprint: Anti-Gravity Pack##55081 |goto 65.84,79.14
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
...
|tip If she isn't in town, then you will need to wait a day for a chance for her to spawn.
|tip Complete the daily quest "Other Interests" to obtain the pattern.
|tip Refer to the "Mechagon Dailies" guide to accomplish this.
Unlock the "Encrypted Black Market Radio" Blueprint |achieve 13478/36 |goto 73.57,34.38
step
_Congratulations!_
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Junkyard Architect\" Achievement.",
},[[
step
...
step
Complete the "Recyclable Parts" Quest |condition completedq(56117)
|tip Refer to the "Mechagon Island" Guide to accomplish this
step
...
step
talk Pascal-K1N6##150359
accept This One's on Me##56181 |goto Mechagon Island/0 71.36,32.27
...
accept Blueprint: Extraordinary Adventurer Augment##56165 |goto 73.67,36.90
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
...
accept Blueprint: Canned Minnows##55057 |goto 34.78,43.36
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
turnin Blueprint: Canned Minnows##55057 |goto 71.36,32.27
step
Unlock the "Canned Minnows" Blueprint |achieve 13478/5
step
...
|tip You can obtain these by completing the "Cogfrenzy's Construction Frenzy" daily.
...
step
talk Oglethorpe Obnoticus##155254 |goto 72.78,37.97
...
accept Blueprint: Holographic Digitalization Relay##56086 |goto 62.83,56.72
|tip You will accept this quest automatically.
step
talk Pascal-K1N6##150359
...
Travel to the Alternate Timeline |havebuff spell:609811 |goto 70.21,30.91 |q 55070 |future
step
Kill enemies around Mechagon Island
...
step
talk Pascal-K1N6##150359
turnin Blueprint: Microbot XD##55079 |goto 71.36,32.27
step
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Junkyard Melomaniac\" Achievement.",
},[[
step
kill Steel Singer Freza##153226
collect Blueprint: Rustbolt Gramophone##168062 |n
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Puzzle Performer\" Achievement.",
},[[
step
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Mrrl's Secret Stash\" Achievement.",
},[[
step
...
step
talk Mrrl##152084
Check to see if he is selling the Crimson Tidestallion |goto 39.10,54.32 |achieve 13707
...
buy 288 Unidentified Mass##167912 |goto 39.96,53.44 |achieve 13707
step
talk Hurlgrl##151953
buy 48 Dirty Murlock Sock##167916 |n
use the Dirty Murlock Sock##167916
collect 48 Clean Murlock Sock##167923 |goto 38.64,54.46 |achieve 13707
Clean the socks here [38.08,52.97]
step
talk Grrmrlg##151951
buy 16 Sea Giant Foot Dust##167908 |goto 37.50,53.46 |achieve 13707
step
talk Mrrglrir##151950
|tip Runs in a circle around the area.
buy 210 Slimy Naga Eyeball##167896 |goto 38.40,54.42 |achieve 13707
step
talk Grrmrlg##151951
buy 70 Curious Murloc Horn##167905 |goto 37.50,53.46 |achieve 13707
step
talk Hurlgrl##151953
buy 14 Health Murloc Lunch##167913 |goto 38.64,54.46 |achieve 13707
step
talk Mrrglrir##151950
|tip Runs in a circle around the area.
buy 2 Pulsating Blood Stone##169780 |goto 38.40,54.42 |achieve 13707
step
talk Hurlgrl##151953
buy 129 Sweet Sea Vegetable##167915 |goto 38.64,54.46 |achieve 13707
step
talk Flrgrrl##151952
|tip Swimming in the water.
buy 32 Just Regular Butter##167911 |goto 39.96,53.44 |achieve 13707
step
talk Mrrglrir##151950
|tip Runs in a circle around the area.
buy 16 Smelly Pile of Gloop##167904  |goto 38.40,54.42 |achieve 13707
step
talk Mrrglrir##151950
|tip Runs in a circle around the area.
buy 504 Slimy Naga Eyeball##167896 |goto 38.40,54.42 |achieve 13707
step
talk Grrmrlg##151951
buy 168 Curious Murloc Horn##167905 |goto 37.50,53.46 |achieve 13707
step
talk Flrgrrl##151952
|tip Swimming in the water.
buy 28 Ghost Food## |goto 39.96,53.44 |achieve 13707
step
talk Hurlgrl##151953
buy 4 Cultists Pinky Finger##169783 |goto 38.64,54.46 |achieve 13707
step
talk Mrrl##152084
buy Crimson Tidestallion##169202 |n
use the Crimson Tidestallion##169202
Learn the "Crimson Tidestallion" Mount |learnmount Crimson Tidestallion##300153 |goto 39.10,54.32
step
_Congratulations!_
You Earned the "Mrrl's Secret Stash" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\A Fistful of Manapearls",{
author="support@zygorguides.com",
achieveid={13711},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"A Fistful of Manapearls\" Achievement.",
},[[
step
Collect 1,000 Prismatic Manapearls |achieve 13711
|tip These are a currency gathered through activities in the zone "Nazjatar".
|tip Rare spawns in this zone have a chance to drop them.
|tip When the "Nazjatar Commanders" spawn, each will give 2 per kill.
|tip Refer to the "Nazjatar Dailies" guide to accomplish this.
step
_Congratulations!_
You Earned the "A Fistful of Manapearls" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Aqua Team Murder Force",{
author="support@zygorguides.com",
achieveid={13762},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Aqua Team Murder Force\" Achievement.",
},[[
step
click Deepflame Bonfire
Reach Rank 30 with All of the Nazjatar Allies |achieve 13762 |goto Nazjatar/0 39.45,53.53
|tip Complete bodyguard quests using the "Nazjatar World Quest" guide.
|tip You will need to reach rank 30 with Farseer Ori, Hunter Akana and Bladesman Inowari.
|tip You can only gain one rank per day.
|tip If you don't miss doing the bodyguard quests, this will take around 90 days for all 3.
step
_Congratulations!_
You Earned the "Aqua Team Murder Force" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Subaquatic Support",{
author="support@zygorguides.com",
achieveid={13765},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Subaquatic Support\" Achievement.",
},[[
step
Complete 30 Bounty or Requistion Daily Quests in Nazjatar |achieve 13765
|tip These are available from NPCs around Newhome.
|tip Refer to the "Nazjatar Dailies" guide to accomplish this.
step
_Congratulations!_
You Earned the "Subaquatic Support" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Back to the Depths!",{
author="support@zygorguides.com",
achieveid={13763},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Back to the Depths!\" Achievement.",
},[[
step
label "Event_Begin"
Wait Here for the Event to Begin |scenariostart |goto Nazjatar/0 58.10,28.34
|tip This event happens when a server-wide emote appears.
|tip "The air crackles with power as Azshara's forces begin summoning a minion from the depths."
|tip This event occurs every 3 hours and you will only recieve a reward for completing it once per day.
step
Slay 12 Naga Forces |scenariostage 1 |scenariogoal 1/45239 |goto 58.10,28.34
step
Slay the Monstrosity |scenariogoal 2/45241 |goto 58.10,28.34
step
Complete the Summons From the Depths Scenario 10 Times |achieve 13763 |or
|tip
Click here to continue |confirm |next "Event_Begin" |or
step
_Congratulations!_
You Earned the "Back to the Depths!" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Nothing To Scry About",{
author="support@zygorguides.com",
achieveid={13713},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Nothing To Scry About\" Achievement.",
},[[
step
collect 10 Scrying Stone##167077
|tip These come from Rare Spawns in Nazjatar.
|tip Upon use, it will provide a 5 minute buff that allows you to search for chests.
|tip Use the PoI system to find Rare Spawns.
|tip You may not need as many depending on how quickly you loot the treasure and move on.
step
map Nazjatar/0
path loop off
path	53.00,53.60	53.30,55.20	54.30,55.20	55.00,56.50	56.10,57.60
path	57.90,57.70	56.90,55.20	55.50,52.20	54.80,49.10	56.30,45.60
path	57.80,45.70	58.10,44.30	58.60,42.10	60.00,41.70	60.20,45.20
path	59.10,47.40	56.90,49.80	58.20,53.00	59.30,53.00	59.90,52.00
path	61.50,51.90	60.00,54.70	60.50,56.20	62.80,57.10	64.10,57.20
path	67.50,51.50	68.50,51.50	69.70,52.50	70.9,51.20	72.50,50.30
path	73.00,48.70	71.60,48.20	69.50,47.90	68.80,46.20	68.10,48.70
path	67.00,47.40	67.20,43.90	64.30,44.20	63.50,46.50	63.10,48.20
path	62.60,46.20	62.00,44.50	63.50,41.10	62.50,38.20	64.30,39.60
path	65.60,38.20	65.30,41.00	67.10,39.10	67.20,41.30	68.90,41.20
use the Scrying Stone##167077
|tip Use it when near the first coordinate.
|tip Follow the path after gaining the buff.
|tip The buff will last for 5 minutes, so be sure to move quickly.
click Glimmering Chest##334736
|tip The treasure will appear at random in an area near the coordinate.
|tip Some searching may be required.
|tip You should have looted 50 treasures before moving to the next step.
Loot 50 Glimmering Chests |achieve 13713
step
map Nazjatar/0
path loop off
path	71.20,40.00	72.20,41.60	71.30,45.30	73.20,46.50	74.50,48.70
path	75.10,45.20	73.50,44.50	74.80,42.00	74.60,40.60	75.30,39.20
path	76.20,41.30	77.00,42.50	78.10,46.80	78.60,44.50	79.00,41.10
path	78.40,38.60	76.90,37.80	75.40,37.30	75.30,34.10	77.00,33.70
path	78.50,33.50	79.80,35.60	81.10,35.60	81.20,39.80	81.00,40.60
path	82.20,40.80	84.20,39.30	85.40,38.20	85.30,35.30	81.00,30.60
path	80.40,31.70	78.80,31.10	79.50,29.70	79.50,27.60	78.50,28.70
path	78.40,27.00	76.50,27.40	75.60,29.30	75.60,31.50	74.50,30.70
path	73.00,29.00	70.70,29.10	69.40,28.20	66.90,26.00	65.10,28.40
path	65.00,25.80	66.10,23.90	64.10,20.40	61.30,21.30	60.30,24.60
use the Scrying Stone##167077
|tip Use it when near the first coordinate.
|tip Follow the path after gaining the buff.
|tip The buff will last for 5 minutes, so be sure to move quickly.
click Glimmering Chest##334736
|tip The caches will appear at random in an area near the coordinate.
|tip Some Searching may be required.
Earn the "Nothing To Scry About" Achievement |achieve 13713
step
_Congratulations!_
You Earned the "Nothing To Scry About" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Terror of the Tadpoles",{
author="support@zygorguides.com",
achieveid={13722},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth,Terror,of,the,Tadpoles"},
description="\nThis guide will walk you through completing the \"Terror of the Tadpoles\" Achievement.",
},[[
step
talk Auctioneer Fitch##8719
buy Monel-Hardened Stirrups##152813 |goto Stormwind City/0 61.16,70.78
|tip These can be made with the Blacksmithing profession.
|tip This will allow you to interact while mounted in Battle for Azeroth zones.
Click here to continue |confirm
|tip Click the line above if you wish to skip this step.
step
talk Auctioneer Fitch##8719
buy Comfortable Rider's Barding##168419 |goto 61.16,70.78
|tip These can be made with the Leatherworking profession.
|tip This is optional, but it will prevent you from being dazed when equipped to your mount slot.
Click here to continue |confirm
|tip Click the line above if you wish to skip this step.
step
clicknpc Bloodfin Tadpole##152275
|tip They are found throughout the Bloodfin Village.
|tip Clicking them causes them to flee, which often triggers an attacker to come for you.
Shoo away 100 Bloodfin Tadpoles
Earn the "Terror of the Tadpoles" Achievement |achieve 13722 |goto Nazjatar/0 28.74,31.66
step
_Congratulations!_
You Earned the "Terror of the Tadpoles" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Periodic Destruction",{
author="support@zygorguides.com",
achieveid={13699},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Periodic Destruction\" Achievement.",
},[[
step
Kill enemies around this area
collect 7 Strange Mineralized Water##169332 |goto Nazjatar/0 29.31,32.60
|tip Equipping "Azsh'ari Stormsurger Handguards" will increase the drop rate of this item. |only if Hunter or Shaman
|tip Equipping "Fathomstalker Grips" will increase the drop rate of this item. |only if Druid or Rogue or Monk or DemonHunter
|tip Equipping "Shirakess Handwraps" will increase the drop rate of this item. |only if Mage or Priest or Warlock
|tip Equipping "Zanj'ir Scaleguard Crushers" will increase the drop rate of this item. |only if Paladin or Warrior or DeathKnight
|tip It is aqcuired through Benthic Gear found in Nazjatar.
step
Kill enemies around this area
collect 8 Strange Volcanic Rock##169333 |goto 29.31,32.60
|tip Equipping "Azsh'ari Stormsurger Handguards" will increase the drop rate of this item. |only if Hunter or Shaman
|tip Equipping "Fathomstalker Grips" will increase the drop rate of this item. |only if Druid or Rogue or Monk or DemonHunter
|tip Equipping "Shirakess Handwraps" will increase the drop rate of this item. |only if Mage or Priest or Warlock
|tip Equipping "Zanj'ir Scaleguard Crushers" will increase the drop rate of this item. |only if Paladin or Warrior or DeathKnight
...
step
Kill enemies around this area
collect 7 Strange Oceanic Sediment##169334 |goto 29.31,32.60
|tip Equipping "Azsh'ari Stormsurger Handguards" will increase the drop rate of this item. |only if Hunter or Shaman
|tip Equipping "Fathomstalker Grips" will increase the drop rate of this item. |only if Druid or Rogue or Monk or DemonHunter
|tip Equipping "Shirakess Handwraps" will increase the drop rate of this item. |only if Mage or Priest or Warlock
|tip Equipping "Zanj'ir Scaleguard Crushers" will increase the drop rate of this item. |only if Paladin or Warrior or DeathKnight
|tip It is aqcuired through Benthic Gear found in Nazjatar.
step
Enter the cave |goto 60.68,31.98 < 15 |walk
click Mardivas's Tome of the Elements
|tip Inside the cave.
accept The Laboratory of Mardivas##55121 |goto 60.66,33.29 |or
|tip This will only be available once per week.
'|achieve 13699/1 |or
step
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
|tip Don't use any reagents for this.
'|achieve 13699/1 |or
step
kill Arcane Amalgamation##155139 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/1 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
turnin The Laboratory of Mardivas##55121 |goto 60.66,33.29 |or
'|achieve 13699/1 |or
step
This Quest is Only Available Once Per Week
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,1) or achieved(13699) |or
'|achieve 13699/1 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Benthic Arcanocrystal with a "Strange Mineralized Water" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/2 |or
step
kill Watery Amalgamation##150846 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/2 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,2) or achieved(13699) |or
'|achieve 13699/2 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Pyroclasmic Arcanocrystal with a "Strange Volcanic Rock" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/3 |or
step
kill Burning Amalgamation##150926 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/3 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,3) or achieved(13699) |or
'|achieve 13699/3 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Lithic Arcanocrystal with a "Strange Oceanic Sediment" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/4 |or
step
kill Dusty Amalgamation##150862 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/4 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,4) or achieved(13699) |or
'|achieve 13699/4 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Benthic Arcanocrystal with a "Strange Mineralized Water".
|tip Then, activate the Greater Lithic Aranocrystal with a "Strange Oceanic Sediment" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/5 |or
step
kill Zomera##150848 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/5 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,5) or achieved(13699) |or
'|achieve 13699/5 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
|tip Inside the cave.
|tip Activate the Lesser Benthic Arcanocrystal with a "Strange Mineralized Water".
|tip Then, activate the Greater Pyroclasmic Aranocrystal with a "Strange Volcanic Rock" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/6 |or
step
kill Omus##151157 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/6 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,6) or achieved(13699) |or
'|achieve 13699/6 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
|tip Inside the cave.
|tip Activate the Lesser Benthic Arcanocrystal with a "Strange Mineralized Water".
|tip Then, activate the Greater Benthic Aranocrystal with a "Strange Mineralized Water" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/7 |or
step
kill Osgen##150856 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/7 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,7) or achieved(13699) |or
'|achieve 13699/7 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Pyroclasmic Arcanocrystal with a "Strange Volcanic Rock".
|tip Then, activate the Greater Lithic Aranocrystal with a "Strange Oceanic Sediment" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/8 |or
step
kill Moghiea##150928 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/8 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,8) or achieved(13699) |or
'|achieve 13699/8 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
'|achieve 13699/9 |or
step
kill Xue##150927 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/9 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,9) or achieved(13699) |or
'|achieve 13699/9 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
'|achieve 13699/10 |or
step
kill Ungormath##151155 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/10 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,10) or achieved(13699) |or
'|achieve 13699/10 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
clicknpc Elemental Essence Amalgamator##155101
|tip Inside the cave.
|tip Activate the Lesser Lithic Aranocrystal with a "Strange Oceanic Sediment".
|tip Then, activate the Greater Benthic Aranocrystal with a "Strange Mineralized Water" before using the Elemental Essence Amalgamator.
Activate the Elemental Essence Amalgamator |goto 59.84,33.93 |q 55121/1 |or
'|achieve 13699/11 |or
step
kill Spawn of Salgos##150863 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/11 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,11) or achieved(13699) |or
'|achieve 13699/11 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
'|achieve 13699/12 |or
step
kill Herald of Salgos##150864 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/12 |or
step
click Mardivas's Tome of the Elements
...
|tip You will need to wait until the weekly reset to continue progressing towards this achievement.
|tip This step will automatically advance when the quest is available again.
'|condition not completedq(55121) and achieved(13699,12) or achieved(13699) |or
'|achieve 13699/12 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
...
'|achieve 13699/13 |or
step
kill Salgos the Eternal##151154 |goto 59.74,34.55 |q 55121/2 |or
|tip Inside the cave.
'|achieve 13699/13 |or
step
click Mardivas's Tome of the Elements
|tip Inside the cave.
turnin The Laboratory of Mardivas##55121 |goto 60.66,33.29 |or
'|condition achieved(13699)
step
_Congratulations!_
You Earned the "Periodic Destruction" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Exploration\\Battle for Azeroth\\Nazjatarget Eliminated",{
author="support@zygorguides.com",
achieveid={13690},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Nazjatarget Eliminated\" Achievement.",
},[[
step
Defeat Queen Azhara's Champions in Nazjatar
|tip They are tied to World Quests and will only appear when their corresponding quest is active.
|tip Refer to the "Nazjatar World Quest" guide to accomplish this.
Click here to continue |confirm |achieve 13690
|tip Click the line above to check your progress.
step
Szun, Breaker of Slaves |achieve 13690/1
Frozen Winds of Zhiela |achieve 13690/2
Zoko, Her Iron Defender |achieve 13690/3
Tempest-Speaker Shalan'ali |achieve 13690/4
Starseeker of the Shirakess |achieve 13690/5
Azanz, the Slitherblade |achieve 13690/6
Undana, Chiling Assassin |achieve 13690/7
Kassar, Wielder of Dark Blades |achieve 13690/8
The Zanj'ir Brutalizer |achieve 13690/9
Champion Aldrantiss, Defender of Her Kingdom |achieve 13690/10
Champion Alzana, Arrow of Thunder |achieve 13690/11
Champion Eldanar, Shield of Her Glory |achieve 13690/12
Champion Kyx'zhul the Deepspeaker |achieve 13690/13
Champion Qalina, Spear of Ice |achieve 13690/14
Champion Vyz'algo the Mind-Taker |achieve 13690/15
step
_Congratulations!_
You Earned the "Nazjatarget Eliminated" Achievement.
]])
...
description="\nTo acquire this achievement, you must purchase the Battle of Azeroth collector's edition.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Feats of Strength\\Dungeons\\Battle for Azeroth Keystone Conqueror: Season Four",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the following Battle for Azeroth "..
...
patch='80300',
startlevel=120,
keywords={"Mythic","Plus"},
},[[
step
Complete the following dungeons on Mythic 10 difficulty or higher:
|tip To earn Mythic keystones, complete Mythic+ dungeons as fast as possible.
|tip You will need to consume at least 10 Mythic keystones to earn this achievement.
Atal'Dazar |achieve 14144/1 |only if not achieved(14144,1)
Freehold |achieve 14144/2 |only if not achieved(14144,2)
Kings' Rest |achieve 14144/3 |only if not achieved(14144,3)
Shrine of the Storm |achieve 14144/4 |only if not achieved(14144,4)
Siege of Boralus |achieve 14144/5 |only if not achieved(14144,5)
Temple of Sethraliss |achieve 14144/6 |only if not achieved(14144,6)
The MOTHERLODE!! |achieve 14144/7 |only if not achieved(14144,7)
The Underrot |achieve 14144/8 |only if not achieved(14144,8)
Tol Dagor |achieve 14144/9 |only if not achieved(14144,9)
Waycrest Manor |achieve 14144/10 |only if not achieved(14144,10)
Mechagon Junkyard |achieve 14144/11 |only if not achieved(14144,11)
Mechagon Workshop |achieve 14144/12 |only if not achieved(14144,12)
step
Earn the "Battle for Azeroth Keystone Conqueror: Season Four" Achievement |achieve 14144
step
_Congratulations!_
You Earned the "Battle for Azeroth Keystone Conqueror: Season Four" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Feats of Strength\\Dungeons\\Battle for Azeroth Keystone Master: Season Four",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the following Battle for Azeroth "..
...
step
Complete the following dungeons on Mythic 15 difficulty or higher:
|tip To earn Mythic keystones, complete Mythic+ dungeons as fast as possible.
|tip You will need to consume at least 15 Mythic keystones to earn this achievement.
Atal'Dazar |achieve 14145/1 |only if not achieved(14145,1)
Freehold |achieve 14145/2 |only if not achieved(14145,2)
Kings' Rest |achieve 14145/3 |only if not achieved(14145,3)
Shrine of the Storm |achieve 14145/4 |only if not achieved(14145,4)
Siege of Boralus |achieve 14145/5 |only if not achieved(14145,5)
Temple of Sethraliss |achieve 14145/6 |only if not achieved(14145,6)
The MOTHERLODE!! |achieve 14145/7 |only if not achieved(14145,7)
The Underrot |achieve 14145/8 |only if not achieved(14145,8)
Tol Dagor |achieve 14145/9 |only if not achieved(14145,9)
Waycrest Manor |achieve 14145/10 |only if not achieved(14145,10)
Mechagon Junkyard |achieve 14145/11 |only if not achieved(14145,11)
Mechagon Workshop |achieve 14145/12 |only if not achieved(14145,12)
step
Earn the "Battle for Azeroth Keystone Master: Season Four" Achievement |achieve 14145
step
_Congratulations!_
You Earned the "Battle for Azeroth Keystone Master: Season Four" Achievement.
]])
...
description="\nTo acquire this achievement, you were required to claim the Toy Armor Set during the 2018 Vintage Winter Veil event.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Feats of Strength\\Events\\Memories of Fel, Frost and Fire",{
achieveid={13931},
patch='80205',
author="support@zygorguides.com",
startlevel=120,
condition_end=function() return achieved(13931) end,
keywords={"15th","Anniversary","Obsidian","Worldbreaker"},
description="\nTo earn this achievement, you have to complete the Outland, Lich King, and Cataclysm timewalking raid bosses "..
"during WoW's 15th anniversary event.",
},[[
step
...
step
Earn the "Memories of Fel, Frost and Fire" Achievement |achieve 13931
step
_Congratulations!_
You Earned the "Memories of Fel, Frost and Fire" Achievement.
]])
...
description="\nTo earn this achievement, you will be required to complete Island Expeditions on five different islands.",
},[[
step
...
description="\nTo earn this achievement, you will be required to collect 1,000,000 azerite on Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to Dread Chain.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to win 10 PvP Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to win 20 PvP Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to win a PvP Island Expedition at Molten Cay.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to win 20 Island Expeditions on Heroic or higher difficulty.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Dread Chain on any difficulty.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to win 50 Island Expeditions on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to collect 30 globes of Azerite Energy on Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an Expedition to Havenswood on any difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP Expedition to Havenswood.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Dread Chain on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Havenswood on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Jorundall on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Molten Cay on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Rotting Mire on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Skittering Hollow on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Un'gol Ruins on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Verdant Wilds on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Whispering Reef on Heroic difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for a "Heroic" Island Expedition.
...
description="\nTo earn this achievement, you will be required to complete the following Mythic Island Expeditions achievements:\n\nMythic: Dread Chain\nMythic: Molten Cay\nMythic: Rotting Mire\nMythic: Skittering Hollow\nMythic: Un'gol Ruins\nMythic: Verdant Wilds\nMythic: Whispering Reef\nMythic: Jorundall\nMythic: Havenswood.",
},[[
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to earn the following PvP Island Expeditions achievements:\n\nReef Madness\nWar for the Wilds\nSkittering Smashed\nMire Marauder\nClash at the Cay\nBane of the Chain\nRuined the Ruins\nJorundall Justice\nHavenswood Hero.",
achieveid={13141},
patch='80001',
startlevel=120,
keywords={"Raid, BFA, Battle, for, Azeroth, Glory, of, Wartorn, Hero"},
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Jorundall.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to Jorundall.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to loot 100 Seafarer's Dubloons from Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an PvP expedition to Rotting Mire.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an Expedition to Molten Cay on any difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to loot 10 Seafarer's Dubloons from Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Dread Chain on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Havenswood on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Jorundall on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Molten Cay on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Rotting Mire on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Skittering Hollow on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Un'gol Ruins on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Verdant Wilds on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Whispering Reef on Mythic difficulty.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Mythic" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to win 10 Island Expeditions on Normal difficulty or higher.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to win 50 PvP Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to Whispering Reef.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Rotting Mire.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to Un'gol Ruins.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on an expedition to Skittering Hollow.",
},[[
step
clicknpc Expedition Map##143968
|tip Queue for any type of Island Expedition.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to Skittering Hollow.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to kill a player that is affected by a Sticky Starfish on Island Expeditions.",
},[[
step
clicknpc Expedition Map##143968
|tip Select "Player vs. Player" Island Expeditions.
...
description="\nTo earn this achievement, you will be required to achieve victory on a PvP expedition to the Verdant Wilds.",
},[[
step
...
description="\nTo earn this achievement you will need to claim victory in the Whispering Reef expedition on any difficulty.",
},[[
step
clicknpc Expedition Map##143967
...
Earn the "Whispering Reef" Achievement |achieve 13119 |goto Boralus/0 66.76,33.23
step
_Congratulations!_
...
description="\nTo earn this achievement, rescue all 25 of the explorers found on Island Expeditions.",
},[[
step
...
Earn the "Helping Hand" Achievement |achieve 13132 |goto Boralus/0 66.76,33.23
...
description="\nTo earn this achievement, need to collect the 28 battle pets that randomly drop from Island Expeditions.",
},[[
step
clicknpc Expedition Map##143967
|tip Queue for Island Expeditions.
...
Earn the "I'm Here for the Pets" Achievement  |achieve 13128 |goto Boralus/0 66.76,33.23
|tip Click the line above to track your progress.
step
_Congratulations!_
...
description="\nTo earn this achievement, you will need to kill the Alliance teams that appear in Island Expeditions.",
},[[
step
...
Click Here to Continue |confirm
step
kill Phoenix Mage Ryleia##129065 |achieve 13142/11
kill Sunbringer Firasi##129062 |achieve 13142/12
kill Phoenix Mage Rhydras##129064 |achieve 13142/10
step
kill Rune Scribe Lusaris##133734 |achieve 13142/9
kill Moonscythe Pelani##133733 |achieve 13142/8
kill Astralite Visara##133738 |achieve 13142/7
step
kill Gazlowe##134997 |achieve 13142/1
kill Skaggit##130871 |achieve 13142/3
kill Lady Sena##130872 |achieve 13142/2
step
kill Sneaky Pete##129364 |achieve 13142/6
kill Dorp##134333 |achieve 13142/5
kill Captain Greenbelly##134332 |achieve 13142/4
step
kill Sunwalker Ordel##134271 |achieve 13142/18
kill Spiritwalker Quura##134270 |achieve 13142/17
kill Mahna Flamewhisper##134269 |achieve 13142/16
step
kill Witch Doctor Unbugu##130303 |achieve 13142/15
kill Shadow Hunter Ju'loa##130301 |achieve 13142/14
kill Berserker Zar'ri##130302 |achieve 13142/13
step
kill Nagtar Wolfsbane##144785 |achieve 13142/20
kill Ranah Saberclaw##144789 |achieve 13142/21
kill Charg "The Boisterous"##144784 |achieve 13142/19
step
_Congratulations!_
...
description="\nCollect 20 items that are randomly dropped from Island Expeditions.",
},[[
step
label "Items"
...
description="\nTo earn this achievement you will be required to achieve victory on an expedition to Un'gol Ruins.",
},[[
step
clicknpc Expedition Map##143967
...
description="\nTo earn this achievement you will be required to achieve victory on an expedition to Verdant Wilds.",
},[[
step
clicknpc Expedition Map##143967
|tip Queue for an Island Expedition.
|tip There are a total of 9 maps but only 3 will be available each week.
|tip The 3 that are currently available are shown on the Weekly Scouting Report (the screen where you select expedition type and queue), make sure Verdant Wilds is shown.
Achieve Victory on an Expedition to Verdant Wilds |achieve 13111 |goto Boralus/0 66.76,33.23
step
_Congratulations!_
You Earned the "Verdant Wilds" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Pet Battles\\Battle for Azeroth\\Pet Battle Challenge: Blackrock Depths",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the Pet Battle Challenge in Blackrock Depths. ",
achieveid={14020},
patch='80300',
startlevel=120,
},[[
step
Complete the "Wailing Caverns" Pet Battle Challenge |achieve 11765
|tip Use the "Wailing Caverns" pet battle dungeon guide to accomplish this.
step
Complete the "Deadmines" Pet Battle Challenge |achieve 11856
|tip Use the "Deadmines" pet battle dungeon guide to accomplish this.
step
Complete the "Gnomeregan" Pet Battle Challenge |achieve 13269
|tip Use the "Gnomeregan" pet battle dungeon guide to accomplish this.
step
Complete the "Stratholme" Pet Battle Challenge |achieve 13627
|tip Use the "Stratholme" pet battle dungeon guide to accomplish this.
step
talk Tizzy Gearjolt##147645
accept Shadowy Showdown##58455 |goto Boralus/0 50.17,46.75
step
talk Burt Macklyn##161782
turnin Shadowy Showdown##58455 |goto Burning Steppes/16 33.07,23.13
step
talk Burt Macklyn##161782
accept Shadows of Blackrock##58457 |goto 33.07,23.13
step
talk Burt Macklyn##161782
Tell him _"I'm ready, send me into Blackrock Depths!"_
Enter Blackrock Depths |scenariostart |goto 33.07,23.13 |q 58457 |future
step
Approach the Center of the Arena |scenariogoal 1/46937 |goto BRD Pet Battle/0 41.26,50.05 |q 58457 |future
step
Watch the dialogue
talk Horu Cloudwatcher##160209
Tell him _"Begin pet battle."_
Defeat Horu Cloudwatcher |scenariogoal 2/46938 |goto 41.74,49.33 |q 58457 |future
step
Watch the dialogue
clicknpc Rampage##161649
Defeat the Caged Creature |scenariogoal 3/46939 |goto 41.73,49.34 |q 58457 |future
step
Watch the dialogue
talk Therin Skysong##160207
Tell him _"Begin pet battle."_
Defeat Therin Skysong |scenariogoal 4/46940 |goto 40.73,50.43 |q 58457 |future
step
Click the Caged Creature
Defeat the Caged Creature |scenariogoal 5/46942 |goto 41.89,50.41 |q 58457 |future
step
Click the Caged Creature
Defeat the Caged Creature |scenariogoal 5/46941 |goto 41.74,49.33 |q 58457 |future
step
Watch the dialogue
talk Alran Heartshade##160206
Tell him _"Begin pet battle."_
Defeat Alran Heartshade |scenariogoal 6/46943 |goto 41.73,49.33 |q 58457 |future
step
Watch the dialogue
talk Zuna Skullcrush##160208
Tell her _"Begin pet battle."_
Defeat Zuna Skullcrush |scenariogoal 7/46944 |goto 41.73,49.33 |q 58457 |future
step
Watch the dialogue
talk Tasha Riley##160210
Tell her _"Begin pet battle."_
Defeat Tasha Riley |scenariogoal 8/46945 |goto 41.12,49.07 |q 58457 |future
step
Watch the dialogue
talk Pixy Wizzle##160205
Tell her _"Begin pet battle."_
Defeat Pixy Wizzle |scenariogoal 9/46946 |goto 41.74,49.34 |q 58457 |future
step
Leave Blackrock Depths |goto Burning Steppes/16 33.40,23.49 < 1000 |c |noway |q 58457 |future
...
step
_Congratulations!_
You Earned the "Pet Battle Challenge: Blackrock Depths" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Pet Battles\\Battle for Azeroth\\Pet Battle Challenge: Gnomeregan",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will need to complete the Pet Dungeon Gnomeregan.",
achieveid={13269},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to collect 500 Polished Pet Charms.",
achieveid={12927},
patch='80001',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to earn the following pet battle achievements:\n\n"..
...
step
_Congratulations!_
You Earned the "Team Aquashock" Achievement.
]])
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Pet Battles\\Battle for Azeroth\\Pet Battle Challenge: Stratholme",{
author="support@zygorguides.com",
achieveid={13627},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Pet Battle Challenge: Stratholme\" Achievement.",
},[[
step
Earn the "Pet Battle Challenge: Stratholme" Achievement |achieve 13627
|tip Refer to the "Stratholme" Battle Pet Dungeon Guide to accomplish this.
step
_Congratulations!_
You Earned the "Pet Battle Challenge: Stratholme" Achievement.
]])
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to complete 20 Pet Battle World Quests on Zandalar and Kul Tiras with a full team of level 25 pets.",
achieveid={12936},
patch='80001',
startlevel=120,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Beast pets.",
achieveid={13270},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Critter pets.",
achieveid={13271},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Dragon pets.",
achieveid={13272},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Elemental pets.",
achieveid={13273},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Flying pets.",
achieveid={13274},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Aquatic pets.",
achieveid={13280},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Humanoid pets.",
achieveid={13281},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Mechanical pets.",
achieveid={13277},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Magic pets.",
achieveid={13275},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nThis guide will assist you in summoning and defeating Postmaster Malown in the Stratholme pet battle dungeon.",
achieveid={13766},
patch='80200',
startlevel=120,
},[[
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to defeat the following World Quest pets on Mechagon "..
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to defeat the following World Quest pets in Nazjatar:\n\n"..
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be required to defeat 15 Master Tamers on Kul Tiras or Zandalar with a team of all level 25 Undead pets.",
achieveid={13278},
patch='80100',
startlevel=110,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Battle Safari\" achievement.",
achieveid={12930},
patch='80001',
startlevel=110,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Master of Minons\" achievement.",
achieveid={12958},
patch='80001',
startlevel=110,
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to collect the following pets on Mechagon Island:\n\n"..
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will be have to collect the following pets in Nazjatar:\n\n"..
"Spireshell Snail\nMuck Slug\nSandclaw Sunshell\nAbyssal Slitherling\nChitterspine Skitterling\n"..
"Deeptide Fingerling\nSandclaw Pincher\nGlimmershell Scuttler\nHissing Chitterspine\nBloodseeker"..
"\nGreat Sea Albatross",
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Pet Emporium\" achievement.",
achieveid={12992},
patch='80001',
startlevel=110,
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Player vs. Player\\Alterac Valley\\Alterac Valley of Olde",{
author="support@zygorguides.com",
description="\nEarn 200 Timewarped Badges from doing quests and participating in Alterac Valley Classic.",
achieveid={13928},
patch='80205',
startlevel=120,
keywords={"Stormpike","Battle","Ram","15th","Anniversary"},
},[[
step
collect Anniversary Gift##172014 |or
|tip You can find it in your mailbox.
...
step
_Congratulations!_
You Earned the "Alterac Valley of Olde" Achievement.
]])
...
description="\nThis guide will walk you through completing the \"Catchin' Some Rays\" Achievement.",
},[[
step
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will need to catch the following daily fish on Mechagon Island:\n\n"..
...
author="support@zygorguides.com",
description="\nTo earn this achievement, you will need to collect the following secret fish:\n\nAncient Mana Fin\n"..
"Barbed Fjord Fin\nCamouflaged Snark\nCollectable Saltfin\nDead Fel Bone\nDeadeye Wally\nDeceptive Maw\n"..
...
collect Barbed Fjord Fin##167710 |achieve 13502/2 |goto Howling Fjord/0 59.26,61.85 |or
...
|tip Wait for the fish to stop moving and then click it.
|tip Continue clicking Secret fish until you catch it.
collect Jade Story Fish##167706 |achieve 13502/13 |goto The Jade Forest/0 46.03,84.64 |or
'|condition not hasbuff(1041266) and not achieved(13502) |next "Gain_Secret_Fish_Goggles_Buff" |or
step
click Secret Fish
|tip Every thirty seconds or so, a fish will spawn in a bubble and swim around.
...
|tip Wait for the fish to stop moving and then click it.
|tip Continue clicking Secret fish until you catch it.
collect Thunderous Flounder##167723 |achieve 13502/20 |goto Isle of Thunder/0 63.81,73.09 |or
'|condition not hasbuff(1041266) and not achieved(13502) |next "Gain_Secret_Fish_Goggles_Buff" |or
step
click Secret Fish
|tip Every thirty seconds or so, a fish will spawn in a bubble and swim around.
...
|tip Wait for the fish to stop moving and then click it.
|tip Continue clicking Secret fish until you catch it.
collect Queen's Delight##167728 |achieve 13502/17 |goto Nazjatar/0 38.63,53.30 |or
'|condition not hasbuff(1041266) and not achieved(13502) |next "Gain_Secret_Fish_Goggles_Buff" |or
step
click Secret Fish
|tip Every thirty seconds or so, a fish will spawn in a bubble and swim around.
|tip Wait for the fish to stop moving and then click it.
|tip Continue clicking Secret fish until you catch it.
collect Mechanized Mackerel##167705 |achieve 13502/15 |goto Mechagon Island/0 77.28,39.38 |or
'|condition not hasbuff(1041266) and not achieved(13502) |next "Gain_Secret_Fish_Goggles_Buff" |or
step
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Quests\\Battle for Azeroth\\The Fourth War",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to complete the War Campaign in its entirety.",
achieveid={13925},
patch='80205',
startlevel=120,
keywords={"War","Campaign"},
},[[
step
Earn the "The Fourth War" Achievement |achieve 13925
|tip To earn this achievement, fully complete the "War Campaign" leveling guide.
step
_Congratulations!_
You Earned the "The Fourth War" Achievement.
]])
...
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"The Mechagonion Threat\" Achievement.",
},[[
step
Complete the "A Tempered Blade" Quest |condition completedq(56156)
|tip Use the "Nazjatar" leveling guide to accomplish this.
...
step
talk Prince Erazmin##149816
accept Operation: Mechagon - The Mechoriginator##55609 |goto Mechagon Island/0 74.12,36.99
step
kill King Mechagon##155438 |goto Mechagon/0 21.31,65.02 |q 55609/1
|tip He's the final boss of the dungeon "Operation: Mechagon".
step
talk Prince Mechagon##153851
turnin Operation: Mechagon - The Mechoriginator##55609 |goto Mechagon/0 21.31,65.02
step
_Congratulations!_
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the \"Wide World of Quests\" Achievement.",
achieveid={13144},
patch='80001',
startlevel=110,
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Quests\\Battle for Azeroth\\Making the Mount",{
author="support@zygorguides.com",
achieveid={13791},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Making the Mount\" Achievement.",
},[[
step
...
|tip You will now be able to craft the Scrapforged Mechaspider mount.
]])
...
description="\nTo earn this achievement, you will be required to obtain the Heart of Azeroth.",
},[[
step
...
description="\nTo earn this achievement, you will be required to feed Bumbles in Stormsong Valley the Mildenhall Growth Formula.",
},[[
step
...
step
kill Bumbling Bee##141901+
collect Annealed Honey Amulet##163699 |goto Stormsong Valley/0 45.19,35.54 |q 53347 |future
step
label "Rosaline_Loop"
talk Rosaline Mildenhall##143128
|tip Inside the building.
Ask her _"I found this amulet, does it belong to you?"_
|tip Give Rosaline the Annealed Honey Amulet.
collect Rosaline's Letter##163702 |next "Accept_Bumbles_the_Bee" |goto Boralus/0 52.71,48.00 |q 53347 |future
Click Here to Continue |confirm
...
Ask her _"I found this amulet, does it belong to you?"_
|tip Give Rosaline the Annealed Honey Amulet.
collect Rosaline's Letter##163702 |next "Accept_Bumbles_the_Bee" |goto 55.5,62.9 |q 53347 |future
Click Here to Continue |confirm
|tip Click the line above if she isn't here.
step
talk Rosaline Mildenhall##143128
Ask her _"I found this amulet, does it belong to you?"_
|tip Give Rosaline the Annealed Honey Amulet.
collect Rosaline's Letter##163702 |next "Accept_Bumbles_the_Bee" |goto 58.1,55.3 |q 53347 |future
Click Here to Continue |confirm
|tip Click the line above if she isn't here.
step
talk Rosaline Mildenhall##143128
Ask her _"I found this amulet, does it belong to you?"_
|tip Give Rosaline the Annealed Honey Amulet.
collect Rosaline's Letter##163702 |next "Accept_Bumbles_the_Bee" |goto 72.4,73.3 |q 53347 |future
Click Here to Continue |confirm |next "Rosaline_Loop"
|tip Click the line above if she isn't here.
step
label "Accept_Bumbles_the_Bee"
talk Ancel Mildenhall##131793
...
step
label "Accept_Let's_Bee_Friends"
Enter the building |goto 70.75,69.13 < 5 |walk
talk Ancel Mildenhall##132647
|tip Inside the building.
...
step
Enter the building |goto 70.75,69.13 < 5 |walk
click Raimond's Secret Ingredient
|tip Inside the building.
...
step
You Must Complete This Daily Quest 7 Times
|tip This section will reset when you can complete the daily again.
'|condition not completedq(53371) |next "Accept_Let's_Bee_Friends" |or
'|condition achieved(13062) |or
step
Earn the "Let's Bee Friends" Achievement |achieve 13062 |or
step
_Congratulations!_
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Quests\\Battle for Azeroth\\Armed for Action",{
author="support@zygorguides.com",
achieveid={13790},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Armed for Action\" Achievement.",
},[[
step
label "Start_Step"
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Quests\\Battle for Azeroth\\Sunken Ambitions",{
author="support@zygorguides.com",
achieveid={13710},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Sunken Ambitions\" Achievement.",
},[[
step
Earn the "Sunken Ambitions" Achievement |achieve 13710
|tip Refer to the "Nazjatar" leveling guide to accomplish this.
step
_Congratulations!_
You Earned the "Sunken Ambitions" Achievement.
]])
...
description="\nThis guide will walk you through completing the \"80 Exalted Reputations\" Achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"90 Exalted Reputations\" Achievement.",
},[[
step
...
description="\nThis guide will walk you through completing the \"100 Exalted Reputations\" Achievement.",
},[[
step
...
description="\nTo earn this achievement, you will be required to earn the allegiance of the Dark Iron dwarves and welcome them into the Alliance.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Reputations\\Battle for Azeroth\\Allied Races: Mechagnome",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will complete the Mechagnome Allied Race questline.",
keywords={"Battle","for","Azeroth","8.3","N'zoth","Nzoth"},
achieveid={14013},
patch='80300',
startlevel=120,
},[[
...
step
Earn the "Allied Races: Mechagnome" Achievement |achieve 14013
step
_Congratulations!_
You Earned the "Allied Races: Mechagnome" Achievement.
]])
...
description="\nThis guide will walk you through completing the \"Azerothian Diplomat\" Achievement.",
},[[
step
...
description="\nTo earn this achievement, you will be requried to earn Exalted status with the 7th Legion.",
},[[
step
...
description="\nTo earn this achievement, you will be requried to earn Exalted status with the Champions of Azeroth.",
},[[
step
...
description="\nTo earn this achievement, you will be required to reach level 110 on a newly created Dark Iron dwarf character.",
},[[
step
Unlock the Dark Iron Dwarf race |achieve 12515
|tip Use the "Dark Iron Dwarf Race Unlock" guide to accomplish this.
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Reputations\\Battle for Azeroth\\Heritage of the Mechagnome",{
author="support@zygorguides.com",
description="\nTo earn this achievement, you will have to create a new Mechagnome character and level it to "..
"110 without using a character boost.",
keywords={"Battle","for","Azeroth","8.3","N'zoth","Nzoth"},
achieveid={14014},
patch='80300',
startlevel=120,
...
step
Earn the "Heritage of the Mechagnome" Achievement |achieve 14014
|tip To earn this achievement, create a new Mechagnome character and level it to 110 without using a character boost.
|tip Refer to our various leveling guides to help you accomplish this.
step
_Congratulations!_
You Earned the "Heritage of the Mechagnome" Achievement.
]])
...
description="\nTo earn this achievement, you will be requried to earn Exalted status with the Order of Embers.",
},[[
step
...
description="\nTo earn this achievement, you will be requried to earn Exalted status with Proudmoore Admiralty.",
},[[
step
...
description="\nTo earn this achievement, you will be requried to earn Exalted status with Storm's Wake.",
},[[
step
...
description="\nThis guide will walk you through completing the \"Tortollan Seekers\" Achievement.",
},[[
step
...
ZygorGuidesViewer:RegisterGuide("Achievement Guides\\Reputation\\Battle for Azeroth\\Waveblade Ankoan",{
author="support@zygorguides.com",
achieveid={13559},
patch='80200',
startlevel=120,
keywords={"Battle,for,Azeroth"},
description="\nThis guide will walk you through completing the \"Waveblade Ankoan\" Achievement.",
},[[
step
...
step
Unlock Nazjatar World Quests |condition completedq(54972)
|tip Use the "Nazjatar" leveling guide to accomplish this.
step
...
step
_Congratulations!_
You Earned the "Waveblade Ankoan" Achievement.
]])
...
step
kill Crackling Shard##158327+
|tip Have 3 people get the "Scales of Wrathion" buff in Phase 2.
|tip Have all of the debuffed players run over the shards at the same time.
|tip Demon Hunters and Monks are well-suited for this task with Fel Rush and Roll respectively.
|tip This must be done on normal difficulty or higher.
Earn the "Smoke Test" Achievement |achieve 14019 |goto Ny'alotha, the Waking City/9 51.10,80.18
step
_Congratulations!_
You Earned the "Smoke Test" Achievement.
]])
...
step
Earn the "Mana Sponge" Achievement |achieve 14008 |goto Ny'alotha, the Waking City/9 19.24,60.61
|tip During phase 2, you need to empower a Dark Manifestation and kill it along with Maut.
|tip Have a third tank pick up the Dark Manifestation and tank it in a Devoured Abyss until phase 2 begins.
|tip As soon as the Dark Manifestation transforms, use personal and raid cooldowns and burn it down.
|tip Kill it before it finishes casting "Obsidian Shatter."
|tip After it dies, kill Maut.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Mana Sponge" Achievement.
]])
...
step
Earn the "Phase 3: Prophet" Achievement |achieve 14037 |goto Ny'alotha, the Waking City/9 83.59,61.08
|tip Clear the trash to the boss room and the left corridor before Skitra.
|tip After pulling Prophet Skitra, pull the Disciple of the Prophet at the end of the left corridor.
|tip Use personal and raid cooldowns and burn down the disciples, then kill Prophet Skitra.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Phase 3: Prophet" Achievement.
]])
...
step
Earn the "Buzzer Beater" Achievement |achieve 14024 |goto Ny'alotha, the Waking City/6 53.30,45.07
|tip Have players get the "Voidwoken" debuff during the Dark Inquisitor Xanesh encounter by soaking "Void Ritual" zones.
|tip After, have the players bounce void orbs back and forth near a portal.
|tip When 3 seconds or less remain on the "Voidwoken" debuff, eliminate it.
|tip The orb will take 1-2 seconds to travel.
|tip After eliminating 3 orbs with 3 seconds or less left on the debuff, kill Dark Inquisitor Xanesh.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Buzzer Beater" Achievement.
]])
...
step
Earn the "Realizing Your Potential" Achievement |achieve 14023 |goto Ny'alotha, the Waking City/4 50.31,53.54
|tip Pick up 3 Promising Specimens before starting The Hivemind fight.
|tip One specimen is located near the entrance to Maw of Gor'ma.
|tip One specimen is located in the Ritual Chamber before Xanesh.
|tip One specimen is located just before The Hivemind.
|tip Shortly after starting the fight with the 3 adds alive, they will evolve.
|tip Use personal and raid cooldowns and burn them down, then finish the encounter.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Realizing Your Potential" Achievement.
]])
...
step
Earn the "You Can Pet the Dog, But..." Achievement |achieve 13990 |goto Ny'alotha, the Waking City/2 52.82,74.50
|tip Everyone in the raid must /pet Shad'har to get the "Bitten Hand" debuff before killing it.
|tip Each time a player pets Shad'har, it will gain a haste buff and not bite anyone for 5 seconds.
|tip Set up a rotation for players to /pet Shad'har every 5 seconds or so.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "You Can Pet the Dog, But..." Achievement.
]])
...
step
Earn the "Temper Tantrum" Achievement |achieve 14026 |goto Ny'alotha, the Waking City/1 32.42,56.91
|tip Kill tentacles until Drest'agath reaches 80 energy and then wait for at least 4 of them to respawn.
|tip Kill one tentacle to trigger "Throes of Agony" the first time.
|tip Immediately use personal and raid cooldowns and burn down the remaining tentacles and any new ones that spawn.
|tip If done correctly, "Throes of Agony" will be cast twice within 60 seconds.
|tip Finish the encounter.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Temper Tantrum" Achievement.
]])
...
step
Earn the "Total Annihilation" Achievement |achieve 14139 |goto Ny'alotha, the Waking City/7 32.89,50.79
|tip Every member of the raid needs to be struck by "Annihilation" at least 30 times before killing Vexiona.
|tip Have the entire group stack up while the tank faces the Void Ascendant towards them.
|tip Use cooldowns when the add begins casting "Annihilation."
|tip You will need to do this several times, alternation raid and personal cooldowns to survive.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Total Annihilation" Achievement.
]])
...
step
Earn the "How? Isn't it Obelisk?" Achievement |achieve 13999 |goto Ny'alotha, the Waking City/5 63.97,67.98
|tip You will need five players to direct the Unstable Void to at least two obelisks before killing Ra-den.
|tip Trigger "Void Empowerment" by killing the Vita Orb.
|tip The five designated players will need to face the obelisk while intercepting the Unstable Void.
|tip Each player will relay it closer until it destroys an obelisk.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "How? Isn't it Obelisk?" Achievement.
]])
...
step
Earn the "Bloody Mess" Achievement |achieve 14038 |goto Ny'alotha, the Waking City/0 48.90,31.18
|tip Defeat 10 Bloods of Ny'alotha in less than 3 seconds before killing Il'gynoth.
|tip The best time in the fight to do this is following the first intermission or at the end of the fight.
|tip Group at least 10 of them together and use personal and raid cooldowns to burn them down.
|tip You will also need to utilized defensive cooldowns.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Bloody Mess" Achievement.
]])
...
step
Earn the "Cleansing Treatment" Achievement |achieve 14147 |goto Ny'alotha, the Waking City/3 48.12,66.73
|tip You must kill all Synthesis Growths within 10 seconds of each other and then kill Fury of N'zoth.
|tip Split the group in two and maintain communication, burning each one down to around 10% health.
|tip Using personal cooldowns should be sufficient to finish them all off within 10 seconds.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "Cleansing Treatment" Achievement.
]])
...
step
Earn the "It's Not A Cult" Achievement |achieve 14148 |goto Ny'alotha, the Waking City/3 47.80,25.29
|tip At the end of the fight, all players must drop to 0 sanity to receive the "Gift of N'Zoth" debuff before killing him.
|tip Ensure every raid member is below 50 sanity and N'Zoth the Corruptor is around 15% health.
|tip Allow the Thought Harvester to finish the "Harvest Thoughts" cast and don't soak it.
|tip This should drop everyone to 0 sanity.
|tip Use personal and raid cooldowns and burn down N'Zoth the Corruptor.
|tip This must be done on normal difficulty or higher.
step
_Congratulations!_
You Earned the "It's Not A Cult" Achievement.
]])
...
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Smoke Test" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Mana Sponge" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Phase 3: Prophet" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Buzzer Beater" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Realizing Your Potential" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\You Can Pet the Dog, But..." 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Temper Tantrum" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Total Annihilation" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\How? Isn't it Obelisk?" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Bloody Mess" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\Cleansing Treatment" 1-1
leechsteps "Achievement Guides\\Dungeons & Raids\\Battle for Azeroth Raids\\It's Not A Cult" 1-1
step
Earn the "Glory of the Ny'alotha Raider" Achievement |achieve 14146
step
_Congratulations!_
You Earned the "Glory of the Ny'alotha Raider" Achievement.
]])
