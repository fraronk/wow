...
ZygorGuidesViewer:RegisterInclude("Sunreavers_dailies",[[
	...
	label "shanzemobs"
		...
		Burn Mummified Remains |q 32218/1 |only if havequest(32218)
...
ZygorGuidesViewer:RegisterInclude("BFA_Choose_World_Quests",[[
		...
		|tip Left-click on a world quest icon to select that world quest.
		|tip The guide will automatically load the steps for that world quest.
		'|confirm |next "Tortollan_Seekers_WQ" |condition (readyq(50604) or readyq(54451)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Horde_War_Effort_WQ" |condition (readyq(50606) or readyq(54455)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Zandalari_Empire_WQ" |condition (readyq(50598) or readyq(54462)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Talanjis_Expedition_WQ" |condition (readyq(50602) or readyq(54460)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Voldunai_WQ" |condition (readyq(50603) or readyq(54461)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Champions_of_Azeroth_WQ" |condition (readyq(50562) or readyq(54453)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Seacaller_Unow_Turnin" |condition (readyq(55777) or readyq(56223) or readyq(55776) or readyq(56226) or readyq(55775) or readyq(56227) or readyq(56225) or readyq(56222) or readyq(56224)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Suva_Turnin" |condition readyq(55766) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Slen_Darkroe_Turnin" |condition readyq(56151) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "The_Unshackled_WQ" |condition (readyq(56120) or readyq(53982)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Nevin_Tideheart_Turnin" |condition (readyq(55663) or readyq(55768)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Rustbolt_Resistance_WQ" |condition readyq(55348) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Rajani_WQ" |condition readyq(58096) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Uldum_Accord_WQ" |condition readyq(58097) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Nazjatar_Battle_Pet_Drop_Q" |condition haveanyquest(56445,56457,56459,56460,56461,56462,56463,56464,56465,56467,56458,56466) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Mechagon_Battle_Pet_Drop_Q" |condition haveanyquest(56437,56443,56442,56440,56441,56438,56439,56436) and not ZGV.WorldQuests:QuestsQueued()
		|worldquestqueue
]])
...
ZygorGuidesViewer:RegisterInclude("BFA_World_Quest_Emissaries",[[
	...
	label "Seacaller_Unow_Turnin"
		...
		turnin WANTED: Braxicus##55777 |goto Nazjatar/0 48.06,61.35 |only if havequest(55777)
		turnin WANTED: Commander Sarj'eth##56223 |goto Nazjatar/0 48.06,61.35 |only if havequest(56223)
		turnin WANTED: Emorneth##55776 |goto Nazjatar/0 48.06,61.35 |only if havequest(55776)
		turnin WANTED: Gler'thogg##56226 |goto Nazjatar/0 48.06,61.35 |only if havequest(56226)
		turnin WANTED: Haggronar##55775 |goto Nazjatar/0 48.06,61.35 |only if havequest(55775)
		turnin WANTED: Inquisitor Ithriza##56227 |goto Nazjatar/0 48.06,61.35 |only if havequest(56227)
		turnin WANTED: Lady Narjiss##56225 |goto Nazjatar/0 48.06,61.35 |only if havequest(56225)
		turnin WANTED: Lady Naz'jess##56222 |goto Nazjatar/0 48.06,61.35 |only if havequest(56222)
		turnin WANTED: Lord Ha'kass##56224 |goto Nazjatar/0 48.06,61.35 |only if havequest(56224)
		|only if haveanyquest(55777,56223,55776,56226,55775,56227,56225,56222,56224)
	step
	label "Suva_Turnin"
		talk Suva##153024
		|tip Inside the cave.
		turnin She Sells These Shells##55766 |goto Nazjatar/0 50.26,63.95
		|only if havequest(55766)
	step
	label "Slen_Darkroe_Turnin"
		talk Slen Darkroe##151635
		|tip Inside the cave.
		turnin Poen's Favorite Dish##56151 |goto Nazjatar/0 50.85,64.79
		|only if havequest(56151)
	step
	...
	label "Nazjatar_Battle_Pet_Drop_Q"
		...
		turnin Wiggletail's Poking Fork##56445 |goto Nazjatar/0 49.23,62.08 |only if havequest(56445)
		turnin Leathery Venom Gland##56457 |goto 49.23,62.08 |only if havequest(56457)
		turnin Half-Digested Deepcoral Pod##56459 |goto 49.23,62.08 |only if havequest(56459)
		turnin Molted Spineshell##56460 |goto 49.23,62.08 |only if havequest(56460)
		turnin Pearlescent Shell##56461 |goto 49.23,62.08 |only if havequest(56461)
		turnin Eel Jelly##56462 |goto 49.23,62.08 |only if havequest(56462)
		turnin Mottled Hydra Scale##56463 |goto 49.23,62.08 |only if havequest(56463)
		turnin Strange Organ##56464 |goto 49.23,62.08 |only if havequest(56464)
		turnin Overgrown Stone##56465 |goto 49.23,62.08 |only if havequest(56465)
		turnin Frenzy Fang##56467 |goto 49.23,62.08 |only if havequest(56467)
		turnin Opaline Conch##56458 |goto 49.23,62.08 |only if havequest(56458)
		turnin Crackling Mandible##56466 |goto 49.23,62.08 |only if havequest(56466)
		|only if haveanyquest(56445,56457,56459,56460,56461,56462,56463,56464,56465,56467,56458,56466)
	step
	label "Mechagon_Battle_Pet_Drop_Q"
		talk Vera Lonelycog##150629
		turnin Rusty Tube##56437 |goto Mechagon Island/0 69.27,30.65 |only if havequest(56437)
		turnin Mechanical Eye##56443 |goto 69.27,30.65 |only if havequest(56443)
		turnin Broken Unit 6##56442 |goto 69.27,30.65 |only if havequest(56442)
		turnin Can of Critter Spray##56440 |goto 69.27,30.65 |only if havequest(56440)
		turnin Cluckbox##56441 |goto 69.27,30.65 |only if havequest(56441)
		turnin Flashing Siren##56438 |goto 69.27,30.65 |only if havequest(56438)
		turnin Mechanical Egg Sac##56439 |goto 69.27,30.65 |only if havequest(56439)
		turnin Small Skull##56436 |goto 69.27,30.65 |only if havequest(56436)
		|only if haveanyquest(56437,56443,56442,56440,56441,56438,56439,56436)
	step
		|next "Choose_World_Quest"
]])