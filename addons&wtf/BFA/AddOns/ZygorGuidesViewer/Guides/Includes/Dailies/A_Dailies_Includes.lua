...
ZygorGuidesViewer:RegisterInclude("BFA_Choose_World_Quests",[[
		...
		'|confirm |next "Alliance_War_Effort_WQ" |condition (readyq(50605) or readyq(54454)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Order_of_Embers_WQ" |condition (readyq(50600) or readyq(54456)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Proudmoore_Admiralty_WQ" |condition (readyq(50599) or readyq(54458)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "Storms_Wake_WQ" |condition (readyq(50601) or readyq(54457)) and not ZGV.WorldQuests:QuestsQueued()
		...
		'|confirm |next "Lieutenant_Hawkins_Turnin" |condition (readyq(55845) or readyq(55777) or readyq(55770) or readyq(55776) or readyq(55773) or readyq(55775) or readyq(55774) or readyq(55772) or readyq(55750) or readyq(55771)) and not ZGV.WorldQuests:QuestsQueued()
		'|confirm |next "The_Ankoan_WQ" |condition (readyq(56119) or readyq(55976)) and not ZGV.WorldQuests:QuestsQueued()
		...
		'|confirm |next "Nazjatar_Battle_Pet_Drop_Q" |condition (haveanyquest(56444,56446,56447,56448,56449,56450,56451,56452,56453,56454,56455,56456)) and not ZGV.WorldQuests:QuestsQueued()
...
ZygorGuidesViewer:RegisterInclude("BFA_World_Quest_Emissaries",[[
	...
	label "Nazjatar_Battle_Pet_Drop_Q"
		...
		|tip Inside the building.
		turnin Wiggletail's Poking Fork##56444 |goto Nazjatar/0 37.85,55.71 |only if havequest(56444)
		turnin Leathery Venom Gland##56446 |goto 37.85,55.71 |only if havequest(56446)
		turnin Half-Digested Deepcoral Pod##56447 |goto 37.85,55.71 |only if havequest(56447)
		turnin Molted Spineshell##56448 |goto 37.85,55.71 |only if havequest(56448)
		turnin Pearlescent Shell##56449 |goto 37.85,55.71 |only if havequest(56449)
		turnin Eel Jelly##56450 |goto 37.85,55.71 |only if havequest(56450)
		turnin Mottled Hydra Scale##56451 |goto 37.85,55.71 |only if havequest(56451)
		turnin Strange Organ##56452 |goto 37.85,55.71 |only if havequest(56452)
		turnin Overgrown Stone##56453 |goto 37.85,55.71 |only if havequest(56453)
		turnin Crackling Mandible##56454 |goto 37.85,55.71 |only if havequest(56454)
		turnin Frenzy Fang##56455 |goto 37.85,55.71 |only if havequest(56455)
		turnin Opaline Conch##56456 |goto 37.85,55.71 |only if havequest(56456)
		|only if haveanyquest(56444,56446,56447,56448,56449,56450,56451,56452,56453,56454,56455,56456)
	step
	...
	label "Lieutenant_Hawkins_Turnin"
		...
		|tip Inside the building.
		turnin WANTED: Braxicus##55777 |goto Nazjatar/0 40.04,55.53 |only if havequest(55777)
		turnin WANTED: Commander Sarj'eth##55770 |goto Nazjatar/0 40.04,55.53 |only if havequest(55770)
		turnin WANTED: Emorneth##55776 |goto Nazjatar/0 40.04,55.53 |only if havequest(55776)
		turnin WANTED: Gler'thogg##55773 |goto Nazjatar/0 40.04,55.53 |only if havequest(55773)
		turnin WANTED: Haggronar##55775 |goto Nazjatar/0 40.04,55.53 |only if havequest(55775)
		turnin WANTED: Inquisitor Ithriza##55774 |goto Nazjatar/0 40.04,55.53 |only if havequest(55774)
		turnin WANTED: Lady Narjiss##55772 |goto Nazjatar/0 40.04,55.53 |only if havequest(55772)
		turnin WANTED: Lady Naz'jess##55750 |goto Nazjatar/0 40.04,55.53 |only if havequest(55750)
		turnin WANTED: Lord Ha'kass##55771 |goto Nazjatar/0 40.04,55.53 |only if havequest(55771)
		turnin Plans of Attack##55845 |goto Nazjatar/0 40.04,55.53 |only if havequest(55845)
		|only if haveanyquest(55777,55770,55776,55773,55775,55774,55772,55750,55771,55845)
	step
		|next "Choose_World_Quest"
]])
