...
ZygorGuidesViewer:RegisterInclude("Garrison_BAlexston",[[
		...
		|tip He's standing under a wooden awning near the north western exit. |only if garrisonlvl(1)
...
ZygorGuidesViewer:RegisterInclude("Garrison_BlueprintVendor",[[
		...
		|tip She's inside the Town Hall building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Crowler",[[
		...
		|tip He's standing near the top of the stairs. |only if garrisonlvl(2)
		|tip He's outside with the supplies next to the Town Hall building. |only if garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Morthis",[[
		Enter the cave |goto Lunarfall/0 41.23,79.37 < 7 |walk
...
ZygorGuidesViewer:RegisterInclude("Garrison_QMoonshadow",[[
		...
		|tip She's inside the Town Hall building. |only if garrisonlvl(1)
]])
