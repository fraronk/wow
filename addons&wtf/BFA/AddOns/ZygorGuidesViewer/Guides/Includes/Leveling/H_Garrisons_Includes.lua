...
ZygorGuidesViewer:RegisterInclude("Garrison_Gazlowe",[[
		...
		|tip He's standing just outside the Town Hall building. |only if garrisonlvl(1)
		|tip He's inside the Town Hall building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Grimjaw",[[
		...
		|tip He's standing just outside the Town Hall building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Saurfang",[[
		...
		|tip He's inside the Town Hall building. |only if garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Drix",[[
		...
		|tip He's standing just outside the Town Hall building. |only if garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Durotan",[[
		...
		|tip He's standing near the large fire in the northern part of the Garrison.
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_ArchitectTable",[[
		...
		|tip It looks like a slanted stone table with paper blueprints on it. |only if garrisonlvl(1)
		|tip It looks like a slanted wooden table with paper blueprints on it inside the Town Hall building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_CommandTable",[[
		...
		|tip It looks like a wooden table with a map laying open on it inside the Town Hall building.
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Warplans",[[
		...
		|tip It looks like a wooden table with a map laying open on it inside the Town Hall building. |only if garrisonlvl(2) or garrisonlvl(3)
]])
...
ZygorGuidesViewer:RegisterInclude("Garrison_Campaign",[[
	...
	label "crystals"
		...
		Deastroy #6# Felstorm Crystals |q 35191/1 |goto Shadowmoon Valley D/0 49.6,73.2
	step
		talk Anchorite Laanda##81530
...
ZygorGuidesViewer:RegisterInclude("Garrison_Inn_Quests",[[
	...
	step
		...
		only if havequest(37156) or havequest(37154)
	step
	...
	step
		...
		only if havequest(37150) or havequest(37165) or havequest(37166)
	step
	...
	step
		...
		|tip This could take a long time.
		only if havequest(37159) or havequest(37158)
	step
