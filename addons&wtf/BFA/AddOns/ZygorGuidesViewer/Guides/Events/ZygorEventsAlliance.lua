...
Defeat Bruce |condition ZGV:GetReputation(2011).friendRep>=250 |or
'|condition isdead |next "Queue_For_Bruce" |or
step
...
Defeat Thog Hammerspace |condition ZGV:GetReputation(2011).friendRep>=500 |or
'|condition isdead |next "Queue_For_Thog" |or
step
...
Defeat Grandpa Grumplefloot |condition ZGV:GetReputation(2011).friendRep>=750 |or
'|condition isdead |next "Queue_For_Grandpa_Grumplefloot" |or
step
...
Defeat Ash'katzuum |condition ZGV:GetReputation(2011).friendRep>=1000 |or
'|condition isdead |next "Queue_For_Ash'katzuum" |or
step
...
Defeat Blat |condition ZGV:GetReputation(2011).friendRep>=1250 |or
'|condition isdead |next "Queue_For_Blat" |or
step
...
Defeat Phillip Carter Tracey |condition ZGV:GetReputation(2011).friendRep>=1500 |or
'|condition isdead |next "Queue_For_Phillip_Carter_Tracey" |or
step
...
Defeat Johnny Awesome |condition ZGV:GetReputation(2011).friendRep>=1750 |or
'|condition isdead |next "Queue_For_Johnny_Awesome" |or
step
...
Defeat Mama Stormstout |condition ZGV:GetReputation(2011).friendRep>=2000 |or
'|condition isdead |next "Queue_For_Mama_Stormstout" |or
step
label "Queue_For_Oso"
talk Bizmo's Brawlpub Bouncer##68408
Tell him _"Yes, sign me up for a fight!"_
...
Defeat Oso the Betrayer |condition ZGV:GetReputation(2011).friendRep>=2250 |or
'|condition isdead |next "Queue_For_Oso" |or
step
...
Defeat Klunk |condition ZGV:GetReputation(2011).friendRep>=2500 |or
'|condition isdead |next "Queue_For_Klunk" |or
step
...
Defeat Farmer Xiang-Su |condition ZGV:GetReputation(2011).friendRep>=2750 |or
'|condition isdead |next "Queue_For_Farmer_Xiang-Su" |or
step
...
Defeat Ahoo'ru |condition ZGV:GetReputation(2011).friendRep>=3000 |or
'|condition isdead |next "Queue_For_Ahoo'ru" |or
step
...
Defeat Ouroboros |condition ZGV:GetReputation(2011).friendRep>=3250 |or
'|condition isdead |next "Queue_For_Ouroboros" |or
step
...
Defeat Sanoriak |condition ZGV:GetReputation(2011).friendRep>=3500 |or
'|condition isdead |next "Queue_For_Sanoriak" |or
step
...
Defeat the Spymaster |condition ZGV:GetReputation(2011).friendRep>=3750 |or
'|condition isdead |next "Queue_For_Spymaster" |or
step
...
Defeat the Warhammer Council |condition ZGV:GetReputation(2011).friendRep>=4000 |or
'|condition isdead |next "Queue_For_Warhammer_Council" |or
step
...
Defeat Meatball |condition ZGV:GetReputation(2011).friendRep>=4250 |or
'|condition isdead |next "Queue_For_Meatball" |or
step
...
Defeat Millie Watt |condition ZGV:GetReputation(2011).friendRep>=4500 |or
'|condition isdead |next "Queue_For_Millie_Watt" |or
step
...
Defeat Tidemistress Shellbreaker |condition ZGV:GetReputation(2011).friendRep>=4750 |or
'|condition isdead |next "Queue_For_Tidemistress_Shellbreaker" |or
step
...
Defeat Mingus Diggs |condition ZGV:GetReputation(2011).friendRep>=5000 |or
'|condition isdead |next "Queue_For_Mingus_Diggs" |or
step
...
Defeat Nibbleh |condition ZGV:GetReputation(2011).friendRep>=5250 |or
'|condition isdead |next "Queue_For_Nibbleh" |or
step
...
Defeat Stitches |condition ZGV:GetReputation(2011).friendRep>=5500 |or
'|condition isdead |next "Queue_For_Stitches" |or
step
...
Defeat Robe-Robber Robert |condition ZGV:GetReputation(2011).friendRep>=5750 |or
'|condition isdead |next "Queue_For_Robe-Robber_Robert" |or
step
...
Defeat Mecha-Bruce |condition ZGV:GetReputation(2011).friendRep>=6000 |or
'|condition isdead |next "Queue_For_Mecha-Bruce" |or
step
...
Defeat Hyper Mega-Mecha Seagull x9000 |condition ZGV:GetReputation(2011).friendRep>=6250 |or
'|condition isdead |next "Queue_For_Hyper_Mega-Mecha_Seagull_x9000" |or
step
...
Defeat Fran and Riddoh |condition ZGV:GetReputation(2011).friendRep>=6500 |or
'|condition isdead |next "Queue_For_Fran_and_Riddoh" |or
step
...
Defeat Blackmange |condition ZGV:GetReputation(2011).friendRep>=6750 |or
'|condition isdead |next "Queue_For_Blackmange" |or
step
...
Defeat the Ogrewatch |condition ZGV:GetReputation(2011).friendRep>=7000 |or
'|condition isdead |next "Queue_For_Ogrewatch" |or
step
_Congratulations!_
...
_Next to you:_
talk Liam##145394
turnin Children's Week##53811
accept The Mountain Folk##53859
accept Yo Ho, Yo Ho!##53861
accept The Squid Shrine##53862
step
use the Kul Tiran Orphan Whistle##164772
...
use the Kul Tiran Orphan Whistle##164772
|tip Ensure that you have your orphan, Liam, summoned.
Visit Shrine of the Storm |q 53862/1 |goto 72.59,49.92
step
Cross the bridge |goto Tiragarde Sound/0 77.94,84.16 < 10 |only if walking
use the Kul Tiran Orphan Whistle##164772
|tip Ensure that you have your orphan, Liam, summoned.
Visit Freehold |q 53861/1 |goto 79.82,82.50
step
use the Kul Tiran Orphan Whistle##164772
_Next to you:_
talk Liam##145394
turnin The Mountain Folk##53859
turnin Yo Ho, Yo Ho!##53861
turnin The Squid Shrine##53862
accept Bird Friends##53863
accept Shapeshifters!##53864
step
use the Kul Tiran Orphan Whistle##164772
|tip Ensure that you have your orphan, Liam, summoned.
...
_Next to you:_
talk Liam##145394
turnin Bird Friends##53863
turnin Shapeshifters!##53864
accept Return to the Orphanage##53865
step
Run up the stairs |goto Boralus/0 44.22,57.84 < 15 |only if walking
Run down the stairs |goto 41.65,44.93 < 15 |only if walking
Enter the building |goto 48.16,39.43 < 10 |walk
...
use Human Orphan Whistle##18598
|tip Use it to summon your Human Orphan, if needed.
Take Your Orphan to Visit King Magni in Old Ironforge |q 29106/1 |goto 34.40,51.26
step
use Human Orphan Whistle##18598
|tip Use it to summon your Human Orphan, if needed.
talk Human Orphan##14305
...
use the Human Orphan Whistle##18598
|tip Use it to summon your Human Orphan, if needed.
use Tigule and Foror's Strawberry Ice Cream##7228
Eat Tigule and Foror's Strawberry Ice Cream |achieve 1788/1
step
...
step
Complete the "Feast of Winter Veil Quests" guide |condition completedq(7045) |achieve 277 |future |only if level >= 60
...
buy 1 Pattern: Red Winter Clothes##34319 |goto 33.60,67.92 |achieve 277 |future
step
...
step
Reach Level 60 |ding 60 |achieve 1690 |future
step
...
step
Reach Level 60 |ding 60 |achieve 273 |future
step
talk Wulmort Jinglepocket##13433
...
step
Reach Level 60 |ding 60 |achieve 279 |future
step
talk Wulmort Jinglepocket##13433
...
accept You're a Mean One...##7043 |goto Ironforge 33.56,67.90 |only if level >= 60 and not completedq(7045)
step
talk Greatfather Winter##13444
...
|tip You must be level 100 to continue.
Click Here to Repeat the Level 60 Daily Quest |confirm |next "Reach_Level_60" |or
...
step
Click Here to Repeat the Daily Quests |confirm |next "Reach_Level_60"
|tip You will need to wait until the next server reset.
]])
...
|only if havequest(11360) or completedq(11360)
step
Click the Water Barrel |goto 42.73,62.01
|tip It looks like a large bucket of water.
Use the "Throw Bucket" ability to put out fires
...
|tip You will have to go back and get more water buckets from the water barrel.
|only if havequest(11440) or completedq(11440)
step
Click the Water Barrel |goto 42.73,62.01
|tip It looks like a large bucket of water.
Use the "Throw Bucket" ability to put out fires
...
|tip You will have to go back and get more water buckets from the water barrel.
|only if havequest(11439) or completedq(11439)
step
talk Costumed Orphan Matron##24519
turnin Fire Brigade Practice##11360 |goto 42.62,64.38 |only if havequest(11360) or completedq(11360)
turnin Fire Brigade Practice##11440 |goto 42.62,64.38 |only if havequest(11440) or completedq(11440)
turnin Fire Brigade Practice##11439 |goto 42.62,64.38 |only if havequest(11439) or completedq(11439)
step
...
talk Zidormi##141489
Ask her _"Can you show me what Darkshore was like before the battle?"_
Travel to the Past |condition ZGV.InPhase('Old Darnassus') |goto Darkshore/0 48.86,24.46 |q 8357 |future
step
...
step
talk Costumed Orphan Matron##24519
turnin Stop the Fires!##11131 |goto 42.62,64.39 |only if havequest(11131) or completedq(11131)
turnin "Let the Fires Come!"##12135 |goto 42.62,64.39 |only if havequest(12135) or completedq(12135)
turnin Smash the Pumpkin##12133 |goto 42.62,64.39 |only if havequest(12133) or completedq(12133)
step
talk Zidormi##141488
Tell her _"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?"_
Travel to the Past |condition ZGV.InPhase('Old Undercity') |goto Tirisfal Glades/0 69.45,62.80 |q 29371
step
...
step
Construct a Level 3 Garrison |condition garrisonlvl() == 3
...
click Water Bucket
Get a Water Bucket |havebuff 1063279 |goto Elwynn Forest/0 42.50,64.49
step
...
'|nobuff 1063279 |next "Get_Water_Bucket"
step
label "Earn_Achievement"
...
Visit the Candy Bucket in Stormwind, Trade District |q 12336 |future |goto Stormwind City/0 60.52,75.32
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Elwynn Forest, Goldshire |q 12286 |future |goto Elwynn Forest/0 43.74,65.89
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Redridge Mountains, Lakeshire |q 12342 |future |goto Redridge Mountains/0 26.47,41.50
step
click Candy Bucket##208144
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Loch Modan, Thelsamar |q 12339 |future |goto Loch Modan/0 35.54,48.49
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Loch Modan, Farstrider Lodge |q 28963 |future |goto 83.03,63.54
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Ironforge, The Commons |q 12335 |future |goto Ironforge/0 18.34,50.97
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Dun Morogh, Kharanos |q 12332 |future |goto Dun Morogh/0 54.49,50.76
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Wetlands, Menethil Harbor |q 12343 |future |goto Wetlands/0 10.82,60.96
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Wetlands, Swiftgear Station |q 28990 |future |goto 26.07,25.99
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Wetlands, Greenwarden's Grove |q 28991 |future |goto 58.21,39.20
step
talk Zidormi##141649
Ask her _"Can you show me what Arathi Highlands was like before the war broke out?"_
Travel to the Past |condition ZGV.InPhase('Old Arathi') |goto Arathi Highlands/0 38.24,90.09 |q 28954 |future
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Arathi Highlands, Refuge Point |q 28954 |future |goto 40.06,49.09
step
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Hinterlands, Aerie Peak |q 12351 |future |goto The Hinterlands/0 14.19,44.60
step
click Candy Bucket##208144
|tip It's inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Hinterlands, Stormfeather Outpost |q 28970 |future |goto 66.16,44.43
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Eastern Plaguelands, Light's Hope Chapel |q 12402 |future |goto Eastern Plaguelands/20 40.69,90.40
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Western Plaguelands, Chillwind Camp |q 28988 |future |goto Western Plaguelands/0 43.39,84.38
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Badlands, Dragon's Mouth |q 28956 |future |goto 20.86,56.31
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Swamp of Sorrows, Bogpaddle |q 28967 |future |goto Swamp of Sorrows/0 71.65,14.10
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Swamp of Sorrows, The Harborage |q 28968 |future |goto 28.93,32.40
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Westfall, Sentinel Hill |q 12340 |future |goto Westfall/0 52.91,53.74
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Duskwood, Darkshire |q 12344 |future |goto Duskwood/0 73.80,44.26
step
talk Zidormi##88206
Tell her: _"Show me the before the invasion"_
Travel to the Past |condition ZGV.InPhase('Old Blasted Lands') |goto Blasted Lands/0 48.16,7.28 < 5 |walk
step
click Candy Bucket##208144
|tip It's inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Blasted Lands, Nethergarde Keep |q 28960 |future |goto 60.69,14.08
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Blasted Lands, Surwich |q 28961 |future |goto 44.34,87.59
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Northern Stranglethorn, Fort Livingston |q 28964 |future |goto Northern Stranglethorn/0 53.16,66.98
step
click Candy Bucket##208144
|tip It's on the bottom floor of the tavern.
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in The Cape of Stranglethorn, Booty Bay |q 12397 |future |goto The Cape of Stranglethorn/0 40.91,73.72
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
Travel to the Past |condition ZGV.InPhase('Old Silithus') |goto Silithus/0 78.93,21.97 |q 12401 |future
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Silithus, Cenarion Hold |q 12401 |future |goto 55.47,36.79
step
click Candy Bucket##208144
|tip It's inside the building.
use the Handful of Treats##37586
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Hellfire Peninsula, Honor Hold |q 12352 |future |goto Hellfire Peninsula/0 54.27,63.66
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
Travel to the Past |condition ZGV.InPhase('OldUldum') |goto Uldum/0 56.02,35.14 |q 29017 |future
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Jade Forest, Tian Monastery |q 32021 |future |goto The Jade Forest/0 41.68,23.14
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Vale of Eternal Blossoms, Shrine of Seven Stars |q 32052 |future |goto Shrine of Seven Stars/1 37.81,65.92
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Dread Wastes, Klaxxi'vess |q 32024 |future |goto Dread Wastes/0 55.93,32.27
step
click Candy Bucket##208144
|tip Inside the building.
use the Handful of Treats##37586
...
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in The Legerdemain Lounge |q 43055 |future |goto 47.96,41.75
step
Enter the building |goto 45.07,59.94 < 10 |walk
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in Hero's Welcome |q 43056 |future |goto 41.47,64.02
step
click Candy Bucket##208144
use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
Visit the Candy Bucket in the Smug Harbor Inn. |q 54710 |future |goto Boralus/0 73.70,12.19
]])
...
'|condition completedq(24656) |or
step
Follow the path |goto Elwynn Forest/0 31.88,48.88 < 15 |only if walking
Get the Crown Chemical Co. Package |condition hasbuff("spell:71459") |q 24656 |goto Stormwind City/0 78.75,89.34 |or
|tip Quickly run by the boxes to get the package.
'|condition not hasbuff("spell:71450") and not readyq(24656) and not completedq(24656) |next "Gain_Crown_Parcel_Service_Uniform_Buff" |or
step
Return the Crown Chemical Co. Package |condition readyq(24656) or completedq(24656) |goto 61.51,75.27 |or
...
'|condition (not hasbuff("spell:71450") or not hasbuff("spell:71459")) and not readyq(24656) and not completedq(24656) |next "Gain_Crown_Parcel_Service_Uniform_Buff" |or
step
talk Inspector Snip Snagglebolt##38066
...
author="support@zygorguides.com",
condition_suggested=function() return isevent('Love is in the Air') and completedq(24657) and not completedanyq(44558,24629,24635,24636,24597,44560,24610,24611,24609) end,
...
Complete the "Love is in the Air Main Questline" guide before using this guide |condition completedq(24657)
step
talk Inspector Snip Snagglebolt##38066
...
step
talk Inspector Snip Snagglebolt##38066
turnin Crushing the Crown##44558 |goto Stormwind City/0 61.51,75.27 |only if havequest(44558) or completedq(44558)
turnin Follow the Recipe##44560 |goto 61.51,75.27 |only if havequest(44560) or completedq(44560)
|only if haveanyquest(44558,44560) or completedanyq(44558,44560)
step
talk Public Relations Agent##37675
turnin A Perfect Puff of Perfume##24629 |goto 62.41,75.38 |only if havequest(24629) or completedq(24629)
turnin A Cloudlet of Classy Cologne##24635 |goto 62.41,75.38 |only if havequest(24635) or completedq(24635)
turnin Bonbon Blitz##24636 |goto 62.41,75.38 |only if havequest(24636) or completedq(24636)
...
talk Zidormi##141489
Ask her _"Can you show me what Darkshore was like before the battle?"_
Travel to the Past |condition ZGV.InPhase('Old Darnassus') |goto Darkshore/0 48.86,24.46 |q 24610 |future
step
talk Kwee Q. Peddlefeet##16075
...
'|condition not completedanyq(44558,24629,24635,24636,24597,44560,24610,24611,24609) |next "Complete_Leveling_Guide"
]])
...
'|condition achieved(1279) |or
step
talk Bruuk Barleybeard##5570
|tip Inside the building.
buy 6 Cherry Grog##4600 |goto Ironforge/0 72.52,76.95 |only if level >= 25
buy 6 Flagon of Dwarven Mead##2594 |goto 72.52,76.95 |only if level < 25 |or
'|condition achieved(1279) |or
step
...
use the Cherry Grog##4600 |only if level >= 25
use the Flagon of Dwarven Mead##2594 |only if level < 25
|tip Use all 6 of your Cherry Grog to get Completely Smashed. |only if level >= 25
|tip Use all 6 of your Flagons of Dwarven Mead to get Completely Smashed. |only if level < 25
...
'|condition achieved(1697,4) |or
step
Kill enemies that yield experience
|tip Any enemy that is green, yellow, or red difficulty will drop charms.
|tip You can kill enemies in dungeons or the open-world zone of your choice.
collect 40 Lovely Charm##49655 |or
'|condition achieved(1697) |or
step
use the Lovely Charm##49655
...
talk Zidormi##141489
Ask her _"Can you show me what Darkshore was like before the battle?"_
Travel to the Past |condition ZGV.InPhase('Old Darnassus') |goto Darkshore/0 48.86,24.46 |q 8715 |future
step
talk Elder Bladeleaf##15595
accept Bladeleaf the Elder##8715 |goto Teldrassil/0 56.85,53.10
step
...
step
talk Earthen Ring Elder##26221
accept Striking Back##11917 |goto 49.32,72.27 |only if level >= 22 and level <= 31
accept Striking Back##11947 |goto 49.32,72.27 |only if level >= 32 and level <= 42
accept Striking Back##11948 |goto 49.32,72.27 |only if level >= 43 and level <= 50
accept Striking Back##11952 |goto 49.32,72.27 |only if level >= 51 and level <= 59
accept Striking Back##11953 |goto 49.32,72.27 |only if level >= 60 and level <= 63
accept Striking Back##11954 |goto 49.32,72.27 |only if level >= 64
step
talk Zidormi##128607
|tip She is at the top of the ramp leading from Un'Goro Crater to Silithus.
Ask her _"Can you show me what Silithus was like before the Wound in the World?"_
Travel to the Past |condition ZGV.InPhase('Old Silithus') |goto Silithus/0 78.93,21.97 |q 11953 |future
|only if havequest(11953)
step
click Ice Stone##188149
|tip Inside the cave. |only if havequest(11952)
Choose _"Lay your hand on the stone"_
kill Frostwave Lieutenant##26116 |q 11917/1 |goto Ashenvale/0 9.62,12.20 |only if havequest(11917)
kill Hailstone Lieutenant##26178 |q 11947/1 |goto Desolace/0 40.35,30.27 |only if havequest(11947)
kill Chillwind Lieutenant##26204 |q 11948/1 |goto Northern Stranglethorn/0 21.31,40.95 |only if havequest(11948)
Enter the cave |goto Searing Gorge/0 21.83,36.18 < 20 |walk |only if havequest(11952)
kill Frigid Lieutenant##26214 |q 11952/1 |goto 16.02,36.86 |only if havequest(11952)
kill Glacial Lieutenant##26215 |q 11953/1 |goto 68.88,20.44 |only if havequest(11953)
kill Glacial Templar##26216 |q 11954/1 |goto Hellfire Peninsula/0 85.64,47.09 |only if havequest(11954)
step
talk Earthen Ring Elder##26221
turnin Striking Back##11917 |goto Stormwind City/0 49.32,72.27 |only if havequest(11917)
turnin Striking Back##11947 |goto Stormwind City/0 49.32,72.27 |only if havequest(11947)
turnin Striking Back##11948 |goto Stormwind City/0 49.32,72.27 |only if havequest(11948)
turnin Striking Back##11952 |goto Stormwind City/0 49.32,72.27 |only if havequest(11952)
turnin Striking Back##11953 |goto Stormwind City/0 49.32,72.27 |only if havequest(11953)
turnin Striking Back##11954 |goto Stormwind City/0 49.32,72.27 |only if havequest(11954)
step
You have completed all available dailies
|tip This guide will reset when more become available.
'|condition not completedanyq(11921,11924,11917,11947,11948,11952,11953,11954) |next "Begin_Daily_Quests"
]])
...
Travel to the Past |condition ZGV.InPhase('Old Blasted Lands') |goto Blasted Lands/0 48.16,7.28 |q 11808 |future
step
...
talk Zidormi##141649
Ask her _"Can you show me what Arathi Highlands was like before the war broke out?"_
Travel to the Past |condition ZGV.InPhase('Old Arathi') |goto Arathi Highlands/0 38.24,90.09 |q 11804 |future
step
...
talk Zidormi##141488
Tell her _"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?"_
Travel to the Past |condition ZGV.InPhase('Old Undercity') |goto Tirisfal Glades/0 69.45,62.80 |q 11786 |future
step
click Horde Bonfire##194039
...
talk Zidormi##141489
Ask her _"Can you show me what Darkshore was like before the battle?"_
Travel to the Past |condition ZGV.InPhase('Old Darnassus') |goto Darkshore/0 48.86,24.46 |q 11811 |future
step
...
turnin Honor the Flame##29030 |goto 62.83,22.89
step
click Horde Bonfire##194039
...
|tip She is at the top of the ramp leading from Un'Goro Crater to Silithus.
Ask her _"Can you show me what Silithus was like before the Wound in the World?"_
Travel to the Past |condition ZGV.InPhase('Old Silithus') |goto Silithus/0 78.93,21.97 |q 11831 |future
step
...
talk Zidormi##162419
Ask her _"Can you show me what Uldum was like during the time of the Cataclysm?"_
Travel to the Past |condition ZGV.InPhase('OldUldum') |goto Uldum/0 56.02,35.14 |q 28950 |future
step
...
talk Zidormi##141488
Tell her _"Can you show me what Tirisfal Glades was like before the Battle for Lordaeron?"_
Travel to the Past |condition ZGV.InPhase('Old Undercity') |goto Tirisfal Glades/0 69.45,62.80 |q 9326 |future
step
...
talk Zidormi##141649
Ask her _"Can you show me what Arathi Highlands was like before the war broke out?"_
Travel to the Past |condition ZGV.InPhase('Old Arathi') |goto Arathi Highlands/0 38.24,90.09 |q 11764 |future
step
talk Arathi Flame Warden##25887
accept Honor the Flame##11804 |goto 44.30,46.04
step
...
|tip This guide will reset when more become available.
'|condition not completedq(13480) |next "Begin_Daily_Quests"
]])
...
Plant a Flower in the Badlands |achieve 2436/2 |goto Desolace/0 64.67,10.44
step
...
author="support@zygorguides.com",
description="\nUse Spring Flowers to place rabbit ears upon players of at least 18th level of the following races:\n\n"..
"Blood Elf\nDraenei\nDwarf\nGnome\nGoblin\nHuman\nNight Elf\nOrc\nTauren\nTroll\nUndead\nWorgen",
condition_suggested=function() return isevent('Noblegarden') end,
achieveid={2422},
patch='30100',
...
'Incursion Detected -  Tiragarde Sound |condition invasion(5896,876) |next "A_Sound_Defense" |only if invasion(5896,876) and not completedq(53711)
'Incursion Detected -  Vol'dun |condition invasion(5970,875) |next "Many_Fine_Heroes" |only if invasion(5970,875) and not completedq(54134)
'Incursion Detected -  Stormsong Valley |condition invasion(5966,876) |next "Storms_Rage" |only if invasion(5966,876) and not completedq(51982)
'Incursion Detected -  Nazmir |condition invasion(5969,875) |next "March_On_The_Marsh" |only if invasion(5969,875) and not completedq(54136)
'Incursion Detected -  Zuldazar |condition invasion(5973,875) |next "Ritual_Rampage" |only if invasion(5973,875) and not completedq(54138)
'Incursion Detected -  Drustvar |condition invasion(5964,876) |next "A_Drust_Cause" |only if invasion(5964,876) and not completedq(53701)
step
