...
condition_suggested=function() return level == 120 and rep('Rajani') < Exalted end,
...
keywords={"8.3","N'zoth","Nzoth","Corruption"},
condition_suggested=function() return level == 120 and rep('Uldum Accord') < Exalted end,
...
step
Reach Exalted Reputation with the Uldum Accord |condition rep('Uldum Accord') == Exalted
