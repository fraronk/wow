...
You must stand next to Ilyssia of the Waters and obtain the buff _Something's Fishy_
...
Become best friends with Ilyssia of the Waters |condition rep("Ilyssia of the Waters")>=BestFriend |goto Azsuna/0 43.20,40.62 |or
step
_Congratulations!_
...
Become best friends with Impus |condition rep("Impus")>=BestFriend |goto Broken Shore/0 33.72,49.98 |or
step
_Congratulations!_
...
Become best friends with Corbyn |condition rep("Corbyn")>=BestFriend |goto Stormheim/0 90.51,10.71 |or
step
_Congratulations!_
...
Become best friends with Keeper Raynae |condition rep("Keeper Raynae")>=BestFriend |goto Val'sharah/0 53.39,72.86
step
_Congratulations!_
...
Become best friends with Sha'leth |condition rep("Sha'leth")>=BestFriend |goto Suramar/0 50.70,49.31 |or
step
_Congratulations!_
...
Become best friends with Akule Riverhorn |condition rep("Akule Riverhorn")>=BestFriend |goto Thunder Totem/0 32.39,41.75 |or
step
_Congratulations!_
...
Gain Exalted reputation with the Argussian Reach |condition rep("Argussian Reach")>=Exalted
step
_Congratulations!_
...
Gain Exalted reputation with the Army of the Light |condition rep("Army of the Light")>=Exalted
step
_Congratulations!_
...
condition_suggested=function() return level >= 100 and level <= 110 and rep('The Nightfallen') < Exalted end,
achieveid={10778},
patch='70003',
},[[
step
