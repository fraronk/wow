...
step
talk Bor Wildmane##15306
accept Encrypted Twilight Texts##8319 |instant |repeatable |goto Silithus,53.2,35.1
...
step
Reach "Friendly" Reputation with The Defilers |condition rep('The Defilers') >= Friendly
...
Travel to the Past |condition ZGV.InPhase('Old Arathi') or rep('The Defilers') == Exalted |goto Arathi Highlands/0 38.24,90.09
step
...
step
Reach "Exalted" Reputation with The Defilers |condition rep('The Defilers') == Exalted
|tip Use the Player vs. Player Group Finder tool and queue for Arathi Basin.
|tip If the "Comp Stomp Brawl" bonus battleground is avalable, queue for that instead.
|tip Continue running these battlegrounds for reputation.
step
...
turnin Mouton Flamestar##28515 |only if havequest(28515) |goto 17.0,51.3
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through getting Neutral reputation with Netherwing faction.",
achieveid={898},
patch='30003',
},[[
step
...
step
talk Gezhe##18265
accept More Crystal Fragments##9883 |instant |n |goto Nagrand,31.4,57.8
...
step
talk Gezhe##18265
accept Membership Benefits##9886 |instant |goto Nagrand,31.4,57.8
...
Reach Exalted with The Sha'tar |condition rep("The Sha'tar")==Exalted
step
label "exalted"
...
step
Once you've bought the Tabard, you will have to run level 80 instances from Wrath of the Lich King in order to gain rep.
...
step
talk Lady Naz'jar##42076
accept The Culmination of Our Efforts##26191 |instant |goto 46.4,79.0
...
buy Tabard of the Earthen Ring##65905 |condition itemcount(65905) >= 1 |goto Shimmering Expanse 49.1,42.2
step
