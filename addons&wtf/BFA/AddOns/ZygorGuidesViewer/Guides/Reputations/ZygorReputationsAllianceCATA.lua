...
Reach _2999/3000_ Neutral reputation with Brood of Nozdormu: |condition repval('Brood of Nozdormu','Neutral')>=2999
...
step
Reach "Friendly" Reputation with The League of Arathor |condition rep('The League of Arathor') >= Friendly
...
Travel to the Past |condition ZGV.InPhase('Old Arathi') or rep('The League of Arathor') == Exalted |goto Arathi Highlands/0 38.24,90.09
step
...
step
Reach "Exalted" Reputation with The League of Arathor |condition rep('The League of Arathor') == Exalted
|tip Use the Player vs. Player Group Finder tool and queue for Arathi Basin.
|tip If the "Comp Stomp Brawl" bonus battleground is avalable, queue for that instead.
|tip Continue running these battlegrounds for reputation.
step
...
accept Lunk No Kill##27957 |instant |goto 68.9,53.3
step
...
step
talk Lunk##47429
accept Lunk Like Your Style##28053 |instant |goto 39.0,26.0
step
talk Overseer Oilfist##14625
...
|use Winterspring Cub##68646
talk Winterspring Cub##51677
turnin Cub's First Toy##29040 |or |only if havequest(29040)
turnin A Cub's Craving##29035 |or |only if havequest(29035)
turnin Hunting Practice##29038 |or |only if havequest(29038)
turnin 'Borrowing' From the Winterfall##29037 |or |only if havequest(29037)
...
accept Nethermine Flayer Hide##11016 |only if skill ("Skinning") >= 350 |or |goto 66.1,86.4
|tip This quest is only available if you have your Skinning skill to at least 350.
accept Nethercite Ore##11018 |only if skill ("Mining") >= 350 |or |goto 66.1,86.4
|tip This quest is only available if you have your Mining skill to at least 350.
accept Netherdust Pollen##11017 |only if skill ("Herbalism") >= 350 |or |goto 66.1,86.4
...
step
The entrance to the mine starts here |goto 65.3,90.2 < 10 |walk
...
collect 35 Nethermine Flayer Hide##32470 |q 11016/1 |only if skill ("Skinning") >= 350
|tip This quest is only available if you have your Skinning skill to at least 350.
step
_Leave_ the mine |goto 65.3,90.2 < 10 |walk
talk Yarzill the Merc##23141
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through getting Neutral reputation with Netherwing faction. You need to have Artisan flying to complete this section.",
achieveid={898},
patch='30003',
},[[
step
...
step
_Enter_ the mine |goto 65.1,87.5 < 10 |walk
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through a chain of pre-quests, that become available once you have earned Friendly reputation with the Netherwing faction. This chain of pre-quests will open up more Netherwing faction daily quests.",
achieveid={898},
patch='30003',
},[[
step
...
step
_Enter_ the mine |goto 71.6,87.6 |walk
...
step
_Leave_ the mine |goto Shadowmoon Valley 65.3,90.2 < 5 |walk
talk Mistress of the Mines##23149
turnin The Great Murkblood Revolt##11081 |goto 65.4,90.2
accept Seeker of Truth##11082 |goto 65.4,90.2
step
_Enter_ the mine and follow the path |goto 73.0,82.2 < 5 |walk
...
step
_Leave_ the mine |goto Shadowmoon Valley 65.3,90.2 < 10 |walk
talk Mistress of the Mines##23149
...
If you want to get the 10 Knothide Leather by skinning, kill the mobs at the following location |goto 60.4,45.2
step
kill Tyrantus##20931
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through a chain of pre-quests, that become available once you have earned Honored reputation with the Netherwing faction. This chain of pre-quests will open up more Netherwing faction daily quests.",
achieveid={898},
patch='30003',
},[[
step
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through getting Revered reputation with the Netherwing faction. You must have completed the Netherwing Reputation (Revered) - Pre-Quests guide section in order to be able to complete the quests in this guide section.",
achieveid={898},
patch='30003',
},[[
step
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through a chain of pre-quests, that become available once you have earned Revered reputation with the Netherwing faction. This chain of pre-quests will open up more Netherwing faction daily quests.",
achieveid={898},
patch='30003',
},[[
step
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through the final steps of getting your Netherdrake Mount, once you've earned Exalted reputation with the Netherwing faction. You must have completed the Netherwing Reputation (Revered) guide section in order to be able to complete the quests in this guide section.",
achieveid={898},
patch='30003',
},[[
step
...
Watch the cut scene
You will be taken to Shattrath City |goto Shattrath City 65.8,18.6 < 5
talk Barthamus##23433
turnin Lord Illidan Stormrage##11108 |goto Shattrath City 66.6,16.4
step
Look at the netherdrakes sitting around this area
Pick whichever one you like the best and complete the quest it offers you:
...
step
talk Gezhe##18265
accept More Crystal Fragments##9883 |instant |n |goto 31.4,57.8
...
step
talk Gezhe##18265
accept Membership Benefits##9886 |instant |goto 31.4,57.8
...
step
talk Gezhe##18265
accept More Obsidian Warbeads##9892 |instant |n |goto 31.4,57.8
...
step
talk Nether-Stalker Khay'ji##19880
turnin Another Heap of Ethereals##10308 |instant |n |goto 32.4,64.2
...
step
talk Gezhe##18265
accept More Obsidian Warbeads##9892 |instant |n |goto Nagrand,31.4,57.8
Click here to return to Insignia farming |next "heap" |confirm |only if rep("The Consortium")<=Revered
Click here to farm Obsidian Warbeads |next "bead" |confirm |only if rep("The Consortium")<=Revered
|next "exalted" |only if rep("The Consortium")==Exalted
step
...
collect Draenei Prayer Beads##31795|q 10916/1 |goto 54.2,63.3
step
...
Achieve Exalted rank with Honor Hold |condition rep('Honor Hold')==Exalted |next "grats"
...
Earn Exalted with Lower city |condition rep('Lower City')==Exalted
step
label "exalted"
