...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Aromatic Fish Oil",{
	...
	meta={goldtype="route",skillreq={kul_tiran_fishing=1},levelreq=100},
	items={{160711,200}},
	maps={"Boralus"},
	startlevel=110.0,
	},[[
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Frenzied Fangtooth",{
	meta={goldtype="route",skillreq={kul_tiran_fishing=1},levelreq=110},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Akunda's Bite",{
	meta={goldtype="route",skillreq={kul_tiran_herbalism=1},levelreq=110},
	items={{152507,160}},
	maps={"Vol'dun"},
	},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Monelite Ore",{
	...
	meta={goldtype="route",skillreq={kul_tiran_mining=1},levelreq=100},
	items={{152512,240}},
	maps={"Stormsong Valley"},
	startlevel=110.0,
	},[[
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Platinum Ore",{
	meta={goldtype="route",skillreq={kul_tiran_mining=1},levelreq=110},
	items={{152513,60}},
	maps={"Stormsong Valley"},
	},[[
	step
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blood-Stained Bone",{
	meta={goldtype="route",skillreq={kul_tiran_skinning=1},levelreq=110},
	items={{154164,140}},
	maps={"Nazmir"},
	startlevel=110.0,
	},[[
