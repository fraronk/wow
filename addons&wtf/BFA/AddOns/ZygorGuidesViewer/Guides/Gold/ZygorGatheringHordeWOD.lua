...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Copper Ore/Rough Stone (Horde)",{
	condition_valid='raceclass("Horde")',
	meta={goldtype="route",skillreq={mining=1},levelreq=8},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Peacebloom/Silverleaf/Earthroot (Horde)",{
	condition_valid='raceclass("Horde")',
	meta={goldtype="route",skillreq={herbalism=1},levelreq={1,10}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rain Poppy (Horde)",{
	condition_valid='raceclass("Horde")',
	meta={goldtype="route",skillreq={pandaria_herbalism=1},levelreq={85,86}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Alabaster Pigment (Horde)",{
	condition_valid='raceclass("Horde")',
	meta={goldtype="route",skillreq={herbalism=1,inscription=1},levelreq={1,10}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ruined Leather Scraps/Light Leather(Horde)",{
	condition_valid='raceclass("Horde")',
	meta={goldtype="route",skillreq={skinning=1},levelreq={8,9}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Abyssal Gulper Eel Flesh/Crescent Saberfish Flesh (Garrison)",{
	...
	step
		You do not have a Fishing Shack in your garrison! |condition hasbuilding(64) or hasbuilding(134) or hasbuilding(135) |only if not hasbuilding(64) and not hasbuilding(134) and not hasbuilding(135)
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blackwater Whiptail Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Blind Lake Sturgeon Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Crescent Saberfish Flesh",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fat Sleeper Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Fire Ammonite Tentacle/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Jawless Skulker Flesh/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sea Scorpion Segment/Crescent Saberfish (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Light Leather/Medium Leather/Light Hide/Medium Hide",{
	meta={goldtype="route",skillreq={skinning=1},levelreq=60},
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Light Leather/Medium Leather/Light Hide/Medium Hide (Hillsbrad Foothills)",{
	meta={goldtype="route",skillreq={skinning=1},levelreq=19},
