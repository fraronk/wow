...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Peacebloom/Silverleaf/Earthroot (Alliance)",{
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Rain Poppy (Alliance)",{
...
-- INSCRIPTION
-- ----------
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Alabaster Pigment (Alliance)",{
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Sea Scorpion Segment/Crescent Saberfish Flesh (Garrison)",{
	meta={goldtype="route",skillreq={draenor_fishing=1},levelreq={90}},
