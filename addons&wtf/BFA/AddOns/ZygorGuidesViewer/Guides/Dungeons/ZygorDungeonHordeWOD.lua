...
step
Press _I_ and queue for Auchindoun or enter the dungeon with your group |goto Auchindoun/1 49.7,90.2 |c
stickystart "Sever"
step
map Auchindoun/1
...
|tip Try to keep Kaathar a short distance away from his shield |grouprole TANK
_DAMAGE:_ |grouprole DAMAGE
|tip Keep moving don't get hit by Hallowed Ground or Sanctified Strike. |grouprole DAMAGE
_HEALER:_ |grouprole HEALER
|tip Look out for people standing in Hallowed Ground. |grouprole HEALER
_EVERYONE:_ |grouprole EVERYONE
|tip Stay out of patches of holy energy on the ground. |grouprole EVERYONE
|tip During Consecrated Light, everyone needs to hide behind the shield. |grouprole EVERYONE
...
collect the Soulweave Vessel##118620 |q 37233/1 |goto Auchindoun/1 24.4,32.4 |only if havequest(37233)
collect the Soulweave Vessel##118620 |q 37154/1 |goto Auchindoun/1 24.4,32.4 |only if havequest(37154)
...
collect the Soulsever Blade##118619 |q 37232/1 |goto Auchindoun/1 53.3,63.4 |only if havequest(37232)
collect the Soulsever Blade##118619 |q 37156/1 |goto Auchindoun/1 53.3,63.4 |only if havequest(37156)
...
|tip Look out for people targeted by Cackling Pyromaniacs if they are not interrupted players targeted will take very high burst damage. |grouprole HEALER
_EVERYONE:_ |grouprole EVERYONE
...
Slay Teron'gor |q 37232/2 |goto Auchindoun/1 49.6,33.5 |only if havequest(37232)
Slay Teron'gor |q 37233/2 |goto Auchindoun/1 49.6,33.5 |only if havequest(37233)
Slay Teron'gor |q 37146/2 |goto Auchindoun/1 49.6,33.5 |only if havequest(37146)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
only if havequest(37232) or havequest(37233) or havequest(37146)
step
|next "Leveling Guides\\Garrisons\\High Overlord Saurfang Dailies"
...
confirm
step
Go right to kill _Slave Watcher Crushto_ first |goto Bloodmaul Slag Mines/1 51.2,66.6 < 15 |next "Crush" |or
Or
Go left to kill _Magmolatus_ first |goto Bloodmaul Slag Mines/1 46.9,66.8 < 15 |next "Magmo" |or
confirm
step
label "Crush"
map Bloodmaul Slag Mines/1
...
collect Ogre Family Tree##118646 |q 37142/1 |goto Bloodmaul Slag Mines/1 52.0,58.6 |only if havequest(37142)
...
collect Olaf's Shield##118616 |q 37229/1 |goto Bloodmaul Slag Mines/1 45.5,57.0 |only if havequest(37229)
collect Olaf's Shield##118616 |q 37153/1 |goto Bloodmaul Slag Mines/1 45.5,57.0 |only if havequest(37153)
...
collect Giant Ogre Head ##118534 |q 37228/1 |only if havequest(37228)
collect Giant Ogre Head ##118534 |q 37152/1 |only if havequest(37152)
...
Slay Gug'rokk |q 37229/2 |goto Bloodmaul Slag Mines/1 65.4,22.7 |only if havequest(37229)
Slay Gug'rokk |q 37142/2 |goto Bloodmaul Slag Mines/1 65.4,22.7 |only if havequest(37142)
Slay Gug'rokk |q 37228/2 |goto Bloodmaul Slag Mines/1 65.4,22.7 |only if havequest(37228)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
only if havequest(37229) or havequest(37142) or havequest(37228)
step
|next "Leveling Guides\\Garrisons\\Muradin Bronzebeard Dailies"
...
collect Overgrown Artifact##118628 |q 37241/1 |goto The Everbloom/1 61.1,66.3 |only if havequest(37241)
collect Overgrown Artifact##118628 |q 37166/1 |goto The Everbloom/1 61.1,66.3 |only if havequest(37166)
...
collect Strangely-Glowing Frond##118627 |q 37240/1 |goto The Everbloom/1 64.4,20.1 |only if havequest(37240)
collect Strangely-Glowing Frond##118627 |q 37165/1 |goto The Everbloom/1 64.4,20.1 |only if havequest(37165)
...
collect Tiny Peachick Hatchling##118652 |q 37227/1 |goto The Everbloom/1 55.4,22.6 |only if havequest(37227)
collect Tiny Peachick Hatchling##118652 |q 37150/1 |goto The Everbloom/1 55.4,22.6 |only if havequest(37150)
...
Slay Yalnu |q 37241/2 |goto The Everbloom/2 45.0,72.0 |only if havequest(37241)
Slay Yalnu |q 37240/2 |goto The Everbloom/2 45.0,72.0 |only if havequest(37240)
Slay Yalnu |q 37227/2 |goto The Everbloom/2 45.0,72.0 |only if havequest(37227)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
collect Huge Crate of Weapons##118643 |q 37242/1 |goto Grimrail Depot/1 53.9,38.2 |only if havequest(37242)
collect Huge Crate of Weapons##118643 |q 37167/1 |goto Grimrail Depot/1 53.9,38.2 |only if havequest(37167)
...
collect Iron Limbcleaver##118644 |q 37243/1 |goto Grimrail Depot/4 53.8,51.9 |only if havequest(37243)
collect Iron Limbcleaver##118644 |q 37160/1 |goto Grimrail Depot/4 53.8,51.9 |only if havequest(37160)
...
collect Iron Autocannon##118653 |q 37209/1 |goto Grimrail Depot/4 67.2,47.7 |only if havequest(37209)
collect Iron Autocannon##118653 |q 37151/1 |goto Grimrail Depot/4 67.2,47.7 |only if havequest(37151)
...
Slay Skylord Tovra |q 37242/2 |goto Grimrail Depot/4 8.6,51.0 |only if havequest(37242)
Slay Skylord Tovra |q 37243/2 |goto Grimrail Depot/4 8.6,51.0 |only if havequest(37243)
Slay Skylord Tovra |q 37209/2 |goto Grimrail Depot/4 8.6,51.0 |only if havequest(37209)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
collect Dark Parchment##118625 |q 37238/1 |goto Shadowmoon Burial Grounds/1 29.4,43.4 |only if havequest(37238)
collect Dark Parchment##118625 |q 37163/1 |goto Shadowmoon Burial Grounds/1 29.4,43.4 |only if havequest(37163)
...
collect the Void-Gate Key##118651 |q 37149/1 |goto 37.45,51.30 |only if havequest(37149)
...
collect Silver-Lined Arrow##118626 |q 37239/1 |goto Shadowmoon Burial Grounds/1 83.3,80.5 |only if havequest(37239)
collect Silver-Lined Arrow##118626 |q 37164/1 |goto Shadowmoon Burial Grounds/1 83.3,80.5 |only if havequest(37164)
...
Slay Ner'zhul |q 37238/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1 |only if havequest(37238)
Slay Ner'zhul |q 37245/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1 |only if havequest(37245)
Slay Ner'zhul |q 37239/2 |goto Shadowmoon Burial Grounds/3 48.1,47.1 |only if havequest(37239)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
collect Pristine Plumage##118622 |q 37235/1 |goto Skyreach/1 63.8,24.9 |only if havequest(37235)
collect Pristine Plumage##118622 |q 37159/1 |goto Skyreach/1 63.8,24.9 |only if havequest(37159)
...
collect the Sun Crystal##118621 |q 37234/1 |goto Skyreach/1 52.9,48.6 |only if havequest(37234)
collect the Sun Crystal##118621 |q 37158/1 |goto Skyreach/1 52.9,48.6 |only if havequest(37158)
...
|tip The Shield Construct casts a buff on the boss that makes him immune to damage this can be interrupted or stunned. |grouprole EVERYONE
...
Slay High Sage Viryx |q 37235/2 |goto Skyreach/2 51.1,27.4 |only if havequest(37235)
Slay High Sage Viryx |q 37234/2 |goto Skyreach/2 51.1,27.4 |only if havequest(37234)
Slay High Sage Viryx |q 37147/2 |goto Skyreach/2 51.1,27.4 |only if havequest(37147)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
collect Spire Flamefly##118650 |q 37244/1 |goto Upper Blackrock Spire 2/1 36.1,17.1 |only if havequest(37244)
collect Spire Flamefly##118650 |q 37148/1 |goto Upper Blackrock Spire 2/1 36.1,17.1 |only if havequest(37148)
...
_HEALER:_ |grouprole HEALER
|tip When Rune Conduits activate watch the raid there will be a lot of aoe damage going out. |grouprole HEALER
_EVERYONE:_ |grouprole EVERYONE
|tip When Rune Conduits active anyone can go down and deactive them. |grouprole EVERYONE
|tip When down on the ground floor deactivating Rune Conduits watch out for the two Electric Pulses that travel around the room. |grouprole EVERYONE
|tip Each active Rune Conduit gives a buff to the boss decreasing damage taken by 14 percent. |grouprole EVERYONE
...
|tip Interrupt Delilitating Fixation. |grouprole EVERYONE
...
collect Finkle's Improved Skinner##118623 |q 37236/1 |goto Upper Blackrock Spire 2/2 30.3,37.4 |only if havequest(37236)
collect Finkle's Improved Skinner##118623 |q 37161/1 |goto Upper Blackrock Spire 2/2 30.3,37.4 |only if havequest(37161)
...
_HEALER:_ |grouprole HEALER
|tip Watch the player targeted by Incinerating Breath or by Iron Reaver, these people will tkae a large amount of damage. |grouprole HEALER
_EVERYONE:_ |grouprole EVERYONE
...
_HEALER:_ |grouprole HEALER
|tip Be aware that he will periodically knock back and AoE fear the group. |grouprole HEALER
...
collect Shed Proto-Dragon Claw##118624 |q 37237/1 |goto Upper Blackrock Spire 2/3 48.4,20.1 |only if havequest(37237)
collect Shed Proto-Dragon Claw##118624 |q 37162/1 |goto Upper Blackrock Spire 2/3 48.4,20.1 |only if havequest(37162)
...
Slay Warlord Zaela |q 37244/2 |goto Upper Blackrock Spire 2/3 14.4,47.7 |only if havequest(37244)
Slay Warlord Zaela |q 37236/2 |goto Upper Blackrock Spire 2/3 14.4,47.7 |only if havequest(37236)
Slay Warlord Zaela |q 37237/2 |goto Upper Blackrock Spire 2/3 14.4,47.7 |only if havequest(37237)
step
|next "Dailies Guides\\Warlords of Draenor Dailies\\Garrison Building Dailies"
...
map Blackrock Foundry/2
path follow smart; loop off; ants curved; dist 15
path	61.2,53.4	67.3,55.4	 66.1,64.3
...
|tip Phantasmal Winds will push you towards the edge of the platform. Simply walk against it until you recieve the orb, once you have the orb be sure to pass it to another effected person or to the designated orb holder. |grouprole EVERYONE
...
|tip During the first phase the group will recieve a debuff that will hurt you the more you move. |grouprole EVERYONE
|tip During the second phase the group will recieve a debuff that decreases the raids maximum HP this will continue until the phase is over,(you will get you max hp back once this phase is over) |grouprole EVERYONE
|tip During the last phase the group will recieve a debuff that increases over time, this will increase your damage done and increase your damage taken. |grouprole EVERYONE
confirm
step
map Hellfire Citadel/8
path follow smart; loop off; ants curved; dist 15
...
|tip Glimpse of Maddness will spawn a shadow on a random player and start casting "Gaze of the Abyss" onto the closest player and keep applying this debuff every 6 seconds.
_Gaze of the Abyss_
