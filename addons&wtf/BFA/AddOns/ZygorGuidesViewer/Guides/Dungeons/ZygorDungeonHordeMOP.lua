...
description="\nThis guide will walk you through completing the Blackfathom Deeps dungeon. This dungeon is located in Ashenvale on the continent of Kalimdor and is home to the Twilight's Hammer, naga, and satyr. This dungeon ranges from level 22 to 25.",
mapid=221,
achieveid={632},
patch='30001',
...
path	14.6,43.2
Swim under the water and _follow_ the path |goto Blackfathom Deeps 14.6,43.2 < 10
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Domina##74476
...
confirm
step
kill 1 Aku'mai the Devourer##75155 |goto 86.5,86.7 |only if default
_Phase 1:_
...
step
talk Sentinel Aluwyn##75606
turnin The Rise of Aku'mai##34673 |goto 87.72,86.46
only if not completedq(34673)
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Blackrock Depths: Detention Block dungeon. This dungeon is located in Blackrock Mountain on the continent of Eastern Kingdoms. It is home to the Dark Iron dwarves and led by Emperor Dagran Thaurissan. This dungeon ranges from level 53 to 56.",
mapid=242,
achieveid={642},
patch='30008',
...
confirm
step
_Go through_ the door |goto Blackrock Depths/2 74.9,12.9
kill Magmus##9938
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Deadmines dungeon. This dungeon is located in Westfall on the continent of Eastern Kingdoms and is home to the Defias Brotherhood, led by Edwin VanCleef. This dungeon ranges from level 15 to 16.",
mapid=291,
achieveid={628},
patch='30002',
condition_suggested=function() return level>=15 and level<=60 end,
...
kill 1 Glubtok##47162 |q 27842/1 |goto 37.7,61.2 |only if havequest(27842)
_Phase 1:_
...
kill 1 Helix Gearbreaker##47296 |q 27844/1 |goto 49.0,87.4 |only if havequest(27844)
_Phase 1:_
...
kill 1 Foe Reaper 5000##43778 |q 27847/1 |goto The Deadmines/2 10.4,82.8 |only if havequest(27847)
...
kill 1 Admiral Ripsnarl##47626 |q 27848/1 |goto 63.9,39.5 |only if havequest(27848)
...
kill 1 "Captain" Cookie##47739 |q 27850/1 |goto 63.9,39.5 |only if not completedq(27850)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Dire Maul: Capital Gardens dungeon. This dungeon is located in Feralas on the continent of Kalimdor and is home to undead and arcane creatures imprisoned by Prince Tortheldrin. This dungeon ranges from level 44 to 47.",
mapid=236,
achieveid={644},
patch='30002',
...
kill Magister Kalendris##11487 |q 27112/1 |goto Dire Maul/3 30.6,45.8 |only if havequest(27112)
...
kill Illyanna Ravenoak##11488 |q 27112/2 |goto 21.7,75.8 |only if havequest(27112)
...
kill 1 Tendris Warpwood##11489 |q 27109/1 |goto Dire Maul/2 34.6,53.3 |only if havequest(27109)
...
kill Immol'thar##11496 |q 27110/1 |goto 35.5,57.0 |only if havequest(27110)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Dire Maul: Gordock Commons dungeon. This dungeon is located in Feralas on the continent of Kalimdor and is home to the Gordok ogres, led by King Gordok. This dungeon ranges from level 44 to 47.",
mapid=235,
achieveid={644},
patch='30002',
condition_suggested=function() return level>=35 and level<=60 end,
...
kill King Gordok##11501 |q 27128/1 |goto 31.8,26.4 |only if havequest(27128)
...
Retrieve the Ogre Tannin |q 27119/1 |goto Dire Maul/1 23.7,55.4 |only if not completedq(27119) |goto Dire Maul/1 23.6,55.2
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Dire Maul: Warpwood Quarter dungeon. This dungeon is located in Feralas on the continent of Kalimdor and has been corrupted by the satyr Alzzin the Wildshaper. This dungeon ranges from level 44 to 47.",
mapid=239,
achieveid={644},
patch='30002',
condition_suggested=function() return level>=35 and level<=60 end,
...
talk Pusillin##14354
Follow the path and _talk to Pusillin_ whenever he stops |goto 71.6,46.8 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
talk Pusillin##14354
...
confirm
step
kill 1 Pusillin##14354 |goto 73.77,43.74
collect the Book of Incantations##18261 |q 27107/1 |goto 73.77,43.74 |only if havequest(27107)
...
collect Lethtendris' Web##18426 |q 27108/1 |goto 42.8,49.1 |only if havequest(27108)
...
collect Hydrospawn Essence##18299 |q 27105/1 |goto Dire Maul/6 55.5,71.4 |only if havequest(27105)
...
kill 1 Zevrim Thornhoof##11490 |q 27104/1 |goto 57.6,74.0 |only if havequest(27104)
...
kill 1 Alzzin the Wildshaper##11492 |q 27104/2 |goto Dire Maul/6 57.7,28.9 |only if havequest(27104)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Gnomeregan dungeon. This dungeon is located in Dun Morogh on the continent of Eastern Kingdoms. Gnomeregan was the former capital city of the gnomes until it fell to a trogg invasion. This dungeon ranges from level 26 to 29.",
mapid=226,
achieveid={634},
patch='30001',
condition_suggested=function() return level>=15 and level<=60 end,
...
kill 1 Viscous Fallout##7079 |q 26939/1 |only if havequest(26939)
...
kill 1 Electrocutioner 6000##6235 |q 26941/1 |only if havequest(26941)
...
Follow the path and _open_ The Final Chamber door |goto 28.8,45.7
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Lower Blackrock Spire dungeon. This dungeon is located in Blackrock Mountain on the continent of Eastern Kingdoms and is home to Warchief Rend Blackhand's Dark Horde. This dungeon ranges from level 57 to 58.",
mapid=250,
achieveid={643},
patch='30001',
condition_suggested=function() return level>=40 and level<=60 end,
...
Defeat Overlord Wyrmthalak |scenariogoal 1/34457 |goto Blackrock Spire/6 56.1,55.6
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Maraudon: Earth Song Falls dungeon. This dungeon is located in Desolace on the continent of Kalimdor and is a vibrant cavern home to Princess Theradras. This dungeon ranges from level 36 to 39. Also known as Inner Dire Maul.",
mapid=280,
achieveid={640},
patch='30003',
...
kill 1 Princess Theradras##12201 |q 27692/1 |goto 26.6,78.8 |only if havequest(27692)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Maraudon: Foulspore Cavern dungeon. This dungeon is located in Desolace on the continent of Kalimdor and is a putrid, diseased cavern. This dungeon ranges from level 36 to 39. Also known as Dire Maul Orange.",
mapid=280,
condition_suggested=function() return level>=30 and level<=60 end,
...
kill 1 Noxxion##13282 |q 27698/1 |goto 34.6,10.7 |only if havequest(27698)
...
kill 1 Razorlash##12258 |q 27698/2 |goto Maraudon/1 16.3,34.0 |only if havequest(27698)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Maraudon: The Wicked Grotto dungeon. This dungeon is located in Desolace on the continent of Kalimdor and is tainted by demon corruption. This dungeon ranges from level 36 to 39. Also known as Dire Maul Purple.",
mapid=280,
condition_suggested=function() return level>=30 and level<=60 end,
...
kill Lord Vyletongue##12236 |q 27697/1 |goto 37.6,69.5 |only if havequest(27697)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Ragefire Chasm dungeon. This dungeon is located in Orgrimmar on the continent of Kalimdor and is home to the Burning Blade cultists and troggs. This dungeon ranges from level 15 to 16.",
mapid=213,
achieveid={629},
patch='30001',
condition_suggested=function() return level>=15 and level<=60 end,
...
Rescue the first Kor'kron Scout |q 30984/1 |count 1 |goto 68.0,60.4
only if not completedq(30984)
step
kill Adarogg##61408
...
Rescue the second Kor'kron Scout |q 30984/1 |count 2 |goto 65.0,70.8
only if not completedq(30984)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
Rescue the third Kor'kron Scout |q 30984/1 |count 3 |goto 60.8,43.2
only if not completedq(30984)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
Tell it: _"It's Safe to come out now."_
Rescue the fourth Kor'kron Scout |q 30984/1 |count 4 |goto 52.0,26.2
only if not completedq(30984)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
step
clicknpc Kor'kron Scout##61680
Rescue the last Kor'kron Scout |q 30984/1 |count 5 |goto 42.8,66.5
only if not completedq(30984)
step
map Ragefire Chasm/1
path follow loose; loop off; ants curved
...
only if havequest(30969) and not completedq(30969)
step
talk Invoker Xorenth##61716
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Razorfen Downs dungeon. This dungeon is located in Thousand Needles on the continent of Kalimdor and is the capital of the quilboars. This dungeon ranges from level 42 to 45.",
mapid=300,
achieveid={636},
patch='30008',
condition_suggested=function() return level>=40 and level<=60 end,
...
Defeat Mordresh Fire Eye |scenariogoal 24955 |goto 85.2,46.4
step
map Razorfen Downs/1
path follow loose; loop off; ants curved; dist 10
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Razorfen Kraul dungeon. This dungeon is located in the Southern Barrens on the continent of Kalimdor and is the ancestral home of the quilboars. This dungeon ranges from level 32 to 35.",
mapid=301,
achieveid={635},
patch='30303',
...
kill 1 Roogug##74948 |q 26907/3 |goto Razorfen Kraul/1 87.2,41.6 |only if havequest(26907)
...
kill 1 Hunter Bonetusk##75001 |q 26907/1 |goto Razorfen Kraul/1 81.9,50.5 |only if havequest(26907)
...
kill 1 Warlord Ramtusk##74462 |q 26907/2 |goto Razorfen Kraul/1 57.0,30.1 |only if havequest(26907)
...
Collect Razorflank's Heart |q 26905/1 |goto 23.7,31.4 |only if havequest(26905)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Scarlet Halls dungeon. This dungeon is located in the Tirisfal Glades on the continent of Eastern Kingdoms and is home to the Scarlet Crusade. This dungeon ranges from level 28 to 31.",
mapid=431,
achieveid={7413},
patch='50004',
condition_suggested=function() return level>=15 and level<=60 end,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Scarlet Monastery dungeon. This dungeon is located in the Tirisfal Glades on the continent of Eastern Kingdoms and is home to the Scarlet Crusade. This dungeon ranges from level 30 to 33.",
mapid=302,
achieveid={637},
patch='30002',
condition_suggested=function() return level>=15 and level<=60 end,
...
Use the Blades of the Anointed on High Inquisitor Whitemane's corpse |use Blades of the Anointed##87390 |q 31516/1 |only if havequest(31516)
Use the Blades of the Anointed on High Inquisitor Whitemane's corpse |use Blades of the Anointed##87388 |q 31514/1 |only if havequest(31514)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Scholomance dungeon. This dungeon is located in the Western Plaguelands on the continent of Eastern Kingdoms and is the academy for Scourge necromancers. This dungeon ranges from level 40 to 43.",
mapid=476,
achieveid={645},
patch='30002',
condition_suggested=function() return level>=35 and level<=60 end,
...
Go through the gate and jump down |goto Scholomance/1 53.2,60.3 < 5
confirm
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Shadowfang Keep dungeon. This dungeon is located in the Silverpine Forest on the continent of Eastern Kingdoms and is home to Vincent Godrey and his renegades. This dungeon ranges from level 18 to 21.",
mapid=310,
achieveid={631},
patch='30200',
condition_suggested=function() return level>=15 and level<=60 end,
...
accept This Land is Our Land##27974 |goto Shadowfang Keep/1 64.4,58.0
only if not completedq(27974)
step
map Shadowfang Keep/1
path follow loose; loop off; ants curved
path	70.0,58.1	72.8,50.5	61.1,44.4
path	60.7,54.9	58.5,63.8
Follow the path |goto 58.5,63.8 < 8
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Baron Ashbury##46962 |goto Shadowfang Keep/1 67.8,72.9
...
kill 1 Baron Ashbury##46962 |q 27974/1 |goto Shadowfang Keep/1 67.8,72.9 |only if havequest(27974)
Defeat Baron Ashbury |scenariogoal 24774 |goto Shadowfang Keep/1 67.8,72.9
step
talk Deathstalker Commander Belmont##47293
turnin This Land is Our Land##27974 |goto 66.4,72.1
accept Plague...Plague Everywhere!##27988 |goto 66.4,72.1
...
Follow the path |goto 38.3,39.0 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
path	38.8,54.7
Follow the path |goto 38.8,54.7 < 8
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Baron Silverlaine##3887 |goto Shadowfang Keep/2 31.2,73.3
...
kill 1 Baron Silverlaine##3887 |q 27988/1 |goto Shadowfang Keep/2 31.2,73.3 |only if havequest(27988)
...
confirm
step
kill 1 Commander Springvale##4278 |goto Shadowfang Keep 28.4,58.6
...
kill 1 Commander Springvale##4278 |q 27988/2 |goto Shadowfang Keep 28.4,58.6 |only if havequest(27988)
Defeat Commander Springvale |scenariogoal 24780 |goto Shadowfang Keep 28.4,58.6
confirm
step
talk Deathstalker Commander Belmont##47293
turnin Plague...Plague Everywhere!##27988 |goto Shadowfang Keep/1 27.9,60.7
accept Orders Are For the Living##27996 |goto Shadowfang Keep/1 27.9,60.7
...
kill 1 Lord Walden##46963 |q 27996/1 |goto Shadowfang Keep/4 54.2,54.3 |only if havequest(27996)
Defeat Lord Walden |scenariogoal 24775 |goto Shadowfang Keep/4 54.2,54.3
step
talk Deathstalker Commander Belmont##47293
turnin Orders Are For the Living##27996 |goto 60.2,41.2
accept Sweet, Merciless Revenge##27998 |goto 60.2,41.2
...
Follow the path |goto 60.9,44.1 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Lord Godfrey##46964 |goto Shadowfang Keep/6 61.6,23.8
...
kill 1 Lord Godfrey##46964 |q 27998/1 |goto Shadowfang Keep/6 61.6,23.8 |only if havequest(27998)
Defeat Lord Godfrey |scenariostage 1 |goto Shadowfang Keep/6 61.6,23.8
step
talk Deathstalker Commander Belmont##47293
turnin Sweet, Merciless Revenge##27998 |goto Shadowfang Keep/6 58.7,53.2
only if not completedq(27998)
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing The Stormwind Stockade dungeon. This dungeon is located in Stormwind City on the continent of Eastern Kingdoms and is a guarded prison containing prominent Defias criminals. This dungeon ranges from level 22 to 25.",
mapid=225,
achieveid={633},
patch='30001',
condition_suggested=function() return level>=15 and level<=60 end,
...
map The Stockade/1
path follow loose; loop off; ants curved
path	70.8,40.1	62.7,36.8	52.8,36.4
path	41.0,36.1	33.1,34.5	25.9,30.1
Follow the path |goto 25.9,30.1 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill Hogger##46254 |goto 22.1,27.0
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Stratholme: Main Gate dungeon. This dungeon is located in the Eastern Plaguelands on the continent of Eastern Kingdoms and is the city in which the Order of the Silver Hand was founded. This dungeon ranges from level 48 to 51.",
mapid=317,
achieveid={646},
patch='30001',
condition_suggested=function() return level>=40 and level<=60 end,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Stratholme: Service Entrance dungeon. This dungeon is located in the Eastern Plaguelands on the continent of Eastern Kingdoms and is the city in which the Order of the Silver Hand was founded. This dungeon ranges from level 48 to 51.",
mapid=317,
achieveid={646},
patch='30001',
condition_suggested=function() return level>=40 and level<=60 end,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Sunken Temple dungeon. This dungeon is located in the Swamp of Sorrows on the continent of Eastern Kingdoms and is a shrine to the Atal'ai trolls. This dungeon ranges from level 52 to 55.",
mapid=220,
achieveid={641},
patch='30003',
condition_suggested=function() return level>=40 and level<=60 end,
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Uldaman dungeon. This dungeon is located in the Badlands on the continent of Kalimdor and is an ancient titan city currently inhabited by Dark Iron dwarves. This dungeon ranges from level 37 to 40.",
mapid=230,
achieveid={638},
patch='30001',
condition_suggested=function() return level>=40 and level<=60 end,
...
path	62.0,75.4	56.7,75.5	57.1,85.6
path	60.0,89.0	55.4,93.4
Follow the path |goto 55.4,93.4 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
kill 1 Olaf##6908 |goto 58.0,94.8
kill 1 Eric "The Swift"##6907 |goto 58.0,94.8
kill 1 Baelog##6906 |goto 58.0,94.8
...
map Uldaman/1
path follow loose; loop off; ants curved; dist 10
path	55.4,93.4	60.0,89.0	57.1,85.6
path	56.6,81.4	53.3,81.4	53.3,78.6
...
kill 1 Ironaya##7228 |goto 45.4,73.7
...
kill 1 Ironaya##7228 |q 27679/1 |goto 45.4,73.7 |only if havequest(27679)
...
Obtain the Obsidian Power Core |q 27682/1 |goto Uldaman/1 28.7,61.7 |only if havequest(27682)
...
Retrieve the Titan Power Core |q 27682/2 |goto Uldaman/1 47.5,42.5 |only if havequest(27682)
...
kill 1 Galgann Firehammer##7291 |q 27681/1 |goto Uldaman/1 25.8,35.9 |only if havequest(27681)
...
Activate the Altar of Archaedas |goto Uldaman/2 41.7,16.7 < 5
confirm
step
map Uldaman/1
path follow loose; loop off; ants curved; dist 10
...
kill 1 Archaedas##2748 |q 27680/1 |goto Uldaman/2 55.4,50.7 |only if havequest(27680)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Wailing Caverns dungeon. This dungeon is located in the Northern Barrens on the continent of Kalimdor and is home to the Druids of the Fang. This dungeon ranges from level 17 to 20.",
mapid=279,
achieveid={630},
patch='30002',
condition_suggested=function() return level>=15 and level<=60 end,
...
kill 1 Lady Anacondra##3671 |q 26870/2 |only if havequest(26870)
...
kill 1 Lord Pythas##3670 |q 26870/3 |only if havequest(26870)
...
kill 1 Lord Cobrahn##3669 |q 26870/1 |only if havequest(26870)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Zul'Farrak dungeon. This dungeon is located in the Tanaris on the continent of Kalimdor and is home to the Sandfury trolls. This dungeon ranges from level 46 to 49.",
mapid=219,
achieveid={639},
patch='30001',
condition_suggested=function() return level>=40 and level<=60 end,
...
Defeat Theka the Martyr |scenariogoal 24949 |goto 54.8,29.3
step
kill Antu'sul##8127
...
Or
You can Right Click the dungeon finder icon on your mini map, teleport out of the dungeon, then teleport back in to the entrance |goto Zul'Farrak/0 56.6,91.0 < 80
confirm
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Blackwing Lair raid. This dungeon is located in Blackrock Mountain on the continent of Eastern Kingdoms and is home to Nefarian and the Blackrock clan orcs. This raid is level 60.",
mapid=287,
achieveid={685},
patch='30001',
...
step
talk Vol'jin##10540
turnin The Lord of Blackrock##7783 |goto Orgrimmar/1 48.2,70.7
|only if not completedq(7783)
step
talk Vol'jin##10540
accept The Lord of Blackrock##7784 |goto Orgrimmar/1 48.2,70.7
|only if completedq(7784)
step
talk Overlord Natoj##14392
turnin The Lord of Blackrock##7784 |goto Orgrimmar/1 52.6,82.2
|only if completedq(7784)
step
...
author="support@zygorguides.com",
description="\nThis guide will walk you through the Molten Core Raid.",
},[[
step
...
kill Ambassador Hellmaw##18731 |goto Shadow Labyrinth/1 21.4,39.1
...
Defeat Ambassador Hellmaw |scenariogoal 24863 |goto 29.5,39.1
step
map Shadow Labyrinth/1
path follow smart; loop off; ants curved; dist 12
...
author="support@zygorguides.com",
description="\nThis guide will walk you through the Cavern's of Time: Opening the Dark Portal dungeon.",
},[[
step
label "start"
...
confirm
step
click Barrels##2886 |goto 67.9,59.7 < 10
...
accept Heart of Rage##29536 |goto The Blood Furnace 51.4,90.0
accept Mind the Gap##29537 |goto The Blood Furnace 51.4,90.0
...
Loot the Fel Infusion Rod |q 29535/2 |goto The Blood Furnace 36.6,40.7 |only if havequest(29535)
...
Defeat the Shadowmoon Channeler |scenariogoal 3239 |goto 59.2,42.5
step
label "felorcblood"
...
step
talk Caza'rez##54636
turnin Make Them Bleed##29535 |goto 51.4,90.1
turnin Heart of Rage##29536 |goto 51.4,90.1
turnin Mind the Gap##29537 |goto 51.4,90.1
only if not completedq(29535) or not completedq(29536) or not completedq(29537)
step
...
accept War on the Ramparts##29527 |goto 48.50,68.10 |only if not havequest(29527) or not completedq(29527)
accept Demons in the Citadel##29530 |goto 48.50,68.10 |only if not havequest(29530) or not completedq(29530)
accept Hitting Them Where It Hurts##29593 |goto 48.50,68.10 |only if not havequest(29593) or not completedq(29593)
...
path	75.90,43.70
kill Watchkeeper Gargolmar##17306 |scenariogoal 1/24926 |goto 76.9,34.4
...
|tip Opening the world map will display an ant trail guiding you through the current floor.
step
collect Gargolmar's Hand##23881 |q 29527/1 |goto 76.9,34.4
|tip Loot it from Watchkeeper Gargolmar's corpse.
|only if havequest(29527)
step
map Hellfire Ramparts/1
path follow smart; loop off; ants curved; dist 20
...
|tip Opening the world map will display an ant trail guiding you through the current floor.
step
collect Omor's Hoof##23886 |q 29530/1 |goto 39.30,21.20
|tip Loot it from Omor the Unscarred's corpse.
|only if havequest(29530)
step
...
|tip Opening the world map will display an ant trail guiding you through the current floor.
step
collect Nazan's Head##23901 |q 29527/2 |goto 36.20,79.30
|tip Loot it from Nazan's corpse.
|only if havequest(29527)
step
talk Stone Guard Stok'ton##54606
|tip Jump down back on the bridge to return to the entrance.
turnin War on the Ramparts##29527 |goto 48.50,68.10 |only if havequest(29527) and not completedq(29527)
turnin Demons in the Citadel##29530 |goto 48.50,68.10 |only if havequest(29530) and not completedq(29530)
turnin Hitting Them Where It Hurts##29593 |goto 48.50,68.10 |only if havequest(29593) and not completedq(29593)
|only if not completedallq(29527,29530,29593) and (havequest(29527) or havequest(29530) or havequest(29593))
step
_Congratulations!_
...
|confirm
step
talk Warchief Blackhand##21752 |goto Karazhan/14 40.9,68.9
"Control Warchief Blackhand"
|tip This will start the boss fight, make sure you are ready.
|confirm
step
kill King Llane##21684 |goto Karazhan/14 39.4,67.6
...
accept Pupil No More##29825 |goto Ahn'kahet: The Old Kingdom 87.2,72.6
step
...
kill Elder Nadox##29309 |q 29825/1 |only if havequest(29825) |goto 70.4,28.6
...
click Ancient Nerubian Device##8393 |goto 56.7,24.4
|confirm
step
map Ahn'kahet: The Old Kingdom/1
path follow smart; loop off; ants curved; dist 15
...
step
Kill the mobs around the Ancient Nerubian Device, then click it.
click Ancient Nerubian Device##8393 |goto 50.1,29.9
|confirm
step
map Ahn'kahet: The Old Kingdom/1
path follow smart; loop off; ants curved; dist 15
...
kill Bonegrinder##30284 |q 29826/2 |goto 56.9,38.2 |only if havequest(29826)
step
kill Prince Taldaram##29308
kill Prince Taldaram##29308 |q 29826/3 |only if havequest(29826) |goto 63.1,50.4
...
confirm
step
kill 3 Forgotten One##30414+ |only if not havequest(13187) |goto 32.4,50.1
kill 3 Forgotten Ones##30414+ |q 13187/1 |only if havequest(13187) |goto 32.4,50.1
...
Defeat Loken |scenariogoal 27921 |goto Halls of Lightning/2 19.2,56.1
step
talk Stormherald Eljrrin##56027
...
At wave 5, you will face _Falric_. Click here to move onto his strategy. |confirm |goto Halls of Reflection/1 41.3,61.9
step
kill Falric##38112
...
|tip Casters shouldn't stand near these, they use Shield Bash. This interrupts spellcasting.
|tip Line of sight the trash and wait for them to come to you. Waves of 4-5 enemies will come at a time.
At wave 10, you will face _Marwyn_. Click here to move onto his strategy. |confirm |goto Halls of Reflection/1 34.4,72.7
step
kill Marwyn##38113
...
accept Have They No Shame?##13095 |goto The Nexus 36.2,83.0
...
Defeat the Grand Champions |scenariogoal 25098 |goto Trial of the Champion/1 51.1,52.5
step
...
accept Ingvar Must Die!##11262 |goto Utgarde Keep,68.2,67.7
...
turnin Ingvar Must Die!##11262 |goto 68.2,67.7
step
...
Tell him to give you a jetpack! |goto Icecrown Citadel/2 74.7,61.9
Equip the jetpack |use Goblin Rocket Pack##49278
|confirm
step
talk High Overlord Saurfang##36939
Tell him "My companions are all accounted for, Saurfang. Let's go!" |goto Icecrown Citadel/2 73.3,61.4
...
Tell him "We're ready, Saurfang." |goto Icecrown Citadel/2 45.6,72.3
...
You can use the Naxxramas Portal to return to the start of the raid. |goto Naxxramas/2 72.7,20.4
...
You can use the Naxxramas Portal to return to the start of the raid. |goto Naxxramas/4 77.5,28.4
...
You can use the Naxxramas Portal to return to the start of the raid. |goto Naxxramas/3 27.9,80.4
Click here to start the Arachnid Quarter |next "arachnidstart" |confirm
Click here to start the Plague Quarter |next "plaguestart" |confirm
Click here to start the Construct Quarter |next "constructstart" |confirm
Click here to start Frostwyrm Lair |next "frostwyrmstart" |confirm
...
You can use the Naxxramas Portal here to return to the start of the raid. |goto Naxxramas/1 27.2,10.7
Click here to start the Arachnid Quarter |next "arachnidstart" |confirm
Click here to start the Plague Quarter |next "plaguestart" |confirm
Click here to start the Military Quarter |next "militarystart" |confirm
Click here to start Frostwyrm Lair |next "frostwyrmstart" |confirm
...
|confirm
step
_The Faction Champions Heroic_ |goto 51.2,52.4
...
Defeat Murozond |scenariogoal 2/24803 |goto End Time/6 48.2,32.4
step
label "next_5"
...
Watch for Forgemaster Throngus who patrols through the room. Go back into the hallway if you haven't cleared the trash yet. |goto 48.7,47.1
...
Follow the path to _Erudax, The Duke of Below_. |goto 86.1,57.4 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
step
click Halls of Origination Transit Device##204979 |goto 56.2,27.2 |n
...
Defeat Slabhide |scenariogoal 1/25090 |goto 37.7,44.9
step
map The Stonecore/1
path follow strict;loop off;ants straight
...
Defeat Peroth'arn |scenariogoal 2/24837 |goto 19.5,52.0
step
talk Nozdormu##55624
...
Defeat Queen Azshara |scenariogoal 3/24838 |goto 47.2,36.9
step
...
Defeat Captain Varo'then |scenariogoal 4/24839 |goto 84.7,55.0
step
...
Defeat Mannoroth |scenariogoal 4/24840 |goto 84.7,55.0
step
talk Alurmi##57864
...
Defeat Akil'zon |scenariogoal 1/24846 |goto 35.1,22.9
step
map Zul'Aman
path follow strict;loop off;ants straight
...
Defeat Halazzi |scenariogoal 1/24849 |goto 58.0,23.3
step
map Zul'Aman
path follow strict;loop off;ants straight
...
confirm
step
Once you get to this opening, avoid the rocks to make it up the hill. |goto 56.2,63.0 < 5
confirm
step
...
Follow the path, clearing trash as you make your way to the next boss, Lord Rhyolith. |goto Firelands/1 71.6,71.0 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
Follow the path, clearing trash as you make your way to the next boss, Alysrazor. |goto Firelands/1 57.9,51.2 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
Follow the path, clearing trash as you make your way to the next boss, Ragnaros. |goto Firelands/3 50.6,30.2 < 5
|tip Opening the world map will display an ant trail guiding you through the current floor.
confirm
step
...
condition_suggested=function() return level>=85 and level<=90 end,
author="support@zygorguides.com",
description="\nThis guide will walk you through the Siege of Temple of the Jade Serpent dungeon.",
},[[
step
