...
kill 1 Mekgineer Thermaplugg##7800 |q 26942/1 |only if havequest(26942)
...
kill 1 Baron Ashbury##46962 |q 27917/1 |only if havequest(27917)
...
kill 1 Commander Springvale##4278 |q 27920/2 |goto Shadowfang Keep 28.4,58.6 |only if havequest(27920)
...
kill 1 Lord Walden##46963 |q 27921/1 |goto Shadowfang Keep/4 54.2,54.3 |only if havequest(27921)
...
kill 1 Lord Godfrey##46964 |q 27968/1 |only if havequest(27968)
...
kill 1 Ironaya##7228 |q 27672/1 |goto 45.4,73.7 |only if havequest(27672)
...
Obtain the Obsidian Power Core |q 27673/1 |goto Uldaman/1 28.7,61.7 |only if havequest(27673)
...
Retrieve the Titan Power Core |q 27673/2 |goto Uldaman/1 47.5,42.5 |only if havequest(27673)
...
kill 1 Galgann Firehammer##7291 |q 27676/1 |goto Uldaman/1 25.8,35.9 |only if havequest(27676)
...
kill 1 Archaedas##2748 |q 27677/1 |goto Uldaman/2 55.4,50.7 |only if havequest(27677)
...
author="support@zygorguides.com",
description="\nThis guide will walk you through completing the Molten Core raid. This dungeon is located in Blackrock Mountain on the continent of Eastern Kingdoms and is home to Ragnaros the Firelord. This raid is level 60.",
mapid=232,
achieveid={686},
patch='30001',
condition_suggested=function() return level>=60 and level<=65 end,
...
accept War on the Ramparts##29528 |goto 48.50,68.10 |only if not havequest(29528) or not completedq(29528)
accept Demons in the Citadel##29529 |goto 48.50,68.10 |only if not havequest(29529) or not completedq(29529)
accept Hitting Them Where It Hurts##29594 |goto 48.50,68.10 |only if not havequest(29594) or not completedq(29594)
...
turnin War on the Ramparts##29528 |goto 48.50,68.10 |only if havequest(29528) and not completedq(29528)
turnin Demons in the Citadel##29529 |goto 48.50,68.10 |only if havequest(29529) and not completedq(29529)
turnin Hitting Them Where It Hurts##29594 |goto 48.50,68.10 |only if havequest(29594) and not completedq(29594)
|only if not completedallq(29528,29529,29594) and (havequest(29528) or havequest(29529) or havequest(29594))
step
_Congratulations!_
