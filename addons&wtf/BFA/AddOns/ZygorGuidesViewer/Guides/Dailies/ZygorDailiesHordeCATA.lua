...
condition_end=function() return completedanyq(26588,26572,26557,26543,26556) end,
...
Accept Today's Fishing Daily |condition false |goto 65.69,41.08 |or
...
'|condition not hasbuff("spell:80868") and not readyq(26557) |next "Collect_Stag_Eye" |or
step
...
talk Razgar##43239
turnin A Furious Catch##26588 |goto Orgrimmar/1 65.69,41.08 |only if havequest(26588)
turnin A Golden Opportunity##26572 |goto 65.69,41.08 |only if havequest(26572)
turnin A Staggering Effort##26557 |goto 65.69,41.08 |only if havequest(26557)
turnin Clammy Hands##26543 |goto 65.69,41.08 |only if havequest(26543)
turnin No Dumping Allowed##26556 |goto 65.69,41.08 |only if havequest(26556)
step
...
'|condition not completedanyq(26588,26572,26557,26543,26556) |next "Accept_Daily_Quests"
]])
...
condition_end=function() return completedanyq(29349,29345,29348,29354,29346) end,
condition_valid=function() return level >= 10 end,
condition_valid_msg="You must be level 10 or higher to use this guide.",
},[[
step
...
Accept Today's Fishing Daily |condition false |goto 56.13,46.41 |or
|tip You will only be able to accept one quest from Orgrimmar, Thunder Bluff, or Undercity each day.
...
step
Collect the Restocking Materials |condition readyq(29348) or completedq(29348) |next "Turnin_Fishing_Dailies"
step
...
label "Turnin_Fishing_Dailies"
talk Kah Mistrunner##3028
turnin Craving Crayfish##29349 |goto Thunder Bluff/0 56.13,46.41 |only if havequest(29349)
turnin Pond Predators##29345 |goto 56.13,46.41 |only if havequest(29345)
turnin The Race to Restock##29348 |goto 56.13,46.41 |only if havequest(29348)
step
...
|tip This guide will automatically reset when the dailies reset.
'|condition not completedanyq(29349,29345,29348,29354,29346) |next "Accept_Daily_Quests"
]])
...
"Like Pike?\nMoat Monster!\nTadpole Terror\nTime for Slime",
condition_end=function() return completedanyq(29320,29361,29319,29322,29317) end,
condition_valid=function() return level >= 10 end,
condition_valid_msg="You must be level 10 or higher to use this guide.",
},[[
step
...
'|condition completedanyq(29320,29361,29319,29322,29317) |or
step
...
Accept Today's Fishing Daily |condition false |goto 80.72,31.25 |or
|tip You will only be able to accept one quest from Orgrimmar, Thunder Bluff, or Undercity each day.
step
...
Lure the Moat Monster |condition itemcount(69998) == 0 |goto 66.18,17.49
step
...
'|condition not hasbuff("spell:99315") and not readyq(29320) |next "Collect_Corpse_Worm" |or
step
...
label "Turnin_Fishing_Dailies"
talk Armand Cromwell##4573
turnin Like Pike?##29320 |goto Undercity/0 80.72,31.25 |only if havequest(29320)
turnin Moat Monster!##29361 |goto 80.72,31.25 |only if havequest(29361)
turnin Tadpole Terror##29319 |goto 80.72,31.25 |only if havequest(29319)
turnin Time for Slime##29322 |goto 80.72,31.25 |only if havequest(29322)
step
...
|tip This guide will automatically reset when the dailies reset.
'|condition not completedanyq(29320,29361,29319,29322,29317) |next "Travel_to_the_Past"
]])
...
condition_valid_msg="You must be level 60 or higher to use this guide.",
},[[
step
label "Accept_Daily_Quests"
...
author="support@zygorguides.com",
description="\nThis guide section will walk you through completing the daily quests for The Sunreavers faction in the Argent Tournament Grounds area of Icecrown.",
},[[
step
label "dailies"
...
description="\nContains the pre-quests to unlock the daily quests in Deepholm. You must be at least level 82 to complete this guide section.",
},[[
step
label "hub"
Proceeding to proper section |next |only if default
...
author="support@zygorguides.com",
description="\nContains the pre-quests to unlock the daily quests in Uldum. You must be at least level 83 to complete this guide section.",
},[[
step
...
author="support@zygorguides.com",
description="\nWalks you through completing the daily quests in the Bloodgulch region of Twilight Highlands.",
},[[
step
The pre-quests for these dailies are in Uldum. You can quest through the guide, or use our Leveling Guide for help. |only if not ZGV.guidesets['LevelingHCATA']
...
author="support@zygorguides.com",
startlevel=85,
description="\nWalks you through completing the Zandalari Menace quest line in Stranglethorn Vale. You must be level 85 to be able to use this guide.",
},[[
step
talk Bwemba##53081
...
author="support@zygorguides.com",
description="\nContains the pre-quests to unlock the Firelands quest line and daily quests. You must be at least level 80 to complete this guide section.",
},[[
step
Proceeding to proper section |next |only if default
