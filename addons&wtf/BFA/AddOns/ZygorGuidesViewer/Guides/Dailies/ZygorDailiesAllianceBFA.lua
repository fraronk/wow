...
Accept 3 Bounty or Requisition Daily Quests |condition false |goto 39.06,54.81 |or 3
...
turnin Bounty: A Few Coral Ancients##55821 |goto 38.02,55.70 |or 3 |only if havequest(55821) or completedq(55821)
turnin Bounty: A Few Crabs##55823 |goto 38.02,55.70 |or 3 |only if havequest(55823) or completedq(55823)
turnin Bounty: A Few Fathom Rays##55825 |goto 38.02,55.70 |or 3 |only if havequest(55825) or completedq(55825)
turnin Bounty: A Few Hydra##55820 |goto 38.02,55.70 |or 3 |only if havequest(55820) or completedq(55820)
turnin Bounty: A Few Makrura##55822 |goto 38.02,55.70 |or 3 |only if havequest(55822) or completedq(55822)
turnin Bounty: A Few Murlocs##55819 |goto 38.02,55.70 |or 3 |only if havequest(55819) or completedq(55819)
turnin Bounty: A Few Naga##55818 |goto 38.02,55.70 |or 3 |only if havequest(55818) or completedq(55818)
turnin Bounty: A Few Snapdragons##55824 |goto 38.02,55.70 |or 3 |only if havequest(55824) or completedq(55824)
turnin Bounty: More Coral Ancients##55830 |goto 38.02,55.70 |or 3 |only if havequest(55830) or completedq(55830)
turnin Bounty: More Crabs##55832 |goto 38.02,55.70 |or 3 |only if havequest(55832) or completedq(55832)
turnin Bounty: More Fathom Rays##55834 |goto 38.02,55.70 |or 3 |only if havequest(55834) or completedq(55834)
turnin Bounty: More Hydra##55829 |goto 38.02,55.70 |or 3 |only if havequest(55829) or completedq(55829)
turnin Bounty: More Makrura##55831 |goto 38.02,55.70 |or 3 |only if havequest(55831) or completedq(55831)
turnin Bounty: More Murlocs##55828 |goto 38.02,55.70 |or 3 |only if havequest(55828) or completedq(55828)
turnin Bounty: More Naga##55827 |goto 38.02,55.70 |or 3 |only if havequest(55827) or completedq(55827)
turnin Bounty: More Snapdragons##55833 |goto 38.02,55.70 |or 3 |only if havequest(55833) or completedq(55833)
turnin Bounty: Dangerous Creatures##55837 |goto 38.02,55.70 |or 3 |only if havequest(55837) or completedq(55837)
turnin Bounty: Elite Naga Forces##55836 |goto 38.02,55.70 |or 3 |only if havequest(55836) or completedq(55836)
turnin Requisition: A Few Carp##55723 |goto 38.02,55.70 |or 3 |only if havequest(55723) or completedq(55723)
turnin Requisition: A Few Cone Shells##55726 |goto 38.02,55.70 |or 3 |only if havequest(55726) or completedq(55726)
turnin Requisition: A Few Deepcoral Buds##55724 |goto 38.02,55.70 |or 3 |only if havequest(55724) or completedq(55724)
turnin Requisition: A Few Flotsam##55727 |goto 38.02,55.70 |or 3 |only if havequest(55727) or completedq(55727)
turnin Requisition: A Few Kelp Buds##55721 |goto 38.02,55.70 |or 3 |only if havequest(55721) or completedq(55721)
turnin Requisition: A Few Seaweed##55720 |goto 38.02,55.70 |or 3 |only if havequest(55720) or completedq(55720)
turnin Requisition: A Few Spiral Leaf##55725 |goto 38.02,55.70 |or 3 |only if havequest(55725) or completedq(55725)
turnin Requisition: A Few Starfish##55719 |goto 38.02,55.70 |or 3 |only if havequest(55719) or completedq(55719)
turnin Requisition: More Carp##55789 |goto 38.02,55.70 |or 3 |only if havequest(55789) or completedq(55789)
turnin Requisition: More Cone Shells##55792 |goto 38.02,55.70 |or 3 |only if havequest(55792) or completedq(55792)
turnin Requisition: More Deepcoral Buds##55790 |goto 38.02,55.70 |or 3 |only if havequest(55790) or completedq(55790)
turnin Requisition: More Flotsam##55793 |goto 38.02,55.70 |or 3 |only if havequest(55793) or completedq(55793)
turnin Requisition: More Kelp Buds##55787 |goto 38.02,55.70 |or 3 |only if havequest(55787) or completedq(55787)
turnin Requisition: More Seaweed##55786 |goto 38.02,55.70 |or 3 |only if havequest(55786) or completedq(55786)
turnin Requisition: More Spiral Leaf##55791 |goto 38.02,55.70 |or 3 |only if havequest(55791) or completedq(55791)
turnin Requisition: More Starfish##55785 |goto 38.02,55.70 |or 3 |only if havequest(55785) or completedq(55785)
turnin Requisition: We Need It All##55801 |goto 38.02,55.70 |or 3 |only if havequest(55801) or completedq(55801)
step
...
Turn in the Requisition Quest |condition completedanyq(56747,56363,56361,55380,55379,55378,56760,56763,56755,56761,56751,56757,56753) |goto 77.59,40.57 |or
step
...
Accept Any Daily Quests Available in Rustbolt |condition false |goto 71.69,35.34
|tip
...
collect 12 Stolen Oil##168608 |q 56328/1 |goto 58.93,28.42 |only if havequest(56328)
collect 12 Stolen Oil##168608 |q 55994/1 |goto 58.93,28.42 |only if havequest(55994)
...
Obtain a Bot Re-Energizer |havebuff spell:290594 |goto 63.15,39.28 |q 54965 |only if havequest(54965)
Obtain a Bot Re-Energizer |havebuff spell:290594 |goto 63.15,39.28 |q 56327 |only if havequest(56327)
|only if haveanyquest(54965,56327)
step
Kill enemies around this area
|tip Use the "Bot Re-Energizer" ability on-screen after they die.
Deliver #12# Re-animated Bots to Bolten Springspark |q 54965/1 |goto 68.56,42.81 |only if havequest(54965)
Deliver #12# Re-animated Bots to Bolten Springspark |q 56327/1 |goto 68.56,42.81 |only if havequest(56327)
|tip
Deliver them here [63.24,38.85]
|only if haveanyquest(54965,56327)
step
talk Bolten Springspark##150086
turnin Chopped Bots##54965 |goto 63.15,39.28 |only if havequest(54965)
turnin Chopped Bots##56327 |goto 63.15,39.28 |only if havequest(56327)
|only if haveanyquest(54965,56327)
step
...
|tip This guide will reset when more become available.
'|condition not completedanyq(56184,55575,54090,56523,56558,55463,55816,55658,56410,55765,56573,55880,55695,56327,56405,56471,56493,56434,56572,55905,56621,54082) |next "Begin_Dailies"
]])
...
step
Reach Mature Reputation with the Honeyback Harvester |condition rep("Honeyback Harvester") == Mature
...
'|condition not completedanyq(57726,57670) |or |next "Kill_Honey_Smasher"
'|condition not hasbuff("spell:299445") and not completedq(57670) |or |next "Gain_Beeholder's_Buff"
'|condition completedq(57670) |or
step
...
'|condition not completedq(57670) |next "Gain_Beeholder's_Buff"
]])
