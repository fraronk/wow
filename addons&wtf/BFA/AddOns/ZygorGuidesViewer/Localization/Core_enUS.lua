...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	--['opt_group_mapinternal'] = "Internal waypointer",
		...
		['opt_pathfinding_comfort'] = "Travel comfort preference", ['opt_pathfinding_comfort_desc'] = "Choose your preference between routes fast or comfortable.\n\nFast routes may be complex - they'll have you teleport to another continent, then fly, then take a flightpath, then use a portal, and then run a few flights of stairs, but it'll still be a shortcut.\n\nComfortable paths will be easier - they may just have you hearth and take a flightpath. It'll take longer, it'll use some cooldowns, but you can go grab a tea in the meantime.\n\nYou can also pick something in between.",
		['opt_pathfinding_comfort_speed'] = "Speed", ['opt_pathfinding_comfort_comfort'] = "Comfort",
		...
		['opt_travelusewhistle'] = "Use Taxi Whistle",
	...
	--['opt_group_gold_desc'] = "These options control the behaviour of Zygor Gold Guides.",
		...
		['opt_gold_shopping_enable'] = "Enable shopping list for Gold Guide",
	...
	['opt_group_share'] = "Share Mode [BETA]",
		['opt_share_enabled'] = "Enable guide sharing [BETA]",
	...
	["stepgoal_level"] = "You should now be level %s.|n    If not, grind a little until you are.",
...
--]]
	...
	["gold_app_no_goldguide_short"] =     "No historical data is available.",
	["gold_app_no_servertrends_short"] =  "No historical data for this realm. ",
	["gold_app_old_servertrends_short"] = "Historical data is out of date (%s). ",
