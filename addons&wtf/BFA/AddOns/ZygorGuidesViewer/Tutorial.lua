...
function Tutorial:SavePositions()
	...
	loc.guideviewer = ZygorGuidesViewerFrame
	loc.options = ZygorGuidesViewerFrame_SettingsButton
	loc.help = ZygorGuidesViewerFrame_HelpButton
	loc.lock = ZygorGuidesViewerFrame_LockButton
	loc.close = ZygorGuidesViewerFrame_CloseButton
