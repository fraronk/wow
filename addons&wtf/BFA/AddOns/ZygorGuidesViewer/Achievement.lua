...
function Achievement:IconSetup()
	...
	hooksecurefunc("HybridScrollFrame_Update",function(scrollframe) if scrollframe==achievescroll then Achievement.ScheduleUpdate() end end)  -- CRAZY and inefficient.
