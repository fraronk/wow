...
-- #GLOBALS CreateFrame,GameTooltip,GetRealmName,InCombatLockdown,NO,StaticPopup_Show,StaticPopupDialogs,TargetFrame,UnitBuff,UnitClass,UnitCreatureType,UnitExists,UnitGUID,UnitIsPlayer,UnitName,UnitRace,YES,ZygorGuidesViewer
