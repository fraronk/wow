...
data.version={
	nodes_version = 301,  -- Increase this when working on the nodes. Bake the connections using the Debug menu when you're done.
}
...
-- Monk
	...
	{"Stormstout Brewery Monk/0","Stormstout Brewery Monk/1"},
	{"Stormstout Brewery Monk/1","Stormstout Brewery Monk/2"},
	{"Stormstout Brewery Monk/0","Stormstout Brewery Monk/2"},
...
-- Warrior
	...
	{"Ulduar L/1","Ulduar L/2"},
	{"Ulduar L/1","Ulduar L/3"},
	{"Ulduar L/2","Ulduar L/3"},
...
-- Highmountain
	...
	{"Highmountain/0","Highmountain/30"},
	{"Highmountain/29","Highmountain/30"},
	{"Highmountain/0","Highmountain/29"},
	...
	{"Highmountain/0","Thunder Totem/0"},
	{"Highmountain/0","Thunder Totem/6"},
	{"Thunder Totem/0","Thunder Totem/6"},

-- Stormeheim
	{"Stormheim/0","Stormheim/9"},
	{"Stormheim/0","Stormheim/25"},
	{"Stormheim/0","Stormheim/26"},
	{"Stormheim/25","Stormheim/26"},
...
-- Suramar
	...
	{"Suramar/0","Suramar/32"},
	{"Suramar/0","Suramar/33"},
	...
	{"Suramar/33","Suramar/32"},			-- Falanaar Tunnels
	{"Suramar/0","Suramar/34"},			-- Elor'shan cave

-- Val'sharah
	{"Val'sharah/0","Val'sharah/14"},		-- Sleeper's Barrow cave
	{"Val'sharah/0","Val'sharah/15"},		-- Sleeper's Barrow cave
	{"Val'sharah/14","Val'sharah/15"},		-- Sleeper's Barrow cave
...
-- Argus
	{"Azuremyst Scenario/0","Azuremyst Scenario/1"},
	{"Azuremyst Scenario/0","Azuremyst Scenario/2"},
	{"Azuremyst Scenario/0","Azuremyst Scenario/3"},
	{"Azuremyst Scenario/1","Azuremyst Scenario/2"},
	{"Azuremyst Scenario/1","Azuremyst Scenario/3"},
	{"Azuremyst Scenario/2","Azuremyst Scenario/3"},

	{"Krokuun/1","Krokuun/2"},			-- Vindicaar (Krokuun)
	{"Mac'Aree/3","Mac'Aree/4"},			-- Vindicaar (Mac'Aree)
...
data.ZoneMeta = {
	...
	["Mac'Aree/3"] = {hostile=false},	-- Vindicaar
	["Mac'Aree/4"] = {hostile=false},	-- Vindicaar
	...
	[86] = {flyable=true}, -- Cleft of Shadow, Orgrimmar
...
data.RemapData = {
	...
	[12] = { -- kalimdor
		...
		{top=911.40002441406, bottom=533.79998779297, left=-4434.2001953125, right=-4767.3002929688, target=1, cond=function() return GetQuestLogIndexByID(56719)>0 end },--Only if on quest 56719, Alliance
		{top=1700, bottom=533, left=-3710, right=-5100, target=1, cond=function() return GetQuestLogIndexByID(56993)>0 end }, --Only if on quest 56993, Alliance
		{top=1760, bottom=1681, left=-3920, right=-3990, target=1534, cond=function() return GetQuestLogIndexByID(56993)>0 end }, --Only if on quest 56993, Alliance
