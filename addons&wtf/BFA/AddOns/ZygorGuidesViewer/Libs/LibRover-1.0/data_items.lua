...
data.portkeys = { -- smile if you're a muggle
	...
	--- LEGION ---
	--------------
	{item=140192, destination="Dalaran L/10 60.92,44.72", cost=45, cooldown=1200, mode="dhearth", cond=function() local m=ZGV.CurrentMapID return m~=625 and m~=626 and m~=627 and m~=628 and m~=629 and m~=695 and m~=717 and m~=718 and m~=715 and m~=734 and m~=735 and m~=672 and m~=673 and m~=674 and m~=675 and m~=719 and m~=720 and m~=721 and m~=702 and m~=747 and m~=739 and m~=725 and m~=726 and m~=709 and m~=24 end}, -- Dalaran Hearthstone: never use from Dala or class halls
	{item=141605, destination="_TAXIWHISTLE", cost=15, cooldown=60, mode="whistle", cond=function() return LibRover.TaxiWhistlePredictor:IsOnValidMap() end }, -- Flight Master's Whistle
	...
	{item=169862, destination="Stormsong Valley/0 62.89,26.52", cost=15, cooldown=60, cond=function() local m=ZGV.CurrentMapID return m==942 end}, -- Alluring Bloom
}
