...
data.basenodes.borders = {
	...
	-- Kalimdor
		...
		"Mulgore 67.8,59.9 -x- Southern Barrens 39.8,48.0 {cond:UnitLevel('player')>30} {title:Go around the side of the Great Gate}",
	...
	-- Draenor
		...
		--"Frostfire Ridge/0 44.15,68.52 <radius:20> -x- Frostwall/0 16.21,73.99 {title_atob:Enter Garrison} {title_btoa:Leave Garrison}", -- 941 is initial Frostfire map
		--"Frostfire Ridge/0 49.63,60.27 <radius:20> -x- Frostwall/0 57.18,06.60 {title_atob:Enter Garrison} {title_btoa:Leave Garrison}", -- 941 is initial Frostfire map
		
		--"Frostfire Ridge/0 44.25,68.73 <radius:20> -x- Frostwall/0 32.18,53.49 {title_atob:Go up the ramp to the Garrison} {title_btoa:Leave Garrison following ramp down}",
		"Frostfire Ridge/0 44.25,68.73 <radius:20> -x- Frostwall/0 32.18,53.49 {title_atob1:Go uphill towards the Garrison} {title_atob2:Enter the Garrison} {title_btoa1:Leave Garrison following ramp up} {title_btoa2:Leave Garrison following ramp down}",
		"Frostfire Ridge/0 49.68,60.39 <radius:20> -x- Frostwall/0 57.26,07.74 {title_atob:Enter Garrison} {title_btoa:Leave Garrison}",

		"Shadowmoon Valley D/0 27.2,15.0 <radius:30> -x- Lunarfall/0 16.0,30.0 {title_atob:Enter Garrison} {title_btoa:Leave Garrison} {cond:C_Garrison.GetGarrisonInfo("..(LE_GARRISON_TYPE_6_0 or 2)..")==1}", -- Only if the Garrison is level 1
		"Shadowmoon Valley D/0 32.4,23.5 <radius:30> -x- Lunarfall/0 63.3,91.3 {title_atob:Enter Garrison} {title_btoa:Leave Garrison}",
		"Shadowmoon Valley D/0 27.4,13.8 <radius:30> -x- Lunarfall/0 23.3,48.3 {title_atob:Walk up the path to enter your garrison} {title_btoa:Walk down the path to leave your garrison} {cond:C_Garrison.GetGarrisonInfo("..(LE_GARRISON_TYPE_6_0 or 2)..")==3}", -- Only if the Garrison is level 3
	...
	-- Zandalar
		...
		"Zuldazar/0 53.65,56.29 -x- Dazar'alor/0 41.43,81.75",
		"Zuldazar/0 53.58,49.19 -x- Dazar'alor/0 40.93,60.84",
		"Zuldazar/0 52.97,40.12 -x- Dazar'alor/0 39.30,26.82",
		"Zuldazar/0 62.02,49.78 -x- Dazar'alor/0 60.49,64.89",
		"Zuldazar/0 60.96,48.02 -x- Dazar'alor/0 58.08,58.00",
		"Zuldazar/0 60.39,28.94 -x- Dazar'alor/0 56.02,02.19",
		"Zuldazar/0 61.06,28.95 -x- Dazar'alor/0 58.33,02.91",
		"Zuldazar/0 57.98,62.66 -x- Dazar'alor/0 50.01,99.83 {fac:H}", -- pier
		"Zuldazar/0 56.10,28.20", "Zuldazar/0 57.14,60.53 {fac:H}", -- around Dazar
