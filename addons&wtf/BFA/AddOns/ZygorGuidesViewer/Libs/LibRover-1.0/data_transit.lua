...
---------------------
	...
	--## ALLIANCE ##--
		...
		"Tanaris/17 58.98,26.75 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
		...
		"The Exodar/0 48.34,62.94 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
		...
		"Silithus/0 41.48,44.85 -to- Boralus/0 70.18,15.87 {fac:A} {mode:PORTAL} {title:Click the Portal to Tiragarde} "..
			"{cond:ZGV.InPhase('BFA') and not ZGV.InPhase('Old Silithus') and UnitLevel('player') >= 120}",

		-- Nordrassil - Mount Hyjal, Kalimdor -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Mount Hyjal/0 62.62,23.12 -to- Stormwind City/0 74.46,18.34 {fac:A} {mode:PORTAL} {cond:PlayerCompletedQuest(25316) or UnitLevel('player') >= 80}",

		-- Rut'theran Village - Darnassus, Kalimdor -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Teldrassil/0 55.03,93.72 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {cond:ZGV.InPhase('Old Darnassus')}",

		-- Rut'theran Village - Darnassus, Kalimdor -to- The Exodar - Azuremyst Isle, Kalimdor --CHECKED
		"Teldrassil/0 52.27,89.47 -to- Azuremyst Isle/0 20.52,54.16 {fac:A} {mode:PORTAL} {cond:ZGV.InPhase('Old Darnassus')}",
		...
		"Darnassus/0 43.99,78.18 <override_text:You must be at least 58 to enter Outland.> <override_icon:error> -to- Hellfire Peninsula/0 89.17,50.86 {fac:A} "..
			"{mode:PORTAL} {cond:UnitLevel('player') < 58 and ZGV.InPhase('Old Darnassus')} {cost:999}",
	...
	--## HORDE ##--
		...
		"Orgrimmar/1 56.40,92.58 -to- Tanaris/17 54.60,28.30 {fac:H} {mode:PORTAL} "..
		...
		"Orgrimmar/1 49.23,36.52 -to- Abyssal Depths/0 51.40,61.01 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(26784) or UnitLevel('player') >= 80}",
		...
		"Orgrimmar/1 48.87,38.55 -to- Uldum New/0 54.90,34.25 {fac:H} {mode:PORTAL} {cond:not ZGV.InPhase('OldUldum')}",
		...
		"Orgrimmar/1 56.00,88.24 -to- Silvermoon City/0 58.26,19.24 {fac:H} {mode:PORTAL} {title:Click the Portal to Silvermoon in the Portal Room}",
		...
		"Orgrimmar/1 51.13,38.28 -to- Mount Hyjal/0 63.49,23.37 {fac:H} {mode:PORTAL} {cond:PlayerCompletedQuest(25316) or UnitLevel('player') >= 80} "..
		...
		"Orgrimmar/1 58.91,89.53 -to- Azsuna/0 47.00,40.89 {fac:H} {mode:PORTAL} {title:Click the Portal to Azsuna in the Portal Room} "..
			"{cond:ZGV.IsLegionOn()}",

		-- Orgrimmar - Durotar, Kalimdor -to- Hall of Ancient Paths - Zuldazar, Zandalar --CHECKED
		"Orgrimmar/1 58.59,91.37 -to- Dazar'alor/1 71.96,82.78 {fac:H} {mode:PORTAL} {title:Click the Portal to Zuldazar in the Portal Room} "..
			"{cond:ZGV.InPhase('BFA')}",

--		-- Orgrimmar - Durotar, Kalimdor -to- The Dark Portal - Blasted Lands, Eastern Kingdoms --CHECKED				-- REMOVED UNTIL BLIZZARD FIXES THE BUG
--		"Orgrimmar/1 56.93,88.34 -to- Blasted Lands/0 54.89,50.11 {fac:H} {mode:PORTAL} "..
--			"{title:Talk to the Thrallmar Mage in the Portal Room\nTell him |cfff0e081\"I must report to the Dark Portal.\"}",
		...
		"Orgrimmar/1 57.11,87.34 -to- Shattrath City/0 53.01,49.21 {fac:H} {mode:PORTAL} {cond:UnitLevel('player') >= 58} "..
			"{title:Click the Portal to Shattrath in the Portal Room}",
	...
	--## NEUTRAL ##--
		...
		"Silithus/0 43.20,44.50 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {title:Click the Titan Translocator} "..
			...
			"Silithus/0 78.93,21.97 -to- Chamber of Heart/0 50.22,35.92 {mode:PORTAL} {cond:ZGV.InPhase('BFA') and ZGV.InPhase('Old Silithus')} "..
				"{title:Talk to Zidormi\nAsk her |cfff0e081\"Can you return me to the present time?\"}",
	...
	--## ALLIANCE ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Stormshield/0 31.71,52.48 {fac:A} {mode:PORTAL} {cond:UnitLevel('player') >= 90 and not ZGV.InPhase('Old Blasted Lands')} "..
			"{template:darkportal}",
		...
		"Blasted Lands/0 55.01,54.27 <override_text:You must be at least 90 to enter Draenor.> <override_icon:error> -to- Stormshield/0 31.71,52.48 {fac:A} "..
			"{mode:PORTAL} {cond:UnitLevel('player') < 90 and not ZGV.InPhase('Old Blasted Lands')} {template:darkportal} {cost:999}",
		...
		-- Stormwind - Elwynn Forest, Eastern Kingdoms -to- The Dark Portal - Blasted Lands, Eastern Kingdoms --CHECKED
--		"Stormwind City/0 49.12,87.34 -to- Blasted Lands/0 54.89,50.11 {fac:A} {mode:PORTAL} "..
--			"{title:Talk to the Honor Hold Mage Inside the Mage Tower\nTell him |cfff0e081\"I must report to the Dark Portal.\"}",
		...
		"Stormwind City/0 76.20,18.69 -to- Mount Hyjal/0 63.49,23.37 {fac:A} {mode:PORTAL} {title:Click the Portal to Hyjal} "..
			"{cond:PlayerCompletedQuest(25316) or UnitLevel('player') >= 80}",
		...
		"Stormwind City/0 48.00,93.73 -to- Boralus/0 66.81,25.06 {fac:A} {mode:PORTAL} "..
	...
	--## HORDE ##--
		...
		"Blasted Lands/0 55.01,54.27 -to- Warspear/0 44.42,35.53 {fac:H} {mode:PORTAL} {cond:UnitLevel('player') >= 90 and not ZGV.InPhase('Old Blasted Lands')} "..
			"{template:darkportal}",
		...
		"Blasted Lands/0 72.65,49.51 -to- Orgrimmar/1 57.10,89.81 {fac:H} {mode:PORTAL} {cond:UnitLevel('player') >= 90 and not ZGV.InPhase('Old Blasted Lands')}",
		...
		-- Undercity - Tirisfal Glades, Eastern Kingdoms -to- The Stair of Destiny - Hellfire Peninsula, Outland (Portal Not Usable) --CHECKED
	...
	--## NEUTRAL ##--
		...
		-- The Dark Portal - Blasted Lands, Eastern Kingdoms (Portal Usable) -to- The Stair of Destiny - Hellfire Penninsula, Outland --CHECKED, CURRENTLY BUGGED
		--"Blasted Lands/0 55.01,54.27 -to- Hellfire Peninsula/0 89.56,50.22 {mode:PORTAL} {cond:UnitLevel('player') >= 58 and ZGV.InPhase('Old Blasted Lands')} "..
		--	"{template:darkportal}",

		-- The Dark Portal - Blasted Lands, Eastern Kingdoms (Portal Usable) -to- The Stair of Destiny - Hellfire Penninsula, Outland --CHECKED, CURRENTLY BUGGED
		--"Blasted Lands/0 55.01,54.27 <override_text:You must be at least 58 to enter Outland.> <override_icon:error> -to- Hellfire Peninsula/0 89.56,50.22 "..
		--	"{mode:PORTAL} {cond:UnitLevel('player') < 58 and ZGV.InPhase('Old Blasted Lands')} {template:darkportal} {cost:999}",
	...
	--## ALLIANCE ##--
		...
		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Stormwind - Elwynn Forest, Eastern Kingdoms --CHECKED
		"Hellfire Peninsula/0 88.62,52.81 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {cond:UnitLevel('player') >= 58}",
	...
	--## HORDE ##--
		...
		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- Orgrimmar - Durotar, Kalimdor --CHECKED
		"Hellfire Peninsula/0 88.57,47.70 -to- Orgrimmar/1 57.10,89.81 {fac:H} {mode:PORTAL} {cond:UnitLevel('player') >= 58}",
	...
	--## NEUTRAL ##--
		...
		-- The Stair of Destiny - Hellfire Peninsula, Outland -to- The Dark Portal - Blasted Lands, Eastern Kingdoms --CHECKED
	...
	--## ALLIANCE ##--
		...
		"Dalaran/1 40.10,62.81 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
	...
	--## ALLIANCE ##--
		...
		"Tol Barad Peninsula/0 75.23,58.86 -to- Stormwind City/0 74.46,18.34 {fac:A} {mode:PORTAL} {cond:UnitLevel('player') >= 85}",
	...
	--## HORDE ##--
		...
		"Azsuna/0 46.66,41.30 -to- Stormwind City/0 46.35,90.23 {fac:A} {mode:PORTAL} {title:Click the Portal to Stormwind}",
	...
	--## NEUTRAL ##--
		...
		"Suramar/0 42.06,60.85 <region:suramar_sanctum_depths> -x- Suramar/0 42.72,61.13 {title:Follow the path}",
		...
		"Mac'Aree/4 49.33,25.38 -to- Dalaran L/10 60.92,44.72 {mode:PORTAL} {title_atob:Click the Portal to Dalaran\nDownstairs Inside the Vindicaar} {cond:LibRover:IsVindicaarIn('Mac\\'Aree')}",
	...
	-------------
		...
		-- DALARAN	-TO-	SKYHOLD
			"Dalaran L/10 75.23,47.22 -to- Skyhold/1 58.92,36.29 {mode:PORTAL} {title:Use the Jump to Skyhold ability} "..
				"{cond:PlayerCompletedQuest(41360) and select(2,UnitClass('player'))=='WARRIOR'}",
	...
	--## ALLIANCE ##--
		...
		"Vindicaar Scenario/2 43.23,25.02 -to- Stormwind City/0 54.00,14.75 {mode:PORTAL} {title_atob:Click the Portal to Stormwind downstairs.} {cond:ZGV:RaceClassMatch('LIGHTFORGEDDRAENEI')}",
		...
		"Shadowforge City/0 59.30,26.38 -to- Stormwind City/0 54.00,14.75 {fac:A} {mode:PORTAL} {title:Click the Mole Machine to Stormwind City} {cond:ZGV:RaceClassMatch('DARKIRONDWARF')}",
...
------------------
		...
		-- Teleport: Stormwind --
		"Stormwind City/0 49.59,86.53				<spell:3561>	<faction:A> <casttime:45>", -- takes forever to get out of the tower
		-- Teleport: Tol Barad --
