...
-- #GLOBALS CreateFrame,GetMouseFocus
-- #GLOBALS C_Garrison,C_Item,Enum
-- #GLOBALS UnitAffectingCombat,UnitGUID,UnitLevel,UnitXP,UnitXPMax
-- #GLOBALS GetFramesRegisteredForEvent,GetItemInfo,GetNumSavedInstances,GetSavedInstanceChatLink,GetSpecialization,GetSpecializationInfo,GetTime
-- #GLOBALS GameTooltip,GenericZygorLicenceEngine,LE_FOLLOWER_TYPE_GARRISON_6_0,LE_GARRISON_TYPE_6_0,RequestRaidInfo,ZGVLP
...
-- #GLOBALS GOLD_AMOUNT_TEXTURE,SILVER_AMOUNT_TEXTURE,COPPER_AMOUNT_TEXTURE,SILVER_PER_GOLD,COPPER_PER_SILVER
