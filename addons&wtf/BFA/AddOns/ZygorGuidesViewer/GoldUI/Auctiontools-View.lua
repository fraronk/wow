...
function Appraiser:MakeOptionsButton()
	...
	ZGV.AuctionButtonFrame = ZGV.ChainCall(CreateFrame("FRAME","ZygorWorldMapMenu",AuctionHouseFrame))
	...
	ZGV.AuctionButton = ZGV.ChainCall(CreateFrame("Button", "ZygorPoiAuctionButton" , ZGV.AuctionButtonFrame))
