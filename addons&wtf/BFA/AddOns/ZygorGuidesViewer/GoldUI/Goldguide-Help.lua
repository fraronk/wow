...
local auctiontool_help = {
	...
	function() return {L['gold_auctiontools_2_header'],nil,L['gold_auctiontools_2_sum'],UIParent,defaultPoint,nil,"ahshow",function() ZGV.WhoWhere:FindNPC("Auctioneer") end } end,
	function() return {L['gold_auctiontools_3_header'],nil,L['gold_auctiontools_3_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",ZGA_Toggle,"BOTTOMRIGHT"} } end,
	gen_help_2,
	gen_help_3,
	function() return {L['gold_appraisebutton_header'],nil,L['gold_appraisebutton_sum'],ZygorAppraiser,{"TOPRIGHT",Goldguide.HelpPopup.line,"BOTTOMLEFT"}, {"TOPRIGHT",ZA_Inventory_Frame.FooterAppraiseButton,"BOTTOMLEFT"} } end,
	function() return {L['gold_auctiontools_4_header'],nil,L['gold_auctiontools_4_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",ZA_Menu_Inventory,"BOTTOMRIGHT"} } end,
	function() return {L['gold_auctiontools_5_header'],nil,L['gold_auctiontools_5_sum'],ZygorAppraiser,defaultPoint2 } end,
	function() return {L['gold_auctiontools_6_header'],nil,L['gold_auctiontools_6_sum'],ZygorAppraiser,{"TOPRIGHT",Goldguide.HelpPopup.line,"BOTTOMLEFT",50,0}, {"TOPLEFT",ZA_Inventory_Frame,"TOPLEFT",100,-15} } end,
	function() return {L['gold_auctiontools_7_header'],nil,L['gold_auctiontools_7_sum'],ZygorAppraiser,{"TOPRIGHT",Goldguide.HelpPopup.line,"BOTTOMLEFT",50,0}, {"TOPLEFT",ZA_Inventory_Frame,"TOPLEFT",270,-15} } end,
	function() return {L['gold_auctiontools_8_header'],nil,{L['gold_auctiontools_8_sum'],15},ZygorAppraiser,{"TOPRIGHT",Goldguide.HelpPopup.line,"BOTTOMLEFT",50,0}, {"TOPLEFT",ZA_Inventory_Frame,"TOPLEFT",370,-15} } end,
	...
	function() return {L['gold_auctiontools_selling2_header'],nil,L['gold_auctiontools_selling2_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",AuctionsItemButton,"BOTTOMRIGHT"} } end,
	function() return {L['gold_auctiontools_selling3_header'],nil,L['gold_auctiontools_selling3_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",BuyoutPriceCopper,"BOTTOMRIGHT"} } end,
	function() return {L['gold_auctiontools_buying1_header'],nil,L['gold_auctiontools_buying1_sum'],ZygorAppraiser,{"BOTTOMLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"BOTTOMLEFT",ZA_Menu_Buy,"TOPRIGHT"},"shoppinglist" } end,
	function() return {L['gold_auctiontools_buying2_header'],nil,L['gold_auctiontools_buying2_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",ZA_INV_ROW1,"BOTTOMLEFT",40,0} } end,
	function() return {L['gold_auctiontools_buying3_header'],nil,L['gold_auctiontools_buying3_sum'],ZygorAppraiser,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",ZA_INV_ROW1,"BOTTOMLEFT",40,0} } end,
}
...
local mailtool_help = {
	...
	function() return {L['gold_mailtools_3_header'],nil,L['gold_mailtools_3_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"TOPRIGHT"}, {"TOPLEFT",Goldguide.Mail.collector.collapseWidget,"BOTTOMRIGHT"} } end,
	function() return {L['gold_mailtools_4_header'],nil,L['gold_mailtools_4_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.collector.senderTabButton,"BOTTOMRIGHT"} } end,
	function() return {L['gold_mailtools_5_header'],nil,L['gold_mailtools_5_sum'],Goldguide.Mail.base,defaultPoint } end,
	function() return {L['gold_mailtools_6_header'],nil,L['gold_mailtools_6_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.collector.frame,"BOTTOMLEFT",50,0} } end,
	function() return {L['gold_mailtools_7_header'],nil,L['gold_mailtools_7_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.collector.senderTabButton,"BOTTOMRIGHT"},"mailsender" } end,
	function() return {L['gold_mailtools_8_header'],nil,L['gold_mailtools_8_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Zygor_Appraiser_Item_1,"BOTTOMLEFT",50,0} } end,
	function() return {L['gold_mailtools_9_header'],nil,L['gold_mailtools_9_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Zygor_Appraiser_Item_1_Toggle,"BOTTOMRIGHT"} } end,
	function() return {L['gold_mailtools_10_header'],nil,L['gold_mailtools_10_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.sender.editBox,"BOTTOMRIGHT"} } end,
	function() return {L['gold_mailtools_11_header'],nil,L['gold_mailtools_11_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.sender.editBox,"BOTTOMRIGHT",25,0} } end,
	function() return {L['gold_mailtools_12_header'],nil,L['gold_mailtools_12_sum'],Goldguide.Mail.base,{"TOPLEFT",Goldguide.HelpPopup.line,"BOTTOMRIGHT"},{"TOPLEFT",Goldguide.Mail.sender.mainBut,"BOTTOMRIGHT"} } end,
	}
