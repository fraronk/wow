...
-- #GLOBALS InterfaceOptionsFrame,LibRover,LibStub,Screenshot,ShowUIPanel,UIParent,UISpecialFrames,UnitBuff,UnitClass,UnitDebuff,UnitFactionGroup,UnitName,UnitRace,ZygorGuidesViewer_DumpFrameReport,ZygorGuidesViewerMaintenanceFrame
...
function BugReport:GetReport(maint)
	local s = ""
...
function BugReport:SaveDump(text,timestamp)
