...
ItemScore.rules = {
	...
	["DEMONHUNTER"] = {
		[1] = { -- HAVOC
			itemtypes={ WARGLAIVE=1, FIST=1, AXE=1, MACE=1, SWORD=1, LEATHER=1 },
	...
	["DRUID"] = {
		[1] = { --BALANCE
			itemtypes={ DAGGER=1, MACE=1, MISCARM=1, TH_MACE=1, TH_STAFF=1, CLOTH=-50, LEATHER=1 },
			stats = { INTELLECT=1.47, HASTE=0.98, CRIT=0.81, VERSATILITY=0.78 , MASTERY=0.66 },
			primary = { STRENGTH=0, AGILITY=0, INTELLECT=1 },
		},
		[2] = { --FERAL
			itemtypes={ TH_POLE=1, TH_STAFF=1, TH_MACE=1, CLOTH=-50, LEATHER=1 },
	...
	["HUNTER"] = {
		[1] = { -- BEAST MASTERY
			itemtypes={BOW=1, CROSSBOW=1, GUN=1, CLOTH=-50, LEATHER=-50, MAIL=1 },
		...
		[3] = { -- SURVIVAL
			itemtypes={AXE=1, SWORD=1, DAGGER=1, FIST=1, TH_AXE=1, TH_SWORD=1, TH_STAFF=1, TH_POLE=1, CLOTH=-50, LEATHER=-50, MAIL=1 },
	...
	["MONK"] = {
		[1] = { --BREWMASTER-TANK
			itemtypes={ TH_POLE=1, TH_STAFF=1, FIST=1, AXE=1, SWORD=1, MACE=1, CLOTH=-50, LEATHER=1 },
		...
		[3] = { --WINDWALKER-DPS
			itemtypes={ FIST=1, AXE=1, SWORD=1, MACE=1, CLOTH=-50, LEATHER=1 },
	...
	["PALADIN"] = {
		[1] = { --HOLY
			itemtypes={ TH_POLE=1, TH_AXE=1, TH_MACE=1, TH_SWORD=1, AXE=1, MACE=1, SWORD=1, SHIELD=1, MISCARM=1, CLOTH=-50, LEATHER=-50, MAIL=-50, PLATE=1 },
			stats = { INTELLECT=1.20, CRIT=0.77, HASTE=0.75, VERSATILITY=0.66, MASTERY=0.01 },
			primary = { STRENGTH=0, AGILITY=0, INTELLECT=1 },
		},
		[2] = { --PROTECTION
			itemtypes={ AXE=1, MACE=1, SWORD=1, SHIELD=1, CLOTH=-50, LEATHER=-50, MAIL=-50, PLATE=1 },
			stats = { STRENGTH=25.84, STAMINA=25.84, HASTE=14.09, MASTERY=13.81, VERSATILITY=11.56, CRIT=9.67 },
			primary = { STRENGTH=1, AGILITY=0, INTELLECT=0 },
		},
		[3] = { --RETRIBUTION
			itemtypes={ TH_POLE=1, TH_AXE=1, TH_MACE=1, TH_SWORD=1, CLOTH=-50, LEATHER=-50, MAIL=-50, PLATE=1 },
	...
	["ROGUE"] = {
		[1] = { --ASSASSINATION
			itemtypes={ DAGGER=1, CLOTH=-50, LEATHER=1 },
			stats = { AGILITY=1.53, HASTE=1.13, CRIT=0.98, MASTERY=0.94, VERSATILITY=0.78 },
			primary = { STRENGTH=0, AGILITY=1, INTELLECT=0 },
		},
		[2] = { --OUTLAW
			itemtypes={ DAGGER=1, FIST=1, AXE=1, MACE=1, SWORD=1, CLOTH=-50, LEATHER=1 },
	...
	["SHAMAN"] = {
		[1] = { -- ELEMENTAL
			itemtypes={ DAGGER=1, FIST=1, AXE=1, MACE=1, TH_STAFF=1, TH_AXE=20, TH_MACE=20, MISCARM=1, SHIELD=1, CLOTH=-50, LEATHER=-50, MAIL=1 },
			stats = { INTELLECT=1.58, HASTE=1.01, MASTERY=0.98, CRIT=0.92, VERSATILITY=0.80 },
			primary = { STRENGTH=0, AGILITY=0, INTELLECT=1 },
		},
		[2] = { -- ENHANCEMENT:
			itemtypes={ DAGGER=1, FIST=1, AXE=1, MACE=1, TH_AXE=20, TH_MACE=20, MISCARM=1, CLOTH=-50, LEATHER=-50, MAIL=1 },
	...
	["WARRIOR"] = {
		...
		[2] = { --FURY
			itemtypes={ TH_POLE=1, TH_AXE=10, TH_MACE=10, TH_SWORD=10, DAGGER=1, FIST=1, AXE=1, MACE=1, SWORD=1, CLOTH=-50, LEATHER=-50, MAIL=-50, PLATE=1 },  -- duals...
			stats = { STRENGTH=1.14, HASTE=1.00, MASTERY=0.86, CRIT=0.82, VERSATILITY=0.80 },
			primary = { STRENGTH=1, AGILITY=0, INTELLECT=0 },
		},
		[3] = { --PROT
			itemtypes={ DAGGER=1, FIST=1, AXE=1, MACE=1, SWORD=1, SHIELD=1, CLOTH=-50, LEATHER=-50, MAIL=-50, PLATE=1},
...
-- Yes Dugi, we did update for season 3
ItemScore.MythicPlusMods = {
	-- level, bonus pack for regular gear, for azerite gear, ilvl of normal gear, ilvl of azerite gear
	 [1]={p=3524}, -- mythic baseline has no bonus ids
	 [2]={p=5440,lvl=435,aze=435}, --  azerite ilvl unknown, most likely equal to other drops
	 [3]={p=5441,lvl=435,aze=435}, -- 
	 [4]={p=5442,lvl=440,aze=440}, -- 
	 [5]={p=5443,lvl=445,aze=445}, -- 
	 [6]={p=5444,lvl=445,aze=445}, -- 
	 [7]={p=5445,lvl=450,aze=450}, -- 
	 [8]={p=5446,lvl=455,aze=455}, -- 
	 [9]={p=5447,lvl=455,aze=455}, -- 
	[10]={p=5448,lvl=455,aze=455}, --
	
	[11]={p=3509,lvl=455,aze=455}, --
	[12]={p=3510,lvl=460,aze=460}, --
	[13]={p=3534,lvl=460,aze=460}, --

	[14]={p=3535,lvl=460,aze=460}, --
	[15]={p=3536,lvl=465,aze=465}, -- 
}

-- base: 1372 - ilvl 200, so bonus is 1372-200+lvl
for i,v in pairs(ItemScore.MythicPlusMods) do
	ItemScore.MythicPlusMods[i][1] = v.p..(v.lvl and ":"..(1172+v.lvl) or "")
	ItemScore.MythicPlusMods[i][2] = v.p..(v.aze and ":"..(1172+v.aze) or "")
end
