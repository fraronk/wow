...
GRML.Dutch = function()
	...
	GRM_L["French"] = "Frans"
	GRM_L["Italian"] = "Italiaans"
	GRM_L["Russian"] = "Russisch"
	GRM_L["SpanishMX"] = "Spaans (MX)"
	GRM_L["SpanishEU"] = "Spaans (EU)"
    GRM_L["Portuguese"] = "Portugees (EU)"
    GRM_L["PortugueseBR"] = "Portugees (BR)"
	GRM_L["Korean"] = "Koreaans"
	GRM_L["MandarinCN"] = "Mandarijn (China)"
    GRM_L["MandarinTW"] = "Mandarijn (Taiwan)"
    GRM_L["Dutch"] = "Nederlands"
    GRM_L["Danish"] = "Deens"
